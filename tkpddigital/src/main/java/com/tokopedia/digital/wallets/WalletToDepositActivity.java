...
public class WalletToDepositActivity extends BaseDigitalPresenterActivity
    ...
    public void onWalletToDepositSucceeded() {
        setResult(RESULT_WALLET_TO_DEPOSIT_SUCCESS);
        finish();
    }

    @Override
    public void onWalletToDepositFailed() {
        setResult(RESULT_WALLET_TO_DEPOSIT_FAILED);
        finish();
    }
