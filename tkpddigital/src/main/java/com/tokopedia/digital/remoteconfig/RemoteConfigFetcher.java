package com.tokopedia.digital.remoteconfig;
...
public class RemoteConfigFetcher {
    ...
    public static final String NOTP_ENABLE = "app_notp_enabled";
    ...
    public void fetch(@Nullable final Listener listener) {
        if (firebaseRemoteConfig != null && activity != null) {
            firebaseRemoteConfig.setDefaults(R.xml.remote_config_notp);
