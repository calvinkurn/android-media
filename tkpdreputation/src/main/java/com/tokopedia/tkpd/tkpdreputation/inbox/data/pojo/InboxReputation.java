...
public class InboxReputation {
    ...
    @SerializedName("debug_inbox_reputation")
    @Expose
    private DebugInboxReputation debugInboxReputation;
    @SerializedName("debug_locking_status")
    @Expose
    private DebugLockingStatus debugLockingStatus;
    ...
    public DebugInboxReputation getDebugInboxReputation() {
        return debugInboxReputation;
    }

    public void setDebugInboxReputation(DebugInboxReputation debugInboxReputation) {
        this.debugInboxReputation = debugInboxReputation;
    }

    public DebugLockingStatus getDebugLockingStatus() {
        return debugLockingStatus;
    }

    public void setDebugLockingStatus(DebugLockingStatus debugLockingStatus) {
        this.debugLockingStatus = debugLockingStatus;
    }
