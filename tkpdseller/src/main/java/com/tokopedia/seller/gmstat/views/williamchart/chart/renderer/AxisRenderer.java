...
package com.tokopedia.seller.gmstat.views.williamchart.chart.renderer;
...
import com.tokopedia.seller.gmstat.views.williamchart.chart.view.ChartView.Style;
...
public abstract class AxisRenderer {
    ...
    /**
     * String formater for formating the labels
     */
    protected StringFormatRenderer stringFormatRenderer = new StringFormatRenderer() {
        @Override
...
//		if (min == max) max += 2;
     ...
     */
    public void setInnerChartBounds(float left, float top, float right, float bottom, float topCanvas, float rightCanvas) {
    ...
    public void addStringFormatRenderer(StringFormatRenderer stringFormatRenderer) {
