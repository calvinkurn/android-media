...
package com.tokopedia.seller.gmstat.views.williamchart.chart.tooltip;
...
import com.tokopedia.seller.gmstat.views.williamchart.chart.listener.OnTooltipEventListener;
...
public class Tooltip extends RelativeLayout {
     ...
     *              clicked {@link com.tokopedia.seller.gmstat.views.williamchart.chart.model.ChartEntry}.
    ...
    public void prepare(Rect rect, float value) {
        ...
        if (mTooltipValue != null)
            mTooltipValue.setText(stringFormatRenderer.formatString(String.valueOf(value)));
    }


    /**
     * Corrects the position of a tooltip and forces it to
     * be within {@link com.tokopedia.seller.gmstat.views.williamchart.chart.view.ChartView}.
     *
     * @param left   left coordinate of {@link com.tokopedia.seller.gmstat.views.williamchart.chart.view.ChartView}
     * @param top    top coordinate of {@link com.tokopedia.seller.gmstat.views.williamchart.chart.view.ChartView}
     * @param right  right coordinate of {@link com.tokopedia.seller.gmstat.views.williamchart.chart.view.ChartView}
     * @param bottom bottom coordinate of {@link com.tokopedia.seller.gmstat.views.williamchart.chart.view.ChartView}
     */
