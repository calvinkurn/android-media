...
public class BuyerDataViewHelper2 {
    ...
    public BuyerDataViewHelper2(TitleCardView buyerDataCardView) {
    ...
    public void bindData(long totalBuyer, long maleBuyerCount, long femaleBuyerCount,
                         double diffTotalPercent) {
