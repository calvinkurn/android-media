...
public class ProductVariantDetailLevel1Activity extends BaseSimpleActivity implements
...
//    public static final String EXTRA_ACTION_DELETE = "del";
    ...
    public static Intent getIntent(Context context,
                                   ...
                                   int variantLevel1Id,
                                   String variantName){
        Intent intent = new Intent(context, ProductVariantDetailLevel1Activity.class);
