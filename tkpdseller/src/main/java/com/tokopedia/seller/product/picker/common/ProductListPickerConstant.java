package com.tokopedia.seller.product.picker.common;

/**
 * Created by zulfikarrahman on 9/8/17.
 */

public class ProductListPickerConstant {
    public static final String PRODUCT_LIST_PICKER_MODEL_EXTRA = "PRODUCT_LIST_PICKER_MODEL_EXTRA";
    public static final int MAX_LIMIT_PRODUCT_LIST_FEATURED_PICKER = 5;
    public static final String REQUEST_PER_PAGE = "10";
