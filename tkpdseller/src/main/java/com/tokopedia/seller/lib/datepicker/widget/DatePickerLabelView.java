...
public class DatePickerLabelView extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        try {
            ...
            colorValue = styledAttributes.getColor(R.styleable.DatePickerLabelView_date_picker_content_color, ContextCompat.getColor(getContext(), R.color.tkpd_main_green));
        } finally {
