...
public abstract class BaseBarChartView extends ChartView {
	...
	void calculatePositionOffset(int size) {
		...
		if (size % 2 == 0) drawingOffset = size * barWidth / 2 + (size - 1) * (style.setSpacing / 2);
	 ...
	 *
	 * @param spacing Spacing between {@link com.tokopedia.seller.lib.williamchart.model.Bar}
	 */
	 ...
	 *
	 * @param spacing Spacing between {@link com.tokopedia.seller.lib.williamchart.model.BarSet}
	 */
	 ...
	 *
	 * @param radius Radius applied to the corners of {@link com.tokopedia.seller.lib.williamchart.model.Bar}
	 */
