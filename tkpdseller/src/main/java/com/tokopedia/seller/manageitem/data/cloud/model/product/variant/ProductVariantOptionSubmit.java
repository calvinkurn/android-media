package com.tokopedia.seller.manageitem.data.cloud.model.product.variant;
...
import com.tokopedia.seller.manageitem.data.model.PictureItem;
...
public class ProductVariantOptionSubmit implements Parcelable {
    ...
    @Expose
    private List<com.tokopedia.seller.manageitem.data.model.PictureItem> pictureItemList;
    ...
    public List<com.tokopedia.seller.manageitem.data.model.PictureItem> getPictureItemList() {
        return pictureItemList;
    }

    public void setPictureItemList(List<com.tokopedia.seller.manageitem.data.model.PictureItem> pictureItemList) {
