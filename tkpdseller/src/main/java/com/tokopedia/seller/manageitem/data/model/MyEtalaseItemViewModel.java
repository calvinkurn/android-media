package com.tokopedia.seller.manageitem.data.model;
...
public class MyEtalaseItemViewModel implements EtalaseViewModel, Parcelable {
    public static final int LAYOUT = R.layout.item_product_manage_item_etalase_picker;
    ...
    public static final Creator<MyEtalaseItemViewModel> CREATOR = new Creator<MyEtalaseItemViewModel>() {
        @Override
