...
public class HorizontalStackBarChartView extends BaseStackBarChartView {
	 ...
	 *
	 * @param data Array of {@link ChartSet} to do the necessary preparation just
	 * before onDraw
	 */
	@Override
	public void onPreDrawChart(ArrayList<ChartSet> data) {
		...
		if (data.get(0).size() == 1) barWidth =
				  (this.getInnerChartBottom() - this.getInnerChartTop() - this.getBorderSpacing() * 2);
