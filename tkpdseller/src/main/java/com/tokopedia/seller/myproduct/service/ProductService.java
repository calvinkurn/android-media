package com.tokopedia.seller.myproduct.service;
...
import com.tokopedia.seller.myproduct.presenter.ManageProductPresenter;
import com.tokopedia.seller.myproduct.utils.MessageErrorException;
import com.tokopedia.seller.myproduct.utils.ProductEditHelper;
import com.tokopedia.seller.myproduct.utils.UploadPhotoTask;
import com.tokopedia.seller.myproduct.network.ProductActAfterService;
    ...
    public static void startDownload(Context context, Bundle bundle, int type) {
        ...
        switch (type) {
            ...
            case TkpdState.ProductService.ADD_PRODUCT:
                ...
                intent.putExtra(TkpdState.ProductService.PRODUCT_POS, bundle.getInt(TkpdState.ProductService.PRODUCT_POS));
            ...
            case TkpdState.ProductService.EDIT_PRODUCT:
                ...
                intent.putExtra(ProductService.PRODUCT_CHANGE_WHOLESALE, bundle.getString(ProductService.PRODUCT_CHANGE_WHOLESALE));
        ...
        switch (type) {
            ...
            case TkpdState.ProductService.ADD_PRODUCT:
                sendProductServiceBroadcast(
                        ...
                        intent.getIntExtra(TkpdState.ProductService.PRODUCT_POS, 0),
                ...
                if (productId != (-1)) {
                    ...
                    inputAddProductModel.setPosition(intent.getIntExtra(TkpdState.ProductService.PRODUCT_POS, 0));
...
//        notificationService = new NotificationProductService(this, inputAddProductModel.getProduk().getNameProd());
                    ...
                    public void onError(Throwable e) {
                        if (e != null) {
                            ...
                            sendProductServiceBroadcast(
                                    ...
                                    TkpdState.ProductService.NO_PRODUCT_POS,
                                    TkpdState.ProductService.NO_PRODUCT_ID,
                                    CommonUtils.generateMessageError(getApplicationContext(), error));
                        }
                    }
    ...
    private void sendProductServiceBroadcast(int type, int status, long productDb, int productPosition, int productId, String errorMessage) {
        ...
        if(productDb != TkpdState.ProductService.NO_PRODUCT_DB) {
            bundle.putLong(TkpdState.ProductService.PRODUCT_DB_ID, productDb);
        }
        if(productPosition != TkpdState.ProductService.NO_PRODUCT_POS) {
            bundle.putInt(TkpdState.ProductService.PRODUCT_POS, productPosition);
        }
        if(productId != TkpdState.ProductService.NO_PRODUCT_ID){
            bundle.putInt(TkpdState.ProductService.PRODUCT_ID, productId);
        }
        if(!errorMessage.equals(TkpdState.ProductService.INVALID_MESSAGE_ERROR)){
        ...
        return new Func1<InputAddProductModel, Observable<InputAddProductModel>>() {
            ...
            public Observable<InputAddProductModel> call(InputAddProductModel inputAddProductModel) {
                ...
                Observable<AddProductPictureModel> addProductPictureAfter =
                        new ProductActAfterService(HTTPS + generateHost.getUploadHost() +
                                "/web-service/v4/action/upload-image-helper/").
                                getApi().addProductPictureAfter(AuthUtil.generateParams(getApplicationContext(), param));
    ...
    private Func1<InputAddProductModel, Observable<InputAddProductModel>> addProductValidation() {
        return new Func1<InputAddProductModel, Observable<InputAddProductModel>>() {
            ...
            public Observable<InputAddProductModel> call(InputAddProductModel inputAddProductModel) {
                ...
                if (inputAddProductModel.getStockStatus().equals(EtalaseVariable.ETALASE_GUDANG)) {
...
//        param.put("product_change_photo","");
        ...
        if (stockStatus.equals(EtalaseVariable.ETALASE_GUDANG)) {
...
//                                }
    ...
    public Observable<EditProductPictureModel> editProductPicture(String userId_, String deviceId_, UploadProductImageData uploadProductImageData) {
