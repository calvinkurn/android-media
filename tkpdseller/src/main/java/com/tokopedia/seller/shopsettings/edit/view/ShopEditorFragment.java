    ...
    void showAboutGM() {
        if(GlobalConfig.isSellerApp()) {
            ...
            if (launchIntent != null) {
                UnifyTracking.eventGMSwitcherManageShop(getActivity(), AppEventTracking.EventLabel.OPEN_TOP_SELLER+AppEventTracking.EventLabel.OPEN_APP);
                getActivity().startActivity(launchIntent);
            } else if (getActivity().getApplication() instanceof TkpdCoreRouter) {
                UnifyTracking.eventGMSwitcherManageShop(getActivity(), AppEventTracking.EventLabel.OPEN_GM+AppEventTracking.Category.SWITCHER);
