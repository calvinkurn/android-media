...
public class GetGMSubscribeExtendProductUseCase extends UseCase<List<GMProductDomainModel>> {
    ...
    public GetGMSubscribeExtendProductUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, ProductRepository productRepository) {
    ...
    public Observable<List<GMProductDomainModel>> createObservable(RequestParams requestParams) {
        return productRepository.getExtendProductSelection();
    }
}
