...
// */
//
//public class OpportunityListUseCase extends UseCase<OpportunityFilterViewModel> {
//
...
//
//    @Override
//    public Observable<OpportunityFilterViewModel> createObservable(final RequestParams params) {
//        final OpportunityFilterViewModel viewModel = new OpportunityFilterViewModel();
//        return Observable.just(viewModel)
//                .flatMap(new Func1<OpportunityFilterViewModel,
//                        Observable<OpportunityFilterViewModel>>() {
//                    @Override
//                    public Observable<OpportunityFilterViewModel> call(
//                            OpportunityFilterViewModel opportunityFilterViewModel) {
//                        return getOpportunityFilterObservable(params, opportunityFilterViewModel);
//                    }
//                })
//                .flatMap(new Func1<OpportunityFilterViewModel,
//                        Observable<OpportunityFilterViewModel>>() {
...
//                    public Observable<OpportunityFilterViewModel> call(
//                            OpportunityFilterViewModel opportunityFilterViewModel) {
//                        return getOpportunityListObservable(params, opportunityFilterViewModel);
//                    }
//                });
//    }
//
//
//    private void setListViewModel(OpportunityFilterViewModel viewModel,
//                                  OpportunityModel opportunityModel) {
//        viewModel.setOpportunityViewModel(getOpportunityViewModel(opportunityModel));
//    }
//
//    private void setFilterViewModel(OpportunityFilterViewModel viewModel,
//                                    OpportunityCategoryData opportunityCategoryData) {
...
//    }
//
//    private Observable<OpportunityFilterViewModel> getOpportunityFilterObservable(
//            RequestParams requestParams,
//            final OpportunityFilterViewModel opportunityFilterViewModel) {
//        return getOpportunityFilterUseCase.createObservable(
//                getOpportunityFilterParam(requestParams))
//                .flatMap(new Func1<OpportunityCategoryModel,
//                        Observable<OpportunityFilterViewModel>>() {
//                    @Override
//                    public Observable<OpportunityFilterViewModel> call(
//                            OpportunityCategoryModel opportunityCategoryModel) {
//                        setFilterViewModel(opportunityFilterViewModel,
//                                opportunityCategoryModel.getOpportunityCategoryData());
//                        return Observable.just(opportunityFilterViewModel);
//                    }
//                })
//                .onErrorReturn(new Func1<Throwable, OpportunityFilterViewModel>() {
//                    @Override
//                    public OpportunityFilterViewModel call(Throwable throwable) {
//                        setFilterViewModel(opportunityFilterViewModel,
//                                new OpportunityCategoryData());
...
//    }
//
//    private Observable<OpportunityFilterViewModel> getOpportunityListObservable(
//            RequestParams requestParams,
//            final OpportunityFilterViewModel opportunityFilterViewModel) {
//
//        return getOpportunityUseCase
//                .createObservable(getOpportunityListParam(requestParams))
//                .flatMap(new Func1<OpportunityModel, Observable<OpportunityFilterViewModel>>() {
//                    @Override
//                    public Observable<OpportunityFilterViewModel> call(
//                            OpportunityModel opportunityModel) {
//                        setListViewModel(opportunityFilterViewModel, opportunityModel);
//                        return Observable.just(opportunityFilterViewModel);
//                    }
//                });
//    }
