...
public class TopAdsCustomRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public TopAdsCustomRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public TopAdsCustomRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        attributes.recycle();
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof TopAdsCustomRadioButton) {
            final TopAdsCustomRadioButton button = (TopAdsCustomRadioButton) child;
    ...
    private void setCheckedStateForView(int viewId, boolean checked) {
        ...
        if (checkedView != null && checkedView instanceof TopAdsCustomRadioButton) {
            ((TopAdsCustomRadioButton) checkedView).setChecked(checked);
        }
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new TopAdsCustomRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void traverseTree(View view) {
            if (view instanceof TopAdsCustomRadioButton) {
                ...
                TopAdsCustomRadioButton radioButton = ((TopAdsCustomRadioButton) view);
        ...
        public void onChildViewAdded(View parent, View child) {
            traverseTree(child);
            if (parent == TopAdsCustomRadioGroup.this && child instanceof TopAdsCustomRadioButton) {
                int id = child.getId();
                // generates an id if it's missing
                if (id == View.NO_ID) {
                    id = View.generateViewId();
                ...
                TopAdsCustomRadioButton radioButton = ((TopAdsCustomRadioButton) child);
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == TopAdsCustomRadioGroup.this && child instanceof TopAdsCustomRadioButton) {
                ((TopAdsCustomRadioButton) child).clearOnCheckedChangeListener();
            }
    ...
    private void setFlagRadioButton(TopAdsCustomRadioButton radioButton) {
