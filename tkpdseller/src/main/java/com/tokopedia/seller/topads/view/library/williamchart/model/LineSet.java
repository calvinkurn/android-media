...
package com.tokopedia.seller.topads.view.library.williamchart.model;
...
import com.tokopedia.seller.topads.view.library.williamchart.Tools;


/**
 * Data model containing a set of {@link Point} to be used by {@link
 * com.tokopedia.seller.topads.view.library.williamchart.view.LineChartView}.
 */
public class LineSet extends ChartSet {
	...
	private int mIsSmooth;
	public static final int NON_SMOOTH = 0;
	public static final int SMOOTH_CUBIC = 1;
	public static final int SMOOTH_QUAD =2;
...
//	}
	...
	/**
	 *
	 * @param type {@value NON_SMOOTH}, {@value SMOOTH_CUBIC}, {@value SMOOTH_QUAD}
	 * @return {@link LineSet} self-reference
     */
	public LineSet setSmooth(int type){
		mIsSmooth = type;
		return this;
	}
