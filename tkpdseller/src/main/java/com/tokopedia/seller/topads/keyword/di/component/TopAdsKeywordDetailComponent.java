...
import com.tokopedia.seller.topads.keyword.view.fragment.TopAdsBaseKeywordDetailFragment;
...
public interface TopAdsKeywordDetailComponent {
    void inject(TopAdsBaseKeywordDetailFragment topAdsKeywordDetailFragment);
}
