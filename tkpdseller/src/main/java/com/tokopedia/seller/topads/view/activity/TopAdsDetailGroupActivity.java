                ...
                if (toolbar.getHeight() > 0) {
                    ...
                    showCaseList.add(
                            new ShowCaseObject(
                                    ...
                                    getString(R.string.showcase_topads_detail_group_title_1),
                                    getString(R.string.showcase_topads_detail_group_desc_1),
                    ...
                    if (statusView!= null) {
                        showCaseList.add(
                                new ShowCaseObject(
                                        statusView,
                                        getString(R.string.showcase_topads_detail_group_title_2),
                                        getString(R.string.showcase_topads_detail_group_desc_2),
                                        ShowCaseContentPosition.UNDEFINED,
                                        Color.WHITE) );
                    }
                    ...
                    if (productView!= null) {
                        showCaseList.add(
                                new ShowCaseObject(
                                        productView,
                                        getString(R.string.showcase_topads_detail_group_title_3),
                                        getString(R.string.showcase_topads_detail_group_desc_3),
                                        ShowCaseContentPosition.UNDEFINED,
                                        Color.WHITE) );
                    }
