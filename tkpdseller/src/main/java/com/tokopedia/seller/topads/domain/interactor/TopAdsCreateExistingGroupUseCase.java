 ...
 */
public class TopAdsCreateExistingGroupUseCase extends UseCase<TopAdsDetailGroupViewModel> {
    ...
    public TopAdsCreateExistingGroupUseCase(ThreadExecutor threadExecutor,
        ...
        return topAdsGroupAdsRepository.createGroup(
                ...
                .map(new Func1<DataResponseCreateGroup, TopAdsDetailGroupViewModel>() {
                    ...
                    public TopAdsDetailGroupViewModel call(DataResponseCreateGroup dataResponseCreateGroup) {
                        ...
                        topAdsDetailGroupViewModel.setPriceDaily(dataResponseCreateGroup.getPriceDaily());
