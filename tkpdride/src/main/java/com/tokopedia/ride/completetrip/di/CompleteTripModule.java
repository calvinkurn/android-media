...
import com.tokopedia.ride.completetrip.domain.GetTipListUseCase;
...
public class CompleteTripModule {
    ...
    @Provides
    @CompleteTripScope
    GetTipListUseCase provideGetTipListUseCase(ThreadExecutor threadExecutor,
                                               PostExecutionThread postExecutionThread,
                                               BookingRideRepository bookingRideRepository) {
        return new GetTipListUseCase(threadExecutor, postExecutionThread, bookingRideRepository);
    }
