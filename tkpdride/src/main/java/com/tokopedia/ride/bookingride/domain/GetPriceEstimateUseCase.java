...
public class GetPriceEstimateUseCase extends UseCase<List<PriceEstimate>> {
    ...
    public GetPriceEstimateUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, BookingRideRepository bookingRideRepository) {
        super(threadExecutor, postExecutionThread);
        this.bookingRideRepository = bookingRideRepository;
    }

    @Override
    public Observable<List<PriceEstimate>> createObservable(RequestParams requestParams) {
        return bookingRideRepository.getPriceEstimate(requestParams.getParameters());
    }
}
