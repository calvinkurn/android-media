...
public class GetUserAddressUseCase extends UseCase<List<RideAddress>> {
    ...
    public GetUserAddressUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, BookingRideRepository bookingRideRepository) {
    ...
    public Observable<List<RideAddress>> createObservable(RequestParams requestParams) {
        return bookingRideRepository.getAddresses(requestParams.getParameters());
    }
}
