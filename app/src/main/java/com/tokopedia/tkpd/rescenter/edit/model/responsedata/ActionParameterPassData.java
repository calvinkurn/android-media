package com.tokopedia.tkpd.rescenter.edit.model.responsedata;
...
import com.tokopedia.tkpd.rescenter.edit.model.passdata.ActionResponseData;
import com.tokopedia.tkpd.rescenter.edit.model.passdata.AppealResCenterFormData;
import com.tokopedia.tkpd.rescenter.edit.model.passdata.EditResCenterFormData;
import com.tokopedia.tkpd.rescenter.edit.model.passdata.EditResCenterFormData.SolutionData;
import com.tokopedia.tkpd.rescenter.edit.model.passdata.EditResCenterFormData.TroubleCategoryData;
import com.tokopedia.tkpd.rescenter.edit.model.passdata.EditResCenterFormData.TroubleData;
...
public class ActionParameterPassData implements Parcelable {
    ...
    private TroubleCategoryData troubleCategoryChoosen;
    ...
    // collected in step 3
    private SolutionData solutionChoosen;
    ...
    public void setAttachmentData(List<AttachmentResCenterDB> attachmentData) {
    ...
    public TroubleCategoryData getTroubleCategoryChoosen() {
        return troubleCategoryChoosen;
    }

    public void setTroubleCategoryChoosen(TroubleCategoryData troubleCategoryChoosen) {
        this.troubleCategoryChoosen = troubleCategoryChoosen;
    }

    public TroubleData getTroubleChoosen() {
        return troubleChoosen;
    }

    public void setTroubleChoosen(TroubleData troubleChoosen) {
        this.troubleChoosen = troubleChoosen;
    }

    public SolutionData getSolutionChoosen() {
        return solutionChoosen;
    }

    public void setSolutionChoosen(SolutionData solutionChoosen) {
    ...
    protected ActionParameterPassData(Parcel in) {
        ...
        this.troubleCategoryChoosen = in.readParcelable(TroubleCategoryData.class.getClassLoader());
        this.packageStatus = in.readInt();
        this.troubleChoosen = in.readParcelable(TroubleData.class.getClassLoader());
        this.productTroubleChoosenList = in.createTypedArrayList(PassProductTrouble.CREATOR);
        this.inputDescription = in.readString();
        this.solutionChoosen = in.readParcelable(SolutionData.class.getClassLoader());
        this.refund = in.readString();
        this.attachmentData = in.createTypedArrayList(AttachmentResCenterDB.CREATOR);
