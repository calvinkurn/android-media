...
import com.tokopedia.tkpd.rescenter.inbox.facade.Facade;
import com.tokopedia.tkpd.rescenter.inbox.facade.FacadeImpl;
import com.tokopedia.tkpd.rescenter.inbox.facade.NetworkParam;
...
public class InboxResCenterImpl implements InboxResCenterPresenter {
    ...
    public void setActionOnItemListClickListener(Context context, String resolutionID) {
        ...
        Intent intent = com.tokopedia.tkpd.rescenter.detail.activity.ResCenterActivity.newInstance(context, activityParamenterPassData);
