 ...
 * Created on 8/28/16.
 */
public class SolutionSpinnerAdapter extends ArrayAdapter<EditResCenterFormData.SolutionData> {

    private class ViewHolder {
        TextView textView;
    }

    public SolutionSpinnerAdapter(Context context, int textViewResourceId, List<EditResCenterFormData.SolutionData> objects) {
