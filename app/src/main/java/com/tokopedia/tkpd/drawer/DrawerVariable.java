...
import com.tokopedia.tkpd.drawer.var.UserType;
    ...
    private void startAction(int position) {
        ...
        switch (((DrawerItem) model.data.get(position)).id) {
            ...
            case TkpdState.DrawerPosition.REGISTER:
                ...
                intent.putExtra(com.tokopedia.tkpd.session.presenter.Session.WHICH_FRAGMENT_KEY, ((DrawerItem) model.data.get(position)).id);
