...
import com.tokopedia.tkpd.database.model.SimpleDatabaseModel;
import com.tokopedia.tkpd.database.model.SimpleDatabaseModel_Table;
...
public class GlobalCacheManager implements DbFlowOperation<SimpleDatabaseModel> {
    ...
    public GlobalCacheManager setCacheDuration(int duration) {
        Log.i(TAG, "Storing expired time: " + (System.currentTimeMillis() / 1000L + (duration * 1000)));
        this.expiredTime = System.currentTimeMillis() / 1000L + (duration * 1000);
        return this;
    }
