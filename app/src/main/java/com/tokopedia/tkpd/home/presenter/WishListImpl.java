...
import com.tokopedia.tkpd.database.CacheDuration;
...
import com.tokopedia.tkpd.home.model.wishlist.Pagination;
import com.tokopedia.tkpd.home.model.wishlist.Wishlist;
import com.tokopedia.tkpd.home.model.wishlist.WishlistPaging;
...
public class WishListImpl implements WishList {
    ...
    public void fetchDataFromInternet(final Context context) {
        Observable<Response<com.tokopedia.tkpd.home.model.wishlist.WishlistData>> observable = mojitoService.getApi().getWishlist(
                SessionHandler.getLoginID(context),
                10,
                mPaging.getPage()
        );

        Subscriber<Response<com.tokopedia.tkpd.home.model.wishlist.WishlistData>> subscriber = new Subscriber<Response<com.tokopedia.tkpd.home.model.wishlist.WishlistData>>() {
            @Override
            ...
            @Override
            public void onNext(Response<com.tokopedia.tkpd.home.model.wishlist.WishlistData> response) {
    ...
    @Override
    public void setData(com.tokopedia.tkpd.home.model.wishlist.WishlistData wishlistData) {
        ...
        for (int i = 0; i < dataWishlist.size(); i++) {
            if (productId.equals(dataWishlist.get(i).getId())) {
                ...
                context.startActivity(
                        AddToCartActivity.createInstance(context, pass)
                );
