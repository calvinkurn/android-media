...
import com.tokopedia.tkpd.facade.FacadeTopAds;
...
import com.tokopedia.tkpd.home.model.network.ProductFeedData3;
...
import com.tokopedia.tkpd.myproduct.utils.FileUtils;
import com.tokopedia.tkpd.network.NetworkHandler;
import com.tokopedia.tkpd.network.apiservices.etc.HomeService;
...
import com.tokopedia.tkpd.var.TopAds;
    ...
    public void getRecentProductFromCache() {
        cacheHome.getProductFeedCache(new CacheHomeInteractor.GetProductFeedCacheListener() {
            ...
            public void onSuccess(ProductFeedTransformData productFeedTransformData) {
                ...
                DataFeedAdapter.HistoryProductListItem historyProductListItem = new DataFeedAdapter.HistoryProductListItem(productFeedTransformData.getHorizontalProductList().getListProduct());
...
//                                FileUtils.writeStringAsFileExt(mContext, productFeedTransformData.getHorizontalProductList() + "", "check_horizontal.txt");
                                ...
                                result.add(new DataFeedAdapter.HistoryProductListItem(listProduct));
