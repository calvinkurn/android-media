package com.tokopedia.tkpd.home.model.network;
...
public class ProductFeedTransformData {
    ...
    public ProductFeedTransformData(Map<String, String> header, Map<String, String> content, HorizontalProductList horizontalProductList) {
        this.header = header;
