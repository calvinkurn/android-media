...
import static com.tokopedia.tkpd.home.adapter.DataFeedAdapter.HistoryProductListItem.HISTORY_PRODUCT_LIST_ITEM;
...
import static com.tokopedia.tkpd.var.ProductItem.PRODUCT_ITEM_TYPE;
...
public class DataFeedAdapter extends ProductAdapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)){
            case PRODUCT_ITEM_TYPE:
                ...
                break;
            case HISTORY_PRODUCT_LIST_ITEM:
                bindHistoryProductViewHolder((ProductFeedAdapter.ViewHolderHistoryProduct) holder, position);
                break;
            default:
    ...
    private void renderHistoryProduct(ProductFeedAdapter.ViewHolderHistoryProduct holder, HistoryProductListItem dataHistory) {
    ...
    private void renderEmptyHistoryProduct(ProductFeedAdapter.ViewHolderHistoryProduct holder) {
