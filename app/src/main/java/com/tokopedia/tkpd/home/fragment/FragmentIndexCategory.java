...
import com.tokopedia.tkpd.home.facade.FacadePromo.PromoItem;
import com.tokopedia.tkpd.home.model.Banner;
import com.tokopedia.tkpd.home.model.Ticker;
import com.tokopedia.tkpd.home.model.homeMenu.CategoryItemModel;
...
import com.tokopedia.tkpd.recharge.presenter.RechargeCategoryPresenter;
import com.tokopedia.tkpd.recharge.presenter.RechargeCategoryPresenterImpl;
import com.tokopedia.tkpd.recharge.view.RechargeCategoryView;
import com.tokopedia.tkpd.recharge.view.widget.WrapContentViewPager;
import com.tokopedia.tkpd.util.NonScrollLayoutManager;
...
//        setTicker(banner);
    ...
    private void addChildTablayout(CategoryData rechargeCategory, List<Integer> newRechargePositions) {
        for (int i = 0; i < rechargeCategory.getData().size(); i++) {
            com.tokopedia.tkpd.recharge.model.category.Category category = rechargeCategory.getData().get(i);
