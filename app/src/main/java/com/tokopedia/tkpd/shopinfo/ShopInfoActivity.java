...
import com.tokopedia.tkpd.shopinfo.adapter.ShopTabPagerAdapter;
import com.tokopedia.tkpd.shopinfo.facades.ActionShopInfoRetrofit;
import com.tokopedia.tkpd.shopinfo.facades.GetShopInfoRetrofit;
import com.tokopedia.tkpd.shopinfo.models.shopmodel.Info;
...
public class ShopInfoActivity extends TActivity {
    ...
    private com.tokopedia.tkpd.shopinfo.models.shopmodel.ShopModel shopModel;
    ...
    private void initModel() {
        shopModel = new com.tokopedia.tkpd.shopinfo.models.shopmodel.ShopModel();
    ...
    private GetShopInfoRetrofit.OnGetShopInfoListener onGetShopInfoRetro() {
        return new GetShopInfoRetrofit.OnGetShopInfoListener() {
            ...
            public void onSuccess(String result) {
                showShopInfo();
                shopModel = new Gson().fromJson(result, com.tokopedia.tkpd.shopinfo.models.shopmodel.ShopModel.class);
