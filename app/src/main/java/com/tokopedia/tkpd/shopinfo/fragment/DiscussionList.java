...
import com.tokopedia.tkpd.shopinfo.adapter.DiscussionAdapter;
import com.tokopedia.tkpd.shopinfo.facades.ActionShopTalkRetrofit;
import com.tokopedia.tkpd.shopinfo.facades.GetShopTalkRetrofit;
...
//        outState.putInt("page", page);
    ...
    private void openTalk(int pos) {
        com.tokopedia.tkpd.shopinfo.models.talkmodel.List model = modelList.list.get(pos);
