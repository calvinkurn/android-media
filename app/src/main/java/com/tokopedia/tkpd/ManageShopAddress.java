...
import com.tokopedia.tkpd.customadapter.ListViewManageShopLocation;
import com.tokopedia.tkpd.network.NetworkErrorHelper;
import com.tokopedia.tkpd.network.apiservices.shop.MyShopAddressActService;
import com.tokopedia.tkpd.network.apiservices.shop.MyShopAddressService;
...
import com.tokopedia.tkpd.shoplocation.model.deletelocation.DeleteLocationResponse;
import com.tokopedia.tkpd.shoplocation.model.getshopaddress.ShopAddress;
    ...
    private void SetToUIV4(ShopAddress data) {
        if (data.getList() != null) {
            ...
            for (int i = 0; i < data.getList().size(); i++) {
                com.tokopedia.tkpd.shoplocation.model.getshopaddress.List Location = data.getList().get(i);
