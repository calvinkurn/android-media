 ...
 */
public class WrappedTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public WrappedTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
