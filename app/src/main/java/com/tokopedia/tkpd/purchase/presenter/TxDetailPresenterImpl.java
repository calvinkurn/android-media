...
import com.tokopedia.tkpd.facade.FacadeLuckyNotification;
...
import com.tokopedia.tkpd.util.UploadImageHandler;
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, int which) {
                        ...
                        viewListener.navigateToActivityRequest(CreateResCenterActivity.newInstancePackageNotReceived(context,
                                orderData.getOrderDetail().getDetailOrderId(), 5, 6), CREATE_RESCENTER_REQUEST_CODE);
                    }
                });
        builder.setNegativeButton(context.getString(R.string.action_refund),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, int which) {
                         ...
                         */
                        viewListener.navigateToActivityRequest(CreateResCenterActivity.newInstancePackageNotReceived(context,
                                orderData.getOrderDetail().getDetailOrderId(), 5, 1), CREATE_RESCENTER_REQUEST_CODE);
                    }
                });
