...
import com.tokopedia.tkpd.session.presenter.RegisterImpl;
import com.tokopedia.tkpd.session.presenter.RegisterNew;
import com.tokopedia.tkpd.session.presenter.RegisterNewImpl;
import com.tokopedia.tkpd.session.presenter.RegisterNewNextView;
import com.tokopedia.tkpd.session.presenter.RegisterNextImpl;
import com.tokopedia.tkpd.session.presenter.RegisterPassPhoneImpl;
import com.tokopedia.tkpd.session.presenter.RegisterThird;
import com.tokopedia.tkpd.session.presenter.RegisterThirdView;
