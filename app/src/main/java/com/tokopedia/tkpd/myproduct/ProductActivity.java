...
import com.tokopedia.tkpd.myproduct.fragment.ImageGalleryAlbumFragment;
import com.tokopedia.tkpd.myproduct.fragment.ImageGalleryFragment;
import com.tokopedia.tkpd.myproduct.fragment.ReturnPolicyDialog;
...
import com.tokopedia.tkpd.myproduct.presenter.ImageGallery;
...
import com.tokopedia.tkpd.myproduct.presenter.ProductView;
        ...
        if (Intent.ACTION_SEND.equals(action) && type != null) {
            if (SessionHandler.isV4Login(this)) {
                ...
                if (shopID == null || shopID.equals("0")) {
                    ...
                    intent1.putExtra(com.tokopedia.tkpd.session.presenter.Session.WHICH_FRAGMENT_KEY, TkpdState.DrawerPosition.LOGIN);
                }
            ...
            if (SessionHandler.isV4Login(this)) {
                ...
                intentLogin.putExtra(com.tokopedia.tkpd.session.presenter.Session.WHICH_FRAGMENT_KEY, TkpdState.DrawerPosition.LOGIN);
...
//        Intent imageGallery = new Intent(context, GalleryBrowser.class);
        ...
        context.startActivityForResult(imageGallery, com.tokopedia.tkpd.ImageGallery.TOKOPEDIA_GALLERY);
    }
