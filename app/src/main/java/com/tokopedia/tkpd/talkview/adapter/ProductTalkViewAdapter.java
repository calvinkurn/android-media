package com.tokopedia.tkpd.talkview.adapter;
...
import com.tokopedia.tkpd.talkview.method.DeleteTalkDialog;
import com.tokopedia.tkpd.talkview.method.ReportTalkDialog;
import com.tokopedia.tkpd.talkview.model.TalkBaseModel;
import com.tokopedia.tkpd.talkview.product.model.CommentTalk;
 ...
 */
public class ProductTalkViewAdapter extends TalkViewAdapter{

    public static ProductTalkViewAdapter createAdapter(TalkViewFragment fragment, List<TalkBaseModel> items) {
        ProductTalkViewAdapter adapter = new ProductTalkViewAdapter();
