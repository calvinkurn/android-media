package com.tokopedia.tkpd.payment.model.responsecartstep2;
...
import com.tokopedia.tkpd.payment.model.responsecartstep1.BCAParam;
import com.tokopedia.tkpd.payment.model.responsecartstep1.Cart;
import com.tokopedia.tkpd.payment.model.responsecartstep1.CreditCard;
import com.tokopedia.tkpd.payment.model.responsecartstep1.Indomaret;
...
public class Transaction implements Parcelable {
    ...
    @Expose
    private List<GAData> gaDataList = new ArrayList<>();
    ...
    @SerializedName("link_mandiri")
    @Expose
    private String linkMandiri;
    ...
    public List<GAData> getGaDataList() {
        return gaDataList;
    }

    public void setGaDataList(List<GAData> gaDataList) {
        this.gaDataList = gaDataList;
    }
    ...
    public String getLinkMandiri() {
        return linkMandiri;
    }

    public void setLinkMandiri(String linkMandiri) {
        this.linkMandiri = linkMandiri;
    }

    public Transaction(String revenue, String payId){
        grandTotalBeforeFee = revenue;
        paymentId = payId;
    }
    ...
    protected Transaction(Parcel in) {
        ...
        if (in.readByte() == 0x01) {
            gaDataList = new ArrayList<GAData>();
            in.readList(carts, GAData.class.getClassLoader());
        } else {
            gaDataList = null;
        }
