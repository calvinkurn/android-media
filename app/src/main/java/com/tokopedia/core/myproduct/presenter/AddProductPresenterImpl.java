...
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.CONDITION_NEW;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.CONDITION_OLD;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.ETALASE_ETALASE;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.ETALASE_ETALASE_INDEX;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.ETALASE_GUDANG;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.ETALASE_TAMBAH_BARU;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.KEBIJAKAN_PENGEMBALIAN_PRODUK;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.PILIH;
import static com.tokopedia.core.myproduct.fragment.AddProductFragment.TAMBAH;
...
//            addProductView.setProductPrice(hargaDanUnitHarga[1]);
        ...
        switch (produk.getStockStatusDB().getStockDetail()) {
            case AddProductView.ETALASE_ETALASE:
                ...
                break;
            case AddProductView.ETALASE_GUDANG:
    ...
    private void proceedEtalase() {
        ArrayList<EtalaseModel> etalaseModels = new ArrayList<EtalaseModel>() {
            {
                add(new EtalaseModel().setText(ETALASE_GUDANG));
                add(new EtalaseModel().setText(ETALASE_ETALASE));
            }
        };
        ...
        for (EtalaseDB etalse : dbManager.getEtalases()) {
            ...
            etalaseModels.set(ETALASE_ETALASE_INDEX,
                    etalaseModels.get(ETALASE_ETALASE_INDEX).add(etalaseModel));
        ...
        etalaseModels.set(ETALASE_ETALASE_INDEX,
                etalaseModels.get(1).add(ETALASE_TAMBAH_BARU));
        etalaseModels.set(ETALASE_GUDANG_INDEX,
                etalaseModels.get(0).add(ETALASE_TAMBAH_BARU));
