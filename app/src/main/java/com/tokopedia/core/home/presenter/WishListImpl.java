...
import com.tokopedia.core.home.model.wishlist.Pagination;
import com.tokopedia.core.home.model.wishlist.Wishlist;
import com.tokopedia.core.home.model.wishlist.WishlistPaging;
...
public class WishListImpl implements WishList {
    ...
    public void fetchDataFromInternet(final Context context) {
        Observable<Response<com.tokopedia.core.home.model.wishlist.WishlistData>> observable = mojitoService.getApi().getWishlist(
                SessionHandler.getLoginID(context),
                10,
                mPaging.getPage()
        );

        Subscriber<Response<com.tokopedia.core.home.model.wishlist.WishlistData>> subscriber = new Subscriber<Response<com.tokopedia.core.home.model.wishlist.WishlistData>>() {
            @Override
            ...
            @Override
            public void onNext(Response<com.tokopedia.core.home.model.wishlist.WishlistData> response) {
    ...
    @Override
    public void setData(com.tokopedia.core.home.model.wishlist.WishlistData wishlistData) {
