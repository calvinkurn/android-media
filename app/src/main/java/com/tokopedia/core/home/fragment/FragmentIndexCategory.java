...
import com.tokopedia.core.home.adapter.RecyclerViewCategoryMenuAdapter;
import com.tokopedia.core.home.adapter.SectionListCategoryAdapter;
import com.tokopedia.core.home.adapter.TickerAnnouncementAdapter;
import com.tokopedia.core.home.facade.FacadePromo;
import com.tokopedia.core.home.facade.FacadePromo.PromoItem;
import com.tokopedia.core.home.model.Banner;
...
import com.tokopedia.core.home.presenter.Category;
import com.tokopedia.core.home.presenter.CategoryImpl;
import com.tokopedia.core.home.presenter.CategoryView;
import com.tokopedia.core.home.presenter.HomeCatMenuPresenter;
import com.tokopedia.core.home.presenter.HomeCatMenuPresenterImpl;
import com.tokopedia.core.home.util.DividerItemDecoration;
...
import com.tokopedia.core.recharge.presenter.RechargeCategoryPresenter;
...
public class FragmentIndexCategory extends TkpdBaseV4Fragment implements
    ...
    private class Model {
        private ArrayList<PromoItem> listBanner = new ArrayList<>();
    ...
    private FacadePromo.GetPromoListener onGetPromoListener() {
        return new FacadePromo.GetPromoListener() {
            ...
            @Override
            public void OnSuccessBanner(List<PromoItem> promoList) {
                setBanner(promoList);
            }
    ...
    private void setBanner(List<PromoItem> promoList) {
...
//        setTicker(banner);
    ...
    protected class PromoImagePagerAdapter extends PagerAdapter {
        ...
        PromoImagePagerAdapter(List<PromoItem> promoList) {
