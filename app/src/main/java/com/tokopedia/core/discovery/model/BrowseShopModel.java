...
public class BrowseShopModel {
    ...
    public static class Shops extends Convert.DefaultConvert<Shops, BrowseShopAdapter.ShopModel>{
        ...
        @Override
        public BrowseShopAdapter.ShopModel from(Shops data) {
            return new BrowseShopAdapter.ShopModel(data);
        }

        public static List<BrowseShopAdapter.ShopModel> toShopItemList(Shops... datas){
            ArrayList<BrowseShopAdapter.ShopModel> result = new ArrayList<>();
            for (Shops s :
                    datas) {
                result.add(s.from(s));
            }
