package com.tokopedia.core.inboxmessage.fragment;
...
import com.tokopedia.core.inboxmessage.adapter.InboxMessageDetailAdapter;
import com.tokopedia.core.inboxmessage.listener.InboxMessageDetailFragmentView;
...
import com.tokopedia.core.inboxmessage.model.inboxmessagedetail.InboxMessageDetailItem;
import com.tokopedia.core.inboxmessage.presenter.InboxMessageDetailFragmentPresenter;
import com.tokopedia.core.inboxmessage.presenter.InboxMessageDetailFragmentPresenterImpl;
...
public class InboxMessageDetailFragment extends BasePresenterFragment<InboxMessageDetailFragmentPresenter>
    ...
    private View.OnClickListener onReputationClicked() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ToolTipUtils.showToolTip(ToolTipUtils.setToolTip(context, R.layout.view_tooltip_user, new ToolTipUtils.ToolTipListener() {
                    @Override
    ...
    public void showUndoFlagSpam(View.OnClickListener listener) {
        SnackbarManager.make(getActivity(), getString(R.string.message_flag_spam), Snackbar.LENGTH_LONG)
                .setAction(getString(R.string.undo_but), listener).show();
    }
    ...
    public void showSuccessUndoSpam(final int position) {
        SnackbarManager.make(getActivity(), getString(R.string.message_undo_flag_spam), Snackbar.LENGTH_LONG)
                .setAction(getString(R.string.see_message), new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void setHasReputation(String positivePercentage) {
        ...
        reputationIcon.setImageResource(R.drawable.ic_icon_repsis_smile_active);
    }

    @Override
    public void setNoReputation() {
        reputationPercentage.setVisibility(View.GONE);
        reputationIcon.setImageResource(R.drawable.ic_icon_repsis_smile);
    }
