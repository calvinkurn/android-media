...
import com.tokopedia.core.purchase.adapter.TxSummaryAdapter;
import com.tokopedia.core.purchase.listener.TxSummaryViewListener;
import com.tokopedia.core.purchase.model.TxSummaryItem;
import com.tokopedia.core.purchase.presenter.TxSummaryPresenter;
import com.tokopedia.core.purchase.presenter.TxSummaryPresenterImpl;
        ...
        if (instanceType == INSTANCE_TYPE_PURCHASE) {
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    listener.OnMenuClick(PurchaseActivity.TAB_TX_VERIFICATION,
                            FilterUtils.ALL_STATUS_FILTER_ID);
                    break;
                case 2:
                    listener.OnMenuClick(PurchaseActivity.TAB_TX_STATUS,
                            FilterUtils.ALL_STATUS_FILTER_ID);
                    break;
                case 3:
                    listener.OnMenuClick(PurchaseActivity.TAB_TX_DELIVER,
                            FilterUtils.ALL_STATUS_FILTER_ID);
                    break;
                case 4:
                    listener.OnMenuClick(PurchaseActivity.TAB_TX_ALL,
