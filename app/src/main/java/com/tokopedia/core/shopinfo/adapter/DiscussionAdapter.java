...
public class DiscussionAdapter extends AbstractRecyclerAdapter {
    ...
    private void bindView(com.tokopedia.core.shopinfo.models.talkmodel.List model, ViewHolder holder) {
    ...
    private void setListener(final com.tokopedia.core.shopinfo.models.talkmodel.List model, ViewHolder holder) {
    ...
    private int getMenuID(int position) {
        int menuID;
        com.tokopedia.core.shopinfo.models.talkmodel.List talk = modelList.list.get(position);
