...
import com.tokopedia.core.rescenter.inbox.facade.Facade;
import com.tokopedia.core.rescenter.inbox.facade.FacadeImpl;
import com.tokopedia.core.rescenter.inbox.facade.NetworkParam;
import com.tokopedia.core.rescenter.inbox.listener.InboxResCenterView;
import com.tokopedia.core.rescenter.inbox.model.Paging;
import com.tokopedia.core.rescenter.inbox.model.ResCenterCounterPending;
import com.tokopedia.core.rescenter.inbox.model.ResCenterHeader;
...
public class InboxResCenterImpl implements InboxResCenterPresenter {
    ...
    public void setActionOnItemListClickListener(Context context, String resolutionID) {
        ...
        Intent intent = com.tokopedia.core.rescenter.detail.activity.ResCenterActivity.newInstance(context, activityParamenterPassData);
