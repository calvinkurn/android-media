 ...
 * Created on 6/20/16.
 */
public class TroubleSpinnerAdapter extends ArrayAdapter<EditResCenterFormData.TroubleData> {

    private class ViewHolder {
        TextView textView;
    }

    public TroubleSpinnerAdapter(Context context, int resource, List<EditResCenterFormData.TroubleData> objects) {
