package com.tokopedia.core.rescenter.detail.customview;
...
import com.tokopedia.core.rescenter.create.customview.BaseView;
import com.tokopedia.core.rescenter.detail.dialog.ConfirmationDialog;
...
public class DetailView extends BaseView<Detail, DetailResCenterView> {
    ...
    @Override
    public void renderData(@NonNull Detail data) {
