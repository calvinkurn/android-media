...
import com.tokopedia.core.shipping.interactor.KeroNetInteractor;
import com.tokopedia.core.shipping.interactor.KeroNetInteractorImpl;
import com.tokopedia.core.shipping.model.kero.Attribute;
import com.tokopedia.core.shipping.model.kero.Data;
import com.tokopedia.core.shipping.network.KeroppiParam;
...
public class AddToCartPresenterImpl implements AddToCartPresenter {
        ...
        for (Attribute shipment : datas) {
            for(Shipment oldShipment : oldShipments)
            {
                if(shipment.getShipperId().equals(oldShipment.getShipmentId())){
                    List<com.tokopedia.core.shipping.model.kero.Product> packages = filterAvailableKeroPackageShipment(shipment
    ...
    private List<com.tokopedia.core.shipping.model.kero.Product> filterAvailableKeroPackageShipment(List<com.tokopedia.core.shipping.model.kero.Product> datas, List<ShipmentPackage> dataOld) {
        List<com.tokopedia.core.shipping.model.kero.Product> packageResults = new ArrayList<>();
        for (com.tokopedia.core.shipping.model.kero.Product packageShipment : datas) {
