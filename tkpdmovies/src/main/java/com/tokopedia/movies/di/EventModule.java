...
import com.tokopedia.movies.data.EventRepositoryData;
import com.tokopedia.movies.data.EventsDataStoreFactory;
...
public class EventModule {
    ...
    @Provides
    @EventScope
    EventRepository provideEventRepository(EventsDataStoreFactory moviesDataStoreFactory) {
        return new EventRepositoryData(moviesDataStoreFactory);
    }
