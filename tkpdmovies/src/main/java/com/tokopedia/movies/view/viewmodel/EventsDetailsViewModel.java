...
public class EventsDetailsViewModel implements Parcelable {
    ...
    public String getCensortext() {
        return censortext;
    }

    public void setCensortext(String censortext) {
    ...
    public Integer getCustomText1() {
        return customText1;
    }

    public void setCustomText1(Integer customText1) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.censortext);
        ...
        dest.writeValue(this.customText1);
        dest.writeString(this.customText2);
        dest.writeString(this.customText3);
    ...
    protected EventsDetailsViewModel(Parcel in) {
        ...
        this.customText1 = (Integer) in.readValue(Integer.class.getClassLoader());
        this.customText2 = in.readString();
        this.customText3 = in.readString();
