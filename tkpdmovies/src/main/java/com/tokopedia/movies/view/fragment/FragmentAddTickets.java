...
//    @Inject
    ...
    public void setData(List<GroupViewModel> groups, EventBookTicketPresenter presenter, String title) {
...
//        executeInjector();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scrollView.setAdapter(new AddTicketAdapter(getActivity(), mGroups, mPresenter, title));
