...
import com.tokopedia.movies.domain.model.request.cart.CartItem;
import com.tokopedia.movies.domain.model.request.cart.CartItems;
import com.tokopedia.movies.domain.model.request.cart.Configuration;
import com.tokopedia.movies.domain.model.request.cart.EntityAddress;
import com.tokopedia.movies.domain.model.request.cart.EntityPackageItem;
import com.tokopedia.movies.domain.model.request.cart.EntityPassengerItem;
import com.tokopedia.movies.domain.model.request.cart.MetaData;
import com.tokopedia.movies.domain.model.request.cart.OtherChargesItem;
import com.tokopedia.movies.domain.model.request.cart.TaxPerQuantityItem;
import com.tokopedia.movies.domain.postusecase.PostPaymentUseCase;
import com.tokopedia.movies.domain.postusecase.PostVerifyCartUseCase;
import com.tokopedia.movies.view.activity.TopPayActivity;
import com.tokopedia.movies.view.contractor.EventReviewTicketsContractor;
...
public class EventReviewTicketPresenter
    ...
    private CartItems convertPackageToCartItem(PackageViewModel packageViewModel) {
        ...
        com.tokopedia.movies.domain.model.request.cart.SubConfig sub = new com.tokopedia.movies.domain.model.request.cart.SubConfig();
