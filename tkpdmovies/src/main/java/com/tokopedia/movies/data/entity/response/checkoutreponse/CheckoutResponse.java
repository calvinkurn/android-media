package com.tokopedia.movies.data.entity.response.checkoutreponse;
...
public class CheckoutResponse{
	...
	private com.tokopedia.movies.data.entity.response.checkoutreponse.Parameter parameter;
	...
	public void setParameter(com.tokopedia.movies.data.entity.response.checkoutreponse.Parameter parameter){
		this.parameter = parameter;
	}

	public com.tokopedia.movies.data.entity.response.checkoutreponse.Parameter getParameter(){
		return parameter;
	}
