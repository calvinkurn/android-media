...
public class EventsItemDomain {
    ...
    @Expose
    private List<SchedulesViewModel> schedules;
    ...
    public List<SchedulesViewModel> getSchedules() {
        return schedules;
    }

    public void setSchedules(List<SchedulesViewModel> schedules) {
