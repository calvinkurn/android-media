...
import com.tokopedia.tkpd.databinding.ActivityMainBinding
...
import com.tokopedia.tkpd.DataLayerListenerService.Companion.DATA_CLIENT_MESSAGE_KEY
...
class MainActivity : ComponentActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnReady.apply {
            setOnClickListener {
                sendDataToApp(this.text.toString())
            }
        }
        binding.btnNotReady.apply {
            setOnClickListener {
                sendDataToApp(this.text.toString())
            }
        }
