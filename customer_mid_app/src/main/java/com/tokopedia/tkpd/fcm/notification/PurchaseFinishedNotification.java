...
public class PurchaseFinishedNotification extends BaseNotification {
    public PurchaseFinishedNotification(Context context) {
        super(context);
    }
    ...
    protected void configureNotificationData(Bundle data) {
        ...
        mNotificationPass.title = mContext.getString(R.string.purchase_finish);
        ...
        bundle.putString(ApplinkConstInternalOrder.ORDER_FILTER_ID, ApplinkConstInternalOrder.PESANAN_SELESAI);
