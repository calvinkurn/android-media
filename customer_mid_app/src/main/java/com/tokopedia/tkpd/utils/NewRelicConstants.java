...
public interface NewRelicConstants {
    String ENCRYPTION_KEY = new String(new char[]{113, 40, 101, 35, 37, 71, 102, 64, 111, 105, 62, 108, 107, 66, 126, 104});
    String PUBLIC_RSA_KEY_STR = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAoHZ7Cq/9VO0ynSSThX8cPf5uoK7vXs5l" +
    ...
    String PRIVATE_RSA_KEY_STR = "MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQCgdnsKr/1U7TKdJJOFfxw9/m6g" +
