...
public class FlightFilterDepartureTimeViewHolder extends CheckableBaseViewHolder<DepartureStat> implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    @LayoutRes
