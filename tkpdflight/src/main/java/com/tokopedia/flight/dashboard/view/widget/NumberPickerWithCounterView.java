...
public class NumberPickerWithCounterView extends BaseCustomView {
    ...
    private DecimalInputView numberInputView;
    ...
    private void init() {
        ...
        numberInputView = (DecimalInputView) view.findViewById(R.id.decimal_input_view);
    ...
    protected void onFinishInflate() {
        ...
        numberInputView.setValue(number);
        plusImageButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (numberInputView.getDoubleValue() < maxValue) {
                    numberInputView.setValue((double) ((int) numberInputView.getDoubleValue() + 1));
                }
                updateButtonState();
            }
        });
        ...
        minusImageButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (numberInputView.getDoubleValue() > minValue) {
                    numberInputView.setValue((double) ((int) numberInputView.getDoubleValue() - 1));
                }
                updateButtonState();
            }
    ...
    private void updateButtonState() {
        minusImageButton.setEnabled(enabled && numberInputView.getDoubleValue() > minValue);
        plusImageButton.setEnabled(enabled && numberInputView.getDoubleValue() < maxValue);
    }

    public void setNumber(int number) {
        numberInputView.setValue((double) number);
        invalidate();
        requestLayout();
    }
    ...
    public int getValue() {
        return (int) numberInputView.getDoubleValue();
    }
}
