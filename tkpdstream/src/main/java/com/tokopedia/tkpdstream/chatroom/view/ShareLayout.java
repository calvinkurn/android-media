...
public class ShareLayout {
    ...
    protected void setShareList() {
        ...
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_g), activity.getString(R.string.share_gplus), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_fb), activity.getString(R.string.share_fb), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_twitter), activity.getString(R.string.share_twitter), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_line), activity.getString(R.string.share_line), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_wa), activity.getString(R.string.share_wa), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_sms), activity.getString(R.string.share_sms), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
                R.drawable.ic_btn_copy), activity.getString(R.string.share_copy), null));
        list.add(new ShareItem(MethodChecker.getDrawable(activity,
...
//                //UnifyTracking.eventFeedClick(getTrackingLabel(FeedTrackingEventLabel.Share.LINE));
//            }
//        };
//    }
...
//
//                        //UnifyTracking.eventFeedClick(getTrackingLabel(FeedTrackingEventLabel.Share.GOOGLEPLUS));
//                    }
//                });
//
//            }
...
//                        ClipData clip = ClipData.newPlainText("Tokopedia", shareUri);
//                        clipboard.setPrimaryClip(clip);
//                        Toast.makeText(activity, "Copied to clipboard", Toast.LENGTH_SHORT).show();
//
//                        //UnifyTracking.eventFeedClick(getTrackingLabel(FeedTrackingEventLabel.Share.COPY));
//                    }
//                });
//
//            }
