...
public class OrderDetail {
    ...
    @Expose
    private int detailAdditionalFee;
    ...
    @Expose
    private float detailTotalWeight;
    ...
    public int getDetailAdditionalFee() {
        return detailAdditionalFee;
    }

    public void setDetailAdditionalFee(int detailAdditionalFee) {
    ...
    public float getDetailTotalWeight() {
        return detailTotalWeight;
    }

    public void setDetailTotalWeight(float detailTotalWeight) {
