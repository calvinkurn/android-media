...
public class TkpdBaseURL {
    ...
    public static class ResCenter {
        ...
        public static final String PATH_GENERATE_TOKEN_HOST = "generate_token_host.pl";
    }
    ...
    public static class ResCenterV2 {
        ...
        public static final String BASE_DETAIL_RESOLUTION_V2 = BASE_RESOLUTION_VERSION_1 + "detail/{resolution_id}";
