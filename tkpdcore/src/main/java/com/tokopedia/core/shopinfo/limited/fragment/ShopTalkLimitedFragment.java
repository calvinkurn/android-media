...
public class ShopTalkLimitedFragment extends ShopTalkFragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        Intent intent = ShopDiscussionActivity.createIntent(getActivity(), getActivity().getIntent().getExtras().getString(SHOP_ID, ""));
