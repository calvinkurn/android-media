...
public class AlbumMediaCollection implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        AlbumItem albumItem = args.getParcelable(ARGS_ALBUM);
        if (albumItem == null) {
            return null;
        }
    ...
    public void load(@Nullable AlbumItem target) {
        load(target, false);
    }

    public void load(@Nullable AlbumItem target, boolean enableCapture) {
