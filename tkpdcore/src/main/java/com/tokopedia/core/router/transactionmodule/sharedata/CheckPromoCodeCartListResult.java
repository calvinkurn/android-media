...
public class CheckPromoCodeCartListResult implements Parcelable {
    ...
    public CheckPromoCodeCartListResult() {
    }

    protected CheckPromoCodeCartListResult(Parcel in) {
        this.isError = in.readByte() != 0;
        this.errorMessage = in.readString();
        this.dataVoucher = in.readParcelable(DataVoucher.class.getClassLoader());
    }

    public static final Parcelable.Creator<CheckPromoCodeCartListResult> CREATOR = new Parcelable.Creator<CheckPromoCodeCartListResult>() {
        @Override
        public CheckPromoCodeCartListResult createFromParcel(Parcel source) {
            return new CheckPromoCodeCartListResult(source);
        }

        @Override
        public CheckPromoCodeCartListResult[] newArray(int size) {
            return new CheckPromoCodeCartListResult[size];
        }
    };
}
