...
public final class AppScreen {
    ...
    public static final String SCREEN_RIDE_HISTORY_NEED_HELP ="Ride History Need Help";
    public static final String SCREEN_RIDE_PENDING_FAIR_CHOOSER ="Ride Pending Fair Chooser";
    public static final String SCREEN_RIDE_TOPUP_TOKOCASH_CHANGE_DESTINATION = "Ride Topup TokoCash Change Destination";
