...
public class UnifyTracking extends TrackingUtils {
    ...
    public static void eventOpenShop(String category, String action, String label){
        sendGTMEvent(new EventTracking(
                AppEventTracking.Event.CLICK_CREATE_SHOP,
                category,
                action,
    ...
    public static void eventOpenShopBiodataSuccess(){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_BIODATA_FORM,
                AppEventTracking.Action.OPEN_SHOP_SUCCESS,
                "");
    }

    public static void eventOpenShopBiodataError(String labelError){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_BIODATA_FORM,
                AppEventTracking.Action.OPEN_SHOP_ERROR,
                labelError
        );
    }

    public static void eventOpenShopBiodataNameError(String labelError){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_BIODATA_FORM,
                AppEventTracking.Action.OPEN_SHOP_ERROR_NAME,
                labelError
        );
    }

    public static void eventOpenShopBiodataDomainError(String labelError){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_BIODATA_FORM,
                AppEventTracking.Action.OPEN_SHOP_ERROR_DOMAIN,
                labelError
        );
    }

    public static void eventOpenShopFormSuccess(){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_INFO_FORM,
                AppEventTracking.Action.OPEN_SHOP_CLICK_NEXT_STEP_SUCCESS,
                ""
        );
    }

    public static void eventOpenShopFormError(String labelError){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_INFO_FORM,
                AppEventTracking.Action.OPEN_SHOP_CLICK_NEXT_STEP_ERROR,
                labelError
        );
    }

    public static void eventOpenShopShippingSuccess(){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_SHIPPING_FORM,
                AppEventTracking.Action.OPEN_SHOP_CLICK_NEXT_STEP_SUCCESS,
                ""
        );
    }

    public static void eventOpenShopShippingError(String labelError){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_SHIPPING_FORM,
                AppEventTracking.Action.OPEN_SHOP_CLICK_NEXT_STEP_ERROR,
                labelError
    ...
    public static void eventOpenShopShippingServices(String courierName){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_SHIPPING_FORM,
                AppEventTracking.Action.OPEN_SHOP_CLICK_CARGO_SERVICES,
                courierName
        );
    }

    public static void eventOpenShopThanksClickLearnMore(){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_THANKS_PAGE,
                AppEventTracking.Action.OPEN_SHOP_CLICK_LEARN_MORE,
                ""
        );
    }

    public static void eventOpenShopThanksClickAddProduct(){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_THANKS_PAGE,
                AppEventTracking.Action.OPEN_SHOP_CLICK_ADD_PRODUCT,
                ""
        );
    }

    public static void eventOpenShopThanksGoToMyShop(){
        eventOpenShop(
                AppEventTracking.Category.OPEN_SHOP_THANKS_PAGE,
                AppEventTracking.Action.OPEN_SHOP_CLICK_MY_SHOP_PAGE,
                ""
        );
    }
}
