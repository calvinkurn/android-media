...
public class PostAppealSolutionRepositoryImpl implements PostAppealSolutionRepository {

    CreateResolutionFactory createResolutionFactory;

    public PostAppealSolutionRepositoryImpl(CreateResolutionFactory createResolutionFactory) {
        this.createResolutionFactory = createResolutionFactory;
    }

    @Override
    public Observable<EditAppealResolutionSolutionDomain>
    postAppealSolutionDataCloud(RequestParams requestParams) {
        return createResolutionFactory.postAppealSolutionCloudSource()
                .postAppealSolutionCloudSource(requestParams);
    }
}
