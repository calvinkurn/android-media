...
public class CreatePictureUseCase extends UseCase<CreatePictureModel> {
    ...
    public static final String PARAM_ATTACHMENT_STRING = "attachment_string";
    private static final String PARAM_FILE_PATH = "file_path";

    private final UploadImageRepository uploadImageRepository;

    public CreatePictureUseCase(ThreadExecutor threadExecutor,
    ...
    private Map<String, RequestBody> generateRequestBody(RequestParams requestParams) {
        ...
        RequestBody attachmentString = RequestBody.create(MediaType.parse("text/plain"),
        ...
        requestBodyMap.put(PARAM_ATTACHMENT_STRING, attachmentString);
        requestBodyMap.put(PARAM_FILE_PATH, attachmentString);
