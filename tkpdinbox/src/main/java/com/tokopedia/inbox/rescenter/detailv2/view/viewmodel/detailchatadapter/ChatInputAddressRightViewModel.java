...
public class ChatInputAddressRightViewModel implements Visitable<DetailChatTypeFactory> {
    ...
    public ChatInputAddressRightViewModel(ShopDomain shop, CustomerDomain customer, ConversationDomain conversation, String addressFormat) {
        this.shop = shop;
