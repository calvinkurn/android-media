...
public class ChatCommonLeftViewModel implements Visitable<DetailChatTypeFactory> {

    private ConversationDomain conversation;
    private String type;

    public ChatCommonLeftViewModel() {
    }

    public ChatCommonLeftViewModel(ConversationDomain conversation, String type) {
