 ...
 * Created on 6/20/16.
 */
public class TroubleCategorySpinnerAdapter extends ArrayAdapter<EditResCenterFormData.TroubleCategoryData> {

    private class ViewHolder {
        TextView textView;
    }

    public TroubleCategorySpinnerAdapter(Context context, int resource, List<EditResCenterFormData.TroubleCategoryData> objects) {
