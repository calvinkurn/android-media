...
public class InputAddressMigrateVersionSubscriber extends Subscriber<ResolutionActionDomainData> {

    private final DetailResChatFragmentListener.View mainView;

    public InputAddressMigrateVersionSubscriber(DetailResChatFragmentListener.View mainView) {
