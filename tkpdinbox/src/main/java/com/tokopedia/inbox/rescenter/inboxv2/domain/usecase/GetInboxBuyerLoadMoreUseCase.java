...
public class GetInboxBuyerLoadMoreUseCase extends UseCase<InboxItemResultViewModel> {


    private ResolutionApi resolutionApi;
    private GetInboxMapper getInboxMapper;

    public GetInboxBuyerLoadMoreUseCase(ResolutionApi resolutionApi, GetInboxMapper getInboxMapper) {
