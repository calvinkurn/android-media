...
public class ChatActionEarlyLeftViewModel implements Visitable<DetailChatTypeFactory> {

    private ConversationDomain conversation;
    private String type;

    public ChatActionEarlyLeftViewModel() {
    }

    public ChatActionEarlyLeftViewModel(ConversationDomain conversation, String type) {
