 ...
 * Created on 6/20/16.
 */
public class TroubleCategorySpinnerAdapter extends ArrayAdapter<CreateResCenterFormData.TroubleCategoryData> {

    private class ViewHolder {
        TextView textView;
    }

    public TroubleCategorySpinnerAdapter(Context context, int resource, List<CreateResCenterFormData.TroubleCategoryData> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            holder.textView.setText(getItem(position - 1).getCategoryTroubleText());
        }
    ...
    private View getCustomDropDownView(int position, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            holderDropDown.textView.setText(getItem(position - 1).getCategoryTroubleText());
        }
