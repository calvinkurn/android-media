 ...
 */
public class ProductSolutionModel extends SolutionComplaintModel implements Parcelable, Visitable<SolutionRefundTypeFactory> {

    public ProductSolutionModel(SolutionProblemModel problem, SolutionShippingModel shipping, SolutionProductModel product, SolutionOrderModel order) {
