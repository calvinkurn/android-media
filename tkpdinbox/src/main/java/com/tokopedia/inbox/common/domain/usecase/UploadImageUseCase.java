...
public class UploadImageUseCase extends UseCase<UploadDomain> {
    ...
    @Inject
    public UploadImageUseCase(ResolutionCommonSource resolutionCommonSource) {
    ...
    public Observable<UploadDomain> createObservable(RequestParams requestParams) {
        return resolutionCommonSource.uploadImage(generateUrl(requestParams),
