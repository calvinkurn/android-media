package com.tokopedia.inbox.inboxchat.viewholder.movement;
...
public class ChatLinkHandlerMovementMethod extends SelectableSpannedMovementMethod {
    ...
    WeakReference<ChatRoomContract.View> viewListener;

    public ChatLinkHandlerMovementMethod(ChatRoomContract.View viewListener) {
