...
public class AttachInvoiceSelectionViewModel extends BaseChatViewModel implements
    ...
    public AttachInvoiceSelectionViewModel(String messageId, String fromUid, String from, String
            fromRole, String attachmentId, String attachmentType, String replyTime,
                                           List<AttachInvoiceSingleViewModel> list) {
