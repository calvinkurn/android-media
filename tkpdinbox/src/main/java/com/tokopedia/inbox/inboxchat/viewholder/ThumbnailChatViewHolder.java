...
public class ThumbnailChatViewHolder extends AbstractViewHolder<ThumbnailChatViewModel> {
    ...
    @LayoutRes
    public static final int LAYOUT = R.layout.layout_thumbnail_chat;
    private AttachmentChatHelper attachmentChatHelper;

    public ThumbnailChatViewHolder(View itemView, ChatRoomContract.View viewListener) {
        super(itemView);
        view = itemView;
    ...
    @Override
    public void bind(final ThumbnailChatViewModel element) {
    ...
    private Spanned getOldMessageText(ThumbnailChatViewModel element) {
