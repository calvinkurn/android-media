package com.tokopedia.inbox.inboxchat.util.getproductinchatroom;
...
public class GetProductInChatRoom {
    ...
    public static GetProductInChatRoom createInstance(Context context) {
        GetProductInChatRoom util = new GetProductInChatRoom(context);
        util.context = context;
        util.paging = new PagingHandler();
        return util;
    }

    public static GetProductInChatRoom createInstance(Context context, String shopId) {
        GetProductInChatRoom util = new GetProductInChatRoom(context, shopId);
        util.context = context;
        util.paging = new PagingHandler();
        return util;
    }

    public GetProductInChatRoom(Context context) {
        this.context = context;
        this.paging = new PagingHandler();
        this.shopId = SessionHandler.getShopID(MainApplication.getAppContext());
    }

    public GetProductInChatRoom(Context context, String shopId) {
        this.context = context;
        this.paging = new PagingHandler();
        this.shopId = shopId;
    }
    ...
    private GetProductInChatRoom.ViewHolder holder;
    ...
    public void getOwnShopProductUrl(GetProductUrlUtil.OnGetUrlInterface listener) {
        initVar();
        setDialog();
    ...
    private void initVar() {
        ...
        holder = new GetProductInChatRoom.ViewHolder();
    ...
    private void setDialog() {
        ...
        dialog.setContentView(com.tokopedia.core.R.layout.dialog_get_url);
    ...
    private void initDialogView() {
        holder.recyclerView = (RecyclerView) dialog.findViewById(com.tokopedia.core.R.id.list);
        holder.search2 = (CustomSearchView) dialog.findViewById(com.tokopedia.core.R.id.search2);
        holder.viewNoShop = dialog.findViewById(com.tokopedia.core.R.id.view_no_shop);
        holder.openShop = dialog.findViewById(com.tokopedia.core.R.id.open_shop);
        holder.recyclerView.setLayoutManager(linearLayoutManager);
        holder.recyclerView.setAdapter(adapter);
    }

    private void setListener(final GetProductUrlUtil.OnGetUrlInterface listener) {
        adapter.setOnGetUrlListener(new GetProductUrlUtil.OnGetUrlInterface() {
            @Override
