...
import com.tokopedia.inbox.inboxmessageold.presenter.InboxMessageFragmentPresenterImpl;
...
public class InboxMessageFragment extends BasePresenterFragment<InboxMessageFragmentPresenter>
    ...
    protected int getFragmentLayout() {
        return com.tokopedia.core.R.layout.fragment_inbox_message_old;
    }

    @Override
    protected void initView(View view) {
        progressDialog = new TkpdProgressDialog(getActivity(), TkpdProgressDialog.NORMAL_PROGRESS);
        filterLayout = getActivity().getLayoutInflater().inflate(com.tokopedia.core.R.layout.layout_filter_message, null);
        search = (EditText) filterLayout.findViewById(com.tokopedia.core.R.id.search);
        confirmButton = (Button) filterLayout.findViewById(com.tokopedia.core.R.id.button_confirm);
        cancelButton = (Button) filterLayout.findViewById(com.tokopedia.core.R.id.button_cancel);
        radioAll = (RadioButton) filterLayout.findViewById(com.tokopedia.core.R.id.radio_all);
        radioUnread = (RadioButton) filterLayout.findViewById(com.tokopedia.core.R.id.radio_unread);
        viewFilterRadio = (RadioGroup) filterLayout.findViewById(com.tokopedia.core.R.id.radio_read);
        ...
        bottomSheetDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                FrameLayout frameLayout = (FrameLayout) bsd.findViewById(com.tokopedia.core.R.id.design_bottom_sheet);
                if (frameLayout != null) {
        ...
        return new ActionMode.Callback() {
            ...
            public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
                ...
                switch (adapter.getChosenMessageStatus()) {
                    case STATE_READ:
                        menu.findItem(com.tokopedia.core.R.id.action_mark_as_unread).setVisible(true);
                        menu.findItem(com.tokopedia.core.R.id.action_mark_as_read).setVisible(false);
                        break;
                    case STATE_NOT_READ:
                        menu.findItem(com.tokopedia.core.R.id.action_mark_as_read).setVisible(true);
                        menu.findItem(com.tokopedia.core.R.id.action_mark_as_unread).setVisible(false);
                        break;
                    case STATE_BOTH:
                        menu.findItem(com.tokopedia.core.R.id.action_mark_as_unread).setVisible(true);
                        menu.findItem(com.tokopedia.core.R.id.action_mark_as_read).setVisible(true);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                if (item.getItemId() == com.tokopedia.core.R.id.action_move_achieve) {
                    presenter.moveInbox(ARCHIVE_ALL);
                    mode.finish();
                    return true;
                } else if (item.getItemId() == com.tokopedia.core.R.id.action_move_trash) {
                    presenter.moveInbox(DELETE_ALL);
                    mode.finish();
                    return true;
                } else if (item.getItemId() == com.tokopedia.core.R.id.action_delete) {
                    presenter.moveInbox(DELETE_FOREVER);
                    mode.finish();
                    return true;
                } else if (item.getItemId() == com.tokopedia.core.R.id.action_move_inbox) {
                    presenter.moveInbox(MOVE_ALL);
                    mode.finish();
                    return true;
                } else if (item.getItemId() == com.tokopedia.core.R.id.action_mark_as_read) {
                    presenter.markAsRead();
                    mode.finish();
                    return true;
                } else if (item.getItemId() == com.tokopedia.core.R.id.action_mark_as_unread) {
    ...
    public void showUndoSnackBar(String message, View.OnClickListener onUndo) {
        snackbarUndo = SnackbarManager.make(getActivity(),
                message,
                Snackbar.LENGTH_LONG).setAction(getString(com.tokopedia.core.R.string.undo_but), onUndo)
        ;
        snackbarUndo.show();
    }
    ...
    public void onSuccessMoveArchive(Bundle resultData) {
        ...
        if (pass != null) {
            ...
            showUndoSnackBar(getString(com.tokopedia.core.R.string.message_undo_to_archive), new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    pass.clearListMove();
    ...
    public void onSuccessMoveToInbox(Bundle resultData) {
        ...
        if (pass != null) {
            ...
            showUndoSnackBar(getString(com.tokopedia.core.R.string.message_undo_to_inbox), new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    pass.clearListMove();
    ...
    public void onSuccessDeleteMessage(Bundle resultData) {
        ...
        if (pass != null) {
            ...
            showUndoSnackBar(getString(com.tokopedia.core.R.string.message_undo_to_trash), new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    pass.clearListMove();
