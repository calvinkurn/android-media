package com.tokopedia.abstraction.view.adapter;
...
import com.tokopedia.abstraction.view.adapter.holder.BaseViewHolder;
...
public abstract class BaseListAdapter<T extends ItemType> extends BaseLinearRecyclerViewAdapter {
    ...
    public void addSingleDataWithPosition(int position, T t) {
        if (data != null && data.size() > 0) {
