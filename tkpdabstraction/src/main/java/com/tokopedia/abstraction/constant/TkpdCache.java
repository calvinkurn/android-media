...
public class TkpdCache {
    ...
    public class Key {
        ...
        public static final String LOYALTY_URL = "loyalty_url";
        public static final String USER_SHOP = "user_shop";
        public static final String USER_PIC_URI = "user_pic_uri";
        public static final String SHOP_PIC_URI = "shop_pic_uri";
        public static final String SHOP_ID = "shop_id";
        public static final String IS_PRODUCT_MANAGER = "is_product_manager";
        public static final String SALES = "sales";
        public static final String TOTAL_AVAIL = "total_avail";
        public static final String INC_NOTIF = "inc_notif";
