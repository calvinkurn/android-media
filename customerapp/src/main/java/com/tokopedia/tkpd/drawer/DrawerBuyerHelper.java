...
import com.tokopedia.challenges.view.activity.ChallengesHomeActivity;
...
public class DrawerBuyerHelper extends DrawerHelper
    ...
    private void createDataLogin(ArrayList<DrawerItem> data) {
        ...
        data.add(new DrawerItem(context.getString(R.string.drawer_title_challenges),
                R.drawable.icon_setting,
                TkpdState.DrawerPosition.CHALLENGES,
                true));
        ...
        if (item.getId() == selectedPosition) {
            ...
            switch (item.getId()) {
                ...
                case TkpdState.DrawerPosition.RESOLUTION_CENTER_SELLER:
                    ...
                    break;
                case TkpdState.DrawerPosition.CHALLENGES:
                    context.startActivity(new Intent(context, ChallengesHomeActivity.class));
                    break;
                default:
