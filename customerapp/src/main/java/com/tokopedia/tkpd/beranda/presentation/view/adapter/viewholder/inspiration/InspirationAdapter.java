...
public class InspirationAdapter extends RecyclerView.Adapter<InspirationAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemLayoutView) {
            ...
            productName = (TextView) itemLayoutView.findViewById(com.tokopedia.tkpd.tkpdfeed.R.id.title);
            productPrice = (TextView) itemLayoutView.findViewById(com.tokopedia.tkpd.tkpdfeed.R.id.price);
            productImage = (ImageView) itemLayoutView.findViewById(com.tokopedia.tkpd.tkpdfeed.R.id.product_image);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.tokopedia.tkpd.tkpdfeed.R.layout.inspiration_item, parent, false);
