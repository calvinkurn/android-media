    ...
    public static void setUserAttribute(Context context, UserAttributeData profileData) {
        ...
        try {
            customerWrapper = new CustomerWrapper.Builder()
                    ...
                    .setRegDate(DateFormatUtils.formatDate(DateFormatUtils.FORMAT_YYYY_MM_DD, DateFormatUtils.FORMAT_DD_MM_YYYY, TrackingUtils.extractFirstSegment(profileData.getProfile().getRegisterDate(), "T")))
                    ...
                    .setLastTransactionDate(DateFormatUtils.formatDate(DateFormatUtils.FORMAT_YYYY_MM_DD, DateFormatUtils.FORMAT_DD_MM_YYYY, TrackingUtils.extractFirstSegment(profileData.getPaymentAdminProfile() != null ? profileData.getPaymentAdminProfile().getLastPurchaseDate() : "", "T")))
                    ...
                    .setDateOfBirth(DateFormatUtils.formatDate(DateFormatUtils.FORMAT_YYYY_MM_DD, DateFormatUtils.FORMAT_DD_MM_YYYY, TrackingUtils.extractFirstSegment(profileData.getProfile().getBday() != null ? profileData.getProfile().getBday() : "", "T")))
