...
public abstract class ConsumerRouterApplication extends MainApplication implements
    ...
    @Override
    public Observable<TKPDMapParam<String, Object>> verifyEventPromo
    ...
    @Override
    public Observable<TKPDMapParam<String, Object>> verifyDealPromo
            (com.tokopedia.usecase.RequestParams requestParams) {
    ...
    @Override
    public void goToCreateTopadsPromo(Context context, String productId, String shopId, String
            source) {
    ...
    @Override
    public Observable<VoucherViewModel> checkFlightVoucher(String voucherCode, String
            cartId, String isCoupon) {
    ...
    @Override
    public Intent getDistrictRecommendationIntent(Activity
                                                          activity, com.tokopedia.core.manage.people.address.model.Token token,
    ...
    @Override
    public Intent getChangePhoneNumberRequestIntent(Context context, String userId, String
            oldPhoneNumber) {
    ...
    @Override
    public Fragment getEmptyCartFragment(String autoApplyMessage, String state, String
            titleDesc) {
    ...
    @Override
    public Intent getAddAddressIntent(Activity activity, @Nullable AddressModel
            data, com.tokopedia.core.manage.people.address.model.Token token, boolean isEdit,
    ...
    @Override
    public Intent createIntentProductVariant(Context
                                                     context, ArrayList<ProductVariantByCatModel> productVariantByCatModelList,
                                             ProductVariantViewModel productVariant, int productPriceCurrency,
                                             double productPrice,
                                             int productStock, boolean officialStore, String productSku,
                                             boolean needRetainImage, ProductPictureViewModel productSizeChart,
                                             boolean hasOriginalVariantLevel1,
    ...
    @Override
    public void logisticUploadRouterActionNavigateByApplinksUrl(Activity activity, String
            applinks, Bundle bundle) {
    ...
    @Override
    public void generateBranchUrlForChallenge(Activity context, String url, String
            title, String channel, String og_url, String og_title, String og_desc, String
                                                      og_image, String deepLink, final BranchLinkGenerateListener listener) {
        ShareData shareData = ShareData.Builder.aShareData()
    ...
    @Override
    public void shareBranchUrlForChallenge(Activity context, String packageName, String
            url, String shareContents) {
    ...
    @Override
    public void sendEventTrackingWithShopInfo(String event, String category, String
            action, String label, String shopId, boolean isGoldMerchant, boolean isOfficialStore) {
        // ignore
    }
    ...
    @Override
    public void sendMoEngageFavoriteEvent(String shopName, String shopID, String
            shopDomain, String shopLocation, boolean isShopOfficaial, boolean isFollowed) {
     ...
     */
    @Override
    public void showAdvancedAppRatingDialog(Activity
                                                    activity, DialogInterface.OnDismissListener dismissListener) {
    ...
    @Override
    @NonNull
    public Intent getTopAdsKeywordNewChooseGroupIntent(@NonNull Context context,
                                                       boolean isPositive, String groupId) {
        return new Intent();
    }
