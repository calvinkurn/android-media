...
public class TripleProductCardViewHolder extends ProductCardViewHolder<ProductCardViewModel> {
    ...
    public TripleProductCardViewHolder(View itemView, FeedPlus.View viewListener) {
