        ...
        public Fragment getItem(int position) {
            if (SessionHandler.isV4Login(ParentIndexHome.this)) {
                ...
                if (getPageTitle(position).equals(content.get(0))) {
                    return com.tokopedia.home.fragment.FragmentIndexCategory.newInstance();
                }

                if (getPageTitle(position).equals(content.get(1))) {
                    return new com.tokopedia.home.fragment.FragmentProductFeed();
                }

                if (getPageTitle(position).equals(content.get(2))) {
                    return new com.tokopedia.home.favorite.view.FragmentIndexFavoriteV2();
                }

                if (getPageTitle(position).equals(content.get(3))) {
                    return new com.tokopedia.home.fragment.FragmentHotListV2();
                }
            } else {
                switch (position) {
                    case 0:
