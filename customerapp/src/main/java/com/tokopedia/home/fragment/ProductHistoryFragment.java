package com.tokopedia.home.fragment;
...
import com.tokopedia.home.adapter.GridLayoutProductAdapter;
 ...
 */
public class ProductHistoryFragment extends Fragment implements com.tokopedia.home.presenter.ProductHistoryView {
...
//    ItemDecorator itemDecorator;
    ...
    com.tokopedia.home.presenter.ProductHistory productHistory;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        productHistory = new com.tokopedia.home.presenter.ProductHistoryImpl(this);
...
//        itemDecorator = new ItemDecorator(getActivity(), R.dimen.item_offset);
            ...
            public int getSpanSize(int position) {
                ...
                switch (getResources().getConfiguration().orientation){
                    case Configuration.ORIENTATION_LANDSCAPE:
                        headerColumnSize = com.tokopedia.home.WishList.LANDSCAPE_COLUMN_HEADER;
                        regularColumnSize = com.tokopedia.home.WishList.LANDSCAPE_COLUMN;
                        footerColumnSize = com.tokopedia.home.WishList.LANDSCAPE_COLUMN_FOOTER;
                        break;
                    case Configuration.ORIENTATION_PORTRAIT:
                        headerColumnSize = com.tokopedia.home.WishList.PORTRAIT_COLUMN_HEADER;
                        regularColumnSize = com.tokopedia.home.WishList.PORTRAIT_COLUMN;
                        footerColumnSize = com.tokopedia.home.WishList.PORTRAIT_COLUMN_FOOTER;
                        break;
                }
    ...
    public int calcColumnSize() {
        ...
        switch (getResources().getConfiguration().orientation){
            case Configuration.ORIENTATION_PORTRAIT:
                defaultColumnNumber = com.tokopedia.home.WishList.PORTRAIT_COLUMN_MAIN;
                break;
            case Configuration.ORIENTATION_LANDSCAPE:
                defaultColumnNumber = com.tokopedia.home.WishList.LANDSCAPE_COLUMN_MAIN;
                break;
        }
