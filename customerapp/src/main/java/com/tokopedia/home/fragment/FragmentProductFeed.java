...
import com.tokopedia.home.presenter.ProductFeed;
import com.tokopedia.home.presenter.ProductFeed2Impl;
import com.tokopedia.home.presenter.ProductFeedView;
import com.tokopedia.home.util.DefaultRetryListener;
import com.tokopedia.home.util.ItemDecorator;
...
import static com.tokopedia.home.presenter.ProductFeed.messageTag;
...
//        }
    ...
    public int calcColumnSize() {
        return ProductFeedHelper.calcColumnSize(getResources().getConfiguration().orientation);
    }
