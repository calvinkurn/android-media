...
import com.tokopedia.tkpd.*;
import com.tokopedia.tkpd.app.MainApplication;
import com.tokopedia.tkpd.database.manager.CategoryDatabaseManager;
import com.tokopedia.tkpd.gcm.GCMHandler;
import com.tokopedia.tkpd.gcm.GCMHandler.GCMHandlerListener;
import com.tokopedia.tkpd.home.ParentIndexHome;
import com.tokopedia.tkpd.myproduct.presenter.AddProductPresenterImpl;
...
import com.tokopedia.tkpd.util.PasswordGenerator.PGListener;
 ...
 */
public class SplashScreenConsumerApp extends AppCompatActivity implements DownloadResultReceiver.Receiver{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tokopedia.tkpd.R.layout.activity_splash_screen);
...
//            @Override
//            public void run() {
        Pgenerator = new PasswordGenerator(SplashScreenConsumerApp.this);
        InitNew();
        getGCMid();
    }
//        }, TIME_DELAY);
...
//            finishSplashScreen();
    ...
    private void finishSplashScreen() {
        startActivity(new Intent(SplashScreenConsumerApp.this, ParentIndexHome.class));
        finish();
    }
    ...
    private void resetAllDatabaseFlag(){
        ...
        if(com.tokopedia.tkpd.BuildConfig.VERSION_NAME.equals("2.2.1") && !flagDB.getBoolean("reset_db_flag", false)){
