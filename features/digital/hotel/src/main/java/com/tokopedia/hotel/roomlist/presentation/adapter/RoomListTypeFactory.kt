...
import com.tokopedia.hotel.roomlist.presentation.adapter.viewholder.HotelEmptyViewHolder
...
class RoomListTypeFactory(val callback: BaseEmptyViewHolder.Callback, val listener: RoomListViewHolder.OnClickBookListener): BaseAdapterTypeFactory() {
    ...
    override fun createViewHolder(parent: View, type: Int): AbstractViewHolder<out Visitable<*>> {
        when (type) {
            ...
            HotelEmptyViewHolder.LAYOUT -> return HotelEmptyViewHolder(parent, callback)
    ...
    override fun type(viewModel: EmptyModel): Int {
        return HotelEmptyViewHolder.LAYOUT
    }
}