...
public class TicketView extends View {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.tokopedia.digital_deals.R.styleable.CustomTicketView);
            mOrientation = typedArray.getInt(com.tokopedia.digital_deals.R.styleable.CustomTicketView_orientation, Orientation.HORIZONTAL);
            mBackgroundColor = typedArray.getColor(com.tokopedia.digital_deals.R.styleable.CustomTicketView_backgroundColor, getResources().getColor(android.R.color.white));
            mScallopRadius = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_scallopRadius, Utils.dpToPx(20f, getContext()));
            mScallopPositionPercent = typedArray.getFloat(com.tokopedia.digital_deals.R.styleable.CustomTicketView_scallopPositionPercent, 50);
            mShowBorder = typedArray.getBoolean(com.tokopedia.digital_deals.R.styleable.CustomTicketView_showBorder, false);
            mBorderWidth = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_borderWidth, Utils.dpToPx(2f, getContext()));
            mBorderColor = typedArray.getColor(com.tokopedia.digital_deals.R.styleable.CustomTicketView_borderColor, getResources().getColor(android.R.color.black));
            mShowDivider = typedArray.getBoolean(com.tokopedia.digital_deals.R.styleable.CustomTicketView_showDivider, false);
            mDividerType = typedArray.getInt(com.tokopedia.digital_deals.R.styleable.CustomTicketView_dividerType, DividerType.NORMAL);
            mDividerWidth = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_dividerWidth, Utils.dpToPx(2f, getContext()));
            mDividerColor = typedArray.getColor(com.tokopedia.digital_deals.R.styleable.CustomTicketView_dividerColor, getResources().getColor(android.R.color.darker_gray));
            mDividerDashLength = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_dividerDashLength, Utils.dpToPx(8f, getContext()));
            mDividerDashGap = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_dividerDashGap, Utils.dpToPx(4f, getContext()));
            mCornerType = typedArray.getInt(com.tokopedia.digital_deals.R.styleable.CustomTicketView_cornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_cornerRadius, Utils.dpToPx(4f, getContext()));
            mDividerPadding = typedArray.getDimensionPixelSize(com.tokopedia.digital_deals.R.styleable.CustomTicketView_dividerPadding, Utils.dpToPx(10f, getContext()));
            float elevation = 0f;
            if (typedArray.hasValue(com.tokopedia.digital_deals.R.styleable.CustomTicketView_ticketElevation)) {
                elevation = typedArray.getDimension(com.tokopedia.digital_deals.R.styleable.CustomTicketView_ticketElevation, elevation);
            } else if (typedArray.hasValue(com.tokopedia.digital_deals.R.styleable.CustomTicketView_android_elevation)) {
                elevation = typedArray.getDimension(com.tokopedia.digital_deals.R.styleable.CustomTicketView_android_elevation, elevation);
            }
            if (elevation > 0f) {
