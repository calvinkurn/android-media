...
public class SelectDealQuantityFragment extends BaseDaggerFragment implements SelectQuantityContract.View, View.OnClickListener {
    ...
    void setButtons() {
        ...
        if (currentQuantity > 1) {
            ivSubtract.setColorFilter(ContextCompat.getColor(getContext(), com.tokopedia.digital_deals.R.color.green_250), android.graphics.PorterDuff.Mode.SRC_IN);
            ivSubtract.setClickable(true);

        } else {
            ivSubtract.setColorFilter(ContextCompat.getColor(getContext(), com.tokopedia.digital_deals.R.color.grey_400), android.graphics.PorterDuff.Mode.SRC_IN);
            ivSubtract.setClickable(false);
        }
        if (currentQuantity < maxQuantity) {
            ivAdd.setColorFilter(ContextCompat.getColor(getContext(), com.tokopedia.digital_deals.R.color.green_250), android.graphics.PorterDuff.Mode.SRC_IN);
            ivAdd.setClickable(true);

        } else {
            ivAdd.setColorFilter(ContextCompat.getColor(getContext(), com.tokopedia.digital_deals.R.color.grey_400), android.graphics.PorterDuff.Mode.SRC_IN);
    ...
    public void renderFromDetails(DealsDetailsResponse dealDetail) {
        ...
        ImageHandler.loadImage(getContext(), ivBrand, dealDetails.getImageWeb(), com.tokopedia.digital_deals.R.color.grey_1100, com.tokopedia.digital_deals.R.color.grey_1100);
        if (dealDetails.getBrand() != null) {
