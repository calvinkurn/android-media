    ...
    public class TopSuggestionHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void setDealTitle(int position, ProductItem value) {
            if (value != null) {
                ...
                ImageHandler.loadImage(context, brandImage, value.getThumbnailWeb(), com.tokopedia.digital_deals.R.color.grey_1100, com.tokopedia.digital_deals.R.color.grey_1100);
                if (value.getMrp() > 0) {
