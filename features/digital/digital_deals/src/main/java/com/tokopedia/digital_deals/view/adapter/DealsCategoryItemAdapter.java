...
public class DealsCategoryItemAdapter extends RecyclerView.Adapter<DealsCategoryItemAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            mainContent = itemView.findViewById(com.tokopedia.design.R.id.container);
            imageViewCatItem = itemView.findViewById(com.tokopedia.digital_deals.R.id.iv_category);
            textViewCatItem = itemView.findViewById(com.tokopedia.digital_deals.R.id.tv_category);
        }

        public void bindData(final CategoryItem categoryItem) {
            textViewCatItem.setText(categoryItem.getTitle());
            itemView.setOnClickListener(this);
            ImageHandler.loadImage(context, imageViewCatItem, categoryItem.getMediaUrl(), com.tokopedia.digital_deals.R.color.grey_1100, com.tokopedia.digital_deals.R.color.grey_1100);
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.tokopedia.digital_deals.R.layout.category_item, parent, false);
