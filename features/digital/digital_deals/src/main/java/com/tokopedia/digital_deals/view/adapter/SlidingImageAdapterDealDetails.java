...
public class SlidingImageAdapterDealDetails extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        ImageHandler.loadImage(context, imageView, images.get(position), com.tokopedia.digital_deals.R.color.grey_1100, com.tokopedia.digital_deals.R.color.grey_1100);
