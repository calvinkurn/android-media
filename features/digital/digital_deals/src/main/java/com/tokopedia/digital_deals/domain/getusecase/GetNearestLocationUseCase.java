...
public class GetNearestLocationUseCase extends RestRequestUseCase {
    private RequestParams params;

    @Inject
    public GetNearestLocationUseCase(){ }
    ...
    protected List<RestRequest> buildRequest(RequestParams requestParams) {
        ...
        String url = DealsUrl.DEALS_DOMAIN + DealsUrl.HelperUrl.DEALS_NEAREST_LOCATION;
        //Request 1
