 ...
 */
public class FlightSearchV2FilterFragment extends BaseDaggerFragment implements OnFlightBaseFilterListener {
    ...
    public static FlightSearchV2FilterFragment newInstance() {
        Bundle args = new Bundle();
        FlightSearchV2FilterFragment fragment = new FlightSearchV2FilterFragment();
        fragment.setArguments(args);
        return fragment;
    }

    private FlightSearchV2FilterFragment.OnFlightSearchFilterFragmentListener onFilterFragmentListener;

    public interface OnFlightSearchFilterFragmentListener extends OnFlightSearchV2FilterListener {
    ...
    protected void onAttachActivity(Context context) {
        onFilterFragmentListener = (FlightSearchV2FilterFragment.OnFlightSearchFilterFragmentListener) context;
    }
