...
import com.tokopedia.flight.searchV2.presentation.fragment.FlightSearchV2FilterFragment;
import com.tokopedia.flight.searchV2.presentation.model.filter.FlightFilterModel;
import com.tokopedia.flight.searchV2.presentation.presenter.FlightSearchV2FilterContract;
import com.tokopedia.flight.searchV2.presentation.presenter.FlightSearchV2FilterPresenter;
 ...
 */
public class FlightSearchV2FilterActivity extends BaseSimpleActivity
        implements FlightSearchV2FilterFragment.OnFlightSearchFilterFragmentListener, FlightSearchV2FilterContract.View {
    ...
    @Inject
    FlightSearchV2FilterPresenter flightFilterPresenter;
    ...
    public static Intent createInstance(Context context,
        ...
        Intent intent = new Intent(context, FlightSearchV2FilterActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonFilter.setOnClickListener(v -> onButtonFilterClicked());
    ...
    protected Fragment getNewFragment() {
        return FlightSearchV2FilterFragment.newInstance();
    }

    @Override
    protected int getLayoutRes() {
        return R.layout.activity_flight_search_v2_filter;
    }
