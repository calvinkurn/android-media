...
public class FlightDetailPriceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.tokopedia.flight.R.layout.fragment_flight_detail_price, container, false);
        labelAdultPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.label_adult_price);
        labelChildPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.label_child_price);
        labelInfantPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.label_infant_price);
        adultPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.adult_price);
        childPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.child_price);
        infantPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.infant_price);
        normalPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.normal_price);
        savingPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.saving_price);
        totalPrice = (TextView) view.findViewById(com.tokopedia.flight.R.id.total_price);
        containerChildPrice = view.findViewById(com.tokopedia.flight.R.id.container_child_price);
        containerInfantPrice = view.findViewById(com.tokopedia.flight.R.id.container_infant_price);
        containerSavingPrice = view.findViewById(com.tokopedia.flight.R.id.container_saving_price);
    ...
    void updateView() {
        ...
        adultPrice.setText(getString(com.tokopedia.flight.R.string.flight_label_currency, CurrencyFormatUtil.getThousandSeparatorString(adultPriceTotal, false, 0).getFormattedString()));
        labelAdultPrice.setText(getString(com.tokopedia.flight.R.string.flight_label_adult, flightDetailViewModel.getCountAdult()));
        if (flightDetailViewModel.getCountChild() > 0) {
            containerChildPrice.setVisibility(View.VISIBLE);
            labelChildPrice.setText(getString(com.tokopedia.flight.R.string.flight_label_child, flightDetailViewModel.getCountChild()));
            double childPriceTotal = flightDetailViewModel.getChildNumericPrice() * flightDetailViewModel.getCountChild();
            childPrice.setText(getString(com.tokopedia.flight.R.string.flight_label_currency, CurrencyFormatUtil.getThousandSeparatorString(childPriceTotal, false, 0).getFormattedString()));
        }
        if (flightDetailViewModel.getCountInfant() > 0) {
            containerInfantPrice.setVisibility(View.VISIBLE);
            labelInfantPrice.setText(getString(com.tokopedia.flight.R.string.flight_label_infant, flightDetailViewModel.getCountInfant()));
