...
public class FlightOrderDetailRouteViewModelMapper {
    private FlightOrderDetailRouteInfoViewModelMapper flightDetailRouteInfoViewModelMapper;

    @Inject
    public FlightOrderDetailRouteViewModelMapper(FlightOrderDetailRouteInfoViewModelMapper flightDetailRouteInfoViewModelMapper) {
        this.flightDetailRouteInfoViewModelMapper = flightDetailRouteInfoViewModelMapper;
    }

    public FlightOrderDetailRouteViewModel transform(Route route) {
        FlightOrderDetailRouteViewModel flightDetailRouteViewModel = null;
        if (route != null) {
            flightDetailRouteViewModel = new FlightOrderDetailRouteViewModel();
    ...
    private List<FlightStopOverViewModel> transform(List<OrderStopDetailEntity> stopDetails) {
        List<FlightStopOverViewModel> details = new ArrayList<>();
        FlightStopOverViewModel viewModel = null;
        if (stopDetails != null){
            for (OrderStopDetailEntity entity : stopDetails){
    ...
    public List<FlightOrderDetailRouteViewModel> transform(List<Route> routes, int totalTransit) {
        List<FlightOrderDetailRouteViewModel> flightDetailRouteViewModels = new ArrayList<>();
        FlightOrderDetailRouteViewModel flightDetailRouteViewModel;
        if (routes != null) {
    ...
    public FlightOrderDetailRouteViewModel transform(RouteEntity route) {
        FlightOrderDetailRouteViewModel flightDetailRouteViewModel = null;
        if (route != null) {
            flightDetailRouteViewModel = new FlightOrderDetailRouteViewModel();
    ...
    public List<FlightOrderDetailRouteViewModel> transformList(List<RouteEntity> routeEntities) {
        List<FlightOrderDetailRouteViewModel> flightDetailRouteViewModels = new ArrayList<>();
        FlightOrderDetailRouteViewModel flightDetailRouteViewModel;
