...
constructor(private val cacheManager: CacheManager) {
    ...
    fun saveCache(orderEntity: DigitalBrowseMarketplaceData) {
        ...
        cacheManager.put(DIGITAL_BROWSE_MARKETPLACE_CACHE_KEY,
    ...
    fun getCache(): Observable<DigitalBrowseMarketplaceData> {
        val jsonString = cacheManager.getString(DIGITAL_BROWSE_MARKETPLACE_CACHE_KEY)
    ...
    companion object {
        private val DIGITAL_BROWSE_MARKETPLACE_CACHE_TIMEOUT = TimeUnit.DAYS.toSeconds(30)
        private val DIGITAL_BROWSE_MARKETPLACE_CACHE_KEY = "DIGITAL_BROWSE_MARKETPLACE_CACHE_KEY"
    }
}
