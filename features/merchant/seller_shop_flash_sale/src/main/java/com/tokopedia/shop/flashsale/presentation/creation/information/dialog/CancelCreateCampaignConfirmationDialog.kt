...
class CancelCreateCampaignConfirmationDialog(private val context: Context) {
    ...
    fun show() {
        ...
        val view = View.inflate(context, R.layout.ssfs_dialog_cancel_create_campaign_confirmation, null)
