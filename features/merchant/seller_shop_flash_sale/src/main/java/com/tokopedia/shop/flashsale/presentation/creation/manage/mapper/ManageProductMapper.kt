...
object ManageProductMapper {
    ...
    fun mapToProductData(product: SellerCampaignProductList.Product) = DoSellerCampaignProductSubmissionRequest.ProductData(
    ...
    fun mapToProductDataList(reserveProductList: List<SellerCampaignProductList.Product>) = reserveProductList
