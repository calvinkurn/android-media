...
abstract class BulkBottomSheetType(
    ...
    data class EtalaseType(var etalaseValue: String = "",
            ...
            com.tokopedia.product.manage.oldlist.R.string.product_bs_etalase_title, etalaseValue, false
    )

    data class StockType(var stockStatus: Int = STOCK_DEFAULT) : BulkBottomSheetType(
            com.tokopedia.product.manage.oldlist.R.string.product_bs_stock_title, "", false
    ) {
    ...
    class DeleteType : BulkBottomSheetType(
            com.tokopedia.product.manage.oldlist.R.string.product_bs_delete_title, "", true
    )
