...
class ConfirmationProductAdapter(private var data: List<ConfirmationProductData>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ConfirmationProductViewHolder {
        return ConfirmationProductViewHolder(LayoutInflater.from(parent.context).inflate(com.tokopedia.product.manage.oldlist.R.layout.item_confirmation_product, parent, false))
    }
    ...
    inner class ConfirmationProductViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        private val txtProductTitle: TextView = view.findViewById(com.tokopedia.product.manage.oldlist.R.id.txt_title_product_confirmation)
        private val imgProduct: ImageView = view.findViewById(com.tokopedia.product.manage.oldlist.R.id.img_product_confirmation)
        private val txtProductStock: TextView = view.findViewById(com.tokopedia.product.manage.oldlist.R.id.txt_stock_confirmation)
        private val txtProductEtalase: TextView = view.findViewById(com.tokopedia.product.manage.oldlist.R.id.txt_etalase_confirmation)
