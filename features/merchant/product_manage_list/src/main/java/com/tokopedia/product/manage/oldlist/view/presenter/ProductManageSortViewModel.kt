    ...
    fun getListSortManageProduct(stringArray: Array<String>) {
        ...
        productManageSortModels.addAll(
                stringArray.map {
                    ...
                    when (it) {
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_position) -> {
                            productManageSortModel.sortId = SortProductOption.POSITION
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_new_product) -> {
                            productManageSortModel.sortId = SortProductOption.NEW_PRODUCT
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_last) -> {
                            productManageSortModel.sortId = SortProductOption.LAST_UPDATE
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_product_name) -> {
                            productManageSortModel.sortId = SortProductOption.PRODUCT_NAME
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_most_viewed) -> {
                            productManageSortModel.sortId = SortProductOption.MOST_VIEW
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_most_discussed) -> {
                            productManageSortModel.sortId = SortProductOption.MOST_TALK
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_most_reviewed) -> {
                            productManageSortModel.sortId = SortProductOption.MOST_REVIEW
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_most_buy) -> {
                            productManageSortModel.sortId = SortProductOption.MOST_BUY
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_lowest_price) -> {
                            productManageSortModel.sortId = SortProductOption.LOWEST_PRICE
                            productManageSortModel.titleSort = it
                        }
                        context.getString(com.tokopedia.product.manage.oldlist.R.string.sort_highest_price) -> {
