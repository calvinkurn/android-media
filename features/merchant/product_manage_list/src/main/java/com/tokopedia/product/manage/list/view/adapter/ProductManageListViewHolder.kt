...
class ProductManageListViewHolder(view: View, checkableListener: CheckableInteractionListener,
    ...
    companion object {
        @LayoutRes
        var LAYOUT = com.tokopedia.product.manage.list.R.layout.item_manage_product_list
    }
    ...
    private val cashbackTextView: TextView = view.findViewById(com.tokopedia.product.manage.list.R.id.text_view_cashback);
    private val wholesaleTextView: TextView = view.findViewById(com.tokopedia.product.manage.list.R.id.text_view_wholesale);
    private val preOrderTextView: TextView = view.findViewById(com.tokopedia.product.manage.list.R.id.text_view_pre_order);
    private val freeReturnImageView: ImageView = view.findViewById(com.tokopedia.product.manage.list.R.id.image_view_free_return);
    private val optionImageButton: View = view.findViewById(com.tokopedia.product.manage.list.R.id.image_button_option);
    private val checkBoxProduct: CheckBox = view.findViewById(com.tokopedia.product.manage.list.R.id.check_box_product);
    private val tagEmptyStock: TextView = view.findViewById(com.tokopedia.product.manage.list.R.id.tag_empty_product);
    private val viewSuperVision: View = view.findViewById(com.tokopedia.product.manage.list.R.id.view_product_on_supervision);
    private val textViewVariant: TextView = view.findViewById(com.tokopedia.product.manage.list.R.id.text_view_variant);
    ...
    override fun bind(productManageViewModel: ProductManageViewModel) {
        ...
        priceTextView.text = priceTextView.context.getString(
                com.tokopedia.product.manage.list.R.string.pml_price_format_text, productManageViewModel.productCurrencySymbol,
        ...
        if (productManageViewModel.productCashback > 0) {
            cashbackTextView.text = cashbackTextView.context.getString(
                    com.tokopedia.product.manage.list.R.string.product_manage_item_cashback, productManageViewModel.productCashback)
