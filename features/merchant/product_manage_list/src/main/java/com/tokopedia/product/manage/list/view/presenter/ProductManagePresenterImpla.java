...
//
//import static com.tokopedia.product.manage.list.data.model.BulkBottomSheetType.STOCK_DELETED;
//
///**
// * Created by zulfikarrahman on 9/22/17.
// */
//
//public class ProductManagePresenterImpla extends BaseDaggerPresenter<ProductManageView> implements ProductManagePresenter {
//
...
//    private final BulkUpdateProductUseCase bulkUpdateProductUseCase;
...
//
//    public ProductManagePresenterImpla(GetShopInfoUseCase getShopInfoUseCase,
...
//        this.bulkUpdateProductUseCase = bulkUpdateProductUseCase;
//    }
//
//    @Override
...
//
//    @Override
//    public void bulkUpdateProduct(List<ConfirmationProductData> listUpdateResponse) {
//
//        bulkUpdateProductUseCase.execute(BulkUpdateProductUseCase.createRequestParams(productUpdateParamMapper(listUpdateResponse)), new Subscriber<List<? extends ProductUpdateV3Response>>() {
//            @Override
//            public void onCompleted() {
//
//            }
...
//            @Override
//            public void onError(Throwable e) {
//                getView().onErrorBulkUpdateProduct(e);
//            }
//
//            @Override
//            public void onNext(List<? extends ProductUpdateV3Response> productUpdateV3Responses) {
//                getView().onSuccessBulkUpdateProduct((List<ProductUpdateV3Response>) productUpdateV3Responses);
//            }
//        });
//    }
//
...
//        String etalaseIdString = generateEtalaseIdFilter(etalaseId);
...
//    }
//
//    private List<ProductUpdateV3Param> productUpdateParamMapper(List<ConfirmationProductData> confirmationData) {
//        List<ProductUpdateV3Param> listParam = new ArrayList<>();
//        for (ConfirmationProductData listData : confirmationData) {
//            ProductUpdateV3Param response = new ProductUpdateV3Param();
//            response.getProductEtalase().setEtalaseId(String.valueOf(listData.getProductEtalaseId()));
//            response.getProductEtalase().setEtalaseName(listData.getProductEtalaseName());
//            response.setProductId(listData.getProductId());
//            response.setProductStatus(listData.getStatusProduct());
//            response.setProductStock(listData.getProductStock());
//            response.getShop().setShopId(userSession.getShopId());
//            listParam.add(response);
//        }
//        return listParam;
//    }
//
//    @Override
//    public ArrayList<ConfirmationProductData> mapToBulkUpdateParam(boolean isActionDelete, BulkBottomSheetType.StockType stockType, BulkBottomSheetType.EtalaseType etalaseType, List<ProductManageViewModel> productManageViewModels) {
//        ArrayList<ConfirmationProductData> confirmationProductDataList = new ArrayList<>();
...
//                if (isActionDelete) {
//                    confirmationProductData.setStatusStock(STOCK_DELETED);
//                } else {
//                    confirmationProductData.setStatusStock(stockType.getStockStatus());
//                }
