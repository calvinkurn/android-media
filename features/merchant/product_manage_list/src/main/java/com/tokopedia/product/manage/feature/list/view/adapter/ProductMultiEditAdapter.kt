...
class ProductMultiEditAdapter(private val listener: MultiEditViewHolder.MenuClickListener) : RecyclerView.Adapter<MultiEditViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MultiEditViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(MultiEditViewHolder.LAYOUT, parent, false)
