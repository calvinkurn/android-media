...
class OfficialTopAdsBannerDataModel(val banner: MutableList<Banner>, val categoryName: String) : OfficialHomeVisitable{
    override fun getChangePayloadFrom(b: Any?): Bundle? = null

    override fun visitableId(): String = categoryName

    override fun equalsWith(b: Any?): Boolean = b is OfficialTopAdsBannerDataModel &&
        banner == b.banner &&
