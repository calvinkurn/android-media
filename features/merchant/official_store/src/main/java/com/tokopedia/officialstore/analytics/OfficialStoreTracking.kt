...
class OfficialStoreTracking(context: Context) : BaseTrackerConst() {
                ...
                DataLayer.mapOf(
                    ...
                    DataLayer.listOf(
                        DataLayer.mapOf(
                            ...
                            categoryId,
                            Promotion.ITEM_NAME,
                            FORMAT_ITEM_NAME.format(categoryName, VALUE_CATEGORY_NAVIGATION),
        ...
        val bundle = Bundle().apply {
            ...
            val promotions = arrayListOf(
                Bundle().apply {
                    ...
                    putString(
                        Promotion.ITEM_NAME,
                        FORMAT_ITEM_NAME_THREE_VALUES.format(
                            categoryName,
                            VALUE_POPULAR_BRANDS,
                            headerName
                        )
            ...
            DataLayer.mapOf(
                ...
                DataLayer.mapOf(
                    ...
                    DataLayer.listOf(
                        DataLayer.mapOf(
                            Promotion.ITEM_ID,
                            FORMAT_UNDERSCORE_THREE_VALUES.format(bannerId, channelId, shopId),
                            Promotion.ITEM_NAME,
                            FORMAT_ITEM_NAME_THREE_VALUES.format(
                                categoryName,
                                VALUE_POPULAR_BRANDS,
    ...
    fun impressionLego36Image(categoryName: String, channelModel: ChannelModel, userId: String) {
        ...
        val promotionBody = channelModel.channelGrids.mapIndexed { index, grid ->
            DataLayer.mapOf(
                Promotion.ITEM_ID,
                FORMAT_UNDERSCORE_TWO_VALUES.format(channelModel.channelBanner.id, channelModel.id),
                Promotion.ITEM_NAME,
                FORMAT_ITEM_NAME_FOUR_VALUES.format(
                    categoryName,
                    VALUE_DYNAMIC_CHANNEL,
