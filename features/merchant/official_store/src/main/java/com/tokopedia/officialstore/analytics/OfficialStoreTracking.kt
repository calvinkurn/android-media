...
class OfficialStoreTracking(context: Context) {
            ...
            DataLayer.mapOf(
                ...
                DataLayer.mapOf(
                    ...
                    DataLayer.listOf(
                        DataLayer.mapOf(
                            FIELD_PRODUCT_ID,
                            PROMOTIONS_ID_POPULAR_BRANDS.format(bannerId, shopId),
                            FIELD_PRODUCT_NAME,
                            PROMOTIONS_NAME_POPULAR_BRANDS.format(
                            ...
                            "$shopPosition",
                            FIELD_PRODUCT_CREATIVE,
                            "$creativeName $REFERENCE_POPULAR_BRANDS"
                        )
                    )
                )
            ),
    ...
    fun flashSaleActionTextClick(categoryName: String, headerId: Long) {
        tracker.sendGeneralEvent(
            DataLayer.mapOf(
                ...
                "clickOSMicrosite",
                EVENT_CATEGORY,
                "os microsite - $categoryName",
                EVENT_ACTION,
                "flash sale - click",
                EVENT_LABEL,
                "click view all - $headerId"
            )
        )
    }
    ...
    fun flashSalePDPClick(categoryName: String, headerName: String, position: String, gridData: Grid, campaignId: Int, campaignCode: String) {
        val ecommerceBody = DataLayer.mapOf(
            ...
            DataLayer.mapOf(
                "actionField",
                DataLayer.mapOf("list", "/official-store/$categoryName - flash sale - $campaignId - $headerName"),
                "products",
                DataLayer.listOf(
                    DataLayer.mapOf(
                        "name", gridData.name,
    ...
    fun dynamicChannelMixCardClick(categoryName: String, headerName: String, position: String, gridData: Grid, campaignCode: String, campaignId: String) {
        val ecommerceBody = DataLayer.mapOf(
            ...
            DataLayer.mapOf(
                "actionField",
                DataLayer.mapOf("list", "/official-store/$categoryName - dynamic channel mix - $headerName"),
                "products",
                DataLayer.listOf(
                    DataLayer.mapOf(
                        "name", gridData.name,
        ...
        val data = DataLayer.mapOf(
            ...
            DataLayer.mapOf(
                ...
                DataLayer.mapOf(
                    ...
                    DataLayer.mapOf(
                        FIELD_PRODUCT_LIST,
                        getListProductClickInsideActionField(categoryName, item.recommendationType)
                    ),
                    FIELD_PRODUCTS,
                    DataLayer.listOf(
    ...
    private fun getDynamicChannelImpressionPromotion(
        categoryName: String,
        channelData: Channel,
        channelType: String,
        headerName: String
    ...
    private fun getHomeComponentImpressionPromotion(
        categoryName: String,
    ...
    fun flashSaleCardClicked(
        ...
        val data = DataLayer.mapOf(
            ...
            DataLayer.mapOf(
                ...
                DataLayer.mapOf(
                    FIELD_ACTION_FIELD,
                    DataLayer.mapOf(FIELD_PRODUCT_LIST, listKeyValue),
                    FIELD_PRODUCTS,
                    DataLayer.listOf(
                        createFlashSaleCardProductItemMap(
                            productItem,
    ...
    fun eventClickMixLeftImageBanner(channel: Channel, categoryName: String, bannerPosition: Int) {
        ...
        eventDataLayer.putParcelableArrayList(
            "promotions",
            createMixLeftEcommerceDataLayer(
