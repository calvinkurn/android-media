...
@Component(modules = [OfficialStoreHomeModule::class, RecommendationModule::class, TopAdsWishlistModule::class, RecommendationCoroutineModule::class], dependencies = [OfficialStoreComponent::class])
