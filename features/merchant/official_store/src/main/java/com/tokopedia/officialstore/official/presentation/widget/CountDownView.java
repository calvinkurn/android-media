...
public class CountDownView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            col1.setTextColor(a.getColor(R.styleable.CountDownView_countDownSparatorColor, ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_YN500)));
            col2.setTextColor(a.getColor(R.styleable.CountDownView_countDownSparatorColor, ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_YN500)));
