...
import com.tokopedia.sellerhomecommon.domain.gqlquery.GqlGetShopInfoTicker
...
class GetShopInfoTickerUseCase @Inject constructor(
    ...
    gqlRepository, mapper, dispatchers, GqlGetShopInfoTicker.QUERY, false
) {
    ...
    override suspend fun executeOnBackground(): List<TickerItemUiModel> {
        val gqlRequest = GraphqlRequest(GqlGetShopInfoTicker, classType, params.parameters)
