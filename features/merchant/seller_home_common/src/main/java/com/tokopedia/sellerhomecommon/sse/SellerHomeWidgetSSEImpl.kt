    ...
    override fun connect(page: String, dataKeys: List<String>) {
        ...
        sse = OkSse().newServerSentEvent(request, object : ServerSentEvent.Listener {
            ...
            override fun onMessage(
                ...
                println("SSE Listener : onMessage")
                sseFlow.tryEmit(WidgetSSEModel(event = event, message = message))
            }

            override fun onComment(sse: ServerSentEvent, comment: String) {
                println("SSE Listener : onComment")
            }

            override fun onRetryTime(sse: ServerSentEvent, milliseconds: Long): Boolean {
                println("SSE Listener : onRetryTime : ${milliseconds.div(1000)}")
                return true
            }
            ...
            override fun onRetryError(
                ...
                println("SSE Listener : onRetryError : ${throwable.message}")
                println("SSE Listener : onRetryError : response message ${response?.message}")
                return true
            }

            override fun onClosed(sse: ServerSentEvent) {
                println("SSE Listener : onClosed")
            }

            override fun onPreRetry(sse: ServerSentEvent, originalRequest: Request): Request {
                println("SSE Listener : onPreRetry")
                return request
            }
        })
    }
