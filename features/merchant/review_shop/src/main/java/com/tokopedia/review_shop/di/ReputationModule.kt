...
import com.tokopedia.review_shop.shop.domain.GetLikeDislikeReviewUseCase
...
import com.tokopedia.review_shop.shop.domain.repository.ReputationRepositoryImpl
...
class ReputationModule {
    ...
    @ReputationScope
    @Provides
    fun reputationTracking(): com.tokopedia.review_shop.analytic.ReputationTracking {
        return com.tokopedia.review_shop.analytic.ReputationTracking()
    }
}