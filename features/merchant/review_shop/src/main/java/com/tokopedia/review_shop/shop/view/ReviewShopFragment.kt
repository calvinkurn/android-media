...
import com.tokopedia.review_shop.analytic.ReputationTracking
import com.tokopedia.review_shop.analytic.ReputationTrackingConstant
import com.tokopedia.review_shop.di.DaggerReputationComponent
import com.tokopedia.review_shop.di.ReputationModule
import com.tokopedia.review_shop.product.view.adapter.ReviewProductAdapter
import com.tokopedia.review_shop.product.view.adapter.ReviewProductContentViewHolder
...
import com.tokopedia.review_shop.shop.view.adapter.ReviewShopTypeFactoryAdapter
import com.tokopedia.review_shop.shop.view.adapter.ReviewShopViewHolder
...
class ReviewShopFragment : BaseListFragment<ReviewShopModelContent?, ReviewShopTypeFactoryAdapter?>(), ReviewProductContentViewHolder.ListenerReviewHolder, ReviewShopContract.View, ReviewShopViewHolder.ShopReviewHolderListener {
    ...
    @kotlin.jvm.JvmField
    @Inject
    var reputationTracking: com.tokopedia.review_shop.analytic.ReputationTracking? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let{
            ...
            shopDomain = it.getString(SHOP_DOMAIN, "")
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        context?.let{
            ...
            dividerItemDecoration.setDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.divider_vertical_product_review)!!)
    ...
    override fun goToPreviewImage(position: Int, list: ArrayList<ImageUpload>, element: ReviewProductModelContent?) {
        ...
        activity?.let{
            startActivity(getCallingIntent(
                    it,
                    listLocation,
                    listDesc,
                    position))
