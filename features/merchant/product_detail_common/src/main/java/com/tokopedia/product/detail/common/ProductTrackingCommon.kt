...
object ProductTrackingCommon {
    ...
    fun onRemindMeClicked(productId: String) {
        val mapEvent = TrackAppUtils.gtmData(
                ProductTrackingConstant.PDP.EVENT_CLICK_PDP,
                ProductTrackingConstant.Category.PDP_VARIANT_BOTTOMSHEET,
    ...
    fun onWishlistCheckClicked(productId: String) {
        val mapEvent = TrackAppUtils.gtmData(
                ProductTrackingConstant.PDP.EVENT_CLICK_PDP,
                ProductTrackingConstant.Category.PDP_VARIANT_BOTTOMSHEET,
    ...
    fun onSeeCartVariantBottomSheetClicked(message: String, productId: String) {
        val mapEvent = TrackAppUtils.gtmData(
                ProductTrackingConstant.PDP.EVENT_CLICK_PDP,
                ProductTrackingConstant.Category.PDP_VARIANT_BOTTOMSHEET,
    ...
    fun onVariantImageBottomSheetClicked(productId: String) {
        val mapEvent = TrackAppUtils.gtmData(
                ProductTrackingConstant.PDP.EVENT_CLICK_PDP,
                ProductTrackingConstant.Category.PDP_VARIANT_BOTTOMSHEET,
    ...
    fun onVariantGuidelineClicked(productId: String) {
        val mapEvent = TrackAppUtils.gtmData(
                ProductTrackingConstant.PDP.EVENT_CLICK_PDP,
                ProductTrackingConstant.Category.PDP_VARIANT_BOTTOMSHEET,
    ...
    fun onVariantPartiallySelected(errorMessage: String, productId: String) {
        val mapEvent = TrackAppUtils.gtmData(
    ...
    private fun addAdditionalParams(productId: String, mapEvent: MutableMap<String, Any>) {
        mapEvent[KEY_BUSINESS_UNIT] = BUSINESS_UNIT_PDP
    ...
    fun eventEcommerceAddToCart(
        ...
        TrackApp.getInstance().gtm.sendEnhanceEcommerceEvent(DataLayer.mapOf(
                ...
                KEY_BUSINESS_UNIT, BUSINESS_UNIT_PDP,
