...
data class ProductVariantInputModel(
        ...
        @Expose
        var productVariant: ArrayList<ProductVariantCombination> = ArrayList(),
        @SerializedName("productSizeChart")
        @Expose
        var productSizeChart: ProductPicture? = null
) : Parcelable
...
@Parcelize
data class ProductVariantCombination(
        @SerializedName("st")
        @Expose
        var st: Int = 0,
...
data class ProductVariantOptionChild(
        ...
        @Expose
        var productPictureViewModelList: List<ProductPicture>? = ArrayList(),
        @SerializedName("hex")
        @Expose
