...
import com.tokopedia.sellerhomedrawer.view.listener.DrawerHeaderListener
import com.tokopedia.sellerhomedrawer.view.listener.RetryTokoCashListener
import com.tokopedia.sellerhomedrawer.view.viewmodel.header.DrawerHeader
import com.tokopedia.sellerhomedrawer.view.viewmodel.header.SellerDrawerTokoCash
import com.tokopedia.sellerhomedrawer.view.viewmodel.header.SellerDrawerWalletAction
...
class DrawerHeaderViewHolder(itemView: View,
    ...
    protected fun bindDrawerHeader(drawerHeader: com.tokopedia.sellerhomedrawer.view.viewmodel.header.DrawerHeader) {
        with(itemView) {
