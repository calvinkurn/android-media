...
data class SellerHomeStatus(
        ...
        @Expose val tickerMessage: String = ""): Parcelable {
    ...
    data class GetCampaignSellerStatus(
            @SerializedName("data")
            val sellerStatus: SellerHomeStatus
    )
    ...
    companion object CREATOR : Parcelable.Creator<SellerHomeStatus> {
        override fun createFromParcel(parcel: Parcel): SellerHomeStatus {
            return SellerHomeStatus(parcel)
        }

        override fun newArray(size: Int): Array<SellerHomeStatus?> {
