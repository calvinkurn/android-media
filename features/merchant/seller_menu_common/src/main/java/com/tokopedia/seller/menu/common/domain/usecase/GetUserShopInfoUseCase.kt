...
class GetUserShopInfoUseCase @Inject constructor(
    ...
    private val goldGetPMShopInfoUseCase: GoldGetPMShopInfoUseCase,
    ...
    override suspend fun executeOnBackground(): UserShopInfoWrapper {
        return withContext(dispatchers.io) {
            ...
            val goldGetPMShopInfoDeferred = async { goldGetPMShopInfoUseCase.execute(shopId) }
            ...
            userShopInfoMapper.mapToUserShopInfoUiModel(
                ...
                goldGetPMShopInfoDeferred.await(),
