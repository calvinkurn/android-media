...
import com.tokopedia.mvc.presentation.creation.step3.VoucherSettingFragment
...
import com.tokopedia.mvc.presentation.redirection.MvcRedirectionPageFragment
...
interface MerchantVoucherCreationComponent {
    ...
    fun inject(bottomSheet: VoucherEditCalendarBottomSheet)
    ...
    fun inject(activity: VoucherSettingActivity)
    fun inject(fragment: VoucherSettingFragment)
    ...
    fun inject(fragment: MvcRedirectionPageFragment)
}
