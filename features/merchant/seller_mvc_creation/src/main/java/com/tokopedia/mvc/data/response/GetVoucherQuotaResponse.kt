...
data class Header (
    @SerializedName("process_time" ) val processTime : Double            = 0.toDouble(),
    @SerializedName("message"      ) val message     : ArrayList<String> = arrayListOf(),
...
data class Data (
    @SerializedName("quota"         ) val quota        : Quota              = Quota(),
    @SerializedName("status_source" ) val statusSource : String             = "",
    @SerializedName("sources"       ) val sources      : ArrayList<Sources> = arrayListOf(),
    @SerializedName("ticker"        ) val ticker       : Ticker             = Ticker(),
    @SerializedName("cta_text"      ) val ctaText      : String             = "",
    @SerializedName("cta_link"      ) val ctaLink      : String             = ""
)
