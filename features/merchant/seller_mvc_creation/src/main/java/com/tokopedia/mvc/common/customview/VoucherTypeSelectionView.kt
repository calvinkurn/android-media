...
class VoucherTypeSelectionView: BaseCustomView {
    ...
    private fun defineCustomAttributes(attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            try {
                titleText = styledAttributes.getString(R.styleable.VoucherTypeSelectionView_title_text).orEmpty()
                descriptionText = styledAttributes.getString(R.styleable.VoucherTypeSelectionView_description_text).orEmpty()
                isActive = styledAttributes.getBoolean(R.styleable.VoucherTypeSelectionView_is_active, false)
            } finally {
