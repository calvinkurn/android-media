...
object ImageAssets {
    const val PRODUCT_EMPTY = TokopediaImageUrl.PRODUCT_EMPTY
    const val SEARCH_SHOWCASE_NOT_FOUND = TokopediaImageUrl.SEARCH_SHOWCASE_NOT_FOUND
    const val PICKER_LIST_EMPTY = TokopediaImageUrl.PICKER_LIST_EMPTY
}
