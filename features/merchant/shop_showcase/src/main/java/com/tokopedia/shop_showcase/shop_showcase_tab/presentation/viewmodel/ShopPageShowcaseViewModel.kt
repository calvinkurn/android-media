package com.tokopedia.shop_showcase.shop_showcase_tab.presentation.viewmodel
...
import com.tokopedia.shop_showcase.shop_showcase_tab.presentation.model.FeaturedShowcaseUiModelResponse
...
class ShopPageShowcaseViewModel @Inject constructor(
    ...
    private fun getAllShowcaseListCall(shopId: String): List<ShopEtalaseModel> {
        ...
        val requestParams = GetShopEtalaseByShopUseCase.createRequestParams(
                ...
                isOwner = ShopShowcaseUtil.isMyShop(shopId, userSession.shopId)
        )
