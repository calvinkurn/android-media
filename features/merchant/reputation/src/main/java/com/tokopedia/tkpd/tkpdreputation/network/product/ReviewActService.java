...
public class ReviewActService extends BaseReputationService {

    public static final String TAG = ReviewActService.class.getSimpleName();

    private ReviewActApi api;
    private Context context;
    private NetworkRouter networkRouter;
    private UserSession userSession;

    public ReviewActService(Context context, NetworkRouter networkRouter, UserSession userSession) {
        super();
