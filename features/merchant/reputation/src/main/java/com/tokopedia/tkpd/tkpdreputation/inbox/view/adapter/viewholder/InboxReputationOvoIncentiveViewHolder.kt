...
class InboxReputationOvoIncentiveViewHolder(view: View, private val viewListener: InboxReputation.View) : AbstractViewHolder<InboxReputationOvoIncentiveViewModel>(view) {
