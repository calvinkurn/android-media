...
public class ActResultMapper implements Func1<Response<TokopediaWsV4Response>, ActResultDomain> {
    private static final String DEFAULT_ERROR = "Terjadi kesalahan, mohon coba kembali.";
    @Override
    public ActResultDomain call(Response<TokopediaWsV4Response> response) {
