...
import com.tokopedia.reviewseller.feature.inboxreview.di.module.InboxReviewViewModelModule
...
@Module(includes = [ReviewProductListViewModelModule::class, InboxReviewViewModelModule::class])
@ReviewSellerScope
