 ...
 */
class ProductReportViewHolder(val view: View, val listener: ProductDetailListener) :
    AbstractViewHolder<ProductReportDataModel>(view) {
    ...
    override fun bind(element: ProductReportDataModel) {
        ...
        binding.productReportTxt.text =
            view.context.getString(R.string.merchant_product_detail_report_text)
                .boldOrLinkText(
                    true,
                    view.context,
                    view.context.getString(R.string.merchant_product_detail_report_suffix) to {
