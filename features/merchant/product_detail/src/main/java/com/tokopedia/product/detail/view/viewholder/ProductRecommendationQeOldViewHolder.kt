...
import com.tokopedia.product.detail.databinding.ItemDynamicRecommendationQeOldBinding
...
@RecomTemporary
class ProductRecommendationQeOldViewHolder(
    ...
    companion object {
        val LAYOUT = R.layout.item_dynamic_recommendation_qe_old
    }

    private val binding = ItemDynamicRecommendationQeOldBinding.bind(view)
            ...
            element.recomWidgetData?.run {
                ...
                if (annotationChipAdapter == null && element.filterData?.isNotEmpty() == true) {
                    annotationChipAdapter =
                        AnnotationChipFilterAdapter(object : ProductRecommendationViewHolder.AnnotationChipListener {
    ...
    internal class AnnotationChipFilterAdapter(private val listener: ProductRecommendationViewHolder.AnnotationChipListener) :
