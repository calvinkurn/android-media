            ...
            if (!GlobalConfig.isSellerApp()) {
                try {
                    withContext(dispatcher.io()) {
                        ...
                        val recomFilterDeferred = async { getRecommendationFilterChips.get().executeOnBackground() }

                        val recomDataDeferred = async { getRecommendationUseCase.get().createObservable(getRecommendationUseCase.get().getRecomParams(
