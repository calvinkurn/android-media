...
open class GetPdpLayoutUseCase @Inject constructor(private val gqlUseCase: MultiRequestGraphqlUseCase,
    ...
    private fun mapIntoModel(data: PdpGetLayout): ProductDetailDataModel {
        val initialLayoutData =
            if (data.basicInfo != null) DynamicProductDetailMapper.mapIntoVisitable(
                data.components,
                data.basicInfo.productID
            ) else DynamicProductDetailMapper.mapIntoVisitable(data.components)
