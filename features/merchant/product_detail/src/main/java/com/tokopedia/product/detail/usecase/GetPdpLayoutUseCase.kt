...
import com.tokopedia.product.detail.di.RawQueryKeyConstant.NAME_COMPONENT_FILTER
...
open class GetPdpLayoutUseCase @Inject constructor(
    ...
    @Named(NAME_COMPONENT_FILTER) private val componentFilterSharedPref: SharedPreferences
) {
