...
class GetProductInfoP2ShopUseCase @Inject constructor(private val rawQueries: Map<String, String>,
    ...
    companion object {
        fun createParams(shopId: Int, productId: String, forceRefresh: Boolean, tradeinParams: TradeInParams): RequestParams {
    ...
    override suspend fun executeOnBackground(): ProductInfoP2ShopData {
        ...
        val requests = mutableListOf(shopRequest, pdpTradeinRequest)
