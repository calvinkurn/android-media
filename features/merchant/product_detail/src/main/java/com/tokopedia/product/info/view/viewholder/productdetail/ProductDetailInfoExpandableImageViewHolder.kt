...
class ProductDetailInfoExpandableImageViewHolder(private val view: View,
    ...
    private fun setupExpandableItem(element: ProductDetailInfoExpandableImageDataModel) = with(binding) {
    ...
    override fun bind(element: ProductDetailInfoExpandableImageDataModel, payloads: MutableList<Any>) {
        ...
        if (payloads.isNotEmpty()) {
            ...
            if (bundle.containsKey(DIFFUTIL_PAYLOAD_TOGGLE)) {
                ...
                if (toggle) {
                    ExpandableAnimation.expand(binding.expandableImage, customHeight = view.resources.displayMetrics.widthPixels) {
