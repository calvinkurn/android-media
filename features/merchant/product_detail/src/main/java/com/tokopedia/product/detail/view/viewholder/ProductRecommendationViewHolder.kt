        ...
        view.rvProductRecom.bindCarouselProductCardViewGrid(
                ...
                carouselProductCardOnItemClickListener = object : CarouselProductCardListener.OnItemClickListener {
                    override fun onItemClick(productCardModel: ProductCardModel, carouselProductCardPosition: Int) {
                        ...
                        if (productCardModel.isTopAds) {
                            ImpresionTask(ProductRecommendationViewHolder::class.java).execute(topAdsClickUrl)
                        }
                ...
                carouselProductCardOnItemImpressedListener = object : CarouselProductCardListener.OnItemImpressedListener {
                    ...
                    override fun onItemImpressed(productCardModel: ProductCardModel, carouselProductCardPosition: Int) {
                        ...
                        if (productCardModel.isTopAds) {
                            ImpresionTask(ProductRecommendationViewHolder::class.java).execute(topAdsImageUrl)
                        }
