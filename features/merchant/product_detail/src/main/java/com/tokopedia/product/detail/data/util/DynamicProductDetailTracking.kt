...
object DynamicProductDetailTracking {
    ...
    object Branch {
        fun eventBranchItemView(productInfo: DynamicProductInfoP1?, userId: String?, description: String) {
            if (productInfo != null) {
                LinkerManager.getInstance().sendEvent(LinkerUtils.createGenericRequest(LinkerConstants.EVENT_ITEM_VIEW, TrackingUtil.createLinkerDataForViewItem(productInfo, userId, description)))
            }
        }
