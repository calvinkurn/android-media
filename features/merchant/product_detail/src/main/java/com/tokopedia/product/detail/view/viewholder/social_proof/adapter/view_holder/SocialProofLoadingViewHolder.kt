...
import com.tokopedia.product.detail.databinding.ShimmeringSocialProofBinding
...
class SocialProofLoadingViewHolder(
    private val binding: ShimmeringSocialProofBinding
    ...
    companion object {
        fun create(
            ...
            val binding = ShimmeringSocialProofBinding.inflate(inflate, parent, false)
