...
object GetScheduledDeliveryRatesQuery : GqlQueryInterface {
    ...
    private const val PARAM_CATEGORY_ID = "cat_id"
    ...
    override fun getQuery() = """
        query ScheduledDeliveryRates(
            $$PARAM_ORIGIN: String!, 
            $$PARAM_DESTINATION: String!, 
            $$PARAM_WAREHOUSE_ID: Int64!, 
            $$PARAM_WEIGHT: String!, 
            $$PARAM_SHOP_ID: Int64, 
            $$PARAM_UNIQUE_ID: String, 
            $$PARAM_PRODUCTS: String, 
            $$PARAM_BO_METADATA: String, 
            $$PARAM_SOURCE: String, 
            $$PARAM_ORDER_VALUE: Int, 
            $$PARAM_CATEGORY_ID: String
        ) {
            ongkirGetScheduledDeliveryRates(input: {
                ...
                $PARAM_SHOP_ID: $$PARAM_SHOP_ID, 
                $PARAM_UNIQUE_ID: $$PARAM_UNIQUE_ID, 
                $PARAM_PRODUCTS: $$PARAM_PRODUCTS, 
                $PARAM_BO_METADATA: $$PARAM_BO_METADATA, 
                $PARAM_SOURCE: $$PARAM_SOURCE, 
                $PARAM_ORDER_VALUE: $$PARAM_ORDER_VALUE,
