...
open class DynamicProductDetailViewModelTest : BasePdpViewModelTest() {
    ...
    fun `test correct product id parameter pdplayout`() {
        ...
        Assert.assertTrue((getPdpLayoutUseCase.requestParams.getObject(PARAM_TOKONOW) as? TokoNow) != null)
    }
    ...
    fun `test correct shop domain and shop key parameter pdplayout`() {
        ...
        Assert.assertTrue((getPdpLayoutUseCase.requestParams.getObject(PARAM_TOKONOW) as? TokoNow)?.shopId == "456")
    }
