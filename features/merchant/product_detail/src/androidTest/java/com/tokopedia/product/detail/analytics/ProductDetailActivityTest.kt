...
class ProductDetailActivityTest {
    ...
    private fun clickSeeAllDiscussion() {
        ...
        viewInteraction.perform(RecyclerViewActions.actionOnItemAtPosition<ProductDiscussionMostHelpfulViewHolder>(15, clickChildViewWithId(R.id.productDiscussionMostHelpfulSeeAll)))
    }
