package com.tokopedia.reviewcommon.constant
...
object AnalyticConstant {
    ...
    const val EVENT_CATEGORY_REVIEW_GALLERY_IMAGE_DETAIL = "product detail page - review - review gallery - image detail"
