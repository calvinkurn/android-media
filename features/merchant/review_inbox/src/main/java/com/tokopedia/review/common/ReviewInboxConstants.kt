...
object ReviewInboxConstants {
    ...
    const val REVIEW_INBOX_NO_PRODUCTS_BOUGHT_IMAGE = ImageUrl.REVIEW_INBOX_NO_PRODUCTS_BOUGHT_IMAGE
    const val REVIEW_INBOX_NO_PRODUCTS_SEARCH_IMAGE = ImageUrl.REVIEW_INBOX_NO_PRODUCTS_SEARCH_IMAGE
    const val REVIEW_INBOX_UNIFY_GLOBAL_ERROR_CONNECTION = ImageUrl.REVIEW_INBOX_UNIFY_GLOBAL_ERROR_CONNECTION
