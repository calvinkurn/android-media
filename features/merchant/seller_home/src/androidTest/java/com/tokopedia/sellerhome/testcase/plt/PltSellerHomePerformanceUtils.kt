...
object PltSellerHomePerformanceUtils {
    ...
    fun login() {
        ...
        if (!userSession.isLoggedIn) {
            ...
            Log.d("SellerHomePLTTest", "Logging in...")
            Espresso.onView(ViewMatchers.withId(R.id.register_btn)).perform(ViewActions.click())

            waitForCondition {
                userSession.isLoggedIn
            }
            Log.d("SellerHomePLTTest", "Logged in.")
        }
    }
