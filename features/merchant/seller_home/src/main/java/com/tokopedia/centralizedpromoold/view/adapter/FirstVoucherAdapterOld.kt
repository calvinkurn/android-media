...
import com.tokopedia.sellerhome.databinding.CentralizedPromoFirstPromoItemLayoutOldBinding
import timber.log.Timber

class FirstVoucherAdapterOld(private val itemList: List<FirstPromoUiModel>) :
    RecyclerView.Adapter<FirstVoucherAdapterOld.FirstVoucherViewHolder>() {

    class FirstVoucherViewHolder(view: View) : RecyclerView.ViewHolder(view) {

        val binding by lazy { CentralizedPromoFirstPromoItemLayoutOldBinding.bind(view) }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FirstVoucherViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.centralized_promo_first_promo_item_layout_old, parent, false)
