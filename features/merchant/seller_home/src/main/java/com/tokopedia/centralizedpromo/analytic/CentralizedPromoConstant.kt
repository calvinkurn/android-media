...
object CentralizedPromoConstant {
    ...
    // ON GOING
    const val EVENT_NAME_ON_GOING_IMPRESSION = "viewAdsPromoIris"
    const val EVENT_NAME_ON_GOING_CLICK = "clickAdsPromo"
    ...
    // PROMO CREATION
    const val EVENT_NAME_PROMO_CREATION_IMPRESSION = "viewAdsPromoIris"
    const val EVENT_NAME_PROMO_CREATION_CLICK = "clickAdsPromo"
