...
class SellerHomeActivity : BaseActivity(), SellerHomeFragment.Listener, IBottomClickListener, SomListLoadTimeMonitoringActivity {
    ...
    private fun setupBottomNav() {
        ...
        menu.add(BottomMenu(R.id.menu_home, resources.getString(R.string.sah_home), R.raw.anim_bottom_nav_home, R.raw.anim_bottom_nav_home_to_enabled, null, null, R.drawable.ic_sah_bottom_nav_home_active, R.drawable.ic_sah_bottom_nav_home_inactive, com.tokopedia.unifyprinciples.R.color.Unify_G600, false, BOTTOM_NAV_EXIT_ANIM_DURATION, BOTTOM_NAV_ENTER_ANIM_DURATION))
