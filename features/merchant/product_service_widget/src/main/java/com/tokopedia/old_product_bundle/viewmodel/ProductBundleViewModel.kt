package com.tokopedia.old_product_bundle.viewmodel
...
import com.tokopedia.old_product_bundle.common.data.model.request.UserLocation
import com.tokopedia.old_product_bundle.common.usecase.GetBundleInfoUseCase
...
import com.tokopedia.old_product_bundle.common.util.ResourceProvider
        ...
        launchCatchError(block = {
            val result = withContext(dispatchers.io) {
                getBundleInfoUseCase.setParams(
                    ...
                    requestData = com.tokopedia.old_product_bundle.common.data.model.request.RequestData(
                        variantDetail = true,
                        CheckCampaign = true,
                        BundleGroup = true,
                        Preorder = true,
                        inventoryDetail = com.tokopedia.old_product_bundle.common.data.model.request.InventoryDetail(
                            required = true,
