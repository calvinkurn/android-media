...
import com.tokopedia.productbundlewidget.adapter.viewholder.ProductBundleSinglePackageViewHolder
import com.tokopedia.productbundlewidget.model.BundleDetailUiModel

class ProductBundleSingleAdapter: RecyclerView.Adapter<ProductBundleSinglePackageViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductBundleSinglePackageViewHolder {
        return ProductBundleSinglePackageViewHolder(
                LayoutInflater.from(parent.context).inflate(
                        ProductBundleSinglePackageViewHolder.LAYOUT,
                        parent,
                        false
                )
        )
