        ...
        launchCatchError(block = {
            val result = withContext(dispatchers.io) {
                getBundleInfoUseCase.setParams(
                    ...
                    requestData = com.tokopedia.oldproductbundle.common.data.model.request.RequestData(
                        variantDetail = true,
                        CheckCampaign = true,
                        BundleGroup = true,
                        Preorder = true,
                        inventoryDetail = com.tokopedia.oldproductbundle.common.data.model.request.InventoryDetail(
                            required = true,
