...
class ReviewInboxActivity : BaseSimpleActivity(), ReviewPerformanceMonitoringListener {
    ...
    override fun startPerformanceMonitoring() {
        pageLoadTimePerformanceMonitoring = PageLoadTimePerformanceCallback(
                ReviewInboxConstants.REVIEW_PENDING_PLT_PREPARE_METRICS,
                ReviewInboxConstants.REVIEW_PENDING_PLT_NETWORK_METRICS,
                ReviewInboxConstants.REVIEW_PENDING_PLT_RENDER_METRICS,
                0,
                0,
                0,
                0,
        ...
        pageLoadTimePerformanceMonitoring?.startMonitoring(ReviewInboxConstants.REVIEW_PENDING_TRACE)
