...
object ReviewPendingTracking {
    ...
    fun eventClickCard(reputationId: Long, productId: Int, userId: String, isEligible: Boolean) {
    ...
    fun eventClickRatingStar(reputationId: Long, productId: Int, starRating: Int, userId: String, isEligible: Boolean) {
        TrackApp.getInstance().gtm.sendGeneralEvent(
                generateTrackingMap(
