...
class ReputationPenaltyAdapterFactory(private val fragment: Fragment): BaseAdapterTypeFactory(),
    ...
    override fun createViewHolder(parent: View, type: Int): AbstractViewHolder<*> {
        return when(type) {
            ...
            SellerReputationShopViewHolder.LAYOUT -> SellerReputationShopViewHolder(parent)
