...
class ReviewPendingFragment : BaseListFragment<ReviewPendingUiModel, ReviewPendingAdapterTypeFactory>(),
    ...
    override fun trackCardClicked(reputationId: Long, productId: Int, isEligible: Boolean) {
        ReviewPendingTracking.eventClickCard(reputationId, productId, viewModel.getUserId(), isEligible)
    }

    override fun trackStarsClicked(reputationId: Long, productId: Int, rating: Int, isEligible: Boolean) {
        ReviewPendingTracking.eventClickRatingStar(reputationId, productId, rating, viewModel.getUserId(), isEligible)
    }

    override fun onStarsClicked(reputationId: Long, productId: Int, rating: Int, inboxReviewId: Long, seen: Boolean) {
        if (!seen) {
    ...
    private fun goToCreateReviewActivity(reputationId: Long, productId: Int, rating: Int, inboxId: String) {
