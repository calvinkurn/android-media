...
object SellerReviewProductDetailMapper {
    ...
    ): ProductFeedbackDetailUiModel {
        return ProductFeedbackDetailUiModel().apply {
            productFeedbackDetailList =
                mapToFeedbackUiModel(productFeedbackDataPerProduct, userSession)
    ...
    fun mapToRatingBarUiModel(
        productFeedbackDataPerProduct: ProductFeedbackFilterData,
        oldData: List<RatingBarUiModel>
    ): ProductReviewFilterUiModel {
        val ratingBarListUiModel = mutableListOf<RatingBarUiModel>()
        val totalAggregateRating: Int =
            productFeedbackDataPerProduct.aggregatedRating.sumBy { it.ratingCount.orZero() }
    ...
    fun mapToTopicUiModel(
        productFeedbackDataPerProduct: ProductFeedbackFilterData,
        oldData: List<SortFilterItemWrapper>
    ): TopicUiModel {
        val topicListUiModel =
            TopicUiModel(countFeedback = productFeedbackDataPerProduct.reviewCount)

        productFeedbackDataPerProduct.topics.map {
            topicListUiModel.apply {
                sortFilterItemList =
                    mapToItemSortFilter(productFeedbackDataPerProduct.topics, oldData)
    ...
    fun mapToFeedbackUiModel(
        productFeedbackDataPerProduct: ProductFeedbackDetailResponse.ProductFeedbackDataPerProduct?,
        userSession: UserSessionInterface
    ...
    fun mapToItemUnifyListFeedback(
        context: Context,
        isEmptyReply: Boolean
    ): ArrayList<ListItemUnify> {
        val itemUnifyList: ArrayList<ListItemUnify> = arrayListOf()
        ...
        itemUnifyList.apply {
            add(
                if (!isEmptyReply) {
                    ...
                    ListItemUnify(
                        title = context.getString(R.string.edit_review_label),
                        description = ""
                    ).apply {
                    ...
                    ListItemUnify(
                        title = context.getString(R.string.review_reply_label),
                        description = ""
                    ).apply {
                        listDrawable = iconList
                        listIconHeight = iconSize
    ...
    private fun mapToItemSortFilter(
        data: List<ProductFeedbackDetailResponse.ProductFeedbackDataPerProduct.Topic>,
        oldData: List<SortFilterItemWrapper>
        ...
        maxData.map {
            ...
            itemSortFilterList.add(
                SortFilterItemWrapper(
                    sortFilter,
                    it.second,
                    it.first.count.orZero(),
                    it.first.title.orEmpty()
                )
            )
        }
    ...
    private fun updateNewDataWithOldData(
        newData: List<ProductFeedbackDetailResponse.ProductFeedbackDataPerProduct.Topic>,
        oldData: List<SortFilterItemWrapper>
    ): List<Pair<ProductFeedbackDetailResponse.ProductFeedbackDataPerProduct.Topic, Boolean>> {
