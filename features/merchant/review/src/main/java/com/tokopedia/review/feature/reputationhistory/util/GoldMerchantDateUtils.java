...
public class GoldMerchantDateUtils {
    ...
    public static String getDate(Integer date) {
        List<String> dateRaw = getDateRaw(date);
        String month = (String) dateRaw.get(1);
        String day = (String) dateRaw.get(0);
        return day + " " + month;
    }
    ...
    public static long getPreviousDate(long currentDay, int previousDayCount) {
        ...
        sCDate.add(5, -1 * previousDayCount);
    ...
    public static int daysBetween(Calendar day1, Calendar day2) {
        ...
        if (dayOne.get(1) == dayTwo.get(1)) {
            ...
            int dayOneOriginalYearDays;
            for (dayOneOriginalYearDays = dayOne.get(6); dayOne.get(1) > dayTwo.get(1); extraDays += dayOne.getActualMaximum(6)) {
                dayOne.add(1, -1);
            }
