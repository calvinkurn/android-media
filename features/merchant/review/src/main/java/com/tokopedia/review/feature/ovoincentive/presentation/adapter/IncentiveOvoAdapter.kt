...
class IncentiveOvoAdapter(private val list: List<String>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IncentiveOvoViewHolder {
        return IncentiveOvoViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_incentive_ovo, parent, false))
    }
