...
object ReviewDetailTracking {
    ...
    fun eventClickBack(productId: String, feedbackId: String, userId: String) {
    ...
    fun eventClickShare(productId: String, feedbackId: String, userId: String) {
        TrackApp.getInstance().gtm.sendGeneralEvent(
                generateTrackingMap(
    ...
    fun eventClickEdit(productId: String, feedbackId: String, userId: String) {
        TrackApp.getInstance().gtm.sendGeneralEvent(
                generateTrackingMap(
    ...
    fun eventClickProductCard(productId: String, feedbackId: String, userId: String) {
        TrackApp.getInstance().gtm.sendGeneralEvent(
                generateTrackingMap(
    ...
    fun eventClickImageGallery(productId: String, feedbackId: String, userId: String) {
        TrackApp.getInstance().gtm.sendGeneralEvent(
                generateTrackingMap(
    ...
    fun eventClickSmiley(productId: String, feedbackId: String, userId: String) {
        TrackApp.getInstance().gtm.sendGeneralEvent(
                generateTrackingMap(
