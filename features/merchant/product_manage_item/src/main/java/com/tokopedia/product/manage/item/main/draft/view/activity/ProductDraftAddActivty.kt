...
open class ProductDraftAddActivity : BaseProductAddEditActivity() {
    ...
    override fun getNewFragment(): Fragment {
        return ProductDraftAddFragment.createInstance(draftProductId, cacheManagerId)
    }
    ...
    companion object {
        ...
        fun createInstance(context: Context, cacheManagerId: String) = Intent(context, ProductDraftAddActivity::class.java).apply {
