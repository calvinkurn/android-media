...
class ShopCampaignFlashSaleViewHolder(
    ...
    companion object {
        @LayoutRes
        val LAYOUT = R.layout.item_shop_campaign_flash_sale_widget
    ...
    private fun setupFlashSaleBackgroundView(productList: List<ShopHomeProductUiModel>) {
        ...
        doubleBackGroundView?.setBackgroundColor(backgroundColor)
        multipleBackGroundView?.setBackgroundColor(backgroundColor)
