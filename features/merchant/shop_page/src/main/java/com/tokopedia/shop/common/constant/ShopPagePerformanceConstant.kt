...
object ShopPagePerformanceConstant {
    ...
    const val SHOP_HEADER_TRACE_V4 = "mp_shop_header_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}"
    const val SHOP_PRODUCT_TAB_TRACE_V4 = "mp_shop_product_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}"
    const val SHOP_HOME_TAB_TRACE_V4 = "mp_shop_home_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}"
    ...
    object PltConstant {
        ...
        const val SHOP_TRACE_V4 = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}"
        ...
        const val SHOP_V4_TRACE_PREPARE = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}_prepare"
        const val SHOP_V4_TRACE_MIDDLE = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}_network"
        const val SHOP_V4_TRACE_RENDER = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}_render"

        const val SHOP_TRACE_ACTIVITY_PREPARE = "mp_shop_activity_prepare"
        const val SHOP_V4_TRACE_ACTIVITY_PREPARE = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}_activity_prepare"
        const val SHOP_TRACE_P1_MIDDLE = "mp_shop_p1_network"
        const val SHOP_V4_TRACE_P1_MIDDLE = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}_p1_network"
        const val SHOP_TRACE_HEADER_SHOP_NAME_AND_PICTURE_RENDER = "mp_shop_header_shop_name_and_picture_render"
        const val SHOP_V4_TRACE_HEADER_SHOP_NAME_AND_PICTURE_RENDER = "mp_shop_${ShopPageConstant.ShopPageFeatureImprovementType.V4_REIMAGINED}_header_shop_name_and_picture_render"
