...
class StickySingleHeaderView : FrameLayout, OnStickySingleHeaderListener {
    ...
    private fun initView() {
        ...
        val onScrollListener: RecyclerView.OnScrollListener = object : RecyclerView.OnScrollListener() {
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                ...
                stickyPosition = adapter!!.stickyHeaderPosition
            }
    ...
    private fun showSticky() {
        ...
        mHeaderContainer!!.setPadding(mRecyclerView!!.paddingLeft, mHeaderContainer!!.paddingTop, mRecyclerView!!.paddingRight, mHeaderContainer!!.paddingBottom)
    }
