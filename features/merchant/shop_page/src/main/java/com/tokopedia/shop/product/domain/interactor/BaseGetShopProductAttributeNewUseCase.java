...
public abstract class BaseGetShopProductAttributeNewUseCase<T> extends UseCase<T> {
    ...
    public BaseGetShopProductAttributeNewUseCase(GetWishListUseCase getWishListUseCase,
