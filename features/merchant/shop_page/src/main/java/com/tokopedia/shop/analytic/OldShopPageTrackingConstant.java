...
public class OldShopPageTrackingConstant {
    ...
    public static final String IMPRESSION_OPEN_OPERATIONAL_SHOP = "impression of open operational shop";
    public static final String CLICK_OPEN_OPERATIONAL_SHOP = "click open operational shop";
    public static final String IMPRESSION_HOW_TO_ACTIVATE_SHOP = "impression of how to activate shop";
    ...
    public static final String CLICK_READ_NOTES = "click read notes";
