...
public class ShopProductEtalaseLabelViewHolder extends AbstractViewHolder<ShopProductEtalaseLabelViewModel> {

    @LayoutRes
    public static final int LAYOUT = R.layout.item_shop_product_etalase_title_view;

    public ShopProductEtalaseLabelViewHolder(View itemView) {
        super(itemView);
        findViews(itemView);
    }
    ...
    @Override
    public void bind(ShopProductEtalaseLabelViewModel shopProductEtalaseLabelViewModel) {
