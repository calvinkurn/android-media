...
import com.tokopedia.shop.campaign.data.mapper.GetPromoVoucherDetailMapper
 ...
 */
class GetPromoVoucherDetailUseCase @Inject constructor(
    private val repository: GraphqlRepository,
    private val mapper: GetPromoVoucherDetailMapper
) : GraphqlUseCase<PromoVoucherDetail>(repository) {
...
"""
    ...
    private fun buildRequest(slug: String): GraphqlRequest {
        ...
        return GraphqlRequest(
            query,
            GetPromoVoucherDetailResponse::class.java,
            params
        )
    }
}
