...
class ShopHomeItemSliderSquareViewHolder(
    ...
    private val viewBinding: ItemShopPageHomeSliderSquareBinding? by viewBinding()
    private val ivSliderSquare: ShopCarouselBannerImageUnify? = viewBinding?.ivSliderSquare
