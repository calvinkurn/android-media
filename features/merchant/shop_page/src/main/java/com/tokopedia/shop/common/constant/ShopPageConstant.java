...
public class ShopPageConstant {
    ...
    public static final int DEFAULT_PROMO_POSITION = 0;
    public static final int DEFAULT_FEATURED_POSITION = 1;
    public static final int DEFAULT_ETALASE_HIGHLIGHT_POSITION = 2;
    public static final int DEFAULT_ETALASE_POSITION = 3;
    public static final int DEFAULT_ETALASE_TITLE_POSITION = 4;
