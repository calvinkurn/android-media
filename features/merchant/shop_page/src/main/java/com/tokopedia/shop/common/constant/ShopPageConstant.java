...
public class ShopPageConstant {
    ...
    public static final int DEFAULT_FREE_ONGKIR_TICKER_POSITION = 1;
    public static final int DEFAULT_MERCHANT_VOUCHER_POSITION = 2;
    public static final int DEFAULT_FEATURED_POSITION = 3;
    public static final int DEFAULT_ETALASE_HIGHLIGHT_POSITION = 4;
    public static final int DEFAULT_ETALASE_POSITION = 5;
    public static final int DEFAULT_ETALASE_TITLE_POSITION = 6;
