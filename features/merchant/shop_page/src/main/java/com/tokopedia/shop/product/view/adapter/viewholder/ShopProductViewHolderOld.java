 ...
 */
@Deprecated
public class ShopProductViewHolderOld extends AbstractViewHolder<ShopProductViewModelOld> {
    ...
    public ShopProductViewHolderOld(View itemView, ShopProductClickedListener shopProductClickedListener) {
        super(itemView);
