...
object ShopPageTrackingConstant {
    ...
    const val CLICK_ETALASE_NAVIGATION_BANNER = "click etalase navigation banner"
    const val IMPRESSION_ETALASE_NAVIGATION_BANNER = "impression etalase navigation banner"
