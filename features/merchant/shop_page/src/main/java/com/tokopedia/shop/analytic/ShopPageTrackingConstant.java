...
public class ShopPageTrackingConstant {
    ...
    public static final String EVENT_ACTION_CLICK_ON_LOGIN_STICKY_WIDGET = "click login sticky widget";
    public static final String EVENT_ACTION_CLICK_ON_CLOSE_STICKY_LOGIN = "click close button on login sticky widget";
