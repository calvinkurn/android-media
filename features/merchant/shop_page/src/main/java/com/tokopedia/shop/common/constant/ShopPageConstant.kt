...
object ShopPageConstant {
    ...
    const val EMPTY_PRODUCT_SEARCH_IMAGE_URL = "https://images.tokopedia.net/android/others/illustration_product_empty.png"
    ...
    const val URL_IMAGE_SELLER_PRODUCT_ALL_ETALASE_EMPTY_STATE_BACKGROUND = "https://images.tokopedia.net/android/shop_page/seller_shop_product_empty_background.png"
    const val URL_IMAGE_BUYER_EMPTY_STATE_TOKOPEDIA_IMAGE = "https://images.tokopedia.net/android/shop_page/image_product_empty_state_buyer.png"
    const val URL_IMAGE_BUYER_SHOP_SEARCH_EMPTY_STATE = "https://images.tokopedia.net/android/empty_state_search_filter.png"
