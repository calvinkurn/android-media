...
public class GetShopProductFeaturedWithAttributeNewUseCase extends BaseGetShopProductAttributeNewUseCase<List<ShopProductViewModel>> {
    ...
    @Inject
    public GetShopProductFeaturedWithAttributeNewUseCase(GetFeatureProductListUseCase getFeatureProductListUseCase,
