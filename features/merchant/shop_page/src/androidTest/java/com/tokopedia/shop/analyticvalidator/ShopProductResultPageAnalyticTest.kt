...
class ShopProductResultPageAnalyticTest {
    ...
    companion object {
        private const val SHOP_PAGE_PRODUCT_RESULT_PAGE_PRODUCT_CARD_TRACKER_MATCHER_PATH = "tracker/shop/shop_page_product_result_page_product_card_tracker.json"
    ...
    fun beforeTest() {
        ...
        setupGraphqlMockResponse(ShopProductResultPageMockResponseConfig())
