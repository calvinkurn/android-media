...
class ComposePersonaSelectTypeViewModelTest : BaseViewModelTest() {
    ...
    val states = mutableListOf<SelectTypeState>()
    val uiEffects = mutableListOf<SelectTypeUiEffect>()
    ...
    private fun TestScope.runStateAndUiEffectTest(testBody: TestScope.() -> Unit) {
