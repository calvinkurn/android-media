...
import com.tokopedia.shop.common.graphql.data.shopetalase.ShopShowcaseListResponse
...
class GetShopShowcasesByShopUseCase @Inject constructor(
        private val graphqlUseCase: MultiRequestGraphqlUseCase
): UseCase<ShopShowcaseListResponse>() {
    ...
    override suspend fun executeOnBackground(): ShopShowcaseListResponse {
        val listShowcase = GraphqlRequest(MUTATION, ShopShowcaseListResponse::class.java, params.parameters)
        graphqlUseCase.clearRequest()
        graphqlUseCase.addRequest(listShowcase)
        val gqlResponse = graphqlUseCase.executeOnBackground()
        val error = gqlResponse.getError(ShopShowcaseListResponse::class.java) ?: listOf()
        if (error == null || error.isEmpty()) {
            return gqlResponse.run {
                getData<ShopShowcaseListResponse>(ShopShowcaseListResponse::class.java)
            }
        } else {
