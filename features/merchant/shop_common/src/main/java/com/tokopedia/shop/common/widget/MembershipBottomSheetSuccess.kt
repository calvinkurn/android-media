...
class MembershipBottomSheetSuccess : BottomSheetUnify() {
    ...
    companion object {
        ...
        private const val IMG_BS_MEMBERSHIP_SUCCESS = ImageUrl.IMG_BS_MEMBERSHIP_SUCCESS
        private const val IMG_BS_MEMBERSHIP_FAIL = ImageUrl.IMG_BS_MEMBERSHIP_FAIL
