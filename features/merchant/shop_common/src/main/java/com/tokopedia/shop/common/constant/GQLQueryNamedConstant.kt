...
object GQLQueryNamedConstant {
    ...
    const val SHOP_INFO_FOR_CLOSE_DETAIL = "shop_info_for_close_detail"
    const val DEFAULT_SHOP_INFO_QUERY_NAME = "getShopInfo"
    const val SHOP_CLOSE_INFO_QUERY_NAME = "getShopCloseDetailInfo"
    ...
    const val SHOP_PAGE_P1_V3_QUERIES = "shop_page_p1_v3_queries" // Faster shop header using more slimmer P1 network call
}
