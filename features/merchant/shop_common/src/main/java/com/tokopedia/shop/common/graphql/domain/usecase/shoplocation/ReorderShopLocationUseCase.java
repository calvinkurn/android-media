...
public class ReorderShopLocationUseCase extends UseCase<String> {
    public static final String IDS = "ids";

    private SingleGraphQLUseCase<ReorderShopLocationMutation> graphQLUseCase;

    @Inject
    public ReorderShopLocationUseCase(@ApplicationContext Context context) {
        graphQLUseCase = new SingleGraphQLUseCase<ReorderShopLocationMutation>(context, ReorderShopLocationMutation.class) {
            @Override
            protected int getGraphQLRawResId() {
                return R.raw.gql_mutation_reorder_shop_location;
            }
