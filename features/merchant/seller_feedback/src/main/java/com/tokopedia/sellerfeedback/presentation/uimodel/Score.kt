...
sealed class Score {
    ...
    data class Bad(
            ...
            override val colorId: Int = com.tokopedia.unifyprinciples.R.color.Unify_YN500,
    ...
    data class Neutral(
            ...
            override val colorId: Int = com.tokopedia.unifyprinciples.R.color.Unify_YN400,
    ...
    data class Good(
            ...
            override val colorId: Int = com.tokopedia.unifyprinciples.R.color.Unify_GN500,
