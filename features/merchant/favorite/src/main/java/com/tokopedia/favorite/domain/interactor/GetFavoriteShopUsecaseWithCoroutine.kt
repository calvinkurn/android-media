...
@Inject constructor(
    ...
    override suspend fun executeOnBackground(): FavoriteShop {
        val isFirstPage =
                requestParams.getBoolean(GetFavoriteShopUseCaseWithCoroutine.KEY_IS_FIRST_PAGE, false)
        requestParams.clearValue(GetFavoriteShopUseCaseWithCoroutine.KEY_IS_FIRST_PAGE)
