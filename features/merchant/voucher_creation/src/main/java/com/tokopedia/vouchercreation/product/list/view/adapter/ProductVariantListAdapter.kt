...
class ProductVariantListAdapter(private val variantItemClickListener: OnVariantItemClickListener)
    : RecyclerView.Adapter<ProductItemVariantViewHolder>() {

    private var variantList: List<ProductVariant> = listOf()
    ...
    fun setVariantList(variantList: List<ProductVariant>) {
