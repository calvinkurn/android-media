...
import com.tokopedia.vouchercreation.product.download.CouponImageViewHolder
...
class DownloadVoucherFactoryImpl : BaseAdapterTypeFactory(), DownloadVoucherFactory {
    ...
    override fun type(model: CouponImageUiModel): Int = CouponImageViewHolder.RES_LAYOUT

    override fun createViewHolder(parent: View?, type: Int): AbstractViewHolder<out Visitable<*>> {
        return when (type) {
            DownloadVoucherViewHolder.RES_LAYOUT -> DownloadVoucherViewHolder(parent)
            CouponImageViewHolder.RES_LAYOUT -> CouponImageViewHolder(parent)
