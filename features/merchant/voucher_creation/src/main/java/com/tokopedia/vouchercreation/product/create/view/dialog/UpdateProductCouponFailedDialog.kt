...
class UpdateProductCouponFailedDialog(
    context: Context,
    ...
    fun show() = with(dialog) {
        ...
        setTitle(context.getString(R.string.error_message_update_coupon_product))
        setDescription(context.getString(R.string.error_message_update_coupon_description))
