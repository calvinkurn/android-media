...
class CouponDetailTracker @Inject constructor() {
    ...
    fun sendDownloadCouponImageClickEvent(couponStatus: String) {
        sendGeneralTracking(
            event = "clickPG",
            action = "click download - kupon detail",
            category = "mvc locked product - detail page",
            label = couponStatus
        )
    }

    fun sendViewAllProductsClickEvent(couponStatus: String) {
        sendGeneralTracking(
            event = "clickPG",
            action = "click download - kupon detail",
            category = "mvc locked product - detail page",
    ...
    fun sendDuplicateCouponClickEvent() {
        sendGeneralTracking(
            event = "clickPG",
            action = "click duplikat",
            category = "mvc locked product - detail page",
            label = EMPTY_STRING
        )
    }
