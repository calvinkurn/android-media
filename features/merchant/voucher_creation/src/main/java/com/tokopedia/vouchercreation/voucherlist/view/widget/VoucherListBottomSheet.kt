...
class VoucherListBottomSheet(
    ...
    private fun getPendingVoucherMenu(): List<BottomSheetMenuUiModel> {
        ...
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_edit_quota), R.drawable.ic_mvc_share))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_edit_shown_period), R.drawable.ic_mvc_share))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_view_detail_and_edit_voucher), R.drawable.ic_mvc_share))
        menuItems.add(ItemDivider(ItemDivider.DIVIDER))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_download), R.drawable.ic_mvc_share))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_duplicate), R.drawable.ic_mvc_share))
        menuItems.add(ItemDivider(ItemDivider.DIVIDER))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_cancel), R.drawable.ic_mvc_share))
    ...
    private fun getOngoingVoucherMenu(): List<BottomSheetMenuUiModel> {
        val menuItems = mutableListOf<BottomSheetMenuUiModel>()
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_edit_quota), R.drawable.ic_mvc_share))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_view_detail), R.drawable.ic_mvc_share))
        menuItems.add(ItemDivider(ItemDivider.DIVIDER))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_share), R.drawable.ic_mvc_share))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_duplicate), R.drawable.ic_mvc_share))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_download), R.drawable.ic_mvc_share))
        menuItems.add(ItemDivider(ItemDivider.DIVIDER))
        menuItems.add(EditQuota(parent.context.getString(R.string.mvc_stop), R.drawable.ic_mvc_share))
        menuItems.add(ItemDivider(ItemDivider.EMPTY_SPACE))
        return menuItems
    }
}