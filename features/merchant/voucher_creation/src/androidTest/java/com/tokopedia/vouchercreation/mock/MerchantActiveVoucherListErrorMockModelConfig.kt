...
class MerchantActiveVoucherListErrorMockModelConfig : MockModelConfig() {
    companion object {
    ...
    override fun createMockModel(context: Context): MockModelConfig {
        ...
        addMockResponse(
                ...
                InstrumentationMockHelper.getRawString(context, R.raw.response_mock_get_error_active_voucher_list),
                FIND_BY_CONTAINS
        )
        return this
    }
