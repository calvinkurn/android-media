...
class MerchantVoucherHistoryListMockModelConfig: MockModelConfig()  {
    companion object {
    ...
    override fun createMockModel(context: Context): MockModelConfig {
        addMockResponse(
                ...
                InstrumentationMockHelper.getRawString(context, R.raw.response_mock_get_voucher_history_list),
                FIND_BY_CONTAINS
        )
        return this
    }
