 ...
 */
class ShopNoteReorderAdapter(baseListAdapterTypeFactory: ShopNoteReorderFactory) : BaseListAdapter<ShopNoteDataModel, ShopNoteReorderFactory>(baseListAdapterTypeFactory), ItemTouchHelperAdapter {
