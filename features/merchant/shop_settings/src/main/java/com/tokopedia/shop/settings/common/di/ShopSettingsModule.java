...
public class ShopSettingsModule {

    @Provides
    public UploadImageUseCase<UploadShopEditImageModel> provideUploadImageUseCase(
        ...
        return new UploadImageUseCase<>(uploadImageRepository, generateHostRepository, gson, userSession, UploadShopEditImageModel.class, imageUploaderUtils);
    }
}
