...
class ShopSettingsNotesActivity : BaseSimpleActivity(),
    ...
    override fun goToReorderFragment(shopNoteDataModels: ArrayList<ShopNoteDataModel>) {
        val fragment = ShopSettingsNotesReorderFragment.newInstance(shopNoteDataModels)
