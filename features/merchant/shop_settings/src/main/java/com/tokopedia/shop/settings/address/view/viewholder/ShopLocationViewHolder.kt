...
class ShopLocationViewHolder(val view: View, private val listener: OnIconMoreClicked): AbstractViewHolder<ShopLocationDataModel>(view) {
    override fun bind(element: ShopLocationDataModel) {
    ...
    interface OnIconMoreClicked {
        fun onIconClicked(item: ShopLocationDataModel, pos: Int)
    }
}