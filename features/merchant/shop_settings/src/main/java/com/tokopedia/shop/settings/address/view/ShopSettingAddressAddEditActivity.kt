...
class ShopSettingAddressAddEditActivity: BaseSimpleActivity(), HasComponent<ShopSettingsComponent> {
    ...
    companion object {
        ...
        fun createIntent(context: Context, shopLocationDataModel: ShopLocationDataModel?, isAddNew: Boolean) =
                Intent(context, ShopSettingAddressAddEditActivity::class.java)
                    .putExtra(PARAM_EXTRA_SHOP_ADDRESS, shopLocationDataModel)
                        .putExtra(PARAM_EXTRA_IS_ADD_NEW, isAddNew)
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        shopLocationDataModel = intent.getParcelableExtra(PARAM_EXTRA_SHOP_ADDRESS)
    ...
    override fun getNewFragment() = ShopSettingAddressAddEditFragment.createInstance(shopLocationDataModel, isAddNew)
