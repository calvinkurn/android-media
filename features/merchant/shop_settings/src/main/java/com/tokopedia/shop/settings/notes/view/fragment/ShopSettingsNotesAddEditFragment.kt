...
class ShopSettingsNotesAddEditFragment: BaseDaggerFragment(), ShopSettingsNotesAddEditView {
    ...
    companion object {
        ...
        fun createInstance(isReturnablePolicy: Boolean, isEdit: Boolean, shopNoteModel: ShopNoteDataModel = ShopNoteDataModel()) =
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            shopNote = it.getParcelable(PARAM_SHOP_NOTE) ?: ShopNoteDataModel()
        }
