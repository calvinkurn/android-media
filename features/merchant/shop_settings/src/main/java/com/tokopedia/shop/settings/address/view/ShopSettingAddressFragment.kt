...
class ShopSettingAddressFragment : BaseListFragment<ShopLocationDataModel, ShopLocationTypeFactory>(),
    ...
    var shopLocationDataModelList: List<ShopLocationDataModel>? = null
    ...
    override fun onItemClicked(t: ShopLocationDataModel?) {
        //no-op
    }
    ...
    override fun onSuccessLoadAddresses(addresses: List<ShopLocationDataModel>?) {
        shopLocationDataModelList = addresses
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        if (shopLocationDataModelList == null) {
            menu?.clear()
        } else {
    ...
    override fun onIconClicked(item: ShopLocationDataModel, pos: Int) {
        activity?.let {
            Menus(it).apply {
    ...
    private fun deleteShopAddress(item: ShopLocationDataModel) {
        activity?.let {
    ...
    private fun editShopAddress(item: ShopLocationDataModel) {
        context?.let {
            startActivityForResult(ShopSettingAddressAddEditActivity
