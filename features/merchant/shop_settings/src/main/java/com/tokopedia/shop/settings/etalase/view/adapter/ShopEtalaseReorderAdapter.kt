 ...
 */
class ShopEtalaseReorderAdapter(baseListAdapterTypeFactory: ShopEtalaseReorderFactory) : BaseListAdapter<ShopEtalaseUiModel, ShopEtalaseReorderFactory>(baseListAdapterTypeFactory), ItemTouchHelperAdapter {
