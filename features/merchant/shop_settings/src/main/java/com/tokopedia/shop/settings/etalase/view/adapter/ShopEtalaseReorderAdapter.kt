 ...
 */
class ShopEtalaseReorderAdapter(baseListAdapterTypeFactory: ShopEtalaseReorderFactory) : BaseListAdapter<ShopEtalaseDataModel, ShopEtalaseReorderFactory>(baseListAdapterTypeFactory), ItemTouchHelperAdapter {
