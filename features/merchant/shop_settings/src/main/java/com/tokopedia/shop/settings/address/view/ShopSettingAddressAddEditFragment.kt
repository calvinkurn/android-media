...
class ShopSettingAddressAddEditFragment: BaseDaggerFragment(), ShopSettingAddressAddEditView {
    ...
    private var shopLocationDataModel: ShopLocationDataModel? = null
    ...
    companion object {
        ...
        fun createInstance(shopAddressDataModel: ShopLocationDataModel?, isAddNew: Boolean) =
                ShopSettingAddressAddEditFragment().also { it.arguments = Bundle().apply {
                    putParcelable(PARAM_EXTRA_SHOP_ADDRESS, shopAddressDataModel)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let { it ->
            shopLocationDataModel = it.getParcelable(PARAM_EXTRA_SHOP_ADDRESS)
            shopLocationDataModel?.let {
    ...
    private fun populateData(): ShopLocationDataModel {
        shopLocationDataModel = shopLocationDataModel ?: ShopLocationDataModel()
        return shopLocationDataModel!!.apply {
