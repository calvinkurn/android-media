...
object PowerMerchantDateFormatter {
    ...
    fun formatCancellationDate(context: Context, expiredDate: String): SpannableString {
        ...
        val warningText = context.getString(R.string.expired_label, cancellationDate, cancellationHour)
