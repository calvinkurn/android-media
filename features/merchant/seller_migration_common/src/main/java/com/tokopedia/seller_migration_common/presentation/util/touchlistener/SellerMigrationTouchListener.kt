package com.tokopedia.seller_migration_common.presentation.util.touchlistener
...
class SellerMigrationTouchListener(private val goToInfoPage: (String) -> Boolean) : View.OnTouchListener {
