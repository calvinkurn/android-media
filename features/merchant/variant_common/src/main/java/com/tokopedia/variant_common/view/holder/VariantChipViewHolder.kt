    ...
    private fun setState(element: VariantOptionWithAttribute) = with(view) {
        ...
        when (element.currentState) {
            VariantConstant.STATE_EMPTY -> {
                ...
                txtChipVariant.setTextColor(MethodChecker.getColor(context, com.tokopedia.unifyprinciples.R.color.R.color.Unify_N700_44))
            ...
            VariantConstant.STATE_UNSELECTED -> {
                ...
                txtChipVariant.setTextColor(MethodChecker.getColor(context, com.tokopedia.unifyprinciples.R.color.R.color.Unify_N700_68))
                view.isEnabled = true
            }
        }
    }
