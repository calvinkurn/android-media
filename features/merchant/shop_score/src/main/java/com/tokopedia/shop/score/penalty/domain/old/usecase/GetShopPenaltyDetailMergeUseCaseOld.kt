package com.tokopedia.shop.score.penalty.domain.old.usecase
...
open class GetShopPenaltyDetailMergeUseCaseOld @Inject constructor(
    private val graphqlRepository: GraphqlRepository,
    private val penaltyMapperOld: PenaltyMapperOld
) : UseCase<PenaltyDataWrapperOld>() {
