...
data class ShopScoreWrapperResponse(
    var shopScoreLevelResponse: ShopScoreLevelResponse.ShopScoreLevel? = null,
    ...
    var goldGetPMOStatusResponse: GoldGetPMOStatusResponse.GoldGetPMOSStatus.Data? = null
)