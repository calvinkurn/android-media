...
import com.tokopedia.gm.common.data.source.cloud.TurnOnOffAutoExtendPowerMerchantCloudSource
...
class TurnOnOffAutoExtendPowerMerchantUseCase @Inject constructor(
    private val turnOnOffAutoExtendPowerMerchantCloudSource: TurnOnOffAutoExtendPowerMerchantCloudSource) : UseCase<PowerMerchantActivationResult>() {
