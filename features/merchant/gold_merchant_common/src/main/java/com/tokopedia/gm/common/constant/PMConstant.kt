...
object PMConstant {
    ...
    object Images {
        ...
        const val PM_BADGE_INACTIVE = ImageUrl.PM_BADGE_INACTIVE
        const val PM_SHOP_ICON = ImageUrl.PM_SHOP_ICON
        const val PM_PRO_BADGE = ImageUrl.PM_PRO_BADGE
        const val PM_NEW_REQUIREMENT = ImageUrl.PM_NEW_REQUIREMENT
        const val PM_ADD_PRODUCT_BOTTOM_SHEET = ImageUrl.PM_ADD_PRODUCT_BOTTOM_SHEET
        const val PM_TOTAL_ORDER_TERM = ImageUrl.PM_TOTAL_ORDER_TERM
        const val IMG_TOPED_PM_ACTIVE = ImageUrl.IMG_TOPED_PM_ACTIVE
        const val IMG_TOPED_PM_INACTIVE = ImageUrl.IMG_TOPED_PM_INACTIVE
        const val IMG_TOPED_PM_PRO_ACTIVE = ImageUrl.IMG_TOPED_PM_PRO_ACTIVE
        const val IMG_TOPED_NEW_SELLER_PM_ACTIVE = ImageUrl.IMG_TOPED_NEW_SELLER_PM_ACTIVE
        const val IMG_TOPED_NEW_SELLER_PM_PRO_ACTIVE = ImageUrl.IMG_TOPED_NEW_SELLER_PM_PRO_ACTIVE
        const val PM_POTENTIAL_BENEFIT_01 = ImageUrl.PM_POTENTIAL_BENEFIT_01
        const val PM_POTENTIAL_BENEFIT_02 = ImageUrl.PM_TOTAL_ORDER_TERM
        const val PM_POTENTIAL_BENEFIT_03 = ImageUrl.PM_POTENTIAL_BENEFIT_03
        const val PM_MODERATED_SHOP = ImageUrl.PM_MODERATED_SHOP
    }
