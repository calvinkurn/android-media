...
class ItemOrderSearchAdapter: ListAdapter<ItemSellerSearchUiModel, ItemOrderSearchViewHolder>(SellerSearchAdapterDiffCallback.ItemSearchDiffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemOrderSearchViewHolder {
        ...
        return ItemOrderSearchViewHolder(view)
    }
