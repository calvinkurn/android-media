...
class ProductSearchViewHolder(private val view: View): AbstractViewHolder<SellerSearchUiModel>(view) {
    ...
    private val adapterProduct by lazy { ItemProductSearchAdapter() }
