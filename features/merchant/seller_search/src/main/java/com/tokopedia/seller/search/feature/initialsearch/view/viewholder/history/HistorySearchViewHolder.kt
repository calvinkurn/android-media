...
class HistorySearchViewHolder(itemView: View): AbstractViewHolder<SellerSearchUiModel>(itemView) {
    ...
    private val adapterHistory by lazy { ItemHistorySearchAdapter() }
