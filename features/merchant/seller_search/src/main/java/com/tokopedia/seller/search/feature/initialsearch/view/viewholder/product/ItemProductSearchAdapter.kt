...
class ItemProductSearchAdapter: ListAdapter<ItemSellerSearchUiModel, ItemProductSearchViewHolder>(SellerSearchAdapterDiffCallback.ItemSearchDiffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemProductSearchViewHolder {
        ...
        return ItemProductSearchViewHolder(view)
    }
