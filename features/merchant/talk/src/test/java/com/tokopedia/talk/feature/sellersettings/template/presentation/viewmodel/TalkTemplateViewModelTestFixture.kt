...
abstract class TalkTemplateViewModelTestFixture {
    ...
    fun setup() {
        ...
        viewModel = TalkTemplateViewModel(addTemplateUseCase, arrangeTemplateUseCase, deleteSpecificTemplateUseCase, enableTemplateUseCase, getAllTemplatesUseCase, updateSpecificTemplateUseCase, CoroutineTestDispatchersProvider)
    }
