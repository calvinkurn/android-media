package com.tokopedia.talk_old.talkdetails.view.adapter
...
class AttachedProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    val image = itemView.findViewById<ImageView>(com.tokopedia.chat_common.R.id.attach_product_chat_image)
    val name = itemView.findViewById<TextView>(com.tokopedia.chat_common.R.id.attach_product_chat_name)
    val price = itemView.findViewById<TextView>(com.tokopedia.chat_common.R.id.attach_product_chat_price)
    val deleteButton = itemView.findViewById<ImageView>(com.tokopedia.chat_common.R.id.delete_button)
