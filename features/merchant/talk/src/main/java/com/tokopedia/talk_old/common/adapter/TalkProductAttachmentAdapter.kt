...
class TalkProductAttachmentAdapter(private val listener: ProductAttachmentItemClickListener,
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val productImage: ImageView = itemView.findViewById(com.tokopedia.chat_common.R.id.attach_product_chat_image)
        val productName: TextView = itemView.findViewById(com.tokopedia.chat_common.R.id.attach_product_chat_name)
        val productPrice: TextView = itemView.findViewById(com.tokopedia.chat_common.R.id.attach_product_chat_price)
    }
