...
object TalkWriteTrackingConstants {
    ...
    const val EVENT_LABEL_CLICK_CATEGORY = "talk category:%s;text output:%s;variant selected:%s;"
    const val EVENT_LABEL_CLICK_SEND = "talk category:%s;success:%s;error message:%s;variant selected:%s;"
