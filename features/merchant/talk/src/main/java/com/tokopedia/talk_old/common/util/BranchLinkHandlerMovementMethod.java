package com.tokopedia.talk_old.common.util;
 ...
 */
public class BranchLinkHandlerMovementMethod extends SelectableSpannedMovementMethod {

    private WeakReference<BranchLinkHandlerListener> viewListener;

    public BranchLinkHandlerMovementMethod(BranchLinkHandlerListener viewListener) {
