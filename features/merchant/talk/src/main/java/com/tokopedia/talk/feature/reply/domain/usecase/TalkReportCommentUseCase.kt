...
class TalkReportCommentUseCase @Inject constructor(
    @ApplicationContext
    graphqlRepository: GraphqlRepository
) : GraphqlUseCase<TalkReportCommentResponseWrapper>(graphqlRepository) {
    ...
    fun setParams(commentId: Long, reason: String = "", reportType: Int = OTHER_REPORT_TYPE) {
        val requestParams = RequestParams()
        requestParams.putLong(PARAM_COMMENT_ID, commentId)
