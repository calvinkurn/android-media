...
object TalkReadingTracking {
    ...
    private fun eventTalk(action: String, label: String, userId: String, productId: String) {
    ...
    fun eventClickSort(sortOption: String, userId: String, productId: String) {
        with(TalkReadingTrackingConstants) {
            eventTalk(EVENT_ACTION_CLICK_SORT_OPTION, String.format(EVENT_LABEL_CLICK_SORT_OPTION, sortOption), userId, productId)
        }
    }

    fun eventClickFilter(filterOption: String, userId: String, productId: String) {
        with(TalkReadingTrackingConstants) {
            eventTalk(EVENT_ACTION_CLICK_FILTER_OPTION, String.format(EVENT_LABEL_CLICK_FILTER_OPTION, filterOption), userId, productId)
        }
    }
}