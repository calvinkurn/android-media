...
class MiniCartGiftDividerViewHolder(
    itemView: View,
    private val listener: BmgmMiniCartAdapter.Listener
) : AbstractViewHolder<BmgmMiniCartVisitable.DividerUiModel>(itemView) {

    companion object {
        val RES_LAYOUT = R.layout.item_mini_cart_gift_divider
    }

    override fun bind(element: BmgmMiniCartVisitable.DividerUiModel) {
