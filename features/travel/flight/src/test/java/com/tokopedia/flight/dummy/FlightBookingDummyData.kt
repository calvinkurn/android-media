...
val DUMMY_CART_PRICE_ENTITY = arrayListOf<FlightPriceDetailEntity>(
    FlightPriceDetailEntity("Anak", "Rp100.000", 100000, ""),
    FlightPriceDetailEntity("Dewasa", "Rp200.000", 200000, "")
)

val DUMMY_OTHER_PRICE_ENTITY = arrayListOf<FlightPriceDetailEntity>(
    FlightPriceDetailEntity("Asuransi", "Rp900.000", 900000, "insurance")
)

val DUMMY_AMENITY_PRICE_ENTITY = arrayListOf<FlightPriceDetailEntity>(
    FlightPriceDetailEntity("Makanan", "Rp10.000", 10000, "")
)

val DUMMY_ADMIN_FEE_PRICE_ENTITY = arrayListOf<FlightPriceDetailEntity>(
    FlightPriceDetailEntity("Biaya Layanan", "Rp1.000", 1000, "")
)

val DUMMY_BOOKING_MODEL = FlightBookingModel(
    "dummyDeparture",
    "dummyReturn",
    "2020-11-11",
    "dummyDepartureTerm",
...
val DUMMY_BOOKING_INTERNATIONAL_MODEL = FlightBookingModel(
    "dummyDeparture",
    "dummyReturn",
    "2020-11-11",
    "dummyDepartureTerm",
