...
public class FlightDetailRouteModel implements Parcelable, Visitable<FlightDetailRouteTypeFactory> {
    ...
    private List<FlightDetailRouteInfoModel> infos;
    private List<Amenity> amenities = null;
    private List<FlightStopOverViewModel> stopOverDetail;
    private String operatingAirline;

    public FlightDetailRouteModel() {
    }

    protected FlightDetailRouteModel(Parcel in) {
        pnr = in.readString();
        ...
        stopOver = in.readInt();
        infos = in.createTypedArrayList(FlightDetailRouteInfoModel.CREATOR);
    ...
    public static final Creator<FlightDetailRouteModel> CREATOR = new Creator<FlightDetailRouteModel>() {
        @Override
        public FlightDetailRouteModel createFromParcel(Parcel in) {
            return new FlightDetailRouteModel(in);
        }

        @Override
        public FlightDetailRouteModel[] newArray(int size) {
            return new FlightDetailRouteModel[size];
        }
    };
    ...
    public List<FlightDetailRouteInfoModel> getInfos() {
        return infos;
    }

    public void setInfos(List<FlightDetailRouteInfoModel> infos) {
        this.infos = infos;
    }
