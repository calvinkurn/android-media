...
class FlightCancellationPassengerActivity : BaseSimpleActivity(),
    HasComponent<FlightCancellationComponent> {

    override fun getNewFragment(): Fragment {
        val flightCancellationJourney: List<FlightCancellationResponseEntity> =
            intent.extras?.getParcelableArrayList(FlightCancellationPassengerFragment.EXTRA_CANCEL_JOURNEY)
                ?: arrayListOf()
        ...
        fun createIntent(
            ...
            Intent(context, FlightCancellationPassengerActivity::class.java)
                ...
                .putParcelableArrayListExtra(
                    FlightCancellationPassengerFragment.EXTRA_CANCEL_JOURNEY,
                    flightCancellationJourney as ArrayList<out Parcelable>
                )
    }
}
