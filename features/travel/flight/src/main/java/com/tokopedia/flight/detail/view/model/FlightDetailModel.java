...
public class FlightDetailModel implements Parcelable {
    ...
    public static final Creator<FlightDetailModel> CREATOR = new Creator<FlightDetailModel>() {
        @Override
        public FlightDetailModel createFromParcel(Parcel in) {
            return new FlightDetailModel(in);
        }

        @Override
        public FlightDetailModel[] newArray(int size) {
            return new FlightDetailModel[size];
        }
    };
    private String id;
    private String term;
    ...
    protected FlightDetailModel(Parcel in) {
        id = in.readString();
        term = in.readString();
    ...
    public FlightDetailModel build(FlightSearchPassDataModel flightSearchPassDataViewModel) {
    ...
    public List<FlightDetailRouteModel> getRouteList() {
        return routeList;
    }

    public void setRouteList(List<FlightDetailRouteModel> routeList) {
