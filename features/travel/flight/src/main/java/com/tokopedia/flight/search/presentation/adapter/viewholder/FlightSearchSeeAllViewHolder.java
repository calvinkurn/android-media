...
public class FlightSearchSeeAllViewHolder extends AbstractViewHolder<FlightSearchSeeAllResultModel> {
    ...
    @Override
    public void bind(FlightSearchSeeAllResultModel element) {
