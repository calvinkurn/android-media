...
public class FlightBookingVoucherModel implements Parcelable {
    ...
    public FlightBookingVoucherModel() {
    }

    protected FlightBookingVoucherModel(Parcel in) {
    ...
    public static final Creator<FlightBookingVoucherModel> CREATOR = new Creator<FlightBookingVoucherModel>() {
        @Override
        public FlightBookingVoucherModel createFromParcel(Parcel in) {
            return new FlightBookingVoucherModel(in);
        }

        @Override
        public FlightBookingVoucherModel[] newArray(int size) {
            return new FlightBookingVoucherModel[size];
        }
    };
