...
class FlightBookingPassengerModel(
        ...
        var flightBookingLuggageMetaViewModels: List<FlightBookingAmenityMetaModel> = arrayListOf(),
        var flightBookingMealMetaViewModels: List<FlightBookingAmenityMetaModel> = arrayListOf(),
