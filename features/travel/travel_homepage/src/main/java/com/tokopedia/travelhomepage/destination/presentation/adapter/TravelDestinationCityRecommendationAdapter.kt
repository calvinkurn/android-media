...
class TravelDestinationCityRecommendationAdapter(private var list: List<TravelDestinationSectionModel.Item>,
    ...
    class ViewHolder(itemView: View, private val actionListener: ActionListener) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: TravelDestinationSectionModel.Item, position: Int) {
            with(itemView) {
