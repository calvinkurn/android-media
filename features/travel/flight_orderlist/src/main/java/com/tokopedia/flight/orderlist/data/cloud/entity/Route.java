...
public class Route implements Parcelable {
    ...
    @Expose
    private List<OrderStopDetailEntity> stopDetails;
    ...
    public Route(String airline, String departureAirport, String departureTimestamp, String arrivalAirport,
                 ...
                 boolean isRefundable, List<Amenity> amenities, int stops, List<OrderStopDetailEntity> stopDetails,
    ...
    protected Route(Parcel in) {
        ...
        stops = in.readInt();
        stopDetails = in.createTypedArrayList(OrderStopDetailEntity.CREATOR);
    ...
    public List<OrderStopDetailEntity> getStopDetails() {
        return stopDetails;
    }

    public void setStopDetails(List<OrderStopDetailEntity> stopDetails) {
        this.stopDetails = stopDetails;
    }
