...
import com.tokopedia.hotel.common.util.QueryHotelGetPopularProperty
...
class GetPropertyPopularUseCase @Inject constructor(
    ...
    override suspend fun executeOnBackground(): List<PopularSearch> {
        val gqlRequest = GraphqlRequest(QueryHotelGetPopularProperty(), PopularSearch.Response::class.java)
