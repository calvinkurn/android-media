...
class HotelFilterPriceRangeSlider @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    fun initView(selectedMinPrice: Int, selectedMaxPrice: Int, maxBound: Int) {
        ...
        seekbar_background.activeBackgroundRailColor = ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_N75)
        seekbar_background.activeKnobColor = ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_G500)
