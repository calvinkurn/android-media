...
public class CurrencyTextWatcher implements TextWatcher {
    ...
    public void afterTextChanged(Editable s) {
        ...
        double doubleValue = HotelStringUtils.Companion.convertToNumeric(sString, useCommaForThousand);
        ...
        if (doubleValue == 0) {
            ...
            ThousandString thousandString =
                    HotelStringUtils.Companion.getThousandSeparatorString(doubleValue, useCommaForThousand, selectionStart);
