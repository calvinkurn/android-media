...
class SearchDestinationViewHolder(val view: View, val searchDestinationListener: SearchDestinationListener) : AbstractViewHolder<SearchDestination>(view) {
    ...
    val boldColor: ForegroundColorSpan = ForegroundColorSpan(ContextCompat.getColor(itemView.context, com.tokopedia.unifyprinciples.R.color.Unify_NN950_96));
    ...
    override fun bind(searchDestination: SearchDestination) {
        with(itemView) {
            ...
            ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_NN950_68))
