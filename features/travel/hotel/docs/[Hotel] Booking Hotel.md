...
![](http://docs-android.tokopedia.net/images/docs/features/Hotel-Order-Page.png)

![](http://docs-android.tokopedia.net/images/docs/features/Hotel-Contact-Form-on-Order.png)
...
| 3 | User want to add special booking requirement to Hotel | User need click “Tambahkan permintaan khusus” | ![](http://docs-android.tokopedia.net/images/docs/features/Add-special-req-booking.png)<br/>                                                                                                                                                            |
