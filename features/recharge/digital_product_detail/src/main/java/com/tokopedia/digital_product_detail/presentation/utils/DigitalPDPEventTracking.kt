...
object DigitalPDPEventTracking {
    ...
    object Action {
        ...
        const val IMPRESSION_CHECK_BALANCE_WIDGET = "impression check balance widget"
        const val IMPRESSION_PDP_OTP_POP_UP = "impression pdp otp pop up"
        const val IMPRESSION_CHECK_BALANCE_INFO = "impression check balance info"
        const val IMPRESSION_ACTIVE_PACKAGE_CHECK_BALANCE = "impression active package check balance"
        ...
        const val CLICK_CHECK_BALANCE_WIDGET = "click check balance widget"
        const val CLICK_PDP_OTP_POP_UP = "click pdp otp pop up"
        const val CLICK_INPUT_OTP = "click input otp"
        const val CLICK_CLOSE_OTP = "click close otp"
        const val CLICK_LIHAT_DETAIL_CHECK_BALANCE = "click lihat detail check balance"
        const val IMPRESSION_SHEET_ACTIVE_PACKAGE = "impression sheet active package"
        const val CLICK_CLOSE_SHEET_ACTIVE_PACKAGE = "click close sheet active package"
        const val CLICK_BELI_LAGI_ACTIVE_PACKAGE = "click beli lagi active package"
    ...
    object TrackerId {
        ...
        const val CLICK_PDP_OTP_TOP_UP = "43700"
        const val CLICK_INPUT_OTP = "43701"
        const val CLICK_CLOSE_OTP = "43702"
        const val IMPRESSION_CHECK_BALANCE_INFO = "43704"
        const val CLICK_LIHAT_DETAIL_CHECK_BALANCE = "43705"
        const val IMPRESSION_SHEET_ACTIVE_PACKAGE = "43706"
