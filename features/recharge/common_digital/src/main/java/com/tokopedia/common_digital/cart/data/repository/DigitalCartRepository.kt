 ...
 */
class DigitalCartRepository(private val digitalGetCartDataSource: DigitalGetCartDataSource,
                            private val digitalInstantCheckoutDataSource: DigitalInstantCheckoutDataSource) : IDigitalCartRepository {

    override fun getCart(requestParam: RequestParams): Observable<CartDigitalInfoData> {
        return digitalGetCartDataSource.getCart(requestParam)
    }
