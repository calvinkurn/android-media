...
class DigitalAddToCartRestUseCase @Inject constructor(@DigitalAddToCartQualifier val repository: RestRepository) :
    ...
    override suspend fun executeOnBackground(): Map<Type, RestResponse?> {
        val requestBodyAtcDigital =
            requestParams.getObject(PARAM_REQUEST_BODY_ATC_DIGITAL) as RequestBodyAtcDigital
    ...
    fun setRequestParams(
        requestBodyAtcDigital: RequestBodyAtcDigital?,
    ...
    companion object {
        const val PARAM_REQUEST_BODY_ATC_DIGITAL = "PARAM_REQUEST_BODY_ATC_DIGITAL"
        const val PARAM_IDEM_POTENCY_KEY = "PARAM_IDEM_POTENCY_KEY"
        const val PARAM_ADD_TO_CART = "add_cart"
        const val PARAM_DATA = "data"
        const val PARAM_CLIENT_NUMBER = "client_number"
        const val PARAM_ZONE_ID = "zone_id"

        const val KEY_IDEM_POTENCY_KEY = "Idempotency-Key"
        ...
        fun getRequestBodyAtcDigital(
            ...
            attributes.instantCheckout =
                digitalCheckoutPassData.instantCheckout == VALUE_INSTANT_CHECKOUT_ID
