package com.tokopedia.common.topupbills.favoritepage.view.fragment
...
import com.tokopedia.common.topupbills.favoritepage.view.adapter.TopupBillsPersoFavoriteNumberListAdapter
import com.tokopedia.common.topupbills.favoritepage.view.bottomsheet.PersoFavoriteNumberMenuBottomSheet
import com.tokopedia.common.topupbills.favoritepage.view.bottomsheet.PersoFavoriteNumberMenuBottomSheet.PersoFavoriteNumberMenuListener
import com.tokopedia.common.topupbills.favoritepage.view.bottomsheet.PersoFavoriteNumberModifyBottomSheet
import com.tokopedia.common.topupbills.favoritepage.view.bottomsheet.PersoFavoriteNumberModifyBottomSheet.PersoFavoriteNumberModifyListener
import com.tokopedia.common.topupbills.favoritepage.view.listener.FavoriteNumberDeletionListener
import com.tokopedia.common.topupbills.favoritepage.view.listener.PersoFavoriteNumberNotFoundStateListener
...
class TopupBillsPersoFavoriteNumberFragment :
    ...
    private fun undoDelete(deletedFavoriteNumber: UpdateFavoriteDetail? = null) {
        ...
        if (favoriteDetail != null) {
            ...
            favNumberViewModel.modifySeamlessFavoriteNumber(
                ...
                hashedClientNumber = favoriteDetail.hashedClientNumber,
    ...
    override fun onChangeName(newName: String, favNumberItem: TopupBillsPersoFavNumberDataView) {
        ...
        favNumberViewModel.modifySeamlessFavoriteNumber(
            ...
            hashedClientNumber = favNumberItem.clientNumberHash,
