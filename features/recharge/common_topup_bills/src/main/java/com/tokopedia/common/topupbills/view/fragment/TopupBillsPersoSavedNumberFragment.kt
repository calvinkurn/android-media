...
import com.tokopedia.common.topupbills.view.adapter.TopupBillsPersoSavedNumTabAdapter
...
class TopupBillsPersoSavedNumberFragment: BaseDaggerFragment() {
    ...
    override fun getScreenName(): String {
        return TopupBillsPersoSavedNumberFragment::class.java.simpleName
    }
    ...
    companion object {
        fun newInstance(
            ...
            val fragment = TopupBillsPersoSavedNumberFragment()
            val bundle = Bundle()
