...
import com.tokopedia.common.topupbills.view.adapter.TopupBillsPersoFavoriteNumberListAdapter
import com.tokopedia.common.topupbills.view.bottomsheet.PersoFavoriteNumberMenuBottomSheet
import com.tokopedia.common.topupbills.view.bottomsheet.PersoFavoriteNumberMenuBottomSheet.PersoFavoriteNumberMenuListener
import com.tokopedia.common.topupbills.view.bottomsheet.PersoFavoriteNumberModifyBottomSheet
import com.tokopedia.common.topupbills.view.bottomsheet.PersoFavoriteNumberModifyBottomSheet.PersoFavoriteNumberModifyListener
...
import com.tokopedia.common.topupbills.view.typefactory.PersoFavoriteNumberTypeFactoryImpl
...
class TopupBillsPersoFavoriteNumberFragment :
    ...
    fun initListener() {
        binding?.run {
            commonTopupbillsPersoFavoriteNumberSearchbar.searchBarTextField
    ...
    private fun observeData() {
        topUpBillsViewModel.seamlessFavNumberUpdateData.observe(viewLifecycleOwner, {
            when (it) {
        ...
        topUpBillsViewModel.persoFavNumberData.observe(viewLifecycleOwner, {
            when (it) {
        ...
        topUpBillsViewModel.seamlessFavNumberDeleteData.observe(viewLifecycleOwner, {
            when (it) {
        ...
        topUpBillsViewModel.seamlessFavNumberUndoDeleteData.observe(viewLifecycleOwner, {
            when (it) {
    ...
    private fun getPersoFavoriteNumber() {
        showShimmering()
        topUpBillsViewModel.getPersoFavoriteNumbers(dgCategoryIds)
    }
    ...
    override fun onDestroyView() {
        ...
        binding?.run {
            commonTopupbillsPersoFavoriteNumberSearchbar.searchBarTextField
                .removeTextChangedListener(getSearchTextWatcher)
        }
        super.onDestroy()
    }
