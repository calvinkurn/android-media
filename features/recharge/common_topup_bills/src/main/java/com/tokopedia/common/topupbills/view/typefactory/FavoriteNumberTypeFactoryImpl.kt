...
class FavoriteNumberTypeFactoryImpl(
    ...
    override fun type(favoriteNumberDataView: TopupBillsFavNumberDataView): Int =
        FavoriteNumberViewHolder.LAYOUT

    override fun type(emptyStateDataView: TopupBillsFavNumberEmptyDataView): Int =
        FavoriteNumberEmptyViewHolder.LAYOUT

    override fun type(favoriteNumberNotFoundDataView: TopupBillsFavNumberNotFoundDataView): Int =
        FavoriteNumberNotFoundViewHolder.LAYOUT

    override fun type(favoriteNumberShimmerDataView: TopupBillsFavNumberShimmerDataView): Int =
        FavoriteNumberShimmerViewHolder.LAYOUT

    override fun type(favoriteNumberErrorDataView: TopupBillsFavNumberErrorDataView): Int =
        FavoriteNumberErrorViewHolder.LAYOUT
    ...
    private fun createFavoriteNumberViewHolder(parent: View): AbstractViewHolder<Visitable<*>> {
        ...
        return FavoriteNumberViewHolder(
            binding,
    ...
    private fun createFavoriteNumberNotFoundViewHolder(parent: View): AbstractViewHolder<Visitable<*>> {
        ...
        return FavoriteNumberNotFoundViewHolder(
            binding,
            emptyStateListener
        ) as AbstractViewHolder<Visitable<*>>
    }
    ...
    private fun createFavoriteNumberErrorViewHolder(parent: View): AbstractViewHolder<Visitable<*>> {
        ...
        return FavoriteNumberErrorViewHolder(
            binding,
            errorStateListener
        ) as AbstractViewHolder<Visitable<*>>
    }
