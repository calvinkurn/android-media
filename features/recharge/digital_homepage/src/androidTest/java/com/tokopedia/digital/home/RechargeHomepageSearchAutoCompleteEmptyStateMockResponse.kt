...
class RechargeHomepageSearchAutoCompleteEmptyStateMockResponse : MockModelConfig() {
    companion object {
    ...
    override fun createMockModel(context: Context): MockModelConfig {
        ...
        addMockResponse(
                KEY_QUERY_SEARCH,
                InstrumentationMockHelper.getRawString(context, R.raw.recharge_homepage_search_autocomplete_empty_mock_response),
                MockModelConfig.FIND_BY_CONTAINS)
        addMockResponse(
