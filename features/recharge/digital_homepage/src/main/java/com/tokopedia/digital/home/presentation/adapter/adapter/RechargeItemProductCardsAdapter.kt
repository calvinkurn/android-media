...
import com.tokopedia.digital.home.presentation.Util.DigitalHomepageTrackingActionConstant.PRODUCT_CARDS_CLICK
import com.tokopedia.digital.home.presentation.listener.OnItemBindListener
import com.tokopedia.kotlin.extensions.view.loadImage
import kotlinx.android.synthetic.main.view_recharge_home_product_cards_item.view.*

class RechargeItemProductCardsAdapter(val items: List<RechargeHomepageSections.Item>, val onItemBindListener: OnItemBindListener)
