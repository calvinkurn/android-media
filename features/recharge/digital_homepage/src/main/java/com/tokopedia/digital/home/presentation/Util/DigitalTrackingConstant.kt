...
object DigitalHomepageTrackingActionConstant {
    ...
    const val PRODUCT_BANNER_IMPRESSION = "video highlight impression"
    const val PRODUCT_BANNER_CLICK = "video highlight click"
}

object DigitalHomepageTrackingLabelConstant {
    const val CLICK = "click"
    const val ORDER_LIST = "daftar transaksi"
    const val LANGGANAN = "langganan"
    const val FAVOURITE_NUMBER = "nomor favorite"
    const val HELP = "bantuan"
}
