...
class DigitalCartViewModelTest {
    ...
    fun setUp() {
        ...
        digitalCartViewModel = DigitalCartViewModel(
            ...
            digitalCancelVoucherUseCase,
            digitalPatchOtpUseCase,
    ...
    fun getCart_onSuccess_NoNeedOtpAndIsNotSubscribed() {
        ...
        coEvery { digitalGetCartUseCase.onExecute(any(), any(), any()) } coAnswers {
    ...
    fun onCheckedFintechProduct_updateCheckoutSummary() {
        ...
        // then
        val fintechPrice =
            digitalCartViewModel.requestCheckoutParam.crossSellProducts["3"]?.fintechAmount
                ?: 0.0
        val fintechName =
            digitalCartViewModel.requestCheckoutParam.crossSellProducts["3"]?.transactionType
        val summary = digitalCartViewModel.payment.value!!.summaries.firstOrNull {
