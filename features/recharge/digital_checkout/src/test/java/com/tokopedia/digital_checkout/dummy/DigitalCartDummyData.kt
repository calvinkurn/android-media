...
object DigitalCartDummyData {
    fun getDummyGetCartResponse(isOpenAmount: Boolean = true): RechargeGetCart {
        ...
        return RechargeGetCart(
                ...
                icon = "https://images.tokopedia.net/img/cache/100-square/attachment/2019/9/26/5511722/5511722_36540d36-688d-40db-b3aa-04114e598e14.png",
                priceText = "Rp 12.500",
                price = 12500.0,
    ...
    fun getDummyGetCartResponseDisableVoucher(): RechargeGetCart {
        val openPaymentConfig = getOpenAmountData(false)
