...
class RechargeGeneralMockResponseConfig(
    ...
    companion object {
        ...
        const val KEY_VARIABLE_OPERATOR_ID = "operator"
        const val VALUE_VARIABLE_TAGIHAN_LISTRIK = "18"
        const val VALUE_VARIABLE_TOKEN_LISTRIK = "6"
    }
    ...
    private fun createMockProductListrik(context: Context): MockModelConfig {
        ...
        addMockResponse(
                MockKey(
                    ...
                    variables = mapOf(
                        KEY_VARIABLE_OPERATOR_ID to VALUE_VARIABLE_TOKEN_LISTRIK
                    )
                ),
        ...
        addMockResponse(
                MockKey(
                    query = KEY_QUERY_CATALOG_DYNAMIC_INPUT,
                    variables = mapOf(
                        KEY_VARIABLE_OPERATOR_ID to VALUE_VARIABLE_TAGIHAN_LISTRIK
                    )
                ),
