...
class TelcoPrepaidInstrumentTest {
    ...
    var mActivityRule: IntentsTestRule<TelcoPrepaidActivity> = object : IntentsTestRule<TelcoPrepaidActivity>(TelcoPrepaidActivity::class.java) {
        ...
        override fun beforeActivityLaunched() {
            ...
            setupGraphqlMockResponse(TelcoPrepaidMockResponseConfig())
        }
    }
    ...
    fun validate_prepaid_login() {
        ...
        InstrumentationAuthHelper.logoutTestUser(context)
        Thread.sleep(3000)
    ...
    fun click_item_recent_widget_login() {
        ...
        Thread.sleep(3000)
        onView(AllOf.allOf(withId(R.id.tab_item_text_id), withText("Recents"))).perform(click())
        val viewInteraction = onView(AllOf.allOf(isDisplayed(), isDescendantOfA(withId(R.id.layout_widget)),
                withId(R.id.recycler_view_menu_component))).check(matches(isDisplayed()))
    ...
    fun validate_showcase() {
        Thread.sleep(4000)
        if (!ShowCasePreference.hasShown(context,
                        "com.tokopedia.topupbills.telco.prepaid.activity.TelcoPrepaidActivity.BroadcastMessage")) {
            onView(withText(R.string.Telco_title_showcase_client_number)).check(matches(isDisplayed()))
    ...
    fun interaction_promo() {
        ...
        viewInteraction.perform(RecyclerViewActions.scrollToPosition<TopupBillsPromoListAdapter.PromoItemViewHolder>(10))
        Thread.sleep(3000)
    }
    ...
    fun interaction_product_filter() {
        ...
        try {
            ...
            Log.e("prepaid_filter", e.viewMatcherDescription)
        }
