...
class SearchQuickFilterTest: SearchTestFixtures() {
    ...
    fun `click quick filter to apply filter`() {
        ...
        `Then verify request params contains the applied quick filter`(requestParamsSlot.captured, selectedQuickFilter)
    }
    ...
    fun `click quick filter to un-apply filter`() {
        ...
        `Then verify get search first page is called twice`()
        `Then verify quick filter does not contain unapplied filter`(requestParamsSlot.captured, selectedQuickFilter)
    }
