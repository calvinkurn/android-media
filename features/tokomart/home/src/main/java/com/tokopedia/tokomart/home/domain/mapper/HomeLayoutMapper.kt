...
object HomeLayoutMapper {
    ...
    private fun mapToCategoryUiModel(it: HomeLayoutResponse): HomeCategoryUiModel {
        val menuList = listOf(
            HomeCategoryMenuUiModel("1", "Daging", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("2", "Makanan Laut", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("3", "Frozen Food", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("4", "Sayuran Segar", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("5", "Category 1", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("6", "Category 2", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("7", "Category 3", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("8", "Category 4", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("9", "Category 5", "https://img.icons8.com/cotton/2x/circled-down--v2.png"),
            HomeCategoryMenuUiModel("10", "Kategori Lainnya", "https://img.icons8.com/cotton/2x/circled-down--v2.png")
        )
