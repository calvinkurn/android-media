package com.tokopedia.paymentmanagementsystem.uploadproofpayment.domain;
...
import com.tokopedia.paymentmanagementsystem.uploadproofpayment.model.DataUploadProof;
import com.tokopedia.paymentmanagementsystem.uploadproofpayment.model.ResponseUploadImageProof;
...
public class UploadProofPaymentUseCase extends UseCase<Boolean> {
                        ...
                        imageUploadDomainModel -> {
                            ...
                            return uploadProofUseCase.createObservable(requestParams)
                                    .map(graphqlResponse -> {
                                        ...
                                        return cancelDetail.getUploadProof().isSuccess();
                                    });
                        }
                );
    }
