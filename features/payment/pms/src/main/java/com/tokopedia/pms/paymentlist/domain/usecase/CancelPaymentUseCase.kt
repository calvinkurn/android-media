...
import com.tokopedia.pms.paymentlist.domain.data.CancelPaymentDetailResponse
...
class CancelPaymentUseCase @Inject constructor(
...
) : GraphqlUseCase<CancelPaymentDetailResponse>(graphqlRepository) {
    ...
    fun invokePaymentCancel(
        ...
        this.setTypeClass(CancelPaymentDetailResponse::class.java)
