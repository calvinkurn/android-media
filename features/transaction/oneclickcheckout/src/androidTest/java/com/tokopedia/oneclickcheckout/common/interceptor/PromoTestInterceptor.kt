...
class PromoTestInterceptor : BaseOccInterceptor() {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (requestString.contains(GET_PROMO_LIST_RECOMMENDATION_QUERY)) {
            return mockResponse(copy, getJsonFromResource(GET_PROMO_LIST_RECOMMENDATION_DEFAULT_RESPONSE))
        }
...
const val GET_PROMO_LIST_RECOMMENDATION_QUERY = "getPromoListRecommendation"

const val GET_PROMO_LIST_RECOMMENDATION_DEFAULT_RESPONSE = "promo/get_promo_list_recommendation_default_response.json"
