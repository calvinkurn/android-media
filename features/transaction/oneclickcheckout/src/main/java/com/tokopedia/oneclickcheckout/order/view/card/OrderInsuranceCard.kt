...
class OrderInsuranceCard(private val view: FragmentOrderSummaryPageBinding, private val listener: OrderInsuranceCardListener, private val orderSummaryAnalytics: OrderSummaryAnalytics) {
