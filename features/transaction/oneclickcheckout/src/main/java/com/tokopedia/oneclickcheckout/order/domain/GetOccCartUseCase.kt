...
//                false, "tncInfo", availableTerms.firstOrNull { it.isSelected })
    ...
    private fun mapPaymentCreditCardAdditionalData(data: GetOccCartData?): OrderPaymentCreditCardAdditionalData {
        ...
        val (merchantCode, profileCode, signature) = data.paymentAdditionalData
        return OrderPaymentCreditCardAdditionalData(id, name, email, msisdn, merchantCode, profileCode, signature)
    }
