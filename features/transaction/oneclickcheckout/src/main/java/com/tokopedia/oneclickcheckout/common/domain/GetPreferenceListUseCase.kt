...
class GetPreferenceListUseCase @Inject constructor(val context: Context, val graphql: GraphqlUseCase<PreferenceListGqlResponse>, val preferenceListModelMapper: PreferenceListModelMapper) : UseCase<PreferenceListResponseModel>() {
