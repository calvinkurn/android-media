...
public class ItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OrderListDetailContract.ActionInterface, RedeemVoucherView.SetTapActionDeals {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView renderActionButtons(int position, ActionButton actionButton, Items item) {
            ...
            tapActionTextView.setPadding((int) context.getResources().getDimension(R.dimen.unify_space_16), (int) context.getResources().getDimension(R.dimen.unify_space_16), (int) context.getResources().getDimension(R.dimen.unify_space_16), (int) context.getResources().getDimension(R.dimen.unify_space_16));
            ...
            if (position == item.getTapActions().size() - 1 && (item.getActionButtons() != null || item.getActionButtons().size() == 0)) {
                float radius = context.getResources().getDimension(R.dimen.unify_space_4);
                shape.setCornerRadii(new float[]{0, 0, 0, 0, radius, radius, radius, radius});

            } else {

                shape.setCornerRadius(context.getResources().getDimension(R.dimen.unify_space_4));
            }
