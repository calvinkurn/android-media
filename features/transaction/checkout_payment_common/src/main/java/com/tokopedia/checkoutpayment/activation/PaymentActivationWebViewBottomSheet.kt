package com.tokopedia.checkoutpayment.activation
...
import com.tokopedia.checkoutpayment.databinding.BottomSheetWebViewBinding
...
class PaymentActivationWebViewBottomSheet(
    ...
    fun show(fragment: Fragment, userSessionInterface: UserSessionInterface) {
