...
class SomDetailLogisticInfoAdapter(private val logisticInfoAll: ArrayList<SomDetailOrder.Data.GetSomDetail.LogisticInfo.All>): RecyclerView.Adapter<SomDetailLogisticInfoAdapter.SomDetailLogisticInfoViewHolder>() {
    ...
    inner class SomDetailLogisticInfoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(data: SomDetailOrder.Data.GetSomDetail.LogisticInfo.All, position: Int) {
            with(itemView) {
                ...
                tvContentItemInfo.text = data.infoTextLong
            }
        }
    }
}