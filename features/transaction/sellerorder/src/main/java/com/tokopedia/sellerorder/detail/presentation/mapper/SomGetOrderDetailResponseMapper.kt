...
object SomGetOrderDetailResponseMapper {
    ...
    fun mapResponseToHeaderUiModel(
        ...
        return response?.run {
            ...
            SomDetailData(dataHeader, SomConsts.DETAIL_HEADER_TYPE)
        }
    }
    ...
    fun mapResponseToProductsHeaderUiModel(
        ...
        return response?.run {
            ...
            val dataProducts = SomDetailProducts(
                flagOrderMeta.isTopAds, flagOrderMeta.isBroadcastChat
            )
            SomDetailData(dataProducts, SomConsts.DETAIL_PRODUCTS_TYPE)
        }
    }
    ...
    fun mapResponseToShipmentUiModel(
        ...
        return response?.run {
            ...
            SomDetailData(dataShipping, SomConsts.DETAIL_SHIPPING_TYPE)
        }
    }
}