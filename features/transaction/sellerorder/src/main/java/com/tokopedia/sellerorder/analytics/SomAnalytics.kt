...
object SomAnalytics {
    ...
    private const val TRACKER_ID_CLICK_ONBOARD_CONTINUE = "33451"
    private const val TRACKER_ID_CLICK_ONBOARD_BACK = "33452"
    private const val TRACKER_ID_CLICK_ONBOARD_OK = "33453"
    ...
    fun eventClickOnboardInfoContinue(userId: String) {
        val data = mapOf(
            ...
            CUSTOM_DIMENSION_BUSINESS_UNIT to BUSINESS_UNIT_PHYSICAL_GOODS_CAPITALIZE,
            CUSTOM_DIMENSION_CURRENT_SITE to TOKOPEDIA_MARKETPLACE,
            CUSTOM_DIMENSION_TRACKER_ID to TRACKER_ID_CLICK_ONBOARD_CONTINUE
        )
        TrackApp.getInstance().gtm.sendGeneralEvent(data)
    }
    ...
    fun eventClickOnboardInfoBack(userId: String) {
        val data = mapOf(
            ...
            CUSTOM_DIMENSION_BUSINESS_UNIT to BUSINESS_UNIT_PHYSICAL_GOODS_CAPITALIZE,
            CUSTOM_DIMENSION_CURRENT_SITE to TOKOPEDIA_MARKETPLACE,
            CUSTOM_DIMENSION_TRACKER_ID to TRACKER_ID_CLICK_ONBOARD_BACK
        )
        TrackApp.getInstance().gtm.sendGeneralEvent(data)
    }
    ...
    fun eventClickOnboardInfoOk(userId: String) {
        val data = mapOf(
            ...
            CUSTOM_DIMENSION_BUSINESS_UNIT to BUSINESS_UNIT_PHYSICAL_GOODS_CAPITALIZE,
            CUSTOM_DIMENSION_CURRENT_SITE to TOKOPEDIA_MARKETPLACE,
            CUSTOM_DIMENSION_TRACKER_ID to TRACKER_ID_CLICK_ONBOARD_OK
        )
        TrackApp.getInstance().gtm.sendGeneralEvent(data)
    }
}