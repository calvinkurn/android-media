package com.tokopedia.sellerorder.reschedulepickup.presentation.viewmodel
...
import com.tokopedia.sellerorder.reschedulepickup.data.mapper.ReschedulePickupMapper
import com.tokopedia.sellerorder.reschedulepickup.data.model.RescheduleDetailModel
import com.tokopedia.sellerorder.reschedulepickup.data.model.RescheduleTimeOptionModel
import com.tokopedia.sellerorder.reschedulepickup.data.model.SaveRescheduleModel
import com.tokopedia.sellerorder.reschedulepickup.domain.GetReschedulePickupUseCase
import com.tokopedia.sellerorder.reschedulepickup.domain.SaveReschedulePickupUseCase
...
class ReschedulePickupViewModel @Inject constructor(
    ...
    fun getReschedulePickupDetail(orderId: String) {
        launchCatchError(
            block = {
                val response = getReschedulePickupUseCase.execute(ReschedulePickupMapper.mapToGetReschedulePickupParam(listOf(orderId)))
