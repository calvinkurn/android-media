...
class WaitingPaymentOrderViewModel @Inject constructor(
    ...
    private val _waitingPaymentOrderResult =
        MutableLiveData<Result<List<WaitingPaymentOrderUiModel>>>()
    ...
    fun loadWaitingPaymentOrder(param: WaitingPaymentOrderRequestParam) {
        launchCatchError(block = {
            ...
            paging = result.first
            _waitingPaymentOrderResult.postValue(Success(result.second))
        }, onError = {
