 ...
 */
public class SomDecoratedBarcodeView extends FrameLayout {
    ...
    public SomDecoratedBarcodeView(Context context) {
        super(context);
        initialize();
    }

    public SomDecoratedBarcodeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs);
    }

    public SomDecoratedBarcodeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                R.styleable.zxing_view_zxing_scanner_layout, com.tokopedia.sellerorder.R.id.som_zxing_barcode_scanner);

        attributes.recycle();

        inflate(getContext(), scannerLayout, this);

        barcodeView = (BarcodeView) findViewById(com.tokopedia.sellerorder.R.id.som_zxing_barcode_surface);
        ...
        viewFinder = (ViewfinderView) findViewById(com.tokopedia.sellerorder.R.id.som_zxing_viewfinder_view);
        ...
        statusView = (TextView) findViewById(com.tokopedia.sellerorder.R.id.som_zxing_status_view);
    }
    ...
    public BarcodeView getBarcodeView() {
        return (BarcodeView) findViewById(com.tokopedia.sellerorder.R.id.som_zxing_barcode_surface);
    }
