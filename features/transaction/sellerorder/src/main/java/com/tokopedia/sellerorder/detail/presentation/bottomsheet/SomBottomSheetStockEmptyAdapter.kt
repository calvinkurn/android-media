...
class SomBottomSheetStockEmptyAdapter: RecyclerView.Adapter<SomBottomSheetStockEmptyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.itemView.iv_product.loadImageRounded(listProduct[position].thumbnail, holder.itemView.resources.getDimension(com.tokopedia.unifyprinciples.R.dimen.unify_space_8))
