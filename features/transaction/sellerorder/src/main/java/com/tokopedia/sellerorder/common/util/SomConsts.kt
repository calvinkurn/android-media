...
object SomConsts {
    ...
    const val SOM_LIST_EMPTY_STATE_NO_FILTER_ILLUSTRATION = ImageUrl.SOM_LIST_EMPTY_STATE_NO_FILTER_ILLUSTRATION
    const val SOM_LIST_EMPTY_STATE_WITH_FILTER_ILLUSTRATION = ImageUrl.SOM_LIST_EMPTY_STATE_WITH_FILTER_ILLUSTRATION
