...
@Deprecated("Use coroutine version", replaceWith = ReplaceWith("Use coroutine version", imports = ["com.tokopedia.atc_common.domain.usecase.coroutine.AddToCartUseCase"]))
