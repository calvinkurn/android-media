package com.tokopedia.one.click.checkout.common.domain.model

import com.tokopedia.purchase_platform.common.feature.promonoteligible.NotEligiblePromoHolderdata
import com.tokopedia.one.click.checkout.order.data.checkout.PriceValidation
...
sealed class OccGlobalEvent {
    ...
    data class CheckoutError(val error: com.tokopedia.one.click.checkout.order.data.checkout.Error) : OccGlobalEvent()
