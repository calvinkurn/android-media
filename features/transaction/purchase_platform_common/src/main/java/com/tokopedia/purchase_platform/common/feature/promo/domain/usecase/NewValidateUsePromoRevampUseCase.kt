...
class NewValidateUsePromoRevampUseCase @Inject constructor(@ApplicationContext private val graphqlRepository: GraphqlRepository,
    ...
    fun setParam(param: ValidateUsePromoRequest): NewValidateUsePromoRevampUseCase {
