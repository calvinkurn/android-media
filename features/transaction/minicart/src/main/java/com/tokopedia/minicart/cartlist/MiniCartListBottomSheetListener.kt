...
interface MiniCartListBottomSheetListener {
    ...
    fun onBottomSheetSuccessAddToCartForCheckout()

    fun onBottomSheetFailedAddToCartForCheckout(toasterAnchorView: View, fragmentManager: FragmentManager, globalEvent: GlobalEvent)
