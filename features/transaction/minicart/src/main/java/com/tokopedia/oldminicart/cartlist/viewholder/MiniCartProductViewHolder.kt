...
import com.tokopedia.oldminicart.common.data.response.minicartlist.Action
import com.tokopedia.oldminicart.common.data.response.minicartlist.Action.Companion.ACTION_DELETE
import com.tokopedia.oldminicart.common.data.response.minicartlist.Action.Companion.ACTION_NOTES
import com.tokopedia.oldminicart.common.data.response.minicartlist.Action.Companion.ACTION_SIMILARPRODUCT
...
class MiniCartProductViewHolder(private val viewBinding: ItemOldMiniCartProductBinding,
