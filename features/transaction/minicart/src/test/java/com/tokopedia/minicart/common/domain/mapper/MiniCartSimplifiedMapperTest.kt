...
class MiniCartSimplifiedMapperTest {
    ...
    fun `WHEN map mini cart data with bundle THEN should return bundle`() {
        ...
        assertEquals(1, miniCartSimplifiedData.miniCartItems.size)
        assertEquals(mapOf(
                MiniCartItemKey("123", type = MiniCartItemType.BUNDLE) to MiniCartItem.MiniCartItemBundleGroup(bundleId = "123", bundleGroupId = "123", bundleQuantity = 1, bundleLabelQuantity = 1, bundleMultiplier = 1, products = mapOf(
