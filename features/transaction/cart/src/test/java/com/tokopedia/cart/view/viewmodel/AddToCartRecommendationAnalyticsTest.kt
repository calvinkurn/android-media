...
class AddToCartRecommendationAnalyticsTest : BaseCartViewModelTest() {
    ...
    fun `WHEN generate add to cart data analytics on recommendation there's 1 item selected on non empty cart THEN should be containing 1 product`() {
        ...
        // When
        result = cartViewModel.generateAddToCartEnhanceEcommerceDataLayer(CartRecommendationItemHolderData(false, RecommendationItem()), AddToCartDataModel(), false)
    ...
    fun `WHEN generate add to cart data analytics on recommendation there's 1 item selected on empty cart THEN should be containing 1 product`() {
        ...
        // When
        result = cartViewModel.generateAddToCartEnhanceEcommerceDataLayer(CartRecommendationItemHolderData(false, RecommendationItem()), AddToCartDataModel(), true)
