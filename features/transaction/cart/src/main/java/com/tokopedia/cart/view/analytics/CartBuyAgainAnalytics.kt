...
object CartBuyAgainAnalytics : TransactionAnalytics() {
    ...
    private const val ITEM_LIST_FORMAT = "/cart - rekomendasi untuk anda - %s - %s"
    ...
    fun sendImpressionProductOnBuyAgainWidgetEvent(itemList: String, items: List<Map<String, Any>>, userId: String) {
        val bundle = bundleOf(
            ...
            ConstantTransactionAnalytics.ExtraKey.CURRENT_SITE to ConstantTransactionAnalytics.CustomDimension.DIMENSION_CURRENT_SITE_MARKETPLACE,
            ConstantTransactionAnalytics.ExtraKey.BUSINESS_UNIT to ConstantTransactionAnalytics.CustomDimension.DIMENSION_BUSINESS_UNIT_HOME_BROWSE,
            ...
            ITEM_LIST_KEY to ITEM_LIST_FORMAT.format(CartViewModel.PAGE_NAME_BUY_AGAIN, itemList),
