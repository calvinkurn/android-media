package com.tokopedia.cartrevamp.view.adapter.wishlist
...
import com.tokopedia.cartrevamp.view.viewholder.CartWishlistItemViewHolder
...
class CartWishlistAdapter(val actionListener: ActionListener?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return CartWishlistItemViewHolder(binding, actionListener, parent.context.resources.getDimension(designR.dimen.dp_120).toInt())
    }
