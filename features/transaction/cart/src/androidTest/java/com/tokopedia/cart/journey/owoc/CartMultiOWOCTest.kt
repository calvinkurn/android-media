...
class CartMultiOWOCTest {
    ...
    fun setup() {
        setupGraphqlMockResponse {
            addMockResponse(GET_CART_LIST_KEY, InstrumentationMockHelper.getRawString(context, carttestR.raw.cart_owoc_multi_response), MockModelConfig.FIND_BY_CONTAINS)
        }
    }
