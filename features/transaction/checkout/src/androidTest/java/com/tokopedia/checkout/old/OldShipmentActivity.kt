...
class OldShipmentActivity : BaseCheckoutActivity() {
    private var oldShipmentFragment: OldShipmentFragment? = null
    ...
    override fun getNewFragment(): Fragment? {
        ...
        oldShipmentFragment = OldShipmentFragment.newInstance(isOneClickShipment, leasingId, pageSource, bundle)
