...
public class RatesDataConverter {
    ...
    private boolean isForceInsurance(List<com.tokopedia.checkout.bundle.domain.model.cartshipmentform.Product> products) {
        for (com.tokopedia.checkout.bundle.domain.model.cartshipmentform.Product product : products) {
