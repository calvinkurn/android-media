...
import com.tokopedia.checkout.subfeature.multiple_address.data.model.response.CartList;
import com.tokopedia.checkout.subfeature.multiple_address.data.model.response.CartMultipleAddressDataListResponse;
import com.tokopedia.checkout.subfeature.multiple_address.data.model.response.Shop;
...
import com.tokopedia.checkout.subfeature.multiple_address.domain.model.cartlist.CartTickerErrorData;
import com.tokopedia.checkout.subfeature.multiple_address.domain.model.cartlist.ShopGroupAvailableData;
import com.tokopedia.checkout.subfeature.multiple_address.domain.model.cartlist.WholesalePriceData;
...
public class CartMapper implements ICartMapper {
    ...
    public CartListData convertToCartItemDataList(Context context, CartMultipleAddressDataListResponse cartDataListResponse) {
        ...
        for (CartList data : cartDataListResponse.getCartList()) {
            ...
            if (!TextUtils.isEmpty(data.getProduct().getProductPreorder().getDurationText())) {
            ...
            for (WholesalePrice wholesalePriceDataModel : data.getProduct().getWholesalePrice()) {
