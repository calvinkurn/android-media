...
import com.tokopedia.checkout.old.data.model.response.shipmentaddressform.*
import com.tokopedia.checkout.old.data.model.response.shipmentaddressform.Shop
...
class ShipmentMapper @Inject constructor() {
    ...
    private fun mapGroupShops(groupAddress: com.tokopedia.checkout.old.data.model.response.shipmentaddressform.GroupAddress,
    ...
    private fun mapProducts(groupShop: com.tokopedia.checkout.old.data.model.response.shipmentaddressform.GroupShop,
                            groupAddress: com.tokopedia.checkout.old.data.model.response.shipmentaddressform.GroupAddress,
                            shipmentAddressFormDataResponse: ShipmentAddressFormDataResponse,
    ...
    private fun mapAnalyticsProductCheckoutData(product: com.tokopedia.checkout.old.data.model.response.shipmentaddressform.Product,
                                                userAddress: UserAddress,
                                                groupShop: com.tokopedia.checkout.old.data.model.response.shipmentaddressform.GroupShop,
                                                cod: Cod,
    ...
    private fun mapShopShipments(shopShipment: List<com.tokopedia.checkout.old.data.model.response.shipmentaddressform.ShopShipment>): List<ShopShipment> {
    ...
    private fun mapShipProds(shipProds: List<com.tokopedia.checkout.old.data.model.response.shipmentaddressform.ShipProd>): List<ShipProd> {
    ...
    private fun mapShopData(shop: Shop): com.tokopedia.checkout.old.domain.model.cartshipmentform.Shop {
        return com.tokopedia.checkout.old.domain.model.cartshipmentform.Shop().apply {
            shopId = shop.shopId
    ...
    private fun mapUserAddress(groupAddress: com.tokopedia.checkout.old.data.model.response.shipmentaddressform.GroupAddress): com.tokopedia.logisticCommon.data.entity.address.UserAddress {
