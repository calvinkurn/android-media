...
import com.tokopedia.checkout.bundle.data.model.response.egold.EgoldAttributes
...
data class ShipmentAddressFormDataResponse(
        ...
        @SerializedName("cross_sell_products")
        val crossSellProducts: List<CrossSellProduct> = emptyList(),
