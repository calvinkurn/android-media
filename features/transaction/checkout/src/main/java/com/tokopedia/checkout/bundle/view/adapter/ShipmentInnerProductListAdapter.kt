...
import com.tokopedia.checkout.bundle.view.viewholder.ShipmentCartItemViewHolder.ShipmentItemListener
import com.tokopedia.checkout.bundle.view.viewholder.ShipmentCartItemViewHolder
...
class ShipmentInnerProductListAdapter(private val mCartItemList: List<CartItemModel>, private val mListener: ShipmentItemListener) : RecyclerView.Adapter<ShipmentCartItemViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShipmentCartItemViewHolder {
        ...
        val view = LayoutInflater.from(mContext).inflate(R.layout.item_shipment_product_bundle, parent, false)
