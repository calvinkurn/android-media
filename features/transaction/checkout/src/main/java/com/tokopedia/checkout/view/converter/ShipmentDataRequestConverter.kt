...
class ShipmentDataRequestConverter @Inject constructor(private val _gson: Gson) {
    ...
    fun createCheckoutRequestDataBackup(
        shipmentCartItemModels: List<com.tokopedia.checkout.backup.view.uimodel.CheckoutOrderModel>,
...
//            ) {
            ...
            if (courierItemData != null) {
                ...
                val shopOrders = shipmentCartItemModel.finalCheckoutProductsGroupByOrder.map {
                    ShopOrder(
                        bundle = mapBundleNewBackup(it.value),
                ...
                groupOrder = GroupOrder(
                    ...
                    orderMetadata = mapOrderMetadataBackup(shipmentCartItemModel, selectedShipper, promoRequests),
...
//            }
    ...
    private fun mapBundleNewBackup(cartItemModels: List<com.tokopedia.checkout.backup.view.uimodel.CheckoutProductModel>): List<Bundle> {
        ...
        cartItemModels.forEach {
            if (!bundleIdProductsMap.containsKey(it.bundleId)) {
                val product = mapProductNewBackup(it)
    ...
    private fun mapProductNewBackup(it: com.tokopedia.checkout.backup.view.uimodel.CheckoutProductModel): Product {
    ...
    private fun mapOrderMetadataBackup(
