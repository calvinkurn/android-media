...
import com.tokopedia.checkout.backup.view.widget.CheckoutDropshipWidget.Companion.DROPSHIPPER_MAX_NAME_LENGTH
import com.tokopedia.checkout.backup.view.widget.CheckoutDropshipWidget.Companion.DROPSHIPPER_MAX_PHONE_LENGTH
import com.tokopedia.checkout.backup.view.widget.CheckoutDropshipWidget.Companion.DROPSHIPPER_MIN_NAME_LENGTH
import com.tokopedia.checkout.backup.view.widget.CheckoutDropshipWidget.Companion.DROPSHIPPER_MIN_PHONE_LENGTH
import com.tokopedia.checkout.databinding.ItemCheckoutOrderBackupBinding
import com.tokopedia.coachmark.CoachMark2
import com.tokopedia.coachmark.CoachMark2Item
import com.tokopedia.logisticCommon.data.entity.address.RecipientAddressModel
import com.tokopedia.logisticcart.shipping.features.shippingwidget.backup.BackupShippingCheckoutRevampWidget
...
class CheckoutOrderViewHolder(
    private val binding: ItemCheckoutOrderBackupBinding,
    private val listener: CheckoutAdapterListener
) : RecyclerView.ViewHolder(binding.root),
    BackupShippingCheckoutRevampWidget.ShippingWidgetListener,
    ...
    override fun onInsuranceChecked(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
        order?.let {
