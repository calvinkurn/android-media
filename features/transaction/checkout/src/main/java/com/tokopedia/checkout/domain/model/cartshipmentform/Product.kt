...
import com.tokopedia.purchase_platform.common.feature.bmgm.data.response.BmGmTierProductGroup
...
data class Product(
    ...
    var bmgmTierProductGroup: List<BmGmTierProductGroup> = emptyList(),
