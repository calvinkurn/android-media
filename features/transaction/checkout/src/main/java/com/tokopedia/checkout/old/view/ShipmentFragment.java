...
import com.tokopedia.checkout.old.analytics.CheckoutEgoldAnalytics;
import com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics;
import com.tokopedia.checkout.old.analytics.CornerAnalytics;
...
import com.tokopedia.checkout.old.subfeature.webview.CheckoutWebViewActivity;
import com.tokopedia.checkout.old.view.CheckoutLogger;
import com.tokopedia.checkout.old.view.ShipmentAdapterActionListener;
import com.tokopedia.checkout.old.view.ShipmentItemDecoration;
import com.tokopedia.checkout.old.view.TradeInInfoBottomsheetHelperKt;
import com.tokopedia.checkout.old.view.adapter.ShipmentAdapter;
import com.tokopedia.checkout.old.view.converter.RatesDataConverter;
import com.tokopedia.checkout.old.view.di.CheckoutModule;
import com.tokopedia.checkout.old.view.di.DaggerCheckoutComponent;
import com.tokopedia.checkout.old.view.dialog.ExpireTimeDialogListener;
import com.tokopedia.checkout.old.view.dialog.ExpiredTimeDialog;
import com.tokopedia.checkout.old.view.helper.CartProtectionInfoBottomSheetHelper;
...
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.EVENT_CATEGORY_SELF_PICKUP_ADDRESS_SELECTION_TRADE_IN;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.EVENT_LABEL_TRADE_IN_CHECKOUT_EE;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.KEY_BUSINESS_UNIT;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.KEY_SCREEN_NAME;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.KEY_USER_ID;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.SCREEN_NAME_DROP_OFF_ADDRESS;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.SCREEN_NAME_NORMAL_ADDRESS;
import static com.tokopedia.checkout.old.analytics.CheckoutTradeInAnalytics.VALUE_TRADE_IN;
...
public class ShipmentFragment extends BaseCheckoutFragment implements ShipmentContract.View,
    ...
    private String getFormattedCurrency(int price) {
        ...
        return CurrencyFormatUtil.INSTANCE.getThousandSeparatorString(price, false, 0).getFormattedString();
    }
