...
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.GroupAddress;
...
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.ProductShipment;
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.ProductShipmentMapping;
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.PurchaseProtectionPlanData;
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.ServiceId;
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.Shop;
import com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.TradeInInfo;
        ...
        if (!mapperUtil.isEmpty(shipmentAddressFormDataResponse.getGroupAddress())) {
            ...
            for (com.tokopedia.transactiondata.entity.response.shippingaddressform.GroupAddress
                ...
                if (groupAddress.getUserAddress() != null) {
                    com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.UserAddress userAddressResult =
                            new com.tokopedia.purchase_platform.checkout.domain.model.cartshipmentform.UserAddress();
