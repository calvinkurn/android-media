...
class TotalBenefitBottomSheetViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    private var totalBenefitLabel: TextView = itemView.findViewById(R.id.tv_total_benefit_label)
    private var totalBenefitAmount: TextView = itemView.findViewById(R.id.tv_total_benefit_amount)
