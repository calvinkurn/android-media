...
class GetPreferenceListUseCase @Inject constructor(@ApplicationContext val context: Context, val graphql: GraphqlUseCase<Response>, val preferenceListModelMapper: PreferenceListModelMapper) : UseCase<PreferenceListResponseModel>() {
