...
class SummaryUiModel(
    ...
    companion object CREATOR : Parcelable.Creator<SummaryUiModel> {
        override fun createFromParcel(parcel: Parcel): SummaryUiModel {
            return SummaryUiModel(parcel)
        }

        override fun newArray(size: Int): Array<SummaryUiModel?> {
