...
import com.tokopedia.purchase_platform.features.checkout.data.model.response.shipment_address_form.*
...
import com.tokopedia.purchase_platform.features.express_checkout.data.entity.response.profile.Address
import com.tokopedia.purchase_platform.features.express_checkout.data.entity.response.profile.Payment
import com.tokopedia.purchase_platform.features.express_checkout.data.entity.response.profile.Shipment
...
import com.tokopedia.purchase_platform.features.express_checkout.domain.model.profile.AddressModel
import com.tokopedia.purchase_platform.features.express_checkout.domain.model.profile.PaymentModel
import com.tokopedia.purchase_platform.features.express_checkout.domain.model.profile.ProfileModel
import com.tokopedia.purchase_platform.features.express_checkout.domain.model.profile.ShipmentModel
import com.tokopedia.purchase_platform.common.data.model.response.WholesalePrice
import com.tokopedia.purchase_platform.features.express_checkout.data.entity.response.variant.Child
...
import com.tokopedia.purchase_platform.features.express_checkout.data.entity.response.variant.Variant
...
open class AtcDomainModelMapper @Inject constructor() : AtcDataMapper {
    ...
    private fun getGroupShopModel(groupShop: GroupShop): GroupShopModel {
        ...
        val shopShipmentModels = ArrayList<com.tokopedia.logisticcart.shipping.model.ShopShipment>()
    ...
    private fun getShopShipmentModel(shopShiment: ShopShipment): com.tokopedia.logisticcart.shipping.model.ShopShipment {
        val shopShipment = com.tokopedia.logisticcart.shipping.model.ShopShipment()
        ...
        val shipProds = ArrayList<com.tokopedia.logisticcart.shipping.model.ShipProd>()
    ...
    private fun getShipProdModel(shipProd: ShipProd): com.tokopedia.logisticcart.shipping.model.ShipProd {
        val shipProdModel = com.tokopedia.logisticcart.shipping.model.ShipProd()
