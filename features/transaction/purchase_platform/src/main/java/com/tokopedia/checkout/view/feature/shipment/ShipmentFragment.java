...
import com.tokopedia.purchase_platform.checkout.subfeature.bottomsheetcod.CodBottomSheetFragment;
import com.tokopedia.purchase_platform.common.feature.promo.ClashBottomSheetFragment;
import com.tokopedia.purchase_platform.checkout.subfeature.promo_benefit.TotalBenefitBottomSheetFragment;
...
//                shipmentAdapter.setPickupPoint(pickupBooth);
    ...
    public void onRemovePromoCode(String promoCode) {
        ...
        shipmentPresenter.cancelAutoApplyPromoStack(INDEX_PROMO_GLOBAL, promoCodes, false);
    }
