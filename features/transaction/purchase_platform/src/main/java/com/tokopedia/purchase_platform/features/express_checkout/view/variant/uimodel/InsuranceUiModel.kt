...
data class InsuranceUiModel(
    ...
    companion object CREATOR : Parcelable.Creator<InsuranceUiModel> {
        override fun createFromParcel(parcel: Parcel): InsuranceUiModel {
            return InsuranceUiModel(parcel)
        }

        override fun newArray(size: Int): Array<InsuranceUiModel?> {
