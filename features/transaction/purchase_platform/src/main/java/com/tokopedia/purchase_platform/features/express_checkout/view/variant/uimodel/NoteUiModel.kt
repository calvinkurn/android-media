...
data class NoteUiModel(
    ...
    companion object CREATOR : Parcelable.Creator<NoteUiModel> {
        override fun createFromParcel(parcel: Parcel): NoteUiModel {
            return NoteUiModel(parcel)
        }

        override fun newArray(size: Int): Array<NoteUiModel?> {
