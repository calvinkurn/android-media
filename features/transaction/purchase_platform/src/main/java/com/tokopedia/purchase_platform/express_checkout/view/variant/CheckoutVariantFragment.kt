...
import com.tokopedia.purchase_platform.express_checkout.view.variant.di.DaggerCheckoutVariantComponent
import com.tokopedia.purchase_platform.express_checkout.view.variant.util.isOnboardingStateHasNotShown
import com.tokopedia.purchase_platform.express_checkout.view.variant.util.setOnboardingStateHasNotShown
...
class CheckoutVariantFragment : BaseListFragment<Visitable<*>, CheckoutVariantAdapterTypeFactory>(),
    ...
    override fun showData(viewModels: ArrayList<Visitable<*>>) {
        for (viewModel: Visitable<*> in viewModels) {
            if (viewModel is com.tokopedia.purchase_platform.express_checkout.view.variant.viewmodel.ProfileViewModel) {
