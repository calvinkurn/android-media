...
data class QuantityUiModel(
    ...
    companion object CREATOR : Parcelable.Creator<QuantityUiModel> {
        override fun createFromParcel(parcel: Parcel): QuantityUiModel {
            return QuantityUiModel(parcel)
        }

        override fun newArray(size: Int): Array<QuantityUiModel?> {
