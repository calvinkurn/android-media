...
class CheckoutProfileBottomSheet : BottomSheets(), CheckoutProfileContract.View, CheckoutProfileActionListener {
    ...
    public fun updateArguments(profileViewModel: com.tokopedia.purchase_platform.express_checkout.view.variant.viewmodel.ProfileViewModel?) {
        val bundle = Bundle()
    ...
    override fun setData(data: ArrayList<ProfileViewModel>) {
        val currentSelectedProfile = arguments?.getParcelable(ARGUMENT_DEFAULT_PROFILE_VIEW_MODEL) as com.tokopedia.purchase_platform.express_checkout.view.variant.viewmodel.ProfileViewModel
