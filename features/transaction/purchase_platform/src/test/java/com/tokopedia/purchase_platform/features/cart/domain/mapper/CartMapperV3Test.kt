...
class CartMapperV3Test : Spek({
    ...
    val cartMapperV3 by memoized { CartMapperV3(context, MapperUtil()) }
    ...
    Feature("convert cart data list") {
        ...
        Scenario("available shops with no error") {
            ...
            Then("should contains 1 available & 0 error") {
        ...
        Scenario("error shops with no available") {
            ...
            Then("should contains 0 available & 1 error") {
        ...
        Scenario("available & error shops") {
            ...
            Then("should contains 2 available & 1 error") {
                assertEquals(result.isError, true)
                assertEquals(CartTickerErrorData
                        .Builder()
                        .errorCount(1)
