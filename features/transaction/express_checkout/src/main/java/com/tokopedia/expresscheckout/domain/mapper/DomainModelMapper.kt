...
class DomainModelMapper : DataMapper {
    ...
    override fun convertToExpressCheckoutFormData(expressCheckoutFormDataResponse: ExpressCheckoutFormDataResponse): ExpressCheckoutFormData {
        var expressCheckoutFormData = ExpressCheckoutFormData()

        return expressCheckoutFormData
    }
