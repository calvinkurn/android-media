...
class BottomSheetCleanerWishlist : BottomSheetUnify() {
    private var binding by autoClearedNullable<BottomsheetWishlistStorageCleanerBinding>()
    private var adapterOptionBottomSheet: BottomSheetWishlistCleanerAdapter? = null
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(title: String, desc: String, buttonText: String): BottomSheetCleanerWishlist {
            return BottomSheetCleanerWishlist().apply {
                val bundle = Bundle()
    ...
    fun setAdapter(adapter: BottomSheetWishlistCleanerAdapter) {
