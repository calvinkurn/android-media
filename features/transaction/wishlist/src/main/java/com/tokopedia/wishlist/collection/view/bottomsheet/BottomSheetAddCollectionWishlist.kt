package com.tokopedia.wishlist.collection.view.bottomsheet
...
import com.tokopedia.wishlist.collection.view.fragment.WishlistCollectionHostBottomSheetFragment
...
class BottomSheetAddCollectionWishlist : BottomSheetUnify(), HasComponent<WishlistCollectionComponent> {
    ...
    private fun updateBottomSheet(dataGetBottomSheetCollections: GetWishlistCollectionsBottomSheetResponse.GetWishlistCollectionsBottomsheet.Data) {
    ...
    private fun mapDataCollectionsBottomSheet(data: GetWishlistCollectionsBottomSheetResponse.GetWishlistCollectionsBottomsheet.Data): ArrayList<BottomSheetWishlistCollectionTypeLayoutData> {
