...
object WishlistAnalytics {
    ...
    fun clickProductCard(wishlistItem: WishlistUiModel.Item, userId: String, position: Int) {
    ...
    fun viewProductCard(trackingQueue: TrackingQueue, wishlistItem: WishlistUiModel.Item, userId: String, position: String) {
    ...
    private fun convertOrderItemToDataImpressionObject(wishlistItem: WishlistUiModel.Item, position: String): List<Any> {
        return listOf(
            DataLayer.mapOf(
    ...
    fun clickAtcOnWishlist(wishlistItem: WishlistUiModel.Item, userId: String, position: Int, cartId: String) {
        val arrayWishlistItems = arrayListOf<Bundle>()
        val bundleProduct = Bundle().apply {
