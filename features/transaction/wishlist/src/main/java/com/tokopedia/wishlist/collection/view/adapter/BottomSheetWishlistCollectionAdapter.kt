...
import com.tokopedia.wishlist.collection.view.adapter.viewholder.BottomSheetWishlistCollectionAdditionalItemViewHolder
import com.tokopedia.wishlist.collection.view.adapter.viewholder.BottomSheetWishlistCollectionCreateItemViewHolder
import com.tokopedia.wishlist.collection.view.adapter.viewholder.BottomSheetWishlistCollectionItemViewHolder
import com.tokopedia.wishlist.collection.view.adapter.viewholder.BottomSheetWishlistCollectionMainItemViewHolder
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            LAYOUT_MAIN_SECTION -> {
                ...
                BottomSheetWishlistCollectionMainItemViewHolder(
                    binding
                )
            }
            LAYOUT_ADDITIONAL_SECTION -> {
                ...
                BottomSheetWishlistCollectionAdditionalItemViewHolder(
                    binding
                )
            }
            LAYOUT_COLLECTION_ITEM -> {
                ...
                BottomSheetWishlistCollectionItemViewHolder(
                    binding
                )
            }
            LAYOUT_CREATE_NEW_COLLECTION -> {
                ...
                BottomSheetWishlistCollectionCreateItemViewHolder(
                    binding
                )
            }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (element.typeLayout) {
            ...
            TYPE_COLLECTION_ITEM -> {
                (holder as BottomSheetWishlistCollectionItemViewHolder).bind(element, actionListener, source)
            }
            TYPE_CREATE_NEW_COLLECTION -> {
                (holder as BottomSheetWishlistCollectionCreateItemViewHolder).bind(element, actionListener)
            }
        }
    }
