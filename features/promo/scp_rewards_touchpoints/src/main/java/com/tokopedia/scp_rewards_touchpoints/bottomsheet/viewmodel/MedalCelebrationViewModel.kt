...
class MedalCelebrationViewModel @Inject constructor(
    ...
    private val _badgeLiveData: MutableLiveData<ScpResult<ScpRewardsCelebrationModel>> = MutableLiveData(Loading)
    val badgeLiveData: LiveData<ScpResult<ScpRewardsCelebrationModel>> = _badgeLiveData
