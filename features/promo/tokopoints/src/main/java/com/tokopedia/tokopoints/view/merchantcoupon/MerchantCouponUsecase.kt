...
import com.tokopedia.tokopoints.view.util.CommonConstant.GraphqlVariableKeys.Companion.CATEGORY_ID
...
class MerchantCouponUsecase @Inject constructor(val graphqlRepository: GraphqlRepository) : UseCase<MerchantCouponResponse>() {
    ...
    companion object {
        ...
        fun createParams(page: Int, categoryId: String): Map<String, Any> {
            return mapOf(PAGE to page, PAGESIZE to PAGE_SIZE, CATEGORY_ID to categoryId)
        }
    }
