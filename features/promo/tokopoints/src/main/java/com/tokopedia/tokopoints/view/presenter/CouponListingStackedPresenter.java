...
public class CouponListingStackedPresenter extends BaseDaggerPresenter<CouponListingStackedContract.View>
        implements CouponListingStackedContract.Presenter, CatalogPurchaseRedemptionPresenter {
    private GraphqlUseCase mGetCoupon;
    private GraphqlUseCase mSaveCouponUseCase;
    private int categoryId = 0;

    @Inject
    public CouponListingStackedPresenter(GraphqlUseCase getCoupon, GraphqlUseCase saveCouponUseCase) {
