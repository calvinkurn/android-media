...
class SectionHorizontalCatalogVH(val view: View, val mPresenter: TokoPointsHomeViewModel)
    ...
    fun bind(content: SectionContent) {
        ...
        if (content.layoutCatalogAttr.countdownInfo != null && content.layoutCatalogAttr.countdownInfo?.isShown!!
            ...
            view.findViewById<View>(R.id.text_title_column).layoutParams.width = view.resources.getDimensionPixelOffset(R.dimen.dp_180)
        } else {
            countDownView?.hide()
            view.findViewById<View>(R.id.text_title_column).layoutParams.width = view.resources.getDimensionPixelOffset(R.dimen.dp_280)
        }
