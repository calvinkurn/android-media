...
public class WidgetRewardCrackResult extends FrameLayout implements View.OnClickListener {
    ...
    private void slideDummyTextBottomToUp(int viewType) {
        ...
        for (int i = listLength - 1; i >= 0; i--) {
            ...
            TranslateAnimation translateAnimationCrackResult = new TranslateAnimation(0, 0, 0f, -rlPoints.getHeight() + getResources().getDimensionPixelOffset(com.tokopedia.unifyprinciples.R.dimen.unify_space_12));
    ...
    private void resetView() {
        tvPoints.setTextColor(getResources().getColor(com.tokopedia.unifyprinciples.R.color.Unify_N0));
        tvLoyalty.setTextColor(getResources().getColor(com.tokopedia.unifyprinciples.R.color.Unify_N0));
        tvCoupons.setTextColor(getResources().getColor(com.tokopedia.unifyprinciples.R.color.Unify_N0));
