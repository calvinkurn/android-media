...
public class WidgetEggSourceTapTap extends LinearLayout {

    private ImageView imageEggSource;
    private TextView textEggSource;

    public WidgetEggSourceTapTap(Context context) {
        super(context);
        init();
    }

    public WidgetEggSourceTapTap(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WidgetEggSourceTapTap(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
