...
import com.tokopedia.promocheckout.detail.view.fragment.PromoCheckoutDetailHotelFragment

class PromoCheckoutDetailHotelActivity : BaseSimpleActivity() ,HasComponent<PromoCheckoutDetailComponent>{
    ...
    override fun getNewFragment(): Fragment {
        return PromoCheckoutDetailHotelFragment.createInstance(
                intent?.extras?.getString(BasePromoCheckoutDetailFragment.EXTRA_KUPON_CODE) ?: "",
                intent?.extras?.getString(PromoCheckoutDetailHotelFragment.EXTRA_CART_ID) ?: "",
    ...
    companion object {
        fun newInstance(context: Context?, codeCoupon: String, cartID: String, isUse: Boolean, pageTracking: Int): Intent {
            val intent = Intent(context, PromoCheckoutDetailHotelActivity::class.java)
            val bundle = Bundle()
            bundle.putString(BasePromoCheckoutDetailFragment.EXTRA_KUPON_CODE, codeCoupon)
            bundle.putString(PromoCheckoutDetailHotelFragment.EXTRA_CART_ID, cartID)
