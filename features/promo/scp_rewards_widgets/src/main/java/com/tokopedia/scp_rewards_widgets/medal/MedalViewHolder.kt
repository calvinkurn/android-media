...
class MedalViewHolder(
            ...
            binding.lottieView.loadLottieFromUrl(
                ...
                onLottieLoaded = {
                    lottieView.postDelayed({
                        ivMedal.runAnimation(SCALE_0, SCALE_100, ALPHA_0, ALPHA_100, DURATION_800_MILLIS, OVER_SHOOT)
                        ivCelebrationPlaceholder.fadeIn(ALPHA_100, ALPHA_0, DURATION_800_MILLIS, LINEAR)
                        ivCelebrationPlaceholder.gone()
                        tvMedalTitle.translateAndAlphaText(POSITION_96, POSITION_0, ALPHA_0, ALPHA_100, DURATION_800_MILLIS, OVER_SHOOT)
                        tvMedalSubTitle.translateAndAlphaText(POSITION_96, POSITION_0, ALPHA_0, ALPHA_100, DURATION_800_MILLIS, OVER_SHOOT)
                        tvMedalCaption.translateAndAlphaText(POSITION_95, POSITION_0, ALPHA_0, ALPHA_100, DURATION_800_MILLIS, OVER_SHOOT)
    ...
    private fun View.translateAndAlphaText(fromPosition: Float, toPosition: Float, fromAlpha: Float, toAlpha: Float, duration: Long, interpolatorType: Int) {
        ...
        animateView(animations, duration, interpolatorType)
    }

    private fun View.fadeIn(from: Float, to: Float, duration: Long, interpolatorType: Int) {
        animateView(arrayOf(propertyValueHolder(View.ALPHA, from, to)), duration, interpolatorType)
    }

    private fun View.runAnimation(fromScale: Float, toScale: Float, fromAlpha: Float, toAlpha: Float, duration: Long, interpolatorType: Int) {
        val animations = arrayOf(
