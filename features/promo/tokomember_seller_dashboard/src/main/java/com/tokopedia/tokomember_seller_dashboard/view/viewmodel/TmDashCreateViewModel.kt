...
class TmDashCreateViewModel @Inject constructor(
    ...
    private val _tokomemberCardModifyLiveData =
        MutableLiveData<TokoLiveDataResult<MembershipCreateEditCardResponse>>()
    ...
    private val _tmCouponPreValidateSingleCouponLiveData =
        MutableLiveData<TokoLiveDataResult<TmVoucherValidationPartialResponse>>()
    ...
    private val _tmCouponPreValidateMultipleCouponLiveData =
        MutableLiveData<TokoLiveDataResult<TmVoucherValidationPartialResponse>>()
    ...
    private val _tmCouponUpdateLiveData =
        MutableLiveData<TokoLiveDataResult<TmKuponUpdateMVResponse>>()
    val tmCouponUpdateLiveData: LiveData<TokoLiveDataResult<TmKuponUpdateMVResponse>> =
        _tmCouponUpdateLiveData

    private val _tmProgramValidateLiveData =
        MutableLiveData<TokoLiveDataResult<MemberShipValidateResponse>>()
    val tmProgramValidateLiveData: LiveData<TokoLiveDataResult<MemberShipValidateResponse>> =
        _tmProgramValidateLiveData

    private val _tmCouponInitialLiveData =
        MutableLiveData<TokoLiveDataResult<TmCouponInitialResponse>>()
    val tmCouponInitialLiveData: LiveData<TokoLiveDataResult<TmCouponInitialResponse>> =
        _tmCouponInitialLiveData

    private val _tmCouponDetailLiveData =
        MutableLiveData<TokoLiveDataResult<TmCouponDetailResponseData>>()
    ...
    private val _tmCouponUploadMultipleLiveData =
        MutableLiveData<TokoLiveDataResult<UploadResult>>()
    ...
    val tmProgramResultLiveData: LiveData<TokoLiveDataResult<ProgramDetailData>> =
        _tmProgramResultLiveData

    private val _tokomemberProgramUpdateResultLiveData =
        MutableLiveData<TokoLiveDataResult<ProgramUpdateResponse>>()
    val tokomemberProgramUpdateResultLiveData: LiveData<TokoLiveDataResult<ProgramUpdateResponse>> =
        _tokomemberProgramUpdateResultLiveData
    ...
    fun getCardColorData(cardData: CardData) {
        ...
        tokomemberCardColorMapperUsecase.getCardColorData(cardData, {
            ...
            getCardBackgroundData(
                cardData,
                (it.tokoVisitableCardColor[0] as TokomemberCardColor).id ?: "",
                (it.tokoVisitableCardColor[0] as TokomemberCardColor).tokoCardPatternList
            )
        }, {
    ...
    fun validateProgram(shopId: String, startTime: String, endTime: String, source: String) {
        ...
        tmKuponProgramValidateUsecase.getMembershipValidateInfo({
            ...
            _tmProgramValidateLiveData.postValue(
                TokoLiveDataResult.error(
                    it,
                    ValidateCouponError()
                )
            )
    ...
    fun preValidateCoupon(tmCouponValidateRequest: TmCouponValidateRequest) {
        ...
        tmKuponCreateValidateUsecase.getPartialValidateData({
            ...
            _tmCouponPreValidateSingleCouponLiveData.postValue(
                TokoLiveDataResult.error(
                    it,
                    ValidateVipError()
                )
    ...
    fun preValidateMultipleCoupon(tmCouponValidateRequest: TmCouponValidateRequest) {
        ...
        tmKuponCreateValidateUsecase.getPartialValidateData({
            ...
            _tmCouponPreValidateMultipleCouponLiveData.postValue(
                TokoLiveDataResult.error(
                    it,
                    ValidatePremiumError()
                )
            )
        }, tmCouponValidateRequest)
    }
    ...
    fun uploadImagePremium(image: File) {
        ...
        launchCatchError(dispatcher, block = {
            ...
            _tmCouponUploadMultipleLiveData.postValue(
                TokoLiveDataResult.error(
                    it,
