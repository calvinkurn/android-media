...
class PromoUsageViewModelViewAllClickTest : BasePromoUsageViewModelTest() {

    @Test
    fun onClickViewAllAccordion_expandAll() {
        // given
        ...
        val clickedViewAll = (viewModel.promoPageUiState.value as PromoPageUiState.Success)
            .items.first { it is PromoAccordionViewAllItem } as PromoAccordionViewAllItem
        viewModel.onClickViewAllAccordion(clickedViewAll)
