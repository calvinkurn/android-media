...
class PromoUsageViewModelCheckoutClickTest : BasePromoUsageViewModelTest() {

    @Test
    fun onClickBackToCheckout_successApply() {
        // given
        val code = "CODE1"
        ...
        viewModel.onClickBackToCheckout(entryPoint, validateUseRequest, boPromoCodes, isCartCheckoutRevamp)
    ...
    @Test
    fun onClickBackToCheckout_successApplyWithMvcPromo() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_errorApplyStateRed() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_errorApplyCodeError() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_errorApplyClashing() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_errorApplyUnexpected() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_successClear() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_errorClear() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClickBackToCheckout_successNoAction() {
        // given
