...
class PromoUsageViewModelCloseClickTest : BasePromoUsageViewModelTest() {

    @Test
    fun onClosePromoPage_successApply() {
        // given
        val code = "CODE1"
        ...
        viewModel.onClosePromoPage(entryPoint, validateUseRequest, boPromoCodes, isCartCheckoutRevamp)

        // then
        assert(viewModel.promoPageUiState.value is PromoPageUiState.Success)
        assert(viewModel.closePromoPageUiAction.value is ClosePromoPageUiAction.SuccessWithApplyPromo)
    }

    @Test
    fun onClosePromoPage_successApplyWithMvcPromo() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClosePromoPage_errorApplyStateRed() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
        ...
        // then
        assert(viewModel.promoPageUiState.value is PromoPageUiState.Success)
        assert(viewModel.closePromoPageUiAction.value is ClosePromoPageUiAction.Failed)
    }

    @Test
    fun onClosePromoPage_errorApplyCodeError() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClosePromoPage_errorApplyClashing() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClosePromoPage_errorApplyUnexpected() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClosePromoPage_successClear() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
        ...
        // then
        assert(viewModel.promoPageUiState.value is PromoPageUiState.Success)
        assert(viewModel.closePromoPageUiAction.value is ClosePromoPageUiAction.SuccessWithClearPromo)
    }

    @Test
    fun onClosePromoPage_errorClear() {
        // given
        val code = "CODE1"
        val promoResponse = GetPromoListRecommendationResponse(
            GetPromoListRecommendationResponseData(
    ...
    @Test
    fun onClosePromoPage_successNoAction() {
        // given
        ...
        // then
        assert(viewModel.promoPageUiState.value is PromoPageUiState.Success)
        assert(viewModel.closePromoPageUiAction.value is ClosePromoPageUiAction.SuccessNoAction)
    }
}
