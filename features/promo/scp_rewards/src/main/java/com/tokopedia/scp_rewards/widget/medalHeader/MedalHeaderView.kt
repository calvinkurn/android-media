...
class MedalHeaderView(private val context: Context, attrs: AttributeSet?) : ConstraintLayout(context, attrs) {
    ...
    private fun WidgetMedalHeaderBinding.loadPodium(podiumUrl: String?) {
        ivBadgeBase.loadImage(podiumUrl)
    }
            ...
            onLottieLoaded = {
                ...
                lottieView.apply {
                    ...
                    setTextDelegate(object : TextDelegate(this) {
                        override fun setText(input: String?, output: String?) {
                            setText("Earned by Clara\ron 17 Mar 2023", "Hello World")
                        }
                    })
                }
            },
    ...
    private fun WidgetMedalHeaderBinding.loadBackground(backgroundUrl: String?) {
