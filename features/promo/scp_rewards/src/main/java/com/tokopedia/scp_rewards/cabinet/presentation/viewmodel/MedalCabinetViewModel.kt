...
class MedalCabinetViewModel @Inject constructor(private val userMedaliUseCase: GetUserMedaliUseCase) :
    ViewModel() {
    companion object {
        private const val SUCCESS_CODE = "200"
        private const val DEFAULT_PAGE_SIZE = 6
        private const val EARNED_SECTION_ID = 1
        private const val PROGRESS_SECTION_ID = 2
            ...
            _cabinetLiveData.postValue(
                Success(
                    MedaliCabinetData(
                        ...
                        earnedMedaliData = earnedMedaliRes,
                        progressMedaliData = progressMedaliRes
                    )
                )
            )
        }, onError = {})
    ...
    private fun getPageSize(
        ...
        val json = sectionList[sectionIndex].jsonParameter
