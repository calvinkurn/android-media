...
class CheckPromoStackingFinalCodeMapper @Inject constructor() : Func1<GraphqlResponse, ResponseGetPromoStackUiModel> {
    ...
    override fun call(t: GraphqlResponse?): ResponseGetPromoStackUiModel {
        ...
        response?.let { responseGetPromoStackFirst ->
            responseGetPromoStackFirst.getPromoStackUse.let {
                // Todo : buka lagi kondisi karena di dummy, statusnya string kosong
    ...
    // Todo : balikin state nya ke state seharusnya --> grey hanya untuk test karena data masih dummy
