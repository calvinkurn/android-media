...
class PromoCouponView @JvmOverloads constructor(
    ...
    private var shadowColor = androidx.core.content.ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_GN950)
    ...
    init {
        ...
        bottomPaint.color = androidx.core.content.ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_NN0)
    ...
    private fun configure() {
        when (viewType) {
            VIEW_TYPE_MVC -> {
                ...
                shadowColor = ContextCompat.getColor(context, com.tokopedia.unifyprinciples.R.color.Unify_NN950_44)
            }
        }
    }
