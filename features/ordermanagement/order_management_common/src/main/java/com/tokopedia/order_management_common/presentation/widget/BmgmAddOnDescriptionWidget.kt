package com.tokopedia.order_management_common.presentation.widget
...
class BmgmAddOnDescriptionWidget @JvmOverloads constructor(
    ...
    private fun createDescriptionOnPreDrawListener(): ViewTreeObserver.OnPreDrawListener {
        return ViewTreeObserver.OnPreDrawListener {
            ...
            binding.tvAddOnDescription.viewTreeObserver.removeOnPreDrawListener(
                descriptionOnPreDrawListener
            )
            continueDraw
        }
    }
