...
class OwocSectionGrouplDiffUtilCallback(
    private val oldItems: List<Visitable<OwocSectionGroupTypeFactoryImpl>>,
    private val newItems: List<Visitable<OwocSectionGroupTypeFactoryImpl>>,
    private val typeFactory: OwocSectionGroupTypeFactoryImpl
): DiffUtil.Callback() {
