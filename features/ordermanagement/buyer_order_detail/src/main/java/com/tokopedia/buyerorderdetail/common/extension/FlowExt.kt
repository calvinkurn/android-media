...
fun <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> combine(
    ...
    flow6: Flow<T6>, flow7: Flow<T7>, flow8: Flow<T8>, flow9: Flow<T9>, flow10: Flow<T10>, flow11: Flow<T11>, transform: suspend (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) -> R
    ...
    transform(
        ...
        args[6] as T7, args[7] as T8, args[8] as T9, args[9] as T10, args[10] as T11
    )
}
