...
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.ButtonData;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.CourierServiceModel;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.CourierViewModel;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.ListCourierViewModel;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.OrderDetailData;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.OrderDetailItemData;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.data.ResponseRuntimeException;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.detail.response.Buttons;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.detail.response.OnlineBooking;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.detail.response.OrderDetailResponse;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.detail.response.courierlist.CourierResponse;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.detail.response.courierlist.Shipment;
import com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.history.response.History;
...
public class OrderDetailMapper {
    ...
    public OrderHistoryData getOrderHistoryData(OrderHistoryResponse response) {
        ...
        com.tokopedia.ordermanagement.orderhistory.purchase.detail.model.history.response
