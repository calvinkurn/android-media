...
object InstantLoanUrl {
    ...
    object COMMON_URL{
        ...
        val WEB_LINK_OTP = WEB_DOMAIN + "pinjaman-online/dana-instant/"
        ...
        val LOAN_AMOUNT_QUERY_PARAM = "?loan_amount=%s&loan_period=%s&loan_duration=%s&loan_category=%s&redirect_to=search"
