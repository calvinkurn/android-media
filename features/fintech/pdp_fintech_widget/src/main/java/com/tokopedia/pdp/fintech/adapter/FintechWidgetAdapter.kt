...
class FintechWidgetAdapter(val context: Context, var widgetClickListner: WidgetClickListner) :
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun clickedWidgetData() {
            safeLet(chipsData[adapterPosition].cta?.androidUrl,
            ...
            chipsData[adapterPosition].userStatus){
                url,ctaType,tenure,productName,bottomSheetWidgetDetail,gatewayId,userStatus ->
                widgetClickListner.clickedWidget(
                    ctaType, url, tenure,productName,bottomSheetWidgetDetail, gatewayId,userStatus
                )
            }
        }
