...
public interface DepositCacheInteractor {
    ...
    void setUsableSaldoBalanceCache(GqlSaldoBalanceResponse gqlSaldoBalanceResponse);

    void getUsableSaldoBalanceCache(GetUsableSaldoBalanceCacheListener listener);
