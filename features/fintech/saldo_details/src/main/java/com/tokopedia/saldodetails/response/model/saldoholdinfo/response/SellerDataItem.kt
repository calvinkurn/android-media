...
data class SellerDataItem(
    ...
    companion object CREATOR : Parcelable.Creator<SellerDataItem> {
        override fun createFromParcel(parcel: Parcel): SellerDataItem {
            return SellerDataItem(parcel)
        }

        override fun newArray(size: Int): Array<SellerDataItem?> {
