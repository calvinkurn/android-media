...
public class SaldoDetailsPresenter extends BaseDaggerPresenter<MerchantSaldoPriorityContract.View>
    ...
    public void updateSellerSaldoStatus(boolean isChecked) {
        ...
        setMerchantSaldoStatusUseCase.execute(isChecked, new Subscriber<GraphqlResponse>() {
            ...
            public void onError(Throwable e) {
                ...
                getView().onSaldoStatusUpdateError(ErrorHandler.getErrorMessage(getView().getActivityContext(), e));
            }
