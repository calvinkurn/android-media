...
//
//public class SummaryWithdraw implements Parcelable {
//
...
//    @SerializedName("list")
//    @Expose
//    private List<Deposit> list = new ArrayList<Deposit>();
...
//
//    protected SummaryWithdraw(Parcel in) {
//        endDate = in.readString();
//        paging = in.readParcelable(PagingHandler.PagingHandlerModel.class.getClassLoader());
//        startDate = in.readString();
//        userId = in.readInt();
//        list = in.createTypedArrayList(Deposit.CREATOR);
//        errorDate = in.readInt();
//        warningHoldDeposit = in.readString();
//    }
//
//    public static final Creator<SummaryWithdraw> CREATOR = new Creator<SummaryWithdraw>() {
//        @Override
//        public SummaryWithdraw createFromParcel(Parcel in) {
//            return new SummaryWithdraw(in);
//        }
//
//        @Override
//        public SummaryWithdraw[] newArray(int size) {
//            return new SummaryWithdraw[size];
//        }
//    };
//
//    /**
...
//
//    /**
//     * @param errorDate The error_date
//     */
...
//        parcel.writeInt(errorDate);
//        parcel.writeString(warningHoldDeposit);
//    }
//}
