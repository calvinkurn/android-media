...
class SaldoHoldInfoActivity : BaseSimpleActivity(), HasComponent<SaldoDetailsComponent>, SaldoHoldInfoContract.View {
    ...
    private val performanceInterface by lazy { PageLoadTimePerformanceCallback(
        SALDOHOLD_FINTECH_PLT_PREPARE_METRICS, SALDOHOLD_FINTECH_PLT_NETWORK_METRICS, SALDOHOLD_FINTECH_PLT_RENDER_METRICS
