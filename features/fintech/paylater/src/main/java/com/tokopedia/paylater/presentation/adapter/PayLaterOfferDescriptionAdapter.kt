...
class PayLaterOfferDescriptionAdapter(private val offerItemList: ArrayList<PayLaterPartnerBenefit>) : RecyclerView.Adapter<PayLaterOfferDescriptionViewHolder>() {
