...
class PayLaterOfferDescriptionAdapter(private val offerItemList: List<OfferDescriptionItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        /*return when (viewType) {
            VIEW_HOW_TO_REGISTER_BUTTON -> PayLaterUseViewHolder.getViewHolder(inflater, parent)
            VIEW_SEE_MORE_BUTTON -> PayLaterSeeMoreViewHolder.getViewHolder(inflater, parent)
    ...
    companion object {
        ...
        const val VIEW_HOW_TO_REGISTER_BUTTON = 1
        const val VIEW_SEE_MORE_BUTTON = 2
    }
}