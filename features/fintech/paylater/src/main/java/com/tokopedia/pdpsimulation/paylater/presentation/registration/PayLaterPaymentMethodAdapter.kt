...
class PayLaterPaymentMethodAdapter(
    ...
    private val applicationStatusList: ArrayList<PayLaterApplicationDetail>,
    private val clickListener: (PayLaterItemProductData, PayLaterApplicationDetail?) -> Unit,
    ...
    override fun onBindViewHolder(holder: PayLaterPaymentMethodViewHolder, position: Int) {
        holder.bindData(
            productDataList[position],
            PayLaterPartnerTypeMapper.getPayLaterApplicationDataForPartner(
                productDataList[position],
