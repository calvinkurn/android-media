...
public class ReksaDanaAuthInterceptor extends TkpdAuthInterceptor {


    Context mContext;

    @Inject
    public ReksaDanaAuthInterceptor(Context context, AbstractionRouter abstractionRouter, UserSession userSession) {
