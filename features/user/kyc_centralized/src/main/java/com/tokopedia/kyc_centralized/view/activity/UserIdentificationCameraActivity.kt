...
class UserIdentificationCameraActivity : BaseSimpleActivity() {
    ...
    override fun getNewFragment(): Fragment? {
        return if (viewMode == PARAM_VIEW_MODE_KTP && isUseCropAndCompression()) {
            ...
            UserIdentificationCameraFragment.createInstance(viewMode)
        }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun createIntent(context: Context?, viewMode: Int, useCropping: Boolean = false, useCompression: Boolean = false): Intent {
