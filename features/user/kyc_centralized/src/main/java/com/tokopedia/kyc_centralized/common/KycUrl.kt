 ...
 */
object KycUrl {
    const val KTP_OK = "https://ecs7.tokopedia.net/img/android/others/ktp_ok.png"
    ...
    const val KTP_VERIF_FAIL = "https://ecs7.tokopedia.net/img/android/others/account_verification_ktp_failed_small.png"
    const val FACE_VERIF_OK = "https://ecs7.tokopedia.net/img/android/others/account_verification_liveness_success_small.png"
    const val FACE_VERIF_FAIL = "https://ecs7.tokopedia.net/img/android/others/scan_verification_liveness_failed_small.png"
}