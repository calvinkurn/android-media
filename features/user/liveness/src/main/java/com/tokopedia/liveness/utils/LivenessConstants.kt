...
object LivenessConstants {
    ...
    const val SCAN_FACE_FAIL_TIME = ImageUrl.SCAN_FACE_FAIL_TIME
    const val SCAN_FACE_FAIL_NETWORK = ImageUrl.SCAN_FACE_FAIL_NETWORK

    const val ANIMATION_YAW = ImageUrl.ANIMATION_YAW
    const val ANIMATION_MOUTH = ImageUrl.ANIMATION_MOUTH
    const val ANIMATION_BLINK = ImageUrl.ANIMATION_BLINK
