...
import com.tokopedia.profilecompletion.settingprofile.addphone.viewmodel.NewAddPhoneViewModel
import com.tokopedia.profilecompletion.settingprofile.addpin.viewmodel.AddChangePinViewModel
import com.tokopedia.profilecompletion.settingprofile.changebiousername.viewmodel.ChangeBioUsernameViewModel
...
abstract class ProfileCompletionViewModelsModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(ProfileManagementViewModel::class)
    internal abstract fun profileManagementViewModel(viewModel: ProfileManagementViewModel): ViewModel
