...
import com.tokopedia.profilecompletion.common.ProfileCompletionUtils.getMessageWithoutErrorCode
...
open class AddPinFragment : BaseDaggerFragment() {
    ...
    private fun onErrorAddPin(throwable: Throwable) {
        ...
        trackingPinUtil.trackFailedInputConfirmationPin(errorMessage.getMessageWithoutErrorCode())
        onError(throwable)
        displayInitPin()
    }
    ...
    private fun onErrorCheckPin(throwable: Throwable) {
        val errorMessage = ErrorHandlerSession.getErrorMessage(context, throwable)
        trackingPinUtil.trackFailedInputCreatePin(errorMessage.getMessageWithoutErrorCode())
        onError(throwable)
    }
