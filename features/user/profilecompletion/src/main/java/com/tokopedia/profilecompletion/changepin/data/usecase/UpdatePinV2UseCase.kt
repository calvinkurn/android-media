...
class UpdatePinV2UseCase @Inject constructor(@ApplicationContext val repository: GraphqlRepository, dispatcher: CoroutineDispatcher):
    CoroutineUseCase<ChangePinV2param, UpdatePinV2Response>(dispatcher){
