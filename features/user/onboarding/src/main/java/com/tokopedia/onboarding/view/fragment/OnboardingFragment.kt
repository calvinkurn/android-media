...
class OnboardingFragment : BaseDaggerFragment(), CoroutineScope, IOnBackPressed {
    ...
    companion object {
        const val ONBOARD_IMAGE_PAGE_1_URL = TokopediaImageUrl.ONBOARD_IMAGE_PAGE_1_URL
        const val ONBOARD_IMAGE_PAGE_2_URL = TokopediaImageUrl.ONBOARD_IMAGE_PAGE_2_URL
        const val ONBOARD_IMAGE_PAGE_3_URL = TokopediaImageUrl.ONBOARD_IMAGE_PAGE_3_URL
