 ...
 */
public class ProductAttachmentViewModel extends SendableViewModel implements Visitable<BaseChatTypeFactory> {
    ...
    public ProductAttachmentViewModel(@NotNull String messageId, @NotNull String fromUid, @NotNull String from, @NotNull String fromRole, @NotNull String attachmentId, @NotNull String attachmentType, @NotNull String replyTime, @NotNull String startTime, boolean isRead, boolean isDummy, boolean isSender, @NotNull String message) {
