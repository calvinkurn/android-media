...
public class ImageUploadViewModel extends SendableViewModel implements
    ...
    public ImageUploadViewModel(@NotNull String messageId, @NotNull String fromUid, @NotNull String from, @NotNull String fromRole, @NotNull String attachmentId, @NotNull String attachmentType, @NotNull String replyTime, @NotNull String startTime, boolean isRead, boolean isDummy, boolean isSender, @NotNull String message) {
...
//     * @param startTime    start uploading time in START_TIME_FORMAT {@link SendableViewModel}
//     */
//    public ImageUploadViewModel(String fromUid, String attachmentId,
//                                String fileLoc, String startTime) {
//        super("", fromUid, "", "", attachmentId,
//                AttachmentType.Companion.TYPE_IMAGE_UPLOAD, DummyChatViewModel.SENDING_TEXT,
//                startTime,
//                false, true, true, "");
//        this.isRetry = false;
