package com.tokopedia.otp.common.design;
...
public class PinInputEditText extends EditText {
    ...
    public PinInputEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PinInputEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PinInputEditText, 0, 0);
        try {
            TypedValue outValue = new TypedValue();
            ta.getValue(R.styleable.PinInputEditText_PinInputAnimationType, outValue);
            mAnimatedType = outValue.data;
            mMask = ta.getString(R.styleable.PinInputEditText_PinInputCharacterMask);
            mSingleCharHint = ta.getString(R.styleable.PinInputEditText_PinInputRepeatedHint);
            mLineStroke = ta.getDimension(R.styleable.PinInputEditText_PinInputLineStroke, mLineStroke);
            mLineStrokeSelected = ta.getDimension(R.styleable.PinInputEditText_PinInputLineStrokeSelected, mLineStrokeSelected);
            mSpace = ta.getDimension(R.styleable.PinInputEditText_PinInputCharacterSpacing, mSpace);
            mTextBottomPadding = ta.getDimension(R.styleable.PinInputEditText_PinInputTextBottomPadding, mTextBottomPadding);
            mIsDigitSquare = ta.getBoolean(R.styleable.PinInputEditText_PinInputBackgroundIsSquare, mIsDigitSquare);
            mPinBackground = ta.getDrawable(R.styleable.PinInputEditText_PinInputBackgroundDrawable);
            ColorStateList colors = ta.getColorStateList(R.styleable.PinInputEditText_PinInputLineColors);
            if (colors != null) {
                mColorStates = colors;
            }
        } finally {
    ...
    /**
     * Request focus on this PinInputEditText
     */
    public void focus() {
        requestFocus();
    ...
    private void animatePopIn() {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                PinInputEditText.this.invalidate();
            }
        });
