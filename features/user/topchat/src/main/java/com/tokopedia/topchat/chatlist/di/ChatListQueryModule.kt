...
class ChatListQueryModule {
    ...
    fun provideRawQueryGetChatListMessage(@ApplicationContext context: Context): String =
            GraphqlHelper.loadRawString(context.resources, com.tokopedia.topchat.R.raw.query_get_chat_list_message)
    ...
    fun provideRawQueryDeleteChatListMessage(@ApplicationContext context: Context): String =
            GraphqlHelper.loadRawString(context.resources, com.tokopedia.topchat.R.raw.query_chat_delete)
    ...
    fun provideRawQueryMutationMarkChatAsRead(@ApplicationContext context: Context): String =
            GraphqlHelper.loadRawString(context.resources, com.tokopedia.topchat.R.raw.mutation_chat_mark_read)
    ...
    fun provideRawQueryMutationMarkChatAsUnread(@ApplicationContext context: Context): String =
            GraphqlHelper.loadRawString(context.resources, com.tokopedia.topchat.R.raw.mutation_chat_mark_unread)
    ...
    fun provideRawQueryChatBlastSellerMetaData(@ApplicationContext context: Context): String =
            GraphqlHelper.loadRawString(context.resources, com.tokopedia.topchat.R.raw.query_chat_blast_seller_metadata)
