...
class EditTemplateViewModel @Inject constructor(
    ...
    private val createTemplateUseCase: CreateTemplateUseCaseNew,
    ...
    private val _deleteTemplate = MutableLiveData<Pair<EditTemplateUiModel, Int>>()
    val deleteTemplate: LiveData<Pair<EditTemplateUiModel, Int>>
        get() = _deleteTemplate
