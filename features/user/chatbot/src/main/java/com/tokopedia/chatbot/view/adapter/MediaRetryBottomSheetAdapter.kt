...
import com.tokopedia.chatbot.databinding.RetryUploadMediaBottomSheetItemBinding
...
class MediaRetryBottomSheetAdapter(private val onBottomSheetItemClicked: (position: Int) -> Unit) : RecyclerView.Adapter<MediaRetryBottomSheetAdapter.MediaRetryBottomSheetViewHoder>() {
    ...
    inner class MediaRetryBottomSheetViewHoder(itemView: RetryUploadMediaBottomSheetItemBinding) : RecyclerView.ViewHolder(itemView.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MediaRetryBottomSheetViewHoder {
        val view = RetryUploadMediaBottomSheetItemBinding.inflate(LayoutInflater.from(parent.context),parent, false)
