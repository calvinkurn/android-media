...
class CsatOptionListViewHolder(
    ...
    private val chatActionListSelection: RecyclerView = itemView.findViewById(R.id.chat_csat_option_list_selection)
    private val chatActionBubbleSelectionContainer: CardUnify = itemView.findViewById(R.id.chat_csat_option_list_container)
