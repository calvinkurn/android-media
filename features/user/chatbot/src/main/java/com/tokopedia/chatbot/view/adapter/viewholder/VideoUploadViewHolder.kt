...
import com.tokopedia.chat_common.R.layout.layout_image_upload
...
//CHANEG UploadListener
//open class VideoUploadViewHolder (itemView: View?, private val listener: VideoUploadListener)
...
//    }
//
//    protected open fun bindImageAttachment(element: VideoUploadUiModel) {
//        if (element.isDummy) {
...
//    companion object {
//        @LayoutRes
//        val LAYOUT = layout_image_upload
