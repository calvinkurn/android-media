...
import com.tokopedia.chatbot.chatbot2.attachinvoice.di.AttachInvoiceModule
import com.tokopedia.chatbot.chatbot2.attachinvoice.di.DaggerAttachInvoiceComponent
import com.tokopedia.chatbot.chatbot2.attachinvoice.domain.model.InvoiceConstants
import com.tokopedia.chatbot.chatbot2.attachinvoice.view.adapter.TransactionInvoiceListAdapterTypeFactoryImpl
...
import com.tokopedia.chatbot.chatbot2.attachinvoice.view.viewholder.EmptyViewHolderListener
import com.tokopedia.chatbot.chatbot2.attachinvoice.view.viewholder.TransactionInvoiceViewHolderListener
...
class TransactionInvoiceListFragment :
    BaseListFragment<Visitable<*>, BaseAdapterTypeFactory>(),
    EmptyViewHolderListener,
    TransactionInvoiceViewHolderListener {
    ...
    private fun setTopMargin(recyclerView: RecyclerView?) {
        recyclerView?.setMargin(
            0,
            context?.resources?.getDimension(com.tokopedia.unifyprinciples.R.dimen.spacing_lvl3)?.toInt()
                ?: 0,
            0,
            0
        )
    ...
    override fun onItemClicked(item: Visitable<*>?) {
        if (item is TransactionInvoiceUiModel) {
            val data = Intent()
            data.putExtra(
                com.tokopedia.chatbot.chatbot2.view.ChatbotInternalRouter.Companion
