...
class AttachedInvoiceSelectionViewHolder(
    ...
    private inner class AttachedInvoiceSingleItemViewHolder(itemView: ItemChatbotCarouselInvoiceAttachBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        private fun setStatus(status: String, statusColor: String?, statusId: Long) {
