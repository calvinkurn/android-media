package com.tokopedia.chatbot.chatbot2.view.customview.reply
...
import com.tokopedia.chatbot.view.util.getTextFromHtml
...
class ReplyBubbleAreaMessage : ConstraintLayout {
    ...
    interface Listener {
        ...
        fun showReplyOption(messageUiModel: MessageUiModel, message: TextView? = null)
