...
import com.tokopedia.chatbot.chatbot2.websocket.ChatbotDefaultWebSocketStateHandler
...
class ChatbotModule {
    ...
    @Provides
    internal fun provideChatbotCacheManager(@ApplicationContext context: Context): com.tokopedia.chatbot.chatbot2.data.cache.ChatbotCacheManager {
        val chatbotCacheManager = context.getSharedPreferences("chatbotCache", Context.MODE_PRIVATE)
        return com.tokopedia.chatbot.chatbot2.data.cache.ChatbotCacheManagerImpl(chatbotCacheManager)
    }
