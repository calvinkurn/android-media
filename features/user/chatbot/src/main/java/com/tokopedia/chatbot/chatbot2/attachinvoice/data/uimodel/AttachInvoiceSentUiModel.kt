package com.tokopedia.chatbot.chatbot2.attachinvoice.data.uimodel
...
class AttachInvoiceSentUiModel private constructor(
    ...
    var statusId: Long = builder.statusId
    ...
    class Builder : SendableUiModel.Builder<Builder, AttachInvoiceSentUiModel>() {
        ...
        fun withStatusId(statusId: Long): Builder {
        ...
        override fun build(): AttachInvoiceSentUiModel {
            return AttachInvoiceSentUiModel(
                this
            )
        }
    }
