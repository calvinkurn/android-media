...
//    public static final int LAYOUT = R.layout.item_chat_invoice_attach_selection;
    ...
    public AttachedInvoiceSelectionViewHolder(View itemView, AttachedInvoiceSelectionListener selectedListener) {
        super(itemView);
...
//                    .inflate(R.layout.item_carousel_invoice_attach, parent, false);
        ...
        @Override
        public void onBindViewHolder(@NonNull AttachedInvoiceSingleItemViewHolder holder,
                                     int position) {
