    ...
    const val DYNAMIC_ATTACHMENT_CODE_101_DYNAMIC_CONTENT_NULL = """
{
  ...
  "data": {
    ...
    const val DYNAMIC_ATTACHMENT_CODE_104_MEDIA_BUTTON_TRUE = """
        {
    "code": 103,
    "data": {
        "msg_id": 4058088,
    ...
    const val DYNAMIC_ATTACHMENT_CODE_104_MEDIA_BUTTON_FALSE = """
        {
    "code": 103,
    "data": {
        "msg_id": 4058088,
    ...
    const val DYNAMIC_ATTACHMENT_CODE_104_DYNAMIC_CONTENT_NULL = """
        {
    "code": 103,
    "data": {
        "msg_id": 4058088,
    ...
    const val DYNAMIC_ATTACHMENT_CODE_200 = """
        {
  "code": 103,
  "data": {
    "msg_id": 4058088,
    ...
    const val DYNAMIC_ATTACHMENT_CONTENT_CODE_105 = """
        {
    "code": 103,
    "data": {
        "msg_id": 3181924,
            ...
            "attributes": {
                "dynamic_attachment": {
                    "attribute": {
                        "content_code": 105, 
                        "render_target": "all", 
                        "dynamic_content": "{\"button_action\":{\"action\":\"notifikasi_chat\",\"text\":\"Notifikasi Chat\",\"value\":\"Notifikasi Chat\"},\"text_message\":\"Klik pilihan kendala notifikasi dibawah ini sesuai dengan yang kamu alami, ya.\\n\"}",
                        "user_id": 5480593
                    },
                    "fallback": {
                        "html": "<div>Fallback</div>",
    ...
    const val JSON_NOT_FORMATTED_THROWS_EXCEPTION = """
{
  ...
  "data": { {
    ...
    const val DYNAMIC_ATTACHMENT_110_NEW_CHATBOT_SESSION = """
        {
    "code": 103,
    "data": {
        "msg_id": 3181924,
    ...
    const val DYNAMIC_ATTACHMENT_111_SLOW_MODE = """
        {
    "code": 103,
    "data": {
        "msg_id": 3181924,
        ...
        "attachment": {
            "attributes": {
                "dynamic_attachment": {
                    "attribute": {
                        "content_code": 111,
                        "dynamic_content": "{\"is_using_slow_mode\": true,\"slow_mode_duration_in_seconds\": 3}",
                        "render_target": "all",
                        "user_id": 5480593
                    },
                    "fallback": {
