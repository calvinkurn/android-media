...
object StickyLoginConstant {
    ...
    const val KEY_LAST_SEEN_AT_TOKONOW = "last_seen_at_tokonow"
    ...
    const val KEY_STICKY_LOGIN_WIDGET_TOKONOW = "android_customer_sticky_login_tokonow"
    ...
    const val KEY_STICKY_LOGIN_REMINDER_TOKONOW = "android_customer_sticky_login_reminder_tokonow"
