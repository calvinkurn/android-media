...
import com.tokopedia.verification.common.di.OtpComponentBuilder
...
abstract class BaseOtpActivity : BaseSimpleActivity(), HasComponent<OtpComponent> {
    ...
    override fun getLayoutRes(): Int {
        return com.tokopedia.verification.R.layout.activity_otp
    }

    override fun getParentViewResourceID(): Int {
        return com.tokopedia.verification.R.id.parent_view
    }
