package com.tokopedia.verification.verification.viewmodel
...
import com.tokopedia.verification.common.idling_resource.TkpdIdlingResource
import com.tokopedia.verification.verification.data.OtpConstant
import com.tokopedia.verification.verification.data.OtpConstant.DEFAULT_OTP_BEHAVIOR_ONE
import com.tokopedia.verification.verification.data.OtpConstant.DEFAULT_OTP_BEHAVIOR_THREE
import com.tokopedia.verification.verification.data.OtpConstant.StaticText.SMS_AND_CHANGE_PN_FOOTER_TEXT
import com.tokopedia.verification.verification.data.OtpConstant.StaticText.SPAN_USE_OTHER_METHODS
import com.tokopedia.verification.verification.data.OtpConstant.StaticText.SPAN_USE_SMS_METHOD
import com.tokopedia.verification.verification.data.OtpConstant.StaticText.spanFactory
import com.tokopedia.verification.verification.domain.data.OtpRequestData
import com.tokopedia.verification.verification.domain.data.OtpValidateData
import com.tokopedia.verification.verification.domain.pojo.GetOtpModeListParam
import com.tokopedia.verification.verification.domain.pojo.GetVerificationMethodPhoneRegisterMandatoryParam
import com.tokopedia.verification.verification.domain.pojo.ModeListData
import com.tokopedia.verification.verification.domain.pojo.OtpModeListData
import com.tokopedia.verification.verification.domain.pojo.OtpRequestPhoneRegisterMandatoryParam
import com.tokopedia.verification.verification.domain.pojo.OtpValidatePhoneRegisterMandatoryParam
import com.tokopedia.verification.verification.domain.usecase.GetOtpModeListUseCase
import com.tokopedia.verification.verification.domain.usecase.GetVerificationMethodInactivePhoneUseCase
import com.tokopedia.verification.verification.domain.usecase.GetVerificationMethodPhoneRegisterMandatoryUseCase
...
import com.tokopedia.verification.verification.domain.usecase.InactivePhoneVerificationMethodeParams
import com.tokopedia.verification.verification.domain.usecase.OtpValidatePhoneRegisterMandatoryUseCase
...
import com.tokopedia.verification.verification.domain.usecase.SendOtp2FAUseCase
import com.tokopedia.verification.verification.domain.usecase.SendOtpPhoneRegisterMandatoryUseCase
import com.tokopedia.verification.verification.domain.usecase.SendOtpUseCase
import com.tokopedia.verification.verification.view.uimodel.DefaultOtpUiModel
