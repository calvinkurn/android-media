...
open class LoginEmailPhoneFragment : BaseDaggerFragment(), ScanFingerprintInterface, LoginEmailPhoneContract.View {
    ...
    fun isEnableEncryptRollout(): Boolean {
        val variant = getAbTestPlatform().getString(SessionConstants.Rollout.ROLLOUT_LOGIN_ENCRYPTION)
        return variant == SessionConstants.Rollout.ROLLOUT_LOGIN_ENCRYPTION
    }
