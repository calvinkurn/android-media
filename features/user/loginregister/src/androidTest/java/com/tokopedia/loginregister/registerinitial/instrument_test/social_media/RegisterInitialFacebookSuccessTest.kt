...
@LargeTest
class RegisterInitialFacebookSuccessTest {
    val trackerPath = "tracker/user/loginregister/social_media/loginregister_register_fb_success.json"
    ...
    fun setup() {
        ...
        val mockResponse = hashMapOf<String, Int>(
                Pair(RegisterMockResponse.KEY_LOGIN_TOKEN_CHECK, com.tokopedia.loginregister.test.R.raw.register_facebook),
    ...
    @Test
    fun `check_success_register_facebook_tracker`() {
        checkRegisterFacebookFailed()
    ...
    private fun checkRegisterFacebookFailed() {
        Thread.sleep(1000)
