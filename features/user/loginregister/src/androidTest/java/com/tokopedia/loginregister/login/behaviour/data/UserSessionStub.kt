...
class UserSessionStub: UserSessionInterface {
    ...
    override fun setLoginSession(isLogin: Boolean, userId: String?, fullName: String?, shopId: String?, isMsisdnVerified: Boolean, shopName: String?, email: String?, shopIsGold: Boolean, phoneNumber: String?) {
        TODO("Not yet implemented")
    }
