...
@LargeTest
class RegisterInitialGoogleSuccessTest {
    val trackerPath = "tracker/user/loginregister/social_media/loginregister_register_google_success.json"
    ...
    @Test
    fun `check_success_register_google_tracker`() {
        checkRegisterGoogle()
