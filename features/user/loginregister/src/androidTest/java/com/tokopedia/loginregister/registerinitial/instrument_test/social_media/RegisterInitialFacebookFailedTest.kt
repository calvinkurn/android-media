...
@LargeTest
class RegisterInitialFacebookFailedTest {
    val trackerPath = "tracker/user/loginregister/social_media/loginregister_register_fb_failed.json"
    ...
    fun setup() {
        ...
        val mockResponse = hashMapOf<String, Int>(
                Pair(RegisterMockResponse.KEY_LOGIN_TOKEN_CHECK, com.tokopedia.loginregister.test.R.raw.register_facebook_failed)
        )
