...
public final class RxWebSocket {
     ...
     * @return
     */
    public static Observable<WebSocketInfo> get(String url, String accessToken, long timeout, TimeUnit timeUnit) {
        return RxWebSocketUtil.getInstance().getWebSocketInfo(url, accessToken, timeout, timeUnit);
    }
