    ...
    private View.OnClickListener shareOthers(final String channelType) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (activity.getApplication() instanceof GroupChatModuleRouter) {
                    ((GroupChatModuleRouter) activity.getApplication()).generateBranchLink
                            (shareModel.getId(), shareModel.getName
                                    (), description, shareModel.getImgUri(), urlLink, activity, new
                                    GroupChatModuleRouter.ShareListener() {
                                        @Override
    ...
    private View.OnClickListener shareSMS(final String channelType) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String description = generateShareText(urlLink);
                if (activity.getApplication() instanceof GroupChatModuleRouter) {
                    ((GroupChatModuleRouter) activity.getApplication()).generateBranchLink(shareModel.getId(), shareModel.getName
                            (), description, shareModel.getImgUri(), urlLink, activity, new GroupChatModuleRouter.ShareListener() {
                        @Override
                        public void onGenerateLink(String shareContents, String shareUri) {
