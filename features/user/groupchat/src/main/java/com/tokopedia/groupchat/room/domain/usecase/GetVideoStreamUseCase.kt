 ...
 */
class GetVideoStreamUseCase @Inject constructor(private val channelInfoSource:
                                                   ChannelInfoSource) : UseCase<VideoStreamViewModel>() {

    override fun createObservable(requestParams: RequestParams): Observable<VideoStreamViewModel> {
        return channelInfoSource.getVideoStream(requestParams.getString(
                GetDynamicButtonsUseCase.PARAM_CHANNEL_UUID, ""),
