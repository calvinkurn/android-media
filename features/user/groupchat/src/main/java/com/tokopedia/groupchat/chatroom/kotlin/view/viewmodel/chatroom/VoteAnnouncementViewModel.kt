...
class VoteAnnouncementViewModel : BaseChatViewModel, Visitable<GroupChatTypeFactory>, Parcelable {
    ...
    companion object {
        ...
        val POLLING_START = "polling_start"
        val POLLING_FINISHED = "polling_finish"
        val POLLING_END = "polling_end"
        val POLLING_CANCEL = "polling_cancel"
        val POLLING_UPDATE = "polling_update"
