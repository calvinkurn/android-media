...
public class RxWebSocketUtil {
     ...
     * @return
     */
    public Observable<WebSocketInfo> getWebSocketInfo(final String url, String accessToken, final long timeout, final TimeUnit timeUnit) {
        Observable<WebSocketInfo> observable = observableMap.get(url);
        if (observable == null) {
            observable = Observable.create(new WebSocketOnSubscribe(url, accessToken))
//                    //自动重连
...
//                    .retry()
     ...
     * </p>
     */
    public Observable<WebSocketInfo> getWebSocketInfo(String url, String accessToken) {
        return getWebSocketInfo(url, accessToken, 30, TimeUnit.DAYS);
    }

    public Observable<String> getWebSocketString(String url, String accessToken) {
    ...
    public Observable<ByteString> getWebSocketByteString(String url, String accessToken) {
        return getWebSocketInfo(url, accessToken)
    ...
    public final class WebSocketOnSubscribe implements Observable.OnSubscribe<WebSocketInfo> {
        ...
        public WebSocketOnSubscribe(String url, String accessToken) {
            this.url = url;
