...
public class ProfileModule {
    ...
    public Interceptor provideChuckInterceptory(@ApplicationContext Context context) {
        if (context instanceof ProfileModuleRouter) {
            return ((ProfileModuleRouter) context).getChuckInterceptor();
        }
        throw new RuntimeException("App should implement " + ProfileModuleRouter.class.getSimpleName());
    }
}
