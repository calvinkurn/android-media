...
import static com.tokopedia.profile.analytics.TopProfileAnalytics.Action.CLICK_ON_COMPLETE_NOW;
    ...
    private class ClickProfileCompletion implements OnClickListener {
        ...
        public void onClick(View v) {
            if (getContext().getApplicationContext() instanceof ProfileModuleRouter) {
                Intent intent = ((ProfileModuleRouter) getContext().getApplicationContext()).
                        getProfileCompletionIntent(getContext());
