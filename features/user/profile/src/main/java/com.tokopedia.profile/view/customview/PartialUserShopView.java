...
import static com.tokopedia.profile.analytics.TopProfileAnalytics.Action.CLICK_ON_FAVORITE;
import static com.tokopedia.profile.analytics.TopProfileAnalytics.Action.CLICK_ON_UNFAVORITE;
...
public class PartialUserShopView extends BaseCustomView {
    ...
    private class ClickShopInfo implements OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            if (getContext().getApplicationContext() instanceof ProfileModuleRouter) {
                getContext().startActivity(
                        ((ProfileModuleRouter) getContext().getApplicationContext())
