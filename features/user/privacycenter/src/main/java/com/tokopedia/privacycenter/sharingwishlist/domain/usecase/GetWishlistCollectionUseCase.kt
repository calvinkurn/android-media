...
import com.tokopedia.privacycenter.sharingwishlist.domain.data.GetWishlistCollectionResponse
import com.tokopedia.privacycenter.sharingwishlist.domain.data.GetWishlistCollectionsParams
import com.tokopedia.privacycenter.sharingwishlist.domain.data.WishlistCollectionsParams
...
class GetWishlistCollectionUseCase @Inject constructor(
    ...
    override suspend fun execute(params: Int): SharingWishlistStateResult<WishlistDataModel> {
        ...
        return if (response.status == STATUS_OK && response.errorMessage.isEmpty()) {
