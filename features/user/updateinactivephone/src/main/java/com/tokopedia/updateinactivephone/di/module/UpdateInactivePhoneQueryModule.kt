...
class UpdateInactivePhoneQueryModule {
    ...
    fun provideRawQueryCheckPhoneNumberStatus(@UpdateInActiveContext context: Context): String =
    ...
    fun provideRawQueryValidateUserData(@UpdateInActiveContext context: Context): String =
    ...
    fun provideRawQueryUpdatePhoneEmail(@UpdateInActiveContext context: Context): String =
