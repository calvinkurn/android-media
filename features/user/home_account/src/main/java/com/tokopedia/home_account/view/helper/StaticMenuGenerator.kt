...
class StaticMenuGenerator @Inject constructor(val context: Context) {
    ...
    fun generateUserSettingMenu(): SettingDataView {
        return SettingDataView(context?.getString(R.string.menu_account_section_title_account_setting), mutableListOf(
                ...
                CommonDataView(applink = ApplinkConstInternalGlobal.PAYMENT_SETTING, title = context?.getString(R.string.menu_account_title_instant_payment), body = context?.getString(R.string.menu_account_desc_instant_payment), type = CommonViewHolder.TYPE_DEFAULT, icon = R.drawable.ic_account_card, id = AccountConstants.SettingCode.SETTING_INSTANT_PAYMENT),
                CommonDataView(applink = ApplinkConstInternalMarketplace.PREFERENCE_LIST, title = context?.getString(R.string.menu_account_title_quick_buy), body = context?.getString(R.string.menu_account_desc_quick_buy), type = CommonViewHolder.TYPE_DEFAULT, icon = R.drawable.ic_account_quick_buy, id = AccountConstants.SettingCode.SETTING_INSTANT_BUY),
                ...
                CommonDataView(applink = ApplinkConstInternalGlobal.PAYMENT_SETTING, title = context?.getString(R.string.menu_account_title_instant_payment), body = context?.getString(R.string.menu_account_desc_instant_payment), type = CommonViewHolder.TYPE_DEFAULT, icon = IconUnify.CARD),
