...
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.ABOUT_US
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.ACCOUNT
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.ADVANCED_SETTING
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.APPLICATION_REVIEW
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.DEVELOPER_OPTIONS
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.HELP_CENTER
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.LOGOUT
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.NOTIFICATION
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.PAYMENT_METHOD
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.PRIVACY_POLICY
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.SAFE_MODE
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.SHAKE_SHAKE
import com.tokopedia.home_account.account_settings.AccountConstants.Analytics.TERM_CONDITION
...
import com.tokopedia.home_account.account_settings.constant.SettingConstant.Url.PATH_CHECKOUT_TEMPLATE
import com.tokopedia.home_account.account_settings.data.util.NotifPreference
import com.tokopedia.home_account.account_settings.di.component.DaggerAccountLogoutComponent
...
import com.tokopedia.home_account.account_settings.presentation.listener.SettingOptionsView
...
class GeneralSettingFragment : BaseGeneralSettingFragment(), RedDotGimmickView, GeneralSettingAdapter.SwitchSettingListener, SettingOptionsView {
    ...
    override fun getSettingItems(): List<SettingItemViewModel> {
        ...
        if (GlobalConfig.isAllowDebuggingTools()) {
            settingItems.add(SettingItemViewModel(SettingConstant.SETTING_DEV_OPTIONS,
                    getString(R.string.menu_account_title_dev_options)))
        }

        val itemOut = SettingItemViewModel(SettingConstant.SETTING_OUT_ID, getString(R.string.new_home_account_button_logout))
    ...
    private fun showDialogLogout() {
        if(activity != null) {
            val dialog = DialogUnify(requireActivity(), DialogUnify.VERTICAL_ACTION, DialogUnify.NO_IMAGE)
    ...
    private fun createAndShowLocationAlertDialog(currentValue: Boolean) {
        ...
        builder.setMessage(R.string.new_home_account_batal_geolocation_alertdialog)
        builder.setPositiveButton(R.string.new_home_account_ok_geolocation_alertdialog) { dialog, id -> goToApplicationDetailActivity() }
        builder.setNegativeButton(R.string.new_home_account_batal_geolocation_alertdialog) { dialog, id -> }
