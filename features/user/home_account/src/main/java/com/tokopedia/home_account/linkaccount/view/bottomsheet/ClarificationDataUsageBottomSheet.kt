...
import com.tokopedia.home_account.databinding.LayoutBottomSheetClarificationDataUsageBinding
...
class ClarificationDataUsageBottomSheet : BottomSheetUnify() {
    ...
    override fun onCreateView(
        ...
        _binding = LayoutBottomSheetClarificationDataUsageBinding.inflate(inflater, container, false)
