...
class EmptySearchBankViewHolder(val v: View) :
    ...
    companion object {
        val LAYOUT = R.layout.empty_search_result
    }

    private val titleText: TextView = itemView.findViewById(R.id.empty_search_result_title)
    private val contentText: TextView = itemView.findViewById(R.id.empty_search_result_content)
