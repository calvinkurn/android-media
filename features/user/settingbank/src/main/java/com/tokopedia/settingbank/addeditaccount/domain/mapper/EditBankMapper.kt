...
class EditBankMapper : Func1<Response<EditBankAccountPojo>, String> {

    override fun call(response: Response<EditBankAccountPojo>): String {
        var messageError: String

        if (response.isSuccessful) {

            val pojo: EditBankAccountPojo = response.body().copy()
