...
public class PhoneVerificationInterceptor extends TkpdAuthInterceptor {
    ...
    public PhoneVerificationInterceptor(Context context, NetworkRouter networkRouter, UserSession userSession) {
        super(context, networkRouter, userSession);
    }

    public PhoneVerificationInterceptor(Context context, NetworkRouter networkRouter, UserSession userSession, String authKey) {
