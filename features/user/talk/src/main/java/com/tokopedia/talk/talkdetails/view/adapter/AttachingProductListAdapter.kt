...
class AttachedProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    val image = itemView.findViewById<ImageView>(com.tokopedia.talk.R.id.attach_product_chat_image)
    val name = itemView.findViewById<TextView>(com.tokopedia.talk.R.id.attach_product_chat_name)
    val price = itemView.findViewById<TextView>(com.tokopedia.talk.R.id.attach_product_chat_price)
    val deleteButton = itemView.findViewById<ImageView>(com.tokopedia.talk.R.id.delete_button)
