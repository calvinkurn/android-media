 ...
 */
class GetTalkCommentsMapper: Func1<Response<DataResponse<String>>, TalkDetailsViewModel> {
    override fun call(t: Response<DataResponse<String>>?): TalkDetailsViewModel {
