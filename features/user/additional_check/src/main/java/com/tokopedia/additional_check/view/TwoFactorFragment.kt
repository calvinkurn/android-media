...
class TwoFactorFragment: BaseDaggerFragment() {
    ...
    companion object {
        ...
        private const val PIN_ONBOARDING_IMG = ImageUrl.PIN_ONBOARDING_IMG
        private const val PHONE_ONBOARDING_IMG = ImageUrl.PHONE_ONBOARDING_IMG
        private const val PIN_SUCCESS_IMG = ImageUrl.PIN_SUCCESS_IMG
