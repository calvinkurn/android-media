...
object InfiniteRecomTracker : BaseTrackerConst() {
    ...
    private const val KEY_PAGE_SOURCE = "product_id"
    ...
    fun eventRecomItemImpression(recomItem: RecommendationItem, userId: String): Map<String, Any> {
        ...
        trackerBuilder.appendCustomKeyValue(KEY_PAGE_SOURCE, String.format(VALUE_PAGE_SOURCE, "infinite recom", recomItem.recommendationType))
    ...
    fun eventClickRecomAddToCart(recomItem: RecommendationItem, userId: String, quantity: Int): Map<String, Any> {
        ...
        trackerBuilder.appendCustomKeyValue(RecomTokonow.KEY_EVENT_PAGE_SOURCE, String.format(VALUE_PAGE_SOURCE, "infinite recom", recomItem.recommendationType))
