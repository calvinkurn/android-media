...
class RecommendationPageTracking {
    ...
    val EVENT_CATEGORY_RECOMMENDATION_PAGE = "productDetailData page"

    val EVENT_ACTION_CLICK_PRODUCT_RECOMMENDATION_LOGIN = "click - product productDetailData"
    val EVENT_ACTION_CLICK_PRODUCT_RECOMMENDATION_NON_LOGIN = "click - product productDetailData - non login"
    val EVENT_CLICK_PRODUCT_ON_HEADER_LOGIN = "click product productDetailData on %s"
    val EVENT_CLICK_PRODUCT_ON_HEADER_NON_LOGIN = "click product productDetailData on %s - non login"
    val EVENT_ACTION_IMPRESSION_PRODUCT_ON_HEADER = "impression product productDetailData on %s - non login"
    val EVENT_ACTION_IMPRESSION_PRODUCT_ON_HEADER_LOGIN = "impression product productDetailData on %s"

    val EVENT_ACTION_IMPRESSION_PRODUCT_RECOMMENDATION_LOGIN = "impression - product productDetailData"
    val EVENT_ACTION_IMPRESSION_PRODUCT_RECOMMENDATION_NON_LOGIN = "impression - product productDetailData - non login"
    val EVENT_ACTION_ADD_WISHLIST_ON_PRODUCT_RECOMMENDATION_LOGIN = "add - wishlist on product productDetailData"
    val EVENT_ACTION_REMOVE_WISHLIST_ON_PRODUCT_RECOMMENDATION_LOGIN = "remove - wishlist on product productDetailData"
    val EVENT_ACTION_ADD_WISHLIST_ON_PRODUCT_RECOMMENDATION_NON_LOGIN = "add - wishlist on product productDetailData - non login"
