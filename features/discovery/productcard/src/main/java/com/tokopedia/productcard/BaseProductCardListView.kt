...
abstract class BaseProductCardListView: BaseCustomView, IProductCardView {
    ...
    abstract val buttonAddVariant: UnifyButton?
    abstract val buttonNotify: UnifyButton?
    ...
    abstract val buttonAddToCartWishlist: UnifyButton?
    abstract val buttonSeeSimilarProductWishlist: UnifyButton?
