...
class ProductCardListView: ProductConstraintLayout, IProductCardView {
    ...
    constructor(context: Context) : super(context) {
        productCardStrategy = ProductCardStrategyFactory.listStrategy(this)
    ...
    fun setDeleteProductOnClickListener(deleteProductClickListener: (View) -> Unit) {
        productCardStrategy.setDeleteProductOnClickListener(deleteProductClickListener)
    }

    fun setRemoveWishlistOnClickListener(removeWishlistClickListener: (View) -> Unit) {
        productCardStrategy.setRemoveWishlistOnClickListener(removeWishlistClickListener)
    }
