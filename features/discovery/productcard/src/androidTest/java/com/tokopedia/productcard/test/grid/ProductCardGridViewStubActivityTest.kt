...
internal class ProductCardGridViewStubActivityTest: AppCompatActivity() {
    ...
    class Adapter: RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.product_card_grid_item_viewstub_test_layout, null)

            return ViewHolder(view)
        }

        override fun getItemCount(): Int {
            return productCardGridViewStubTestData.size
        }

        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            holder.bind(productCardGridViewStubTestData[position].productCardModel)
        }
