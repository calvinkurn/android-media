...
internal class ProductCardListViewStubActivityTest: AppCompatActivity() {
    ...
    class Adapter: RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.product_card_list_item_viewstub_test_layout, null)
