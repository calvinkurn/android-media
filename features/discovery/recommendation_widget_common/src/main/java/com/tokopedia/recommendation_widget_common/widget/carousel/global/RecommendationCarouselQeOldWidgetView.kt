...
import com.tokopedia.recommendation_widget_common.databinding.RecommendationWidgetCarouselLayoutQeOldBinding
...
@RecomTemporary
class RecommendationCarouselQeOldWidgetView : ConstraintLayout,
    ...
    private val binding: RecommendationWidgetCarouselLayoutQeOldBinding by lazyThreadSafetyNone {
        RecommendationWidgetCarouselLayoutQeOldBinding.inflate(LayoutInflater.from(context), this)
    }
            ...
            override fun onItemImpressed(
                ...
                if (productCardModel.isTopAds) {
                    TopAdsUrlHitter(context).hitImpressionUrl(
                        this@RecommendationCarouselQeOldWidgetView::class.java.simpleName,
    ...
    companion object {
        val LAYOUT = R.layout.recommendation_widget_carousel_layout_qe_old
    }
}
