...
interface ComparisonBpcAnalyticListener {
    fun onProductCardImpressed(recommendationItem: RecommendationItem, trackingModel: RecommendationWidgetTrackingModel, anchorProductId: String) { }
    ...
    fun onViewAllCardClicked(trackingModel: RecommendationWidgetTrackingModel) { }
}
