...
class OfficialStoreRecommendationEntityMapper : Func1<List<OfficialStoreRecommendationEntity.RecomendationData>,
        List<RecommendationWidget>> {

    override fun call(recommendations: List<OfficialStoreRecommendationEntity.RecomendationData>): List<RecommendationWidget> {
        throwIfNull(recommendations, OfficialStoreRecommendationEntityMapper::class.java)
    ...
    companion object {
        ...
        private fun convertToRecommendationWidget(recomendationData: OfficialStoreRecommendationEntity.RecomendationData): RecommendationWidget {
        ...
        private fun convertToRecommendationItem(
                data: OfficialStoreRecommendationEntity.Recommendation,
                title: String,
                pageName: String,
                position: Int,
        ...
        private fun isLabelDiscountVisible(productItem: OfficialStoreRecommendationEntity.Recommendation): Boolean {
