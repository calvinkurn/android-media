...
public class RecomendationEntity {
    ...
    public static class ProductRecommendationWidget {
        @SerializedName("data")
        private List<RecomendationData> data;

        public List<RecomendationData> getData() {
            return data;
        }

        public void setData(List<RecomendationData> data) {
            this.data = data;
        }
    ...
    public static class RecomendationData {
