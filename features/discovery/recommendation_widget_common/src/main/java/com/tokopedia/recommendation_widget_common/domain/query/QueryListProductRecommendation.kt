...
object QueryListProductRecommendation {
    ...
    const val LIST_PRODUCT_RECOMMENDATION_QUERY: String = "" +
        "query productRecommendation(${'$'}userID: Int!, ${'$'}pageName: String!, ${'$'}pageNumber: Int!, ${'$'}xDevice: String!, ${'$'}xSource: String!, ${'$'}queryParam: String!, ${'$'}productIDs: String!, ${'$'}categoryIDs: String!, ${'$'}keywords: [String!]!, ${'$'}tokoNow: Boolean, ${'$'}shopIDs: String, ${'$'}productCardVersion: Int, ${'$'}currentSessionID: String!, ${'$'}enterFrom: String!, ${'$'}sourcePageType: String!) {\n" +
