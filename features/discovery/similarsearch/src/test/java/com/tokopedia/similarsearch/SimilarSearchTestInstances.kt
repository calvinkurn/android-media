...
private val similarProductModelJSONString = """
{
...
internal val similarProductModel = Gson().fromJson(similarProductModelJSONString, SimilarProductModel::class.java)

private val similarProductModelOnePageString = """
{
    "similar_products_image_search": {
      "data": {
        "products": [
...
internal val similarProductModelOnePage = Gson().fromJson(similarProductModelOnePageString, SimilarProductModel::class.java)