...
private val similarProductModelCommonJSONString = """
{
...
internal fun getSimilarProductModelCommon() = Gson().fromJson(similarProductModelCommonJSONString, SimilarProductModel::class.java)