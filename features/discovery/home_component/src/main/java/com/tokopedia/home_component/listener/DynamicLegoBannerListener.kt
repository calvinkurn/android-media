...
interface DynamicLegoBannerListener {
    ...
    fun onClickGridSixImage(channelModel: ChannelModel, position: Int, parentPosition: Int)
    fun onClickGridFourImage(channelModel: ChannelModel, position: Int, parentPosition: Int)
    fun onClickGridThreeImage(channelModel: ChannelModel, position: Int, parentPosition: Int)
}