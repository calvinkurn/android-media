...
class ShopFlashSaleShimmerViewHolder(
    itemView: View
): AbstractViewHolder<ShopFlashSaleItemShimmerDataModel>(itemView) {
    companion object {
        @LayoutRes
        val LAYOUT = com.tokopedia.home_component.R.layout.home_component_product_card_grid_shimmer
    }

    override fun bind(tab: ShopFlashSaleItemShimmerDataModel) {
