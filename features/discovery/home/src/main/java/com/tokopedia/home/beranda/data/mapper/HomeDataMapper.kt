...
class HomeDataMapper(
    ...
    fun mapToHomeRevampViewModel(homeData: HomeData?, isCache: Boolean, addShimmeringChannel: Boolean = false, haveCachedData: Boolean = false): HomeDynamicChannelModel {
