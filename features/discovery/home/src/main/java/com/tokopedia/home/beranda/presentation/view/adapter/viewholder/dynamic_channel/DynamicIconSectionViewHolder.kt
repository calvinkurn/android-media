...
class DynamicIconSectionViewHolder(val view: View,
    ...
    override fun bind(element: DynamicIconSectionViewModel) {
        HomeTrackingUtils.homeUsedCaseImpression(itemView.context, element.itemList)
        val recyclerView = itemView.findViewById<RecyclerView>(R.id.list)
        val adapter = DynamicIconAdapter(listener, element)
    ...
    private class DynamicIconAdapter(private val listener: HomeCategoryListener,
                                     private val sectionViewModel: DynamicIconSectionViewModel) : RecyclerView.Adapter<DynamicIconViewHolder>() {
