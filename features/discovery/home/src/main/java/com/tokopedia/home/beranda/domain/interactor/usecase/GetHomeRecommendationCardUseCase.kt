...
const val GET_HOME_RECOMMENDATION_CARD_QUERY = """
    query GetHomeRecommendationCard(${'$'}productPage: Int!, ${'$'}layouts: String!, ${'$'}param: String!, ${'$'}location: String!, , ${'$'}productCardVersion: String!, ${'$'}bytedanceSessionID: String!, ${'$'}refreshType: String!) {
