...
import com.tokopedia.home.beranda.helper.glide.GlideErrorLogHelperKt;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        stickyLoginView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getActivity() != null) {
                    GlideErrorLogHelperKt.logError(getActivity(), new GlideException("tes glide error production"), "https://ecs7.tokopedia.net/");
                }
            }
        });
