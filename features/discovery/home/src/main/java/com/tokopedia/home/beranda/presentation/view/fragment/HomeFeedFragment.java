...
////                getAdapter().getDataSize() > position && getAdapter().getData().get(position) instanceof HomeRecommendationItemDataModel) {
////            HomeRecommendationItemDataModel model = (HomeRecommendationItemDataModel) getAdapter().getData().get(position);
...
//
//    @Override
//    public void onProductImpression(HomeRecommendationItemDataModel model, int position) {
//        if (model.getProduct().isTopads()) {
//            new ImpresionTask().execute(model.getProduct().getTrackerImageUrl());
...
//
//    @Override
//    public void onProductThreeDotsClick(@NotNull HomeRecommendationItemDataModel homeRecommendationItemDataModel, int position) {
...
//    }
//
//    private ProductCardOptionsModel createProductCardOptionsModel(@NotNull HomeRecommendationItemDataModel homeRecommendationItemDataModel, int position) {
//        ProductCardOptionsModel productCardOptionsModel = new ProductCardOptionsModel();
//
//        productCardOptionsModel.setHasWishlist(true);
//        productCardOptionsModel.setWishlisted(homeRecommendationItemDataModel.getProduct().isWishlist());
//        productCardOptionsModel.setProductId(homeRecommendationItemDataModel.getProduct().getId());
//        productCardOptionsModel.setTopAds(homeRecommendationItemDataModel.getProduct().isTopads());
//        productCardOptionsModel.setTopAdsWishlistUrl(homeRecommendationItemDataModel.getProduct().getWishlistUrl());
...
//
//    @Override
//    public void onProductClick(HomeRecommendationItemDataModel homeRecommendationItemDataModel, int position) {
//        if (userSession.isLoggedIn()) {
//            if (!homeRecommendationItemDataModel.getProduct().isTopads()) {
...
//                ));
//            } else {
//                new ImpresionTask().execute(homeRecommendationItemDataModel.getProduct().getClickUrl());
...
//            }
//        }
//        goToProductDetail(homeRecommendationItemDataModel.getProduct().getId(), position);
//    }
//
//    @Override
//    public void onPause() {
