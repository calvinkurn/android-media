...
public class ThreeGridChannelViewHolder extends AbstractViewHolder<DynamicChannelViewModel> {
    @LayoutRes
    public static final int LAYOUT = R.layout.home_three_grid_channel;
    ...
    public ThreeGridChannelViewHolder(View itemView,
