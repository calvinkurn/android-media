...
class HomeBalanceWidgetAtf1UseCase @Inject constructor(
    ...
    suspend fun onGetBalanceWidgetData(previousHeaderDataModel: HomeHeaderAtf1DataModel? = null): HomeHeaderAtf1DataModel {
        val homeHeaderAtf1DataModel = HomeHeaderAtf1DataModel()
        if (!userSession.isLoggedIn) return homeHeaderAtf1DataModel
        ...
        try {
            ...
            if (getHomeBalanceWidget.getHomeBalanceList.error.isNotBlank()) {
                ...
                homeHeaderAtf1DataModel.headerDataModel?.homeBalanceModel?.balanceDrawerItemModels?.clear()
                var homeBalanceModel = getHomeBalanceModel(homeHeaderAtf1DataModel)
                ...
                return homeHeaderAtf1DataModel.copy(
                    headerDataModel = homeHeaderAtf1DataModel.headerDataModel?.copy(
            ...
            homeHeaderAtf1DataModel.headerDataModel?.homeBalanceModel?.status = HomeBalanceModel.STATUS_ERROR
            homeHeaderAtf1DataModel.headerDataModel?.isUserLogin = userSession.isLoggedIn
            return homeHeaderAtf1DataModel
        }
    }

    private fun getHomeBalanceModel(currentHeaderDataModel: HomeHeaderAtf1DataModel): HomeBalanceModel {
    ...
    suspend fun onGetTokopointData(
        currentHeaderDataModel: HomeHeaderAtf1DataModel,
        position: Int,
        headerTitle: String
    ): HomeHeaderAtf1DataModel {
    ...
    fun onGetBalanceWidgetLoadingState(currentHeaderDataModel: HomeHeaderAtf1DataModel): HomeHeaderAtf1DataModel {
