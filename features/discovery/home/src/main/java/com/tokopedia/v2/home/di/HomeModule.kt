...
class HomeModule {
    ...
    @HomeScope
    @Provides
    fun provideHomeRepository(homeDao: HomeDao, homeRemoteDataSource: HomeRemoteDataSource, walletRemoteDataSource: WalletRemoteDataSource): HomeRepository = HomeRepositoryImpl(homeDao, homeRemoteDataSource, walletRemoteDataSource)
}