...
object MixLeftComponentTracking : BaseTrackerConst() {
    ...
    private const val CLICK_MIX_LEFT_LOADMORE_CARD = "click view all recommendationCard on dynamic channel left carousel"
    ...
    fun getMixLeftProductView(channel: ChannelModel, grid: ChannelGrid, position: Int, positionOnHome: Int, userId: String): Map<String, Any> {
