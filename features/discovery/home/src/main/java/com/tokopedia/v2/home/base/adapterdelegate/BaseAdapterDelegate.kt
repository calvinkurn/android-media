...
abstract class BaseAdapterDelegate : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
     ...
     */
    val items: ArrayList<ModelViewType> = ArrayList()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return delegateAdapters.get(viewType)?.onCreateViewHolder(parent) ?: throw IllegalStateException("viewType is defined, but does not exist on adapter delegates")
    }
