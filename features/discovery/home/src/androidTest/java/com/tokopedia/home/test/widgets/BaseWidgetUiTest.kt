...
abstract class BaseWidgetUiTest{
    ...
    open val playBannerUseCase = mockk<Lazy<GetPlayWidgetUseCase>>(relaxed = true)
    open val playToggleReminderUseCase = mockk<Lazy<PlayToggleChannelReminderUseCase>>(relaxed = true)
