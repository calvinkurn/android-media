...
class PlayBannerUITest : BaseWidgetUiTest(){
    ...
    override val playBannerUseCase = mockk<Lazy<GetPlayWidgetUseCase>>(relaxed = true)
    override val playToggleReminderUseCase = mockk<Lazy<PlayToggleChannelReminderUseCase>>(relaxed = true)
...
//    }
    ...
    override fun reInitViewModel() = HomeViewModel(
            ...
            getPlayBannerUseCase = playBannerUseCase,
            playToggleChannelReminderUseCase = playToggleReminderUseCase
    )
}