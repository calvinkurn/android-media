...
fun TopAdsImageViewUseCase.givenDataReturn(data: ArrayList<TopAdsImageUiModel>) {
    coEvery { getImageData(any()) } returns data
}

fun TopAdsImageViewUseCase.givenDataReturn(data: ArrayList<TopAdsImageUiModel>, secondData: ArrayList<TopAdsImageUiModel>) {
    coEvery { getImageData(any()) } returns data andThen secondData
}

fun TopAdsImageViewUseCase.givenDataReturnAndThenThrows(data: ArrayList<TopAdsImageUiModel>) {
