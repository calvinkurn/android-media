...
import com.tokopedia.topads.sdk.old.view.adapter.DynamicFeedShopAdapter.DynamicFeedShopViewHolder
...
class DynamicFeedShopAdapter(private val itemClickListener: LocalAdsClickListener) : RecyclerView.Adapter<DynamicFeedShopViewHolder>() {
    ...
    inner class DynamicFeedShopViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val imageLoader: com.tokopedia.topads.sdk.utils.ImageLoader = com.tokopedia.topads.sdk.utils.ImageLoader(itemView.context)
        ...
        internal fun onViewRecycled() {
            com.tokopedia.topads.sdk.utils.ImageLoader.clearImage(ivImageLeft)
            com.tokopedia.topads.sdk.utils.ImageLoader.clearImage(ivImageMiddle)
            com.tokopedia.topads.sdk.utils.ImageLoader.clearImage(ivImageRight)
            com.tokopedia.topads.sdk.utils.ImageLoader.clearImage(ivProfile)
        }
            ...
            when {
                shop.isShop_is_official -> {
                    ...
                    ivBadge.setImageDrawable(
                            com.tokopedia.topads.sdk.utils.ImageLoader.getDrawable(ivBadge.context, topadssdkR.drawable.ic_badge_shop_official)
                    )
                ...
                shop.isGoldShopBadge -> {
                    ivBadge.show()
                    ivBadge.setImageDrawable(
                            com.tokopedia.topads.sdk.utils.ImageLoader.getDrawable(
                                    ivBadge.context,
