...
public class ImpressedImageView extends AppCompatImageView {
    ...
    private boolean isVisible(final View view) {
        ...
        int offset = getResources().getDimensionPixelOffset(com.tokopedia.design.R.dimen.dp_45);
    ...
    private int getOffsetHeight() {
        if (offset > 0) {
            ...
            return getScreenHeight() - getResources().getDimensionPixelOffset(com.tokopedia.design.R.dimen.dp_45);
        }
    }
