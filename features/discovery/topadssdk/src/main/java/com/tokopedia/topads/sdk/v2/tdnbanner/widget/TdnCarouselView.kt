...
class TdnCarouselView : BaseCustomView, CoroutineScope {
    ...
    fun setCarouselModel(
        ...
        if (widgetType != TYPE_VERTICAL_CAROUSEL) {
            ...
            lastPagePosition = if (topAdsImageUiModel.isNotEmpty()) topAdsImageUiModel.size - Int.ONE else INITIAL_PAGE_POSITION
        ...
        tdnCarouselAdapter?.setList(topAdsImageUiModel)
    }
