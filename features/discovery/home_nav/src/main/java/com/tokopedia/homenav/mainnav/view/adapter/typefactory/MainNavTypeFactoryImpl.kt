...
import com.tokopedia.homenav.mainnav.view.adapter.viewholder.wishlist.EmptyStateViewHolder
import com.tokopedia.homenav.mainnav.view.adapter.viewholder.wishlist.ErrorStateViewHolder
...
class MainNavTypeFactoryImpl(private val mainNavListener: MainNavListener,
    ...
    override fun type(errorStateDataModel: ErrorStateDataModel): Int {
        return ErrorStateViewHolder.LAYOUT
    }

    override fun type(emptyStateDataModel: EmptyStateDataModel): Int {
    ...
    override fun createViewHolder(view: View, viewType: Int): AbstractViewHolder<*> {
        return when (viewType) {
            ...
            ErrorStateViewHolder.LAYOUT -> ErrorStateViewHolder(view, mainNavListener)
