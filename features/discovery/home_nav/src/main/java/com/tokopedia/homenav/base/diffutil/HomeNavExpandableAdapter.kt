...
import com.tokopedia.homenav.mainnav.view.adapter.viewholder.MainNavDiffCallback
 ...
 * Created by dhaba
 */
class HomeNavExpandableAdapter(private val mainNavTypeFactoryImpl: MainNavTypeFactoryImpl): ListAdapter<Visitable<*>, AbstractViewHolder<Visitable<*>>>(
