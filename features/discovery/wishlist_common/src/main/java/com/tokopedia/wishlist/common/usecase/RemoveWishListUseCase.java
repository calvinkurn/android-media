...
@Deprecated /*this use case will be deleted, use DeleteWishlistV2UseCase from new depencendy : implementation projectOrAar(rootProject.ext.features.wishlistcommon) */
