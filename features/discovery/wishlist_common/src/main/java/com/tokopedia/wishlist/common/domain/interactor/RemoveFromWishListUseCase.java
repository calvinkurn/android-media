...
public class RemoveFromWishListUseCase extends UseCase<Boolean> {
    ...
    public RemoveFromWishListUseCase(WishListCommonRepository wishListCommonRepository) {
    ...
    public Observable<Boolean> createObservable(RequestParams requestParams) {
        ...
        return wishListCommonRepository.removeFromWishList(userId, productId);
    }
