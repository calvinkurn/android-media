...
@Deprecated /*this use case will be deleted, use GetWishlistV2UseCase from new depencendy : implementation projectOrAar(rootProject.ext.features.wishlistcommon) */
