...
@Deprecated /*this interface will be deleted, use WishlistV2ActionListener from new depencendy : implementation projectOrAar(rootProject.ext.features.wishlistcommon) */
