...
class PopularSearchUseCase(
...
) : UseCase<List<InitialStateItem>>() {

    override fun createObservable(requestParams: RequestParams): Observable<List<InitialStateItem>> {
        return initialStateRepository.refreshPopularSearch(requestParams.parameters)
    }
    ...
    companion object {
        ...
        private fun getParams(searchParameter: Map<String, Any>, registrationId: String, userId: String): RequestParams {
            val params = RequestParams.create()
