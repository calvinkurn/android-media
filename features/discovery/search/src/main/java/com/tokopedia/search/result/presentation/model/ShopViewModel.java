...
public class ShopViewModel implements Parcelable {
    ...
    private List<ShopViewItem> shopItemList = new ArrayList<>();
    ...
    public List<ShopViewItem> getShopItemList() {
        return shopItemList;
    }

    public void setShopItemList(List<ShopViewItem> shopItemList) {
    ...
    public static class ShopViewItem implements Parcelable {
        ...
        protected ShopViewItem(Parcel in) {
        ...
        public static final Creator<ShopViewItem> CREATOR = new Creator<ShopViewItem>() {
            @Override
            public ShopViewItem createFromParcel(Parcel source) {
                return new ShopViewItem(source);
            }

            @Override
            public ShopViewItem[] newArray(int size) {
                return new ShopViewItem[size];
            }
        };
    }
    ...
    protected ShopViewModel(Parcel in) {
        ...
        this.shopItemList = in.createTypedArrayList(ShopViewItem.CREATOR);
    }

    public static final Parcelable.Creator<ShopViewModel> CREATOR = new Parcelable.Creator<ShopViewModel>() {
        @Override
