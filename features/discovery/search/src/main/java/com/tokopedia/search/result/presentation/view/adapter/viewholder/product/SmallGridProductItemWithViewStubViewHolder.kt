...
import com.tokopedia.search.databinding.SearchResultProductCardSmallGridWithViewstubBinding
import com.tokopedia.search.result.presentation.model.ProductItemDataView
import com.tokopedia.search.result.presentation.view.listener.ProductListener
import com.tokopedia.utils.view.binding.viewBinding

class SmallGridProductItemWithViewStubViewHolder(
    itemView: View,
    ...
    companion object {
        @LayoutRes
        @JvmField
        val LAYOUT = R.layout.search_result_product_card_small_grid_with_viewstub
    }

    private var binding: SearchResultProductCardSmallGridWithViewstubBinding? by viewBinding()
