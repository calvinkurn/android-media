...
public class ShopListTypeFactoryImpl extends SearchSectionTypeFactoryImpl implements ShopListTypeFactory {
    ...
    @Override
    public int type(@NonNull ShopViewModelKt.ShopItem shopItem) {
    ...
    @NonNull
    @Override
    public AbstractViewHolder createViewHolder(@NonNull View view, int type) {

        AbstractViewHolder viewHolder;

        if (type == EmptySearchViewHolder.LAYOUT) {
            viewHolder = new EmptySearchViewHolder(view, emptyStateListener, bannerAdsListener, null);
        } else if (type == ShopItemViewHolder.LAYOUT) {
            viewHolder = new ShopItemViewHolder(view, shopListener);
        } else {
