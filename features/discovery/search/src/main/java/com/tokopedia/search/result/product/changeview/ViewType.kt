...
enum class ViewType(
    ...
    SMALL_GRID(SMALL_GRID_VALUE, SMALL_GRID_LABEL, IconUnify.VIEW_GRID),
    LIST(LIST_VALUE, LIST_LABEL, IconUnify.VIEW_LIST),
    BIG_GRID(BIG_GRID_VALUE, BIG_GRID_LABEL, IconUnify.VIEW_GRID_BIG);
