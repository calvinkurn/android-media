...
internal class ShopListFragment:
    ...
    private fun trackEventProductPreviewImpression(trackingObjectList: java.util.ArrayList<Any>) {
        val keyword = searchShopViewModel?.getSearchParameterQuery()
    ...
    private fun trackEventImpressionShopRecommendation(trackingObjectList: java.util.ArrayList<Any>) {
        val keyword = searchShopViewModel?.getSearchParameterQuery()
    ...
    private fun trackEventImpressionShopRecommendationProductPreview(trackingObjectList: java.util.ArrayList<Any>) {
        val keyword = searchShopViewModel?.getSearchParameterQuery()
