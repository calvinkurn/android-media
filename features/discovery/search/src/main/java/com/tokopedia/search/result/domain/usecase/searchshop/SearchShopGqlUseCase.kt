...
class SearchShopGqlUseCase(
        ...
        private val searchShopModelMapper: Func1<GraphqlResponse, SearchShopModelKt>
): UseCase<SearchShopModelKt>() {

    override fun createObservable(requestParams: RequestParams): Observable<SearchShopModelKt> {
