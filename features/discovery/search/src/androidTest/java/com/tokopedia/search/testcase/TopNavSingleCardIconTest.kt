...
internal class TopNavSingleCardIconTest {
    ...
    fun setUp() {
        ...
        setupGraphqlMockResponse(SearchMockModelConfig(com.tokopedia.search.test.R.raw.search_product_response_keyword_hotel_jakarta))
