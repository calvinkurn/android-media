 ...
 * created by Dhaba
 */
class BestSellerProductVariant4Test {
    ...
    fun setUp() {
        ...
        setupGraphqlMockResponse(SearchMockModelConfig(com.tokopedia.search.test.R.raw.search_product_best_seller_variant_4))
    ...
    private fun performUserJourney() {
        ...
        val bestSellerVariant4Position =
            recyclerView.getProductListAdapter().itemList.getVariant4BestSellerProduct()
