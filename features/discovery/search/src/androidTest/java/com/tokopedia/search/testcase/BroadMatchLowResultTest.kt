...
internal class BroadMatchLowResultTest {
    ...
    fun setUp() {
        ...
        setupGraphqlMockResponse(SearchMockModelConfig(com.tokopedia.search.test.R.raw.search_product_broad_match_low_result_response))
