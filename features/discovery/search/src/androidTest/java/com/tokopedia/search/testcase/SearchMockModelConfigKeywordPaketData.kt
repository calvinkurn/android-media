...
internal class SearchMockModelConfigKeywordPaketData: MockModelConfig() {
    ...
    private fun createMapOfMockResponse(context: Context) = mapOf(
            "SearchProduct" to getRawString(context, R.raw.search_product_response_keyword_paket_data)
    )
}