...
internal class BenchmarkEmptySearchProductComponent {
    ...
    fun benchmark_onBind_ViewHolder_empty_search_product() {
        val itemView = BenchmarkObject.simpleViewFromLayout(EmptyStateViewHolder.LAYOUT, benchmarkViewRule.getBenchmarkActivity())
        val viewHolder = EmptyStateViewHolder(itemView, createEmptyStateListener())
    ...
    fun benchmark_onCreateViewHolder_ViewHolder_empty_search_product() {
        ...
        val recyclerViewAdapter = BenchmarkObject.simpleAdapter(
            ...
            EmptyStateViewHolder(it, createEmptyStateListener())
        }
