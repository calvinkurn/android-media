...
internal class SearchMockModelConfigKeywordTiketPesawatBandung: MockModelConfig() {
    ...
    private fun createMapOfMockResponse(context: Context) = mapOf(
            "SearchProduct" to getRawString(context, R.raw.search_product_response_keyword_tiket_pesawat_bandung)
    )
}