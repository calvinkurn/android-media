...
import com.tokopedia.search.result.domain.usecase.searchproduct.SearchProductTopAdsCorrectionFirstPageUseCase
...
internal class SearchProductTopAdsTypoCorrectionFirstPageTest : ProductListPresenterTestFixtures() {
    ...
    override val searchFirstPageUseCase: UseCase<SearchProductModel>
        get() = SearchProductTopAdsCorrectionFirstPageUseCase(
    ...
    @Test
    fun `Response Code 3 and experiment is enabled will call TopAds GQL again`() {
