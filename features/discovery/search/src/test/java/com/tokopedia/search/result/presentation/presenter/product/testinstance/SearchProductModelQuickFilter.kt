...
private val searchProductModelQuickFilterJSON = """
{
    "searchProduct": {
      "query": "samsung",
      "source": "search",
          ...
          "options": [
            {
              "name": "Official Store",
              "key": "official",
              "icon": "https://ecs7.tokopedia.net/img/official_store/badge/OS-Badge-40.png",
              "value": "true",
              "is_new": false,
              "input_type": "checkbox",
              "total_data": "",
          ...
          "options": [
            {
              "name": "Power Merchant",
              "key": "goldmerchant",
              "icon": "https://ecs7.tokopedia.net/img/power-badge/power-badge-192.png",
              "value": "true",
              "is_new": false,
              "input_type": "checkbox",
              "total_data": "",
...
val searchProductModelQuickFilter: SearchProductModel = Gson().fromJson(searchProductModelQuickFilterJSON, SearchProductModel::class.java)

private val searchProductModelWithNoQuickFilterJSON = """
{
    "searchProduct": {
      "query": "samsung",
      "source": "search",
...
val searchProductModelWithNoQuickFilter: SearchProductModel = Gson().fromJson(searchProductModelWithNoQuickFilterJSON, SearchProductModel::class.java)