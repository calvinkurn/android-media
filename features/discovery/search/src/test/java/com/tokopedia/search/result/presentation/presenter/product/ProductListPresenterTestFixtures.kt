...
internal open class ProductListPresenterTestFixtures {
    ...
    protected val warehouseId = "2216"
    protected val dummyChooseAddressData = LocalCacheModel(
            address_id = "123",
            city_id = "45",
            district_id = "123",
            lat = "10.2131",
    ...
    protected fun `Setup choose address`(chooseAddressModel: LocalCacheModel?) {
