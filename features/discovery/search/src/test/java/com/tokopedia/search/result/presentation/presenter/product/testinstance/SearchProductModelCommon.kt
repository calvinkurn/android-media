...
private val searchProductModelCommonJSON = """
{
    "searchProduct": {
      "query": "samsung",
      "source": "search",
...
val searchProductModelCommon: SearchProductModel = Gson().fromJson(searchProductModelCommonJSON, SearchProductModel::class.java)
