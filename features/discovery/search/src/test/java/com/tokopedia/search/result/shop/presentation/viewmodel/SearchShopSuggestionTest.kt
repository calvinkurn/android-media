...
internal class SearchShopSuggestionTest: SearchShopViewModelTestFixtures() {
    ...
    private fun `Then verify search shop suggestion`(searchShopModel: SearchShopModel) {
        ...
        visitableList[0].shouldBeInstanceOf<ShopSuggestionViewModel>()

        val suggestionModel = searchShopModel.aceSearchShop.suggestion
        val suggestionViewModel = visitableList[0] as ShopSuggestionViewModel
