...
internal val globalNavWidgetPillModelItemNoInfo = GlobalNavWidgetModel(
        ...
        title = "Beli Tiket",
        navTemplate = "pill",
        background = "https://images.tokopedia.net/img/green-container.png",
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    name = "pesawat",
                    imageUrl = "https://images.tokopedia.net/img/recharge/category/pesawat/colored-active.png",
            ...
            it.add(GlobalNavWidgetModel.Item(
                    name = "Tiket Hiburan",
                    imageUrl = "https://images.tokopedia.net/img/recharge/category/theme-park/colored-active.png",
            ...
            it.add(GlobalNavWidgetModel.Item(
                    name = "Kereta Api",
                    imageUrl = "https://images.tokopedia.net/img/recharge/category/kai/colored-active.png",
...
internal val globalNavWidgetPillModelItemWithInfo = GlobalNavWidgetModel(
        ...
        background = "https://images.tokopedia.net/img/yellow-container.png",
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    name = "1.000",
                    info = "Rp 1.800",
                    imageUrl = "https://images.tokopedia.net/img/recharge/operator/simpati_2.png",
...
internal val globalNavWidgetModelCard = GlobalNavWidgetModel(
        ...
        navTemplate = "card",
        background = "https://images.tokopedia.net/img/red-container.png",
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    ...
                    imageUrl = "https://images.tokopedia.net/img/attachment/2019/7/30/5510064/5510064_44d8a048-f210-429d-b2e1-325dcbc6a5a5.png",
...
internal val globalNavWidgetModelCard2 = GlobalNavWidgetModel(
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    ...
                    clickItemApplink = "tokopedia://deals/test-giftn-7419",
                    clickItemUrl = "https://www.tokopedia.com/deals/i/test-giftn-7419/",
                    backgroundUrl = "https://images.tokopedia.net/img/autocomplete/image_background_default_widget.png",
                    logoUrl = "https://images.tokopedia.net/img/recharge/category/pesawat/colored-active.png",
                    position = 1
            ))
            it.add(GlobalNavWidgetModel.Item(
                    categoryName = "Deals",
                    ...
                    clickItemUrl = "https://www.tokopedia.com/deals/i/test-giftn-7419/",
                    subtitle = "Harga /kamar/malam",
                    backgroundUrl = "https://images.tokopedia.net/img/red-container.png",
                    logoUrl = "https://images.tokopedia.net/img/recharge/category/pesawat/colored-active.png",
                    position = 2
            ))
        }
...
internal val singleGlobalNavWidgetModelPill = GlobalNavWidgetModel(
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    ...
                    name = "Qurban",
                    info = "",
                    imageUrl = "https://images.tokopedia.net/img/cache/100-square/attachment/2019/12/13/51829405/51829405_214934b2-3751-49fd-8288-7e0dd49625ff.png",
                    clickItemApplink = "tokopedia://discovery/qurban",
                    clickItemUrl = "https://www.tokopedia.com/s/qurban/",
                    subtitle = "",
                    backgroundUrl = "https://images.tokopedia.net/img/autocomplete/image_background_default_widget.png",
                    logoUrl = "https://images.tokopedia.net/img/cache/100-square/attachment/2019/12/13/51829405/51829405_214934b2-3751-49fd-8288-7e0dd49625ff.png",
                    position = 1
            ))
        }
)
...
internal val singleGlobalNavWidgetModelCardIconWithNoSubtitleInfo = GlobalNavWidgetModel(
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    ...
                    subtitle = "",
                    backgroundUrl = "https://images.tokopedia.net/img/autocomplete/image_background_default_widget.png",
                    logoUrl = "https://images.tokopedia.net/img/cache/100-square/attachment/2019/10/28/21181130/21181130_14539e75-40c6-49f4-8db6-12c5a001a511.png",
                    position = 1
            ))
        }
)
...
internal val singleGlobalNavWidgetModelCardIcon = GlobalNavWidgetModel(
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    ...
                    subtitle = "Mulai dari",
                    backgroundUrl = "https://images.tokopedia.net/img/autocomplete/image_background_default_widget.png",
                    logoUrl = "https://images.tokopedia.net/img/cache/100-square/attachment/2019/4/1/3127195/3127195_2258af2c-550d-4b7f-a8d4-f62178070ed8.png",
                    position = 1
            ))
        }
)
...
internal val singleGlobalNavWidgetModelCardImage = GlobalNavWidgetModel(
        ...
        itemList = mutableListOf<GlobalNavWidgetModel.Item>().also {
            it.add(GlobalNavWidgetModel.Item(
                    ...
                    name = "3 Months ",
                    info = "Rp 265.000",
                    imageUrl = "https://images.tokopedia.net/img/attachment/2019/10/7/66301108/66301108_c12ded0f-e784-4db4-99f4-45e3ac0d70ba.png",
                    ...
                    subtitle = "Mulai dari",
                    backgroundUrl = "",
                    logoUrl = "https://images.tokopedia.net/img/cache/100-square/attachment/2019/10/22/21181130/21181130_fa52cbc3-016e-4b04-ac8b-dbef10c2b923.png",
                    position = 1
            ))
        }
)
