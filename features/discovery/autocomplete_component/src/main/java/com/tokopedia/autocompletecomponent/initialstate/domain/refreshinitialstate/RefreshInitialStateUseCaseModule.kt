...
import com.tokopedia.autocompletecomponent.initialstate.data.InitialStateRepositoryModule
...
class RefreshInitialStateUseCaseModule {
    ...
    fun provideRefreshInitialStateUseCase(
        repository: InitialStateRepository
    ): UseCase<List<InitialStateData>> =
        RefreshInitialStateUseCase(repository)
}