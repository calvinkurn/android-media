...
public class AlphabeticalSideBar extends View {
    ...
    private void init() {
        ...
        itemTextSize = getContext().getResources().getDimensionPixelSize(com.tokopedia.filter.R.dimen.sp_12);
        int magnifierTextSize = getContext().getResources().getDimensionPixelSize(com.tokopedia.filter.R.dimen.sp_20);
        magnifierPadding = getContext().getResources().getDimensionPixelSize(com.tokopedia.filter.R.dimen.dp_10);
        int magnifierToSidebarDistance = getContext().getResources().getDimensionPixelSize(com.tokopedia.filter.R.dimen.dp_20);
        ...
        contentTextPaint.setColor(getContext().getResources().getColor(com.tokopedia.unifyprinciples.R.color.Unify_GN500));
        contentTextPaint.setStyle(Paint.Style.FILL_AND_STROKE);

        magnifierBackPaint = new Paint();
        magnifierBackPaint.setColor(getContext().getResources().getColor(com.tokopedia.unifyprinciples.R.color.Unify_GN500));
        magnifierBackPaint.setStyle(Paint.Style.FILL_AND_STROKE);

        magnifierTextPaint = new Paint();
        magnifierTextPaint.setColor(getContext().getResources().getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN0));
