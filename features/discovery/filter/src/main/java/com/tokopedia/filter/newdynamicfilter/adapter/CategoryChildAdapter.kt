...
class CategoryChildAdapter(private val clickListener: OnItemClickListener) : MultiLevelExpIndListAdapter() {
    ...
    inner class ItemRowHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private var colorTextNormal = view.context.resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_68)
        private var colorTextSelected: Int = view.context.resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_GN500)
