    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(pricePillOption: Option, position: Int) {
            ...
            if (isPricePillSelected) {
                pricePillItem?.setTextColor(context.resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_GN500))
                pricePillItem?.background = context.resources.getDrawable(R.drawable.filter_price_pill_item_background_selected)
            } else {
                pricePillItem?.setTextColor(context.resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_68))
