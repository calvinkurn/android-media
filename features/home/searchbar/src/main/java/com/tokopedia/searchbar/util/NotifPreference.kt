...
class NotifPreference(val context: Context){
    ...
    var isViewedGimmickNotif: Boolean
        get() = sharedPreferences.getBoolean(IS_VIEWED_GIMMICK_NOTIF, false)
        set(value) = sharedPreferences.edit().putBoolean(IS_VIEWED_GIMMICK_NOTIF, value).apply()
    ...
    companion object {
        ...
        private const val IS_VIEWED_GIMMICK_NOTIF = "is_viewed_gimmick_notif"
    }
}