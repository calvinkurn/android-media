...
public class MainParentActivity extends BaseActivity implements
    ...
    private static final String ROLLENCE_EXP_NAME = "Navigation Revamp";
    private static final String ROLLENCE_VARIANT_OLD = "existing navigation";
    private static final String ROLLENCE_VARIANT_REVAMP = "navigation revamp";
    ...
    private void createView(Bundle savedInstanceState) {
        ...
        String rollenceNavType = RemoteConfigInstance.getInstance().getABTestPlatform().getString(ROLLENCE_EXP_NAME, ROLLENCE_VARIANT_OLD);
    ...
    public void populateBottomNavigationView(String rollenceNavType){
        ...
        if (!rollenceNavType.equals(ROLLENCE_VARIANT_REVAMP)) {
