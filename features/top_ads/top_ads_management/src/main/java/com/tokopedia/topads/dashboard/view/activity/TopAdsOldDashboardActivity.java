...
import com.tokopedia.topads.dashboard.view.fragment.TopAdsOldDashboardFragment;
 ...
 */
@Deprecated
public class TopAdsOldDashboardActivity extends DrawerPresenterActivity implements TopAdsOldDashboardFragment.Callback {
    ...
    public static Intent getCallingIntent(Context context) {
        return new Intent(context, TopAdsOldDashboardActivity.class);
    }
    ...
    protected int getLayoutId() {
        return R.layout.activity_top_ads_old_dashboard;
    }
    ...
    public void startShowCase() {
        final String showCaseTag = TopAdsOldDashboardActivity.class.getName();
        ...
        viewPager.post(new Runnable() {
            ...
            public void run() {
                ...
                showCaseDialog.show(TopAdsOldDashboardActivity.this, showCaseTag, showCaseList);
            }
        });
    }
}