 ...
 */
class CreateManualAdsBudgetingAdsFragment: CreateManualAdsBaseStepperFragment<CreateManualAdsStepperModel>() {

    companion object {
        fun createInstance(): Fragment {

            val fragment = CreateManualAdsBudgetingAdsFragment()
            val args = Bundle()
