...
class BidInfoAdapterTypeFactoryImpl(private var selectedKeywords: MutableList<String>, private var selectedSuggestBid: MutableList<Int>, private var actionClose: (pos: Int) -> Unit, private var actionClick: () -> Int, var actionEnable: (flag: Boolean) -> Unit) : BindInfoAdapterTypeFactory {
