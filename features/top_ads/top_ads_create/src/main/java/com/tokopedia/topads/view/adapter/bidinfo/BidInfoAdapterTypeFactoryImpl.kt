...
class BidInfoAdapterTypeFactoryImpl(private var selectedKeywords: MutableList<String>?, private var selectedSuggestBid: MutableList<String>?, private var actionClick: (pos: Int) -> Unit) : BindInfoAdapterTypeFactory {
