...
class BidInfoAdapterTypeFactoryImpl(private var selectedKeywords: MutableList<String>, private var selectedSuggestBid: MutableList<Int>, private var actionClose: (pos: Int) -> Unit, private var actionClick: () -> MutableMap<String, Int>, var actionEnable: (flag: Boolean) -> Unit) : BindInfoAdapterTypeFactory {
    ...
    override fun holder(type: Int, view: View): BidInfoViewHolder<*> {
        return when (type) {
            ...
            BidInfoItemViewHolder.LAYOUT -> BidInfoItemViewHolder(view, selectedKeywords, selectedSuggestBid, actionClose, actionClick, actionEnable)
