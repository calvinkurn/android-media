...
public class TopAdsCacheDataSourceImpl implements TopAdsCacheDataSource {
    ...
    private static final String REQUEST_DATE_FORMAT = TopAdsCommonConstant.REQUEST_DATE_FORMAT;
    ...
    public void updateLastInsertStatistic() {
        localCacheHandler.setExpire(TopAdsCommonConstant.CACHE_EXPIRED_TIME);
        localCacheHandler.applyEditor();
    }
