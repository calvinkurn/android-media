...
@GqlQuery("TopadsGetGroupListQuery", TOP_ADS_GET_GROUP_LIST_QUERY)
class TopAdsGetGroupDataUseCase @Inject constructor(val userSession: UserSessionInterface) : RestRequestUseCase() {
    ...
    override fun buildRequest(requestParams: RequestParams?): MutableList<RestRequest> {
        ...
        val query = TopadsGetGroupListQuery.GQL_QUERY
        var request: GraphqlRequest = GraphqlRequest(query, GroupItemResponse::class.java, requestParams?.parameters)
