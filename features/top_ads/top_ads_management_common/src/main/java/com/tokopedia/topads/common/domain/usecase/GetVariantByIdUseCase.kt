...
class GetVariantByIdUseCase @Inject constructor(
    ...
    private val ANDROID_CLIENT_ID = 1L
    ...
    private fun createRequestParam(): RequestParams {
        ...
        requestParam.putObject(ParamObject.INPUT, GetVariantByIdInput(shopId = userSession.shopId.toLongOrZero(), clientId = ANDROID_CLIENT_ID))
        return requestParam
    }
}
