...
class EditAdGroupAdsPotentialViewHolder(private val viewBinding: TopadsEditItemEditAdGroupBinding) : AbstractViewHolder<EditAdGroupItemUiModel>(viewBinding.root) {
