...
class DashboardPresenterTest {
    ...
    private val topAdsGetShopDepositUseCase = mockk<TopAdsGetDepositUseCase>()
    private val shopAdInfoUseCase = mockk<GraphqlUseCase<ShopAdInfo>>()
    private val gqlGetShopInfoUseCase = mockk<GQLGetShopInfoUseCase>()
    private val topAdsGetGroupDataUseCase = mockk<TopAdsGetGroupDataUseCase>()
    private val topAdsGetGroupStatisticsUseCase = mockk<TopAdsGetGroupStatisticsUseCase>()
    private val topAdsGetProductStatisticsUseCase = mockk<TopAdsGetProductStatisticsUseCase>()
    private val topAdsGetProductKeyCountUseCase = mockk<TopAdsGetProductKeyCountUseCase>()
    private val topAdsGetGroupListUseCase = mockk<TopAdsGetGroupListUseCase>()
    private val topAdsGroupActionUseCase = mockk<TopAdsGroupActionUseCase>()
    private val topAdsProductActionUseCase = mockk<TopAdsProductActionUseCase>()
    private val topAdsGetGroupProductDataUseCase = mockk<TopAdsGetGroupProductDataUseCase>()
    private val topAdsInsightUseCase = mockk<TopAdsInsightUseCase>()
    private val getStatisticUseCase = mockk<TopAdsGetStatisticsUseCase>()
    private val budgetRecomUseCase = mockk<GraphqlUseCase<DailyBudgetRecommendationModel>>()
    private val productRecomUseCase = mockk<GraphqlUseCase<ProductRecommendationModel>>()
    private val validGroupUseCase = mockk<TopAdsGroupValidateNameUseCase>()
    private val topAdsCreateUseCase = mockk<TopAdsCreateUseCase>()
    private val bidInfoUseCase = mockk<BidInfoUseCase>()
    private val groupInfoUseCase = mockk<GroupInfoUseCase>()
    private val autoTopUpUSeCase = mockk<TopAdsAutoTopUpUSeCase>()
    private val adsStatusUseCase = mockk<GraphqlUseCase<AdStatusResponse>>()
    private val autoAdsStatusUseCase = mockk<GraphqlUseCase<AutoAdsResponse>>()
    private val getExpiryDateUseCase = mockk<GraphqlUseCase<ExpiryDateResponse>>()
    private val getHiddenTrialUseCase = mockk<GraphqlUseCase<FreeTrialShopListResponse>>()
    private val whiteListedUserUseCase = mockk<GetWhiteListedUserUseCase>()
    private val topAdsGetDeletedAdsUseCase = mockk<TopAdsGetDeletedAdsUseCase>()
