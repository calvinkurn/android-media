...
class TopAdsInsightNegKeyAdapter(var onButtonClick: ((position: Int) -> Unit?)) :
    RecyclerView.Adapter<TopAdsInsightNegKeyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txtSearch.text =
            holder.view.resources.getString(R.string.topads_insight_item_neg_1)
        ...
        holder.txtSavings.text =
            holder.view.resources.getString(R.string.topads_insight_item_neg_2)
        ...
        holder.txtpotential.text =
            String.format(holder.view.resources.getString(R.string.topads_insight_item_neg_3),
