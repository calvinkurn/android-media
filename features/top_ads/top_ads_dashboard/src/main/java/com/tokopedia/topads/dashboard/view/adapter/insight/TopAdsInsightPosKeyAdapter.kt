...
class TopAdsInsightPosKeyAdapter(private var onButtonClick: ((position: Int) -> Unit?)) : RecyclerView.Adapter<TopAdsInsightPosKeyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.view.txtpotential.text = String.format(holder.view.resources.getString(R.string.topads_insight_item_pos_3), items[position].data?.get(INDEX_4)?.value.toString())
