...
class HeadLineItemsItemViewHolder(val view: View, var selectMode: ((select: Boolean) -> Unit),
                               ...
                               private var onClickItem: ((id: Int, priceSpent: String, groupName: String) -> Unit)) : HeadLineItemsViewHolder<HeadLineItemsItemViewModel>(view) {
    ...
    override fun bind(item: HeadLineItemsItemViewModel, selectedMode: Boolean, fromSearch: Boolean, statsData: MutableList<DataItem>, countList: MutableList<CountDataItem>) {
        item.let {
