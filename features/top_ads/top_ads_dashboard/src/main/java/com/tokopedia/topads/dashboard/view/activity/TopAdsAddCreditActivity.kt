...
class TopAdsAddCreditActivity : BaseSimpleActivity() {
    ...
    override fun onBackPressed() {
        if (intent.extras.getBoolean(TopAdsDashboardConstant.EXTRA_APPLINK_FROM_PUSH, false) && application is TopAdsDashboardRouter) {
