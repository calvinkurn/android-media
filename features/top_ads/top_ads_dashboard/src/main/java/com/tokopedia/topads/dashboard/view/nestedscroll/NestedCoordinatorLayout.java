package com.tokopedia.topads.dashboard.view.nestedscroll;
...
/**
 * Created by Pika on 4/6/20.
 */
class NestedCoordinatorLayout extends CoordinatorLayout implements NestedScrollingChild {
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        ...
        dispatchNestedPreScroll(dx - tConsumed[0][0], dy - tConsumed[0][1], tConsumed[1], null);
