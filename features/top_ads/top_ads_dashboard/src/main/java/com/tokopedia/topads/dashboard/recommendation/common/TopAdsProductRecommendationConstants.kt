...
object TopAdsProductRecommendationConstants {
    ...
    const val INSIGHT_CENTRE_BID_INFO_SOURCE = "android.group_detail"
    const val INSIGHT_CENTRE_CREATE_GROUP_SOURCE = "android.mp_create_group"
    const val MINIMUM_DAILY_BUDGET_DEFAULT_VALUE = 0
