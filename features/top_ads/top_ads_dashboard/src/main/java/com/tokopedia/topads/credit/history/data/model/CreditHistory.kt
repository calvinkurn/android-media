...
data class CreditHistory(
    ...
    @SerializedName("amount_fmt") @Expose
    ...
    @SerializedName("is_reduction") @Expose
    val isReduction: Boolean = false,

    @SerializedName("show_timestamp") @Expose
    val showTimestamp: Boolean = false,

    @SerializedName("transaction_type") @Expose
    val transactionType: Int = 0,

    @SerializedName("status") @Expose
    val status: String = "",

    @SerializedName("expiry_date") @Expose
    val expiryDate: String = "",

    @SerializedName("invoice_url") @Expose
