...
import com.tokopedia.topads.common.constant.TopAdsCommonConstant.TOPADS_EDUCATION_URL

val topAdsHomepageLatestReadingJson = """
        [
          {
            "unifyIcon":"promo_ads",
            ...
            "articles":[
              {
                "slug":"${TOPADS_EDUCATION_URL}iklan-produk-melalui-topads",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}cara-pantau-iklan-otomatis",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}performa-iklan-manual",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}cara-topads-mendeteksi-klik-tampil-yang-tidak-valid",
          ...
          },
          {
            ...
            "articles":[
              {
                "slug":"${TOPADS_EDUCATION_URL}cara-top-up-saldo-topads",
          ...
          },
          {
            ...
            "articles":[
              {
                "slug":"${TOPADS_EDUCATION_URL}topads-produk",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}topads-iklan-toko",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}tambah-iklan-otomatis-topads",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}iklan-manual-baru",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}tokopedia-display-network",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}fitur-kata-kunci",
          ...
          },
          {
            ...
            "articles":[
              {
                "slug":"${TOPADS_EDUCATION_URL}cara-meningkatkan-persentase-klik-iklan-topads",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}tips-meningkatkan-konversi-dengan-topads",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}halaman-rekomendasi-topads",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}halaman-topads",
          ...
          },
          {
            ...
            "articles":[
              {
                "slug":"${TOPADS_EDUCATION_URL}cerita-topads-ombotak",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}cerita-topads-wardah",
          ...
          },
          {
            ...
            "articles":[
              {
                "slug":"${TOPADS_EDUCATION_URL}cara-meningkatkan-pelayanan-toko",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}cara-mendapatkan-review-bintang-5",
              ...
              {
                "slug":"${TOPADS_EDUCATION_URL}tips-pilih-admin-toko",
