package com.tokopedia.logisticcart.shipping.features.shippingwidget.backup
...
import com.tokopedia.logisticcart.shipping.model.backup.BackupShippingWidgetUiModel
import com.tokopedia.logisticcart.shipping.model.backup.InsuranceWidgetUiModel
...
class BackupShippingCheckoutRevampWidget : ConstraintLayout {
    ...
    interface ShippingWidgetListener {
        ...
        fun onInsuranceChecked(shippingWidgetUiModel: BackupShippingWidgetUiModel)
    ...
    fun renderShippingVibrationAnimation(
        shippingWidgetUiModel: BackupShippingWidgetUiModel
    ) {
        binding?.apply {
    ...
    fun renderErrorCourierState(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
        binding?.apply {
    ...
    fun renderFreeShippingCourier(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
    ...
    fun setLabelSelectedShippingCourier(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
        binding?.apply {
    ...
    fun showLayoutTradeIn(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
        binding?.apply {
            purchasePlatformPartialShimmeringList.root.gone()
            layoutStateNoSelectedShipping.gone()
            layoutStateHasSelectedNormalShipping.gone()
    ...
    private fun renderFreeShippingTitle(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
        binding?.apply {
    ...
    private fun renderFreeShippingEta(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
    ...
    private fun renderFreeShippingCod(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
    ...
    private fun showInsuranceInfo(shippingWidgetUiModel: BackupShippingWidgetUiModel) {
