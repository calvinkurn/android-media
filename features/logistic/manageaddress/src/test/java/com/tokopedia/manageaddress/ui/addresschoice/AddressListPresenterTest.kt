...
class AddressListPresenterTest  {
    ...
    fun `Get Address Success`() {
        ...
        every { useCase.execute(any(), any(), any()) } returns Observable.just(items)

        presenter.getAddress(-1, -1)
    ...
    fun `Get Address Error`() {
        ...
        every { useCase.execute(any(), any(), any()) } returns Observable.error(response)
    ...
    fun `LoadMore Address Success`() {
        ...
        every { useCase.loadMore(any(), any(), any(), any()) } returns Observable.just(items)
    ...
    fun `LoadMore Address Error`() {
        ...
        every { useCase.loadMore(any(), any(), any(), any()) } returns Observable.error(response)
