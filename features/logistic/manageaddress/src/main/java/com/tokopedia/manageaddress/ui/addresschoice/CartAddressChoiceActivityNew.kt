...
import com.tokopedia.purchase_platform.common.analytics.CheckoutAnalyticsChangeAddress.eventClickAtcCartChangeAddressClickArrowBackFromGantiAlamat
...
import com.tokopedia.manageaddress.ui.addresschoice.CartAddressChoiceActivityNew
 ...
 * Fajar U N
 */
class CartAddressChoiceActivityNew : BaseCheckoutActivity(), ShipmentAddressListFragment.ICartAddressChoiceActivityListener {
    ...
    override fun setupBundlePass(extras: Bundle?) {
        typeRequest = extras!!.getInt(CheckoutConstant.EXTRA_TYPE_REQUEST)
        token = extras.getParcelable(CheckoutConstant.EXTRA_DISTRICT_RECOMMENDATION_TOKEN)
        prevState = extras.getInt(CheckoutConstant.EXTRA_PREVIOUS_STATE_ADDRESS)
    }
    ...
    override fun getNewFragment(): Fragment? {
        ...
        return when (typeRequest) {
            CheckoutConstant.TYPE_REQUEST_SELECT_ADDRESS_FROM_COMPLETE_LIST -> ShipmentAddressListFragmentNew.newInstance(currentAddress, prevState)
            CheckoutConstant.TYPE_REQUEST_SELECT_ADDRESS_FROM_COMPLETE_LIST_FOR_MONEY_IN -> ShipmentAddressListFragmentNew.newInstance(currentAddress, CheckoutConstant.TYPE_REQUEST_SELECT_ADDRESS_FROM_COMPLETE_LIST_FOR_MONEY_IN)
            CheckoutConstant.TYPE_REQUEST_MULTIPLE_ADDRESS_ADD_SHIPMENT, CheckoutConstant.TYPE_REQUEST_MULTIPLE_ADDRESS_CHANGE_ADDRESS -> ShipmentAddressListFragmentNew.newInstanceFromMultipleAddressForm(currentAddress, prevState)
