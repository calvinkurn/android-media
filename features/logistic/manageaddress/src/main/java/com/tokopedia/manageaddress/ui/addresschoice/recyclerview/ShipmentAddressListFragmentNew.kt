...
class ShipmentAddressListFragmentNew : BaseCheckoutFragment(), AddressListContract.View,
    ...
    private fun getChosenAddrId(): Long {
        return localChosenAddr?.address_id?.toLong() ?: 0
    }
    ...
    companion object {
        ...
        fun newInstance(currentAddress: RecipientAddressModel, prevState: Int) : ShipmentAddressListFragmentNew {
            return ShipmentAddressListFragmentNew().apply {
        ...
        fun newInstance(currentAddress: RecipientAddressModel, requestType: Int, prevState: Int) : ShipmentAddressListFragmentNew {
            return ShipmentAddressListFragmentNew().apply {
                arguments = Bundle().apply {
                    putParcelable(EXTRA_CURRENT_ADDRESS, currentAddress)
                    putInt(ARGUMENT_ORIGIN_DIRECTION_TYPE, ORIGIN_DIRECTION_TYPE_DEFAULT)
        ...
        fun newInstanceFromMultipleAddressForm(currentAddress: RecipientAddressModel, prevState: Int) : ShipmentAddressListFragmentNew {
            return ShipmentAddressListFragmentNew().apply {
                arguments = Bundle().apply {
                    putParcelable(EXTRA_CURRENT_ADDRESS, currentAddress)
