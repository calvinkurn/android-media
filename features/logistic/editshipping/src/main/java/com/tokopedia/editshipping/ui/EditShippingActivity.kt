...
import com.tokopedia.editshipping.SCREEN_CONFIG_S_SHIPPING
...
class EditShippingActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            fragmentManager.beginTransaction().add(R.id.main_view, FragmentEditShipping.createInstance()).commit()
        }
    }
