...
class AddNewAddressTest {
    ...
    fun setup() {
        ...
        logisticInterceptor.autoCompleteResponsePath = getRawString(context, R.raw.autocomplete_jak)
        logisticInterceptor.getDistrictResponsePath = getRawString(context, R.raw.get_district_jakarta)
