...
class AddNewAddressNegativeTest {
    ...
    fun addAddressUserFunnel_PassedAnalyticsTest() {
        val query = getJsonDataFromAsset(context, "tracker/logistic/cvr_user_funnel_negative.json")
    ...
    fun addAddressCartFunnel_PassedAnalyticsTest() {
        val query = getJsonDataFromAsset(context, "tracker/logistic/cvr_cart_funnel_negative.json")
                ?: throw AssertionError("Validator Query not found")
    ...
    fun addAddressNewUserFunnel_PassedAnalyticsTest() {
        val query = getJsonDataFromAsset(context, "tracker/logistic/cvr_new_user_funnel_negative.json")
                ?: throw AssertionError("Validator Query not found")
