...
class ZipCodeChipsAdapter(context: Context?, private var actionListener: ActionListener) : RecyclerView.Adapter<ZipCodeChipsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.tv_chips_item.apply {
            ...
            setTextColor(res.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_44))
            setOnClickListener {
                setTextColor(res.getColor(com.tokopedia.unifyprinciples.R.color.Unify_GN300))
