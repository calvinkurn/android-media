 ...
 */
interface AutoCompleteGeocodeBottomSheetView: CustomerView {
    fun hideListPointOfInterest()
    fun onSuccessGetListPointOfInterest(responseAutocompleteGeocodeDataUiModel: AutoCompleteGeocodeDataUiModel)
}