...
import com.tokopedia.logisticaddaddress.features.district_recommendation.adapter.DiscomAdapter
...
class DiscomBottomSheet :
    ...
    companion object {
        ...
        fun show(
            ...
            val bottomSheet = DiscomBottomSheet()
    ...
    private val listDistrictAdapter by lazy { DiscomAdapter(this) }
