...
class AddressFormFragment : BaseDaggerFragment(), LabelAlamatChipsAdapter.ActionListener,
    ...
    private fun prepareLayout(data: DistrictItem?) {
        ...
        LogisticUserConsentHelper().displayUserConsent(activity as Context, binding.userConsent, getString(R.string.btn_simpan), if(isPositiveFlow) LogisticUserConsentHelper.ANA_REVAMP_POSITIVE else LogisticUserConsentHelper.ANA_REVAMP_NEGATIVE)
