...
) : CoroutineUseCase<GetChosenAddressListParam, GetChosenAddressListQglResponse>(dispatcher.io) {
    override fun graphqlQuery(): String {
        return QUERY
    }

    override suspend fun execute(params: GetChosenAddressListParam): GetChosenAddressListQglResponse {
