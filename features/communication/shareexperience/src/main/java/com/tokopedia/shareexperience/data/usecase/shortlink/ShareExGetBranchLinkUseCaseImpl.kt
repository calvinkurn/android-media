...
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.ANDROID_DEEPLINK_PATH
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.ANDROID_URL
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.AN_MIN_VERSION
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.CUSTOM_META_TAGS
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.DESKTOP_URL
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.IOS_DEEPLINK_PATH
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.IOS_URL
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.OG_DESCRIPTION
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.OG_IMAGE_URL
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.OG_TITLE
import com.tokopedia.shareexperience.domain.util.ShareExConstants.ShortLinkKey.OG_URL
