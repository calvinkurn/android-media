...
import com.tokopedia.shareexperience.stub.common.CoroutineAndroidTestDispatchersProvider
import com.tokopedia.shareexperience.stub.data.GraphqlRepositoryStub
...
class ShareExFakeAppModule(private val context: Context) {
    @ApplicationScope
    @Provides
    @ApplicationContext
