...
data class UniversalInboxTopAdsVerticalBannerUiModel constructor(var ads: List<TopAdsImageViewModel>? = null, var isRequested:Boolean = false) : Visitable<UniversalInboxTypeFactory> {
