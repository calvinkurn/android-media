...
import com.tokopedia.internal_review.common.SellerReviewHelper
...
public fun createReviewHelper(context: Context) : SellerReviewHelper {
    ...
    return SellerReviewHelper(cacheHandler, userSession, remoteConfig, dispatcher)
}
...
public fun createReviewViewModel(storeOwner: ViewModelStoreOwner) : SellerReviewViewModel {
    ...
    return ViewModelProvider(storeOwner, viewModelFactory).get(SellerReviewViewModel::class.java)
}
