...
object Const {
    ...
    const val LOTTIE_URL_RATING_1 = TokopediaImageUrl.LOTTIE_URL_RATING_1
    const val LOTTIE_URL_RATING_2 = TokopediaImageUrl.LOTTIE_URL_RATING_2
    const val LOTTIE_URL_RATING_3 = TokopediaImageUrl.LOTTIE_URL_RATING_3
    const val LOTTIE_URL_RATING_4 = TokopediaImageUrl.LOTTIE_URL_RATING_4
    const val LOTTIE_URL_RATING_5 = TokopediaImageUrl.LOTTIE_URL_RATING_5

    const val IMG_REQUEST_FEEDBACK = TokopediaImageUrl.IMG_REQUEST_FEEDBACK
    const val IMG_THANK_YOU = TokopediaImageUrl.IMG_THANK_YOU
