    ...
    inner class InboxMessageViewHolder(val view: View) : InboxDetailViewHolder(view), View.OnClickListener {
        ...
        fun bindViewHolder(position: Int, mPresenter: InboxDetailContract.Presenter) {
            ...
            if (item.rating != null && item.rating == KEY_DIS_LIKED) {
                ...
                ratingThumbsDown.setColorFilter(ContextCompat.getColor(mContext, com.tokopedia.unifyprinciples.R.color.Unify_RN500))
                ratingThumbsUp.hide()
            } else if (item.rating != null && item.rating == KEY_LIKED) {
                ratingThumbsUp.show()
                ratingThumbsUp.setColorFilter(ContextCompat.getColor(mContext, com.tokopedia.unifyprinciples.R.color.Unify_GN500))
