    ...
    class TicketItemHolder extends RecyclerView.ViewHolder implements ServicePrioritiesBottomSheet.CloseServicePrioritiesBottomSheet {
        ...
        void bindViewHolder(TicketsItem item) {
            if (item.getReadStatusId() == 2) {
                tvTicketDesc.setTextColor(mContext.getResources().getColor(com.tokopedia.core2.R.color.black_38));
            ...
            if (item.getStatusId() == 1) {
                ...
                tvTicketStatus.setTextColor(mContext.getResources().getColor(com.tokopedia.core2.R.color.black_38));
