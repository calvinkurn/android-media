package com.tokopedia.contactus.inboxticket2.view.behaviour;
 ...
 */
public class QuickHideBehaviour extends CoordinatorLayout.Behavior<View> {
    ...
    public QuickHideBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
