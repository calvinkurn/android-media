...
sealed class InboxUiEffect {
    ...
    data class LoadNextPageSuccess(val isFirstPage : Boolean = true, val isHasNext: Boolean = false, val allItems: List<InboxTicketListResponse.Ticket.Data.TicketItem>, val currentPageItems: List<InboxTicketListResponse.Ticket.Data.TicketItem>) : InboxUiEffect()
