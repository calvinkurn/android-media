        ...
        when (emoji) {
            ...
            FIRST_EMOJI -> {
                return FirstScreenState(
                    captionsList[FIRST_EMOJI - 1],
                    questionList[FIRST_EMOJI - 1]
                )
            }
            SECOND_EMOJI -> {
                return SecondScreenState(
                    captionsList[SECOND_EMOJI - 1],
                    questionList[SECOND_EMOJI - 1]
                )
            }
            THIRD_EMOJI -> {
                return ThirdScreenState(
                    captionsList[THIRD_EMOJI - 1],
                    questionList[THIRD_EMOJI - 1]
                )
            }
            FOURTH_EMOJI -> {
                return FourthScreenState(
                    captionsList[FOURTH_EMOJI - 1],
                    questionList[FOURTH_EMOJI - 1]
                )
            }
            FIFTH_EMOJI -> {
                return FifthScreenState(
                    captionsList[FIFTH_EMOJI - 1],
                    questionList[FIFTH_EMOJI - 1]
                )
            }
            else -> {
