...
public class BaseFragmentProvideRating extends BaseDaggerFragment implements ProvideRatingContract.ProvideRatingView {
    ...
    public static BaseFragmentProvideRating newInstance(Bundle bundle) {
        BaseFragmentProvideRating fragment = new BaseFragmentProvideRating();
    ...
    protected void initInjector() {
        component = DaggerCsatComponent.builder()
                .csatModule(new CsatModule())
                .build();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.csat_fragment_rating_provide, container, false);
        return view;
    }
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int i) {
                if (filterList.size() % 2 == 0) {
                    ...
                    return (i == filterList.size()-1) ? 2 : 1;
                }
            }
        });
    ...
    private void initView(View view) {
        ...
        mTxtFinished.setOnClickListener((View v) -> {
