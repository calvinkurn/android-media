...
public class EventEntityMaper {
    ...
    public EventDetailsDomain tranformEventDetails(EventsDetailsEntity eventsDetailsEntity) {
        ...
        eventDetailsDomain.setSaleStartDate(eventsDetailsEntity.getSaleStartDate());
        eventDetailsDomain.setSaleEndDate(eventsDetailsEntity.getSaleEndDate());
        ...
        eventDetailsDomain.setCustomText1(eventsDetailsEntity.getCustomText1());
