...
object EventMetaDataMapper {
    ...
    fun getCheckoutParamInstant(metaDataResponse: MetaDataResponse, productDetailData: ProductDetailData, packageV3: PackageV3): CheckoutGeneralV2InstantParams {
        val gson = Gson()
        val checkoutGeneralV2InstantParams = CheckoutGeneralV2InstantParams()
        val cartInfo = CartInfo(gson.toJson(mapToIntMetaData(metaDataResponse,productDetailData,packageV3)),productDetailData.checkoutDataType)
