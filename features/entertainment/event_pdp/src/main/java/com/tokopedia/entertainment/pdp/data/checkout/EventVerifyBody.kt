...
data class EventVerifyBody(
        ...
        @Expose
        val cartItems: List<CartItemVerify> = emptyList(),
...
data class MetaDataVerify(
        ...
        @Expose
        val entityPackages: List<EntityPackageVerify> = emptyList(),
        ...
        @Expose
        val entityPassengers: List<EntityPassengerVerify> = emptyList(),
