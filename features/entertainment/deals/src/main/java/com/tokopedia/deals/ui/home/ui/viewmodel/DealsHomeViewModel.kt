package com.tokopedia.deals.ui.home.ui.viewmodel
...
import com.tokopedia.deals.ui.home.domain.GetInitialHomeLayoutModelUseCase
...
class DealsHomeViewModel @Inject constructor(
    ...
    private var mutableTickerData = com.tokopedia.deals.ui.home.data.DealsEventHome.TickerHome()
    ...
    private fun setTickerData(tickerData: com.tokopedia.deals.ui.home.data.DealsEventHome.TickerHome) {
