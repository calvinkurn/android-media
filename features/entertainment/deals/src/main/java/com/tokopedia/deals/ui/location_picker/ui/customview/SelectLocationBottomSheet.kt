package com.tokopedia.deals.ui.location_picker.ui.customview
...
class SelectLocationBottomSheet : BottomSheetUnify() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currentLocation = arguments?.getParcelable(com.tokopedia.deals.ui.location_picker.DealsLocationConstants.LOCATION_OBJECT)
