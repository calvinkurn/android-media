...
class DealsLandmarkLocationUseCase @Inject constructor(
        @Named(com.tokopedia.deals.ui.location_picker.DealsLocationConstants.GQL_LANDMARK) private val gqlUseCase: GraphqlUseCase<LocationData>
) {
    ...
    private fun generateSearchParams(
        ...
        requestParam.add(RequestParam(com.tokopedia.deals.ui.location_picker.DealsLocationConstants.MAP_LOCATION_TYPE, com.tokopedia.deals.ui.location_picker.DealsLocationConstants.LANDMARK))
        ...
        requestParam.add(RequestParam(com.tokopedia.deals.ui.location_picker.DealsLocationConstants.MAP_SORT_BY, PRIORITY))
        requestParam.add(RequestParam(com.tokopedia.deals.ui.location_picker.DealsLocationConstants.MAP_FIXED, STR_TRUE))
        requestParam.add(RequestParam(com.tokopedia.deals.ui.location_picker.DealsLocationConstants.MAP_DISTANCE, DISTANCE))
        return requestParam
    }
