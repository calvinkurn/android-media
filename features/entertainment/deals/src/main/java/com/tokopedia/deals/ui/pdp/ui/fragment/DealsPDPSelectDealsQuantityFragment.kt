...
class DealsPDPSelectDealsQuantityFragment : BaseDaggerFragment() {
    ...
    private var productDetailData: com.tokopedia.deals.ui.pdp.data.ProductDetailData? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        productDetailData = arguments?.getParcelable<com.tokopedia.deals.ui.pdp.data.ProductDetailData>(EXTRA_PRODUCT_DATA)
    ...
    companion object {
        ...
        fun createInstance(data: com.tokopedia.deals.ui.pdp.data.ProductDetailData): DealsPDPSelectDealsQuantityFragment {
