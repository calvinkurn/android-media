...
data class DealsProductDetail(
    ...
    val eventProductDetail: com.tokopedia.deals.ui.pdp.data.EventProductDetail = com.tokopedia.deals.ui.pdp.data.EventProductDetail()
)

data class EventProductDetail(
    @SerializedName("productDetailData")
    val productDetailData: com.tokopedia.deals.ui.pdp.data.ProductDetailData = com.tokopedia.deals.ui.pdp.data.ProductDetailData()
)
...
data class ProductDetailData(
    ...
    val brand: com.tokopedia.deals.ui.pdp.data.Brand = com.tokopedia.deals.ui.pdp.data.Brand(),
    @SerializedName("brand_id")
    val brandId: String = "",
    @SerializedName("catalog")
    val catalog: com.tokopedia.deals.ui.pdp.data.Catalog = com.tokopedia.deals.ui.pdp.data.Catalog(),
    @SerializedName("category")
    val category: List<com.tokopedia.deals.ui.pdp.data.Category> = emptyList(),
    ...
    val facilities: List<com.tokopedia.deals.ui.pdp.data.Facilities>? = emptyList(),
    @SerializedName("facility_group_id")
    val facilityGroupId: String = "",
    @SerializedName("form")
    val form: String = "",
    @SerializedName("forms")
    val forms: List<com.tokopedia.deals.ui.pdp.data.Form> = emptyList(),
    ...
    val media: List<com.tokopedia.deals.ui.pdp.data.Media> = emptyList(),
    ...
    val outlets: List<com.tokopedia.deals.ui.pdp.data.Outlet> = emptyList(),
    @SerializedName("packages")
    val packages: List<com.tokopedia.deals.ui.pdp.data.PackageV3> = emptyList(),
    ...
    val schedules: List<com.tokopedia.deals.ui.pdp.data.Schedules> = emptyList(),
...
data class Group(
    ...
    val name: String = "",
    @SerializedName("packages")
    val packages: List<com.tokopedia.deals.ui.pdp.data.Package> = emptyList(),
    @SerializedName("product_id")
    val productId: String = "",
    @SerializedName("product_schedule_id")
    val productScheduleId: String = "",
...
data class Schedules(
    ...
    val addressDetail: com.tokopedia.deals.ui.pdp.data.AddressDetail,
    @SerializedName("groups")
    val groups: List<com.tokopedia.deals.ui.pdp.data.Group> = emptyList(),
    @SerializedName("schedule")
    val schedule: com.tokopedia.deals.ui.pdp.data.Schedule
) : Parcelable
...
data class PackageV3(
    ...
    val packageItems: List<com.tokopedia.deals.ui.pdp.data.PackageItem> = emptyList(),
    @SerializedName("forms_package")
    val formsPackages: List<com.tokopedia.deals.ui.pdp.data.Form> = emptyList(),
...
data class PackageItem(
    ...
    val formsItems: List<com.tokopedia.deals.ui.pdp.data.Form> = emptyList()
) : Parcelable
