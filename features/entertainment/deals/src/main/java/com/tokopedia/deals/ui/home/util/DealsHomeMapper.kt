package com.tokopedia.deals.ui.home.util
...
class DealsHomeMapper @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    fun mapLayoutToBaseItemViewModel(
        homeLayout: List<com.tokopedia.deals.ui.home.data.EventHomeLayout>,
        brands: List<Brand>,
        nearestLocations: List<Location>,
        tickerData: com.tokopedia.deals.ui.home.data.DealsEventHome.TickerHome
