package com.tokopedia.deals.ui.pdp.share
...
class DealsPDPShare(private val activity: WeakReference<Activity>) {
    ...
    fun shareEvent(data: com.tokopedia.deals.ui.pdp.data.ProductDetailData, titleShare: String, context: Context, loadShare: () -> Unit, doneLoadShare: () -> Unit) {
    ...
    private fun generateBranchLink(data: com.tokopedia.deals.ui.pdp.data.ProductDetailData, context: Context, titleShare: String, loadShare: () -> Unit, doneLoadShare: () -> Unit) {
        loadShare()
    ...
    private fun pdpToLinkerDataMapper(data: com.tokopedia.deals.ui.pdp.data.ProductDetailData, context: Context): LinkerShareData {
