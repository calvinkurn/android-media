...
public class DealsSearchActivity extends DealsBaseActivity implements
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                if (verticalOffset != 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        appBarToolbar.setElevation(getResources().getDimension(com.tokopedia.unifyprinciples.R.dimen.unify_space_4));
                    }
                } else {
                    divider.setVisibility(View.VISIBLE);
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        appBarToolbar.setElevation(getResources().getDimension(com.tokopedia.unifyprinciples.R.dimen.unify_space_0));
                    }
                }
            }
        });
    ...
    public void setSuggestedBrands(List<Brand> brandList, int count) {
        if (brandList != null && brandList.size() > 0) {
            ...
            params1.setMargins(getResources().getDimensionPixelOffset(com.tokopedia.unifyprinciples.R.dimen.unify_space_16), getResources().getDimensionPixelOffset(com.tokopedia.unifyprinciples.R.dimen.unify_space_12), 0, 0);
