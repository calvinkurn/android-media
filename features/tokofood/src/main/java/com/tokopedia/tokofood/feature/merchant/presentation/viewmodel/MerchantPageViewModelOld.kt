...
import com.tokopedia.tokofood.common.presentation.mapper.CustomOrderDetailsMapperOld.mapTokoFoodProductsToCustomOrderDetails
...
class MerchantPageViewModelOld @Inject constructor(
    ...
    fun mapCartTokoFoodToCustomOrderDetail(cartTokoFood: CartTokoFood, productUiModel: ProductUiModel): CustomOrderDetail? {
        ...
        return TokoFoodMerchantUiModelMapper.mapCartTokoFoodToCustomOrderDetailOld(
