...
import com.tokopedia.tokofood.common.minicartwidget.view.TokoFoodMiniCartWidgetOld
...
import com.tokopedia.tokofood.databinding.FragmentTokofoodHomeOldBinding
...
import com.tokopedia.tokofood.feature.home.presentation.adapter.TokoFoodHomeAdapterOld
import com.tokopedia.tokofood.feature.home.presentation.adapter.TokoFoodHomeAdapterTypeFactoryOld
...
import com.tokopedia.tokofood.feature.home.presentation.view.listener.TokoFoodHomeBannerComponentCallbackOld
import com.tokopedia.tokofood.feature.home.presentation.view.listener.TokoFoodHomeCategoryWidgetV2ComponentCallbackOld
...
class TokoFoodHomeFragmentOld :
    ...
    @Inject
    lateinit var analytics: TokoFoodHomeAnalyticsOld

    @Inject
    lateinit var trackingQueue: TrackingQueue

    private var binding by autoClearedNullable<FragmentTokofoodHomeOldBinding>()
    private val viewModel by lazy {
        ViewModelProvider(this, viewModelFactory).get(TokoFoodHomeViewModelOld::class.java)
    }
    private var parentActivity: HasViewModel<MultipleFragmentsViewModelOld>? = null
    private val activityViewModel: MultipleFragmentsViewModelOld?
        get() = parentActivity?.viewModel()
    private val adapter by lazy {
        TokoFoodHomeAdapterOld(
    ...
    private var miniCartHome: TokoFoodMiniCartWidgetOld? = null
    ...
    override fun onAttachActivity(context: Context?) {
        ...
        parentActivity = activity as? HasViewModel<MultipleFragmentsViewModelOld>
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentTokofoodHomeOldBinding.inflate(inflater)
        return binding?.root
    }
    ...
    private fun createLegoBannerCallback(): TokoFoodHomeLegoComponentCallbackOld {
        return TokoFoodHomeLegoComponentCallbackOld(this, userSession, analytics)
    }

    private fun createBannerCallback(): TokoFoodHomeBannerComponentCallbackOld {
        return TokoFoodHomeBannerComponentCallbackOld(this, userSession, analytics)
    }

    private fun createCategoryWidgetCallback(): TokoFoodHomeCategoryWidgetV2ComponentCallbackOld {
        return TokoFoodHomeCategoryWidgetV2ComponentCallbackOld(this, userSession, analytics)
    }
    ...
    private fun setupRecycleView() {
        context?.let {
            rvHome?.apply {
                adapter = this@TokoFoodHomeFragmentOld.adapter
