...
import com.tokopedia.tokofood.common.presentation.mapper.CustomOrderDetailsMapperOld
...
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getAccordionUiModel
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getAllUnavailableProducts
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getPartiallyLoadedModel
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getProductById
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getProductByUpdateParam
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getProductWithChangedQuantity
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getTickerErrorShopLevelUiModel
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getUiModel
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.VisitableDataHelperOld.getUpdatedCartId
...
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.mapper.TokoFoodPurchaseUiModelMapperOld.updateSummaryData
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.mapper.TokoFoodPurchaseUiModelMapperOld.updateTickerErrorShopLevelData
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.mapper.TokoFoodPurchaseUiModelMapperOld.updateTickersData
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.mapper.TokoFoodPurchaseUiModelMapperOld.updateTotalAmountData
...
open class TokoFoodPurchaseViewModelOld @Inject constructor(
    ...
    private val checkoutGeneralTokoFoodUseCase: Lazy<CheckoutGeneralTokoFoodUseCaseOld>,
    ...
    fun loadData() {
        launchCatchError(block = {
            withContext(dispatcher.io) {
                ...
                _fragmentUiModel.value = TokoFoodPurchaseUiModelMapperOld.mapShopInfoToUiModel(it.data.shop)
                ...
                _visitables.value =
                    TokoFoodPurchaseUiModelMapperOld.mapCheckoutResponseToUiModels(
                        it,
                        isEnabled,
    ...
    fun loadDataPartial() {
        launchCatchError(block = {
            withContext(dispatcher.io) {
                ...
                isConsentAgreed.value = !it.data.checkoutConsentBottomSheet.isShowBottomsheet
                val isEnabled = it.isEnabled()
                val partialData = TokoFoodPurchaseUiModelMapperOld.mapResponseToPartialUiModel(
                    it,
                    isEnabled,
                    !_isAddressHasPinpoint.value.second
                )
    ...
    fun updateProductVariant(element: TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld) {
        launch(coroutineContext) {
            ...
            availableProducts?.let { products ->
                val customOrderDetails =
                    CustomOrderDetailsMapperOld.mapTokoFoodProductsToCustomOrderDetails(products)
                val productUiModel = TokoFoodPurchaseUiModelMapperOld.mapUiModelToCustomizationUiModel(element, customOrderDetails)
                _uiEvent.value = PurchaseUiEvent(
    ...
    private fun getUpdatePartialVisitables(partialData: PartialTokoFoodUiModelOld): MutableList<Visitable<*>> {
        val dataList = getVisitablesValue().toMutableList()
