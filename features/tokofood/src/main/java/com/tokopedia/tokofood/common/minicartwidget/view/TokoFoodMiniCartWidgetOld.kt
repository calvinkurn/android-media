...
@FlowPreview
class TokoFoodMiniCartWidgetOld @JvmOverloads constructor(
    ...
    private var viewModel: MultipleFragmentsViewModelOld? = null
    ...
    fun initialize(sharedViewModel: MultipleFragmentsViewModelOld,
