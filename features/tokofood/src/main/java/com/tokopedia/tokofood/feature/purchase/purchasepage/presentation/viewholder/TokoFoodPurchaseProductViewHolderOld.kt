...
class TokoFoodPurchaseProductViewHolderOld(
    ...
    override fun bind(element: TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld) {
    ...
    private fun View.renderAlphaProductItem(element: TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld) {
            ...
            if (nextItem == null) {
                ...
                if (element.isAvailable) {
                    ...
                    constraintSet.connect(
                        ...
                        SIXTEEN_MARGIN_PX.dpToPx(itemView.resources.displayMetrics)
                    )
                } else {
                    constraintSet.connect(
                        R.id.divider_bottom,
        ...
        with(viewBinding) {
            if (element.addOns.isNotEmpty()) {
                ...
                element.addOns.forEach {
                    val productAddOnView =
                        SubItemPurchaseAddOnBinding.inflate(LayoutInflater.from(itemView.context))
