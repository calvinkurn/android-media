...
class TokoFoodPostPurchaseAnalytics @Inject constructor(private val userSession: UserSessionInterface) {
    ...
    fun clickChatIcon(orderStatus: String, orderId: String, source: String, role: String, unReadChatCounter: String) {
        val mapData = mapOf(
            ...
            TrackAppUtils.EVENT_LABEL to "$orderStatus - $orderId - $source - $role - $unReadChatCounter",
