...
class TokoFoodHomeAdapterTypeFactoryOld (
    private val tokoFoodView: TokoFoodView? = null,
    private val dynamicLegoBannerCallback: TokoFoodHomeLegoComponentCallbackOld? = null,
    private val bannerComponentCallback: TokoFoodHomeBannerComponentCallbackOld? = null,
    private val categoryWidgetCallback: TokoFoodHomeCategoryWidgetV2ComponentCallbackOld? = null,
