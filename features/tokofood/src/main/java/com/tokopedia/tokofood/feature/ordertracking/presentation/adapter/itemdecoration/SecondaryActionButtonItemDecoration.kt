package com.tokopedia.tokofood.feature.ordertracking.presentation.adapter.itemdecoration
...
class SecondaryActionButtonItemDecoration(context: Context) : RecyclerView.ItemDecoration() {
    ...
    override fun getItemOffsets(
        ...
        val isLastItem: Boolean =
            parent.getChildAdapterPosition(view) == parent.adapter?.itemCount.orZero() - Int.ONE
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        for (i in 0 until childCount - Int.ONE) {
