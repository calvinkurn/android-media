...
import com.tokopedia.tokofood.feature.search.searchresult.di.module.SearchResultModule
...
@TokoFoodScope
@Component(modules = [SearchResultModule::class, TokoFoodModule::class], dependencies = [BaseAppComponent::class])
