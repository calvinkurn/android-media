...
import com.tokopedia.tokofood.databinding.FragmentTokofoodCategoryOldBinding
...
class TokoFoodCategoryFragmentOld: BaseMultiFragment(),
    ...
    @Inject
    lateinit var analytics: TokoFoodCategoryAnalyticsOld

    @Inject
    lateinit var trackingQueue: TrackingQueue

    private var binding by autoClearedNullable<FragmentTokofoodCategoryOldBinding>()
    private val viewModel by lazy {
        ViewModelProvider(this, viewModelFactory).get(TokoFoodCategoryViewModelOld::class.java)
    }
    ...
    private var miniCartCategory: TokoFoodMiniCartWidgetOld? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentTokofoodCategoryOldBinding.inflate(inflater)
        return binding?.root
    }
    ...
    override fun onClickMerchant(merchant: Merchant, horizontalPosition: Int) {
        ...
        val merchantApplink = Uri.parse(ApplinkConstInternalTokoFood.MERCHANT_OLD)
            .buildUpon()
    ...
    private fun setupRecycleView() {
        context?.let {
            rvCategory?.apply {
                adapter = this@TokoFoodCategoryFragmentOld.adapter
