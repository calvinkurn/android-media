...
import com.tokopedia.tokofood.feature.purchase.purchasepage.presentation.uimodel.PartialTokoFoodUiModelOld
...
object TokoFoodPurchaseUiModelMapperOld {
    ...
    fun mapResponseToPartialUiModel(
        ...
        return PartialTokoFoodUiModelOld(
    ...
    fun MutableList<Visitable<*>>.updateSummaryData(summaryUiModel: TokoFoodPurchaseSummaryTransactionTokoFoodPurchaseUiModelOld?) {
        getUiModelIndex<TokoFoodPurchaseSummaryTransactionTokoFoodPurchaseUiModelOld>().let { summaryIndex ->
    ...
    fun MutableList<Visitable<*>>.updateTotalAmountData(totalAmountUiModel: TokoFoodPurchaseTotalAmountTokoFoodPurchaseUiModelOld) {
        getUiModelIndex<TokoFoodPurchaseTotalAmountTokoFoodPurchaseUiModelOld>().let { totalAmountIndex ->
    ...
    fun mapUiModelToUpdateParam(uiModels: List<TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld>,
    ...
    fun mapUiModelToCustomizationUiModel(uiModel: TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld,
    ...
    private fun mapProductUiModel(product: CheckoutTokoFoodProduct,
                                  isEnabled: Boolean,
                                  mIsAvailable: Boolean): TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld {
        val addOnsAndParamPair = getAddOnsAndParamPairList(product.variants)
        return TokoFoodPurchaseProductTokoFoodPurchaseUiModelOld(
    ...
    private fun mapSummaryTransactionUiModel(summaryDetails: List<CheckoutTokoFoodSummaryItemDetail>): TokoFoodPurchaseSummaryTransactionTokoFoodPurchaseUiModelOld {
        val summaryDetailList = summaryDetails.map {
            it.mapToUiModel()
        }
        return TokoFoodPurchaseSummaryTransactionTokoFoodPurchaseUiModelOld(summaryDetailList.toList())
    }

    private fun CheckoutTokoFoodSummaryItemDetail.mapToUiModel(): TokoFoodPurchaseSummaryTransactionTokoFoodPurchaseUiModelOld.Transaction {
        return TokoFoodPurchaseSummaryTransactionTokoFoodPurchaseUiModelOld.Transaction(
            title = title,
            value = priceFmt,
            detailInfo = info
        )
    ...
    private fun mapTotalAmountUiModel(isEnabled: Boolean,
                                      total: CheckoutTokoFoodShoppingTotal): TokoFoodPurchaseTotalAmountTokoFoodPurchaseUiModelOld {
        return TokoFoodPurchaseTotalAmountTokoFoodPurchaseUiModelOld(total.cost.toLong(), false).apply {
            this.isEnabled = isEnabled
        }
    }
