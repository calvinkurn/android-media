...
internal constructor(private val userSession: UserSessionInterface,
    ...
    private var viewListener: FeedPlus.View? = null
    private val pagingHandler: PagingHandler

    private val userId: String
        get() = if (userSession.isLoggedIn) userSession.userId else FeedPlusConstantKt.NON_LOGIN_USER_ID
    ...
    override fun favoriteShop(promotedShopViewModel: Data, adapterPosition: Int) {
        ...
        params.putString(PARAM_SHOP_DOMAIN, promotedShopViewModel.shop
                .domain)
            ...
            override fun onNext(isSuccess: Boolean?) {
                ...
                if (isSuccess!!) {
                    stringBuilder.append(
                            MethodChecker.fromHtml(promotedShopViewModel.shop.name)
                    ).append(" ")
        ...
        getDynamicFeedFirstPageUseCase.execute(
                ...
                object : Subscriber<DynamicFeedFirstPageDomainModel>() {
                    ...
                    override fun onNext(firstPageDomainModel: DynamicFeedFirstPageDomainModel) {
                        ...
                        val model = firstPageDomainModel
                        ...
                        if (hasFeed(model)) {
                            ...
                            view.onSuccessGetFeedFirstPage(
                                    ArrayList<Visitable>(model.postList)
                            )
    ...
    private fun hasFeed(model: DynamicFeedDomainModel?): Boolean {
        return model != null && !model.postList.isEmpty()
    }
        ...
        getDynamicFeedUseCase.execute(
                ...
                object : Subscriber<DynamicFeedDomainModel>() {
                    ...
                    override fun onNext(model: DynamicFeedDomainModel) {
                        ...
                        if (model.postList.size != 0) {
                            view.onSuccessGetFeed(ArrayList<Visitable>(model.postList))
                        }
