...
import com.tokopedia.feedplus.presentation.adapter.viewholder.FeedSwipeRefreshViewHolder
...
class FeedAdapterTypeFactory(
    ...
    private val feedSwipeListener: FeedSwipeRefreshListener

    init {
        this.feedListener = context
        this.feedSwipeListener = context
    }
    ...
    fun type(model: FeedSwipeRefreshModel) = FeedSwipeRefreshViewHolder.LAYOUT
    ...
    override fun createViewHolder(parent: View, type: Int): AbstractViewHolder<out Visitable<*>>? =
        when (type) {
            ...
            FeedSwipeRefreshViewHolder.LAYOUT -> FeedSwipeRefreshViewHolder(
                ItemFeedSwipeRefreshBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent as ViewGroup,
                    false
                ),
