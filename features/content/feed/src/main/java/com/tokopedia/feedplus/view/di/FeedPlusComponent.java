...
@FeedPlusScope
@Component(modules = {FeedPlusModule.class, FeedComponentModule.class, GqlRawQueryModule.class, ViewModelModule.class, InterestPickCommonModule.class}, dependencies = BaseAppComponent.class)
