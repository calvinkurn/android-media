...
class FeedShopRecomWidgetAnalytic @Inject constructor(
    ...
    fun sendClickFollowShopRecommendationEvent(eventLabel: String) {
        Tracker.Builder()
            .setEvent(CLICK_PG)
            .setEventAction(EVENT_ACTION_CLICK_FOLLOW_SHOP_RECOMMENDATION)
            .setEventCategory(EVENT_CATEGORY_CONTENT_FEED_TIMELINE)
    ...
    fun sendClickXShopRecommendationEvent(eventLabel: String) {
        Tracker.Builder()
            .setEvent(CLICK_PG)
            .setEventAction(EVENT_ACTION_CLICK_X_SHOP_RECOMMENDATION)
            .setEventCategory(EVENT_CATEGORY_CONTENT_FEED_TIMELINE)
            .setEventLabel(eventLabel)
            .setBusinessUnit(CONTENT)
            .setCurrentSite(currentSite)
    ...
    companion object {
        ...
        private const val EVENT_ACTION_CLICK_FOLLOW_SHOP_RECOMMENDATION =
            "click - follow shop recommendation"
        private const val EVENT_ACTION_CLICK_X_SHOP_RECOMMENDATION =
            "click - x - shop recommendation"
        private const val EVENT_ACTION_CLICK_SHOP_RECOMMENDATION = "click - shop recommendation"
        private const val EVENT_ACTION_IMPRESSION_SHOP_RECOMMENDATION =
            "impression - shop recommendation"
