...
object PerformanceDashboardNavigation {
    ...
    private const val PERFORMANCE_DASHBOARD_URL_PROD = "https://www.tokopedia.com/play/live"
    ...
    fun getPerformanceDashboardAppLink(): String {
        return String.format(PERFORMANCE_DASHBOARD_URL_WEB_VIEW, PERFORMANCE_DASHBOARD_URL_PROD)
    }
