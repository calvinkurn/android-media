...
import static com.tokopedia.content.common.util.sidesheet.Sheet.STATE_EXPANDED;
import static com.tokopedia.content.common.util.sidesheet.Sheet.STATE_HIDDEN;
...
/**
 * A delegate for {@link com.google.android.material.sidesheet.SideSheetBehavior} to handle positioning logic for sheets based on the
...
final class RightSheetDelegate extends SheetDelegate {
    ...
    int calculateTargetStateOnViewReleased(
        ...
        @Sheet.StableSheetState int targetState;
