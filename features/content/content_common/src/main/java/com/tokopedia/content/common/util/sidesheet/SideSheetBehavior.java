...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V>
    ...
    private final StateSettlingTracker stateSettlingTracker = new SideSheetBehavior.StateSettlingTracker();
    ...
    public void onRestoreInstanceState(
        ...
        SavedState ss = (SideSheetBehavior.SavedState) state;
                ...
                public void onViewPositionChanged(
                    ...
                    if (coplanarSiblingView != null) {
                        ViewGroup.MarginLayoutParams layoutParams =
                                (ViewGroup.MarginLayoutParams) coplanarSiblingView.getLayoutParams();
    ...
    private void updateAccessibilityActions() {
        ...
        if (state != STATE_HIDDEN) {
            replaceAccessibilityActionForState(
                    child, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_DISMISS, STATE_HIDDEN);
        }
    ...
    private void replaceAccessibilityActionForState(
            V child, AccessibilityNodeInfoCompat.AccessibilityActionCompat action, @SheetState int state) {
