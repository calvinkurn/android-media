...
class ContentCommentAnalytics @AssistedInject constructor(
    ...
    override fun clickCommentIcon() {
        Tracker.Builder()
            ...
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42591" else "41579")
    ...
    override fun closeCommentSheet() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42592" else "41580")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickReplyChild() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42593" else "41581")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickCommentName() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42594" else "41582")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickProfilePicture() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42595" else "41583")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun impressLihatBalasan() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42596" else "41584")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickLihatBalasan() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42597" else "41585")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickSembunyikan() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42598" else "41586")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickTextBox() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42599" else "41587")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickSendParentComment() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42600" else "41588")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickSendChildComment() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42601" else "41589")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun longClickComment() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42602" else "41590")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickRemoveComment() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42603" else "41591")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickReportComment() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42604" else "41592")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickReportReason(reportType: String) {
        Tracker.Builder()
            ...
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42605" else "41593")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun impressSuccessReport() {
        Tracker.Builder()
            ...
            .setEventCategory(analyticModel.eventCategory)
            .setEventLabel(analyticModel.eventLabel)
            .setCustomProperty(KEY_SESSION_IRIS, if (source.isPlay) "42605" else "41594")
            .setBusinessUnit(businessUnit)
            .setCurrentSite(KEY_MARKETPLACE)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
