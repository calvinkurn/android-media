...
import com.tokopedia.createpost.createpost.databinding.ItemLastPurchasedProductListBinding
 ...
 */
internal class LastPurchasedProductViewHolder private constructor() {

    internal class Product(
        private val binding: ItemLastPurchasedProductListBinding,
        private val onSelected: (ProductUiModel) -> Unit,
    ) : RecyclerView.ViewHolder(binding.root) {

        fun bind(item: LastPurchasedProductAdapter.Model.Product) {
        ...
        companion object {
            ...
            fun create(
                ...
                binding = ItemLastPurchasedProductListBinding.inflate(
