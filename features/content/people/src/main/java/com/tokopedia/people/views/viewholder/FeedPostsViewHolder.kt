...
import com.tokopedia.people.databinding.ItemUserFeedShimmerBinding
 ...
 **/
class FeedPostsViewHolder private constructor() {
    ...
    class Shimmer(
        binding: ItemUserFeedShimmerBinding,
    ) : RecyclerView.ViewHolder(binding.root) {

        companion object {
            fun create(parent: ViewGroup) = Shimmer(
                ItemUserFeedShimmerBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false,
                ),
