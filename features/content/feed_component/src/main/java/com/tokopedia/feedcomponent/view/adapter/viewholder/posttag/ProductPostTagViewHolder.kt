...
class ProductPostTagViewHolder(val mainView: View,
    ...
    private fun renderTag(textView: TextView, tag: TagsItem) {
        ...
        val textColor = if(tag.textColor.hex.isEmpty()) getString(R.string.color_pojo_hex_black_value) else tag.textColor.hex
    ...
    private fun getDefaultBackgroundColor(): ColorPojo {
        return ColorPojo(getString(R.string.color_pojo_hex_black_value), OPACITY_70)
    }

    private fun getDefaultTextColor(): ColorPojo {
        return ColorPojo(getString(R.string.color_pojo_hex_white_value), OPACITY_100)
    }
