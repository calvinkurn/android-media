 ...
 */
class PostStatisticDetailAdapterDelegate : TypedAdapterDelegate<PostStatisticDetailUiModel, PostStatisticUiModel, PostStatisticViewHolder>(R.layout.item_post_statistic) {
