...
public interface KolEventTracking {
    ...
    interface Action {
        ...
        String SHOP_ITEM_IMPRESSION_MULTIPLE = "impression-multiple-merchant-all-merchant_post";
        String SHOP_ITEM_CLICK_MULTIPLE = "click-multiple-merchant-all-merchant_post-tag";
