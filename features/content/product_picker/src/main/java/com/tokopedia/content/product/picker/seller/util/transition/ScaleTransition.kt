package com.tokopedia.content.product.picker.seller.util.transition
...
class ScaleTransition : Visibility {
    ...
    companion object {
        private const val PROPNAME_TRANSITION_SCALE_X = "com.tokopedia.play.broadcaster:scaleTransition:scaleX"
        private const val PROPNAME_TRANSITION_SCALE_Y = "com.tokopedia.play.broadcaster:scaleTransition:scaleY"
    }
}
