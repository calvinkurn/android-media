...
import com.tokopedia.content.product.picker.databinding.ItemContentCreationSortListBinding
...
internal class SortAdapter(
    ...
    ) : TypedAdapterDelegate<SortUiModel, SortUiModel, ViewHolder>(contentcommonR.layout.view_cc_empty) {
