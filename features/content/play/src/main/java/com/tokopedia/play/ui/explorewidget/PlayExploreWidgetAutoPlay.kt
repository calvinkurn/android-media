...
/**
 * @author by astidhiyaa on 02/12/2022
 */
class PlayExploreWidgetAutoPlay(
    ...
    fun configureAutoPlay(widget: PlayWidgetLargeView, config: PlayWidgetConfigUiModel, type: PlayWidgetType) = synchronized(this@PlayExploreWidgetAutoPlay) {
        mConfig = config
