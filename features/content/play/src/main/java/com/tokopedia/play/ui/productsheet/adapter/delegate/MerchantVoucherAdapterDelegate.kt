 ...
 */
class MerchantVoucherAdapterDelegate : TypedAdapterDelegate<MerchantVoucherUiModel, MerchantVoucherUiModel, MerchantVoucherViewHolder>(R.layout.item_play_merchant_voucher) {
