 ...
 */
class WidgetAdapter internal constructor(listener: PlayExploreWidgetViewHolder.Widget.Listener) :
    BaseDiffUtilAdapter<PlayWidgetItemUiModel>() {
    init {
        delegatesManager.addDelegate(WidgetAdapterDelegate.Widget(listener))
