...
class PlayVodMockModelConfig : MockModelConfig() {
    ...
    companion object  {
                ...
                "playGetChannelDetails": {
                  "data": {
                    ...
                    "video": {
                      ...
                      "stream_source": "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4",
                      "autoplay": true,
                      "buffer_control": {
        ...
        """
        private const val KEY_QUERY_PINNED_PRODUCT = "playGetTagsItem"
        private const val RESPONSE_MOCK_PINNED_PRODUCT = """
            {
              "data": {
                "playGetTagsItem": {
                  "products": [
        ...
        """
        private const val KEY_QUERY_PRODUCT_VARIANT = "getProductVariant"
        private const val RESPONSE_MOCK_PRODUCT_VARIANT = """
            {
              "data": {
                "getProductVariant": {
                  "parentID": "745647988",
