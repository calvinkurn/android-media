...
import com.tokopedia.play.util.isKeyboardShown
...
class CavPlayTrackingTest {
    ...
    private fun performShop() {
        IdlingRegistry.getInstance().register(idlResShopInfo)
    ...
    private fun performWatchArea() {
        ...
        IdlingRegistry.getInstance().register(idlResImmersive)
        Espresso.onView(ViewMatchers.withId(R.id.v_immersive_box)).perform(ViewActions.click())
        IdlingRegistry.getInstance().unregister(idlResImmersive)
    }

    private fun performLike() {
        IdlingRegistry.getInstance().register(idlResLike)
        ...
        IdlingRegistry.getInstance().unregister(idlResLike)
    }
    ...
    private fun performSendChatQuickReply() {
        ...
        IdlingRegistry.getInstance().register(idlResKeyboard)
        Espresso.onView(ViewMatchers.withId(R.id.et_chat))
        ...
        IdlingRegistry.getInstance().unregister(idlResKeyboard)
    }
