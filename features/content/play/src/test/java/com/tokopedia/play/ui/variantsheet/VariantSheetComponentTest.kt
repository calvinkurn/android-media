...
class VariantSheetComponentTest {
    ...
    class VariantSheetComponentMock(container: ViewGroup, bus: EventBusFactory, private val scope: CoroutineScope) : VariantSheetComponent(container, bus, coroutineScope, TestCoroutineDispatchersProvider) {
