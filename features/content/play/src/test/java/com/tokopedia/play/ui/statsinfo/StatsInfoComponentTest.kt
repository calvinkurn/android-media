...
class StatsInfoComponentTest {
    ...
    class StatsInfoComponentMock(container: ViewGroup, bus: EventBusFactory, private val scope: CoroutineScope) : StatsInfoComponent(container, bus, coroutineScope, TestCoroutineDispatchersProvider) {
