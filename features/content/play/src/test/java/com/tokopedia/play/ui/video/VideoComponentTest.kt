...
class VideoComponentTest {
    ...
    class VideoComponentMock(container: ViewGroup, bus: EventBusFactory, scope: CoroutineScope) : VideoComponent(container, bus, scope, TestCoroutineDispatchersProvider) {
