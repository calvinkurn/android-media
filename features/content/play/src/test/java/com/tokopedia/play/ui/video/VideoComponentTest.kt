...
class VideoComponentTest {
    ...
    class VideoComponentMock(container: ViewGroup, bus: EventBusFactory, private val scope: CoroutineScope) : VideoComponent(container, bus, coroutineScope, TestCoroutineDispatchersProvider) {
