...
class ChatListComponentTest {
    ...
    class ChatListComponentMock(container: ViewGroup, bus: EventBusFactory, private val scope: CoroutineScope) : ChatListComponent(container, bus, coroutineScope, TestCoroutineDispatchersProvider) {
