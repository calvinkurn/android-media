...
class ImmersiveBoxComponentTest {
    ...
    class ImmersiveBoxComponentMock(container: ViewGroup, bus: EventBusFactory, private val scope: CoroutineScope) : ImmersiveBoxComponent(container, bus, coroutineScope, TestCoroutineDispatchersProvider) {
