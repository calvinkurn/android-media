...
class PinnedComponentTest {
    ...
    class PinnedComponentMock(container: ViewGroup, bus: EventBusFactory, private val scope: CoroutineScope) : PinnedComponent(container, bus, coroutineScope, TestCoroutineDispatchersProvider) {
