    ...
    private RecyclerView.ItemDecoration getItemDecoration() {
        return new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
                ...
                if (position == 0) {
                    outRect.top = (int) getResources().getDimension(R.dimen.unify_space_16);
                }
                ...
                if (visitable instanceof ExploreProductViewModel
                    ...
                    if (spanIndex == 0) {
                        outRect.left = (int) getResources().getDimension(R.dimen.unify_space_12);
                    } else {
                        outRect.right = (int) getResources().getDimension(R.dimen.unify_space_12);
                    }
                }
            }
        };
