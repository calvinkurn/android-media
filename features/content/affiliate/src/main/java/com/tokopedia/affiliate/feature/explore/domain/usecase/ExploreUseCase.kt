 ...
 */
class ExploreUseCase @Inject
internal constructor() : GraphqlUseCase() {
    ...
    fun createObservable(exploreParams: ExploreParams): Observable<GraphqlResponse> {
    ...
    companion object {
        ...
        fun getRequest(context: Context, exploreParams: ExploreParams): GraphqlRequest {
        ...
        fun getRequestLoadMore(context: Context, exploreParams: ExploreParams): GraphqlRequest {
            val query = GraphqlHelper.loadRawString(
                    context.resources,
