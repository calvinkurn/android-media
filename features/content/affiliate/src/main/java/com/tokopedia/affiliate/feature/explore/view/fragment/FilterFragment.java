...
public class FilterFragment extends BaseDaggerFragment {
    ...
    private void initView() {
        adapter = new FilterAdapter(getFilterClickListener(), R.layout.item_explore_filter_detail, FilterAdapter.PAGE_FILTER);
        ...
        rvFilter.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
                ...
                outRect.bottom = (int) getResources().getDimension(R.dimen.unify_space_4);
            }
        });
    ...
    private FilterAdapter.OnFilterClickedListener getFilterClickListener() {
        return (filters, filterViewModel) -> adapter.notifyDataSetChanged();
    }
