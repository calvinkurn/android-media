...
/**
 * copying from Unified Feed (same behaviour) with some adjustment
 */
@SuppressLint("ClickableViewAccessibility")
class ReviewCaptionView(
    ...
    private fun showFull() {
        textView.text = buildSpannedString {
            appendLine(fullText)
            append(getSpannedActionText(textView.context.getString(R.string.product_prev_review_collapse)))
        }
    ...
    private fun setupSelengkapnya() {
        ...
        val selengkapnyaText = textView.context.getString(R.string.product_prev_review_expand)
    ...
    interface Listener {
        fun onExpanded(view: ReviewCaptionView)
    }
}
