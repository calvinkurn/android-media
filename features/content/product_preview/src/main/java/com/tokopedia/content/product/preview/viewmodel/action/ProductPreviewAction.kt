...
sealed interface ProductPreviewAction {
    ...
    object ProductTabNotIdle : ProductPreviewAction
    object ReviewTabNotIdle : ProductPreviewAction
    ...
    data class TabSelected(val position: Int, val isScrolling: Boolean) : ProductPreviewAction
