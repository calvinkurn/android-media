 ...
 */
class PlayWidgetCardJumboTranscodeViewHolder(
    itemView: View,
    ...
    private val llWidgetContainer: LinearLayout =
        itemView.findViewById(R.id.play_widget_info_container)
    ...
    fun bind(item: PlayWidgetJumboChannelUiModel) {
    ...
    private fun setTranscodingModel(model: PlayWidgetJumboChannelUiModel) {
    ...
    private fun setFailedTranscodingModel(model: PlayWidgetJumboChannelUiModel) {
    ...
    companion object {
        @LayoutRes
        val layoutRes = R.layout.item_play_widget_card_transcode_jumbo
