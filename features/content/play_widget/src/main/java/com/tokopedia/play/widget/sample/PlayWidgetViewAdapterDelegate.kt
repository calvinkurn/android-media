 ...
 */
class PlayWidgetViewAdapterDelegate : TypedAdapterDelegate<PlayWidgetUiModel, PlayWidgetUiModel, PlayWidgetViewHolder>(PlayWidgetViewHolder.layout) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, basicView: View): PlayWidgetViewHolder {
        return PlayWidgetViewHolder(basicView)
    }
}