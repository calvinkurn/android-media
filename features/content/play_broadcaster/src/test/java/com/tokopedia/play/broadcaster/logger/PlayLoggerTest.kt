...
class PlayLoggerTest {
    ...
    fun testCollectLogs() {
        ...
        val expectedValue = ConcurrentLinkedQueue<Pair<String, String>>().apply {
            ...
            add(Pair("pusher", PlayLivePusherMediatorState.Idle.getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Connecting.getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Started.getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Resume(true).getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Resume(false).getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Recovered.getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Paused.getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Stopped.getName()))
            add(Pair("pusher", PlayLivePusherMediatorState.Error(PlayLivePusherException("unknown")).getName()))
