...
class PlayBroSetupCoverViewModelTest {
    ...
    private val mockImageGeneratorMapper = ImageGeneratorMapperMock(mockProductTag, mockContentAccount.first().iconUrl)
    ...
    fun `when user SetUploadAutoGeneratedCover`() {
        ...
        val mockPosition = 1
        val mockPreview = mockImageGeneratorMapper.getImagePreview(
            channelTitle = "Title",
            channelAuthor = "Shop",
        ...
        state.assertEqualTo(mockPreview)
    }
