...
class PlayBroadcastMockMapper : PlayBroadcastMapper {
    ...
    override fun mapTickerBottomSheetConfig(response: GetTickerBottomSheetResponse): TickerBottomSheetUiModel {
        return TickerBottomSheetUiModel.Empty
    }

    override fun mapReportSummary(response: GetReportSummaryResponse, isAuthorShop: Boolean): LiveReportSummaryUiModel {
