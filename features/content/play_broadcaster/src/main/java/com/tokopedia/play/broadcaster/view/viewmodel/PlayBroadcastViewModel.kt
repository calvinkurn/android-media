...
class PlayBroadcastViewModel @AssistedInject constructor(
    ...
    private val _autoGeneratedCover = MutableStateFlow<List<AutoGeneratedCoverIUIModel>>(emptyList())
    ...
    fun updateMockGeneratedCover(position: Int) {
