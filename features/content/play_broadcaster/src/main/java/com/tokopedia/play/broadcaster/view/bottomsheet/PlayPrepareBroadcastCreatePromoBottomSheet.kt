...
class PlayPrepareBroadcastCreatePromoBottomSheet : BottomSheetUnify() {
    ...
    private fun showMainStateView() {
        ...
        if (promoPercentage in MIN_PERCENT_QUOTA_VALUE..MAX_PERCENT_VALUE &&
            ...
            tvPlayPrepareBroadcastWithPromoTitle.setTextColor(resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_68))
            ...
            tvPlayPrepareBroadcastWithPromoDescription.setTextColor(resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_96))
            ...
            tvPlayPrepareBroadcastWithPromoTitle.setTextColor(resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_96))
            ...
            tvPlayPrepareBroadcastWithPromoDescription.setTextColor(resources.getColor(com.tokopedia.unifyprinciples.R.color.Unify_NN950_68))
