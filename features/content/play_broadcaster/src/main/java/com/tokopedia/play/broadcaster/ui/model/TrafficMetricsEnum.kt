...
enum class TrafficMetricsEnum(val thumbnailRes: Int, val descriptionRes: Int) {
    ...
    NEW_FOLLOWERS(R.drawable.ic_play_new_follower_white, R.string.play_summary_new_followers);
}