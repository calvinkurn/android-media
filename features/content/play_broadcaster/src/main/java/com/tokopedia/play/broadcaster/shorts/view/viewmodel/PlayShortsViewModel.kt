...
class PlayShortsViewModel @Inject constructor(
    ...
    val coverUri: String
        get() = if (_coverForm.value.coverUri.isEmpty()) {
            _media.value.mediaUri
        } else {
            _coverForm.value.coverUri
        }
    ...
    private fun handleClickNext() {
        viewModelScope.launch {
            ...
            _interspersingConfig.update { interspersingConfig ->
                val isInterspersingAllowed = _config.value.eligibleForInterspersing &&
