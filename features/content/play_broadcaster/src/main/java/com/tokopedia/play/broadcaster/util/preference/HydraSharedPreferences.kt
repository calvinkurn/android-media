...
class HydraSharedPreferences @Inject constructor(
    ...
    fun savedSelectedAutoGeneratedCover(position: Int) {
        mSharedPrefs.edit()
            .putInt(
                String.format(KEY_SAVED_SELECTED_AUTO_GENERATED_COVER, userSession.userId),
                position,
            ).apply()
    }

    fun getSavedSelectedAutoGeneratedCover(): Int {
