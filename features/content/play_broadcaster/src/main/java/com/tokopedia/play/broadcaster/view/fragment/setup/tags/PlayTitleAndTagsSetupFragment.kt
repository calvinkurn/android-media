...
import com.tokopedia.play.broadcaster.view.partial.TextFieldTitleComponent
...
class PlayTitleAndTagsSetupFragment @Inject constructor(
    ...
    private val titleFieldView by viewComponent(isEagerInit = true) { TextFieldTitleComponent(it, R.id.text_field_title) }
