...
internal class EtalaseListAdapter(
    ...
    sealed class Model {
        ...
        data class Campaign(val campaignUiModel: CampaignUiModel, val isSelected: Boolean, val isShowDivider: Boolean) : Model()
        data class Etalase(val etalaseUiModel: EtalaseUiModel, val isSelected: Boolean, val isShowDivider: Boolean) : Model()
    }
}