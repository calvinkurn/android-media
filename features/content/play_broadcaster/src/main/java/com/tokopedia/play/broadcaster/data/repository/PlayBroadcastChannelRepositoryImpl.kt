...
import com.tokopedia.play.broadcaster.domain.usecase.estimatedincome.GetReportProductSummaryUseCase
import com.tokopedia.play.broadcaster.domain.usecase.estimatedincome.GetReportSummaryUseCase
...
class PlayBroadcastChannelRepositoryImpl @Inject constructor(
    ...
    override suspend fun getReportProductSummary(channelId: String): ProductReportSummaryUiModel = withContext(dispatchers.io) {
