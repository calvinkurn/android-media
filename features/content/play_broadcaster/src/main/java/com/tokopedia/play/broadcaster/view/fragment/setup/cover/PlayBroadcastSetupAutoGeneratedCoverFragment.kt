...
class PlayBroadcastSetupAutoGeneratedCoverFragment @Inject constructor(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        showTemplate(viewModel.productSectionList.isNotEmpty())
        if (viewModel.productSectionList.isNotEmpty()) {
    ...
    private fun observeUIEvent() {
        viewLifecycleOwner.lifecycleScope.launchWhenCreated {
            viewModel.uiEvent.collect { event ->
                when (event) {
                    is PlayBroSetupCoverEvent.SubmitCoverLoading -> {
                    ...
                    is PlayBroSetupCoverEvent.ButtonState -> {
    ...
    override fun onClickItem(data: AutoGeneratedCoverUIModel, position: Int) {
        viewModel.submitAction(PlayBroSetupCoverAction.SelectAutoGeneratedCover(data, position))
