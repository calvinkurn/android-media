...
class PlayBroadcastSetupAutoGeneratedCoverFragment @Inject constructor(
    ...
    private fun setupViews() = with(binding) {
        ...
        btnEmptyProduct.setOnClickListener {
            analytic.clickTemplateCoverAddProduct()
            mListener?.setupCoverProductClicked()
        }
        btnSetupCoverChooseTemplate.setOnClickListener {
            if (btnSetupCoverChooseTemplate.isEnabled) {
                analytic.clickSaveGeneratedCoverOption()
                mListener?.setupCoverButtonSaveClicked()
            }
        }
    }
    ...
    override fun onClickItem(data: AutoGeneratedCoverIUModel, position: Int) {
        analytic.clickSelectGeneratedCover()
