...
class PlayBroadcastSetupAutoGeneratedCoverFragment @Inject constructor(
                ...
                when (event) {
                    ...
                    is PlayBroadcastEvent.ErrorGetAutoGeneratedCover -> {
                        toaster.showError(
                            ...
                            actionListener = {
                                analytic.clickTryAgainTemplateCoverBottomSheet()
    ...
    private fun setupViews() = with(binding) {
        ...
        btnSetupCoverChooseTemplateSave.setOnClickListener {
            if (btnSetupCoverChooseTemplateDelete.isVisible) {
                analytic.clickSaveGeneratedCoverOption(parentViewModel.autoGeneratedCoverAnalyticData)
            } else {
                analytic.clickSaveGeneratedCover(parentViewModel.autoGeneratedCoverAnalyticData)
            }
        ...
        btnSetupCoverChooseTemplateDelete.setOnClickListener {
            analytic.clickDeleteGeneratedCover(parentViewModel.autoGeneratedCoverAnalyticData)
    ...
    override fun onClickItem(data: AutoGeneratedCoverUIModel, position: Int) {
        analytic.clickSelectGeneratedCover(parentViewModel.autoGeneratedCoverAnalyticData)
