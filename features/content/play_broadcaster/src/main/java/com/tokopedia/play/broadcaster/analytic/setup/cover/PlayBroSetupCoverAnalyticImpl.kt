...
class PlayBroSetupCoverAnalyticImpl @Inject constructor(
    ...
    override fun clickSaveGeneratedCover(coverData: AutoGeneratedCoverAnalyticModel) {
        Tracker.Builder()
            .setEvent(KEY_TRACK_CLICK_EVENT_SELLER)
            .setEventAction("click - save generated cover")
            .setEventCategory(KEY_TRACK_CATEGORY_PLAY)
            .setCustomProperty(KEY_TRACKER_ID, getTrackerId("40742", "40709"))
            .setEventLabel("$authorId - $authorTypeName - ${coverData.coverId} - ${coverData.coverPosition + 1} - ${coverData.coverColor}")
            .setBusinessUnit(KEY_TRACK_BUSINESS_UNIT)
            .setCurrentSite(currentSite)
            .setCustomProperty(KEY_SESSION_IRIS, sessionIris)
            .setUserId(userId)
    ...
    override fun clickDeleteGeneratedCover(coverData: AutoGeneratedCoverAnalyticModel) {
        Tracker.Builder()
            .setEvent(KEY_TRACK_CLICK_EVENT_SELLER)
    ...
    override fun clickSelectGeneratedCover(coverData: AutoGeneratedCoverAnalyticModel) {
        Tracker.Builder()
            .setEvent(KEY_TRACK_CLICK_EVENT_SELLER)
    ...
    override fun clickSaveGeneratedCoverOption(coverData: AutoGeneratedCoverAnalyticModel) {
        Tracker.Builder()
            .setEvent(KEY_TRACK_CLICK_EVENT_SELLER)
