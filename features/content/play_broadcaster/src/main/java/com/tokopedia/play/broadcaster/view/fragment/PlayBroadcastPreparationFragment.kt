            ...
            parentViewModel.uiEvent.collect { event ->
                when (event) {
                    ...
                    is PlayBroadcastEvent.AutoGeneratedCoverToasterUpdate -> {
                        toaster.showToaster(getString(R.string.play_setup_cover_auto_generated_toaster_update_cover_from_product))
                    }
                    is PlayBroadcastEvent.AutoGeneratedCoverToasterDelete -> {
                        toaster.showToaster(getString(R.string.play_setup_cover_auto_generated_toaster_delete_cover_from_product))
                    }
                    else -> {}
                }
            }
