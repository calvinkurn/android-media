...
sealed interface PlayBroadcastAction {
    ...
    data class SelectAutoGeneratedCover(val data: AutoGeneratedCoverIUModel, val position: Int) : PlayBroadcastAction
    ...
    data class CheckButtonState(val showDelete: Boolean = false): PlayBroadcastAction
}
