...
sealed interface PlayBroadcastAction {
    ...
    data class SelectAutoGeneratedCover(val data: AutoGeneratedCoverUIModel, val position: Int) : PlayBroadcastAction
    object UnSelectAutoGeneratedCover : PlayBroadcastAction
    object GetAutoGeneratedImageCoverPreview : PlayBroadcastAction
    object SaveSelectedImageCover: PlayBroadcastAction
    object CheckButtonState: PlayBroadcastAction
    object RemoveStateAutoGeneratedCover: PlayBroadcastAction
}
