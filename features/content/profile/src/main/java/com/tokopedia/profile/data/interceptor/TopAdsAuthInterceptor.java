package com.tokopedia.profile.data.interceptor;
...
public class TopAdsAuthInterceptor extends TkpdAuthInterceptor {
    ...
    public TopAdsAuthInterceptor(Context context, NetworkRouter abstractionRouter,
