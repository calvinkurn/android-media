...
open class RoundedConstraintLayout : ConstraintLayout {
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?) {
        ...
        val topLeft = attributeArray.getDimension(
            R.styleable.RoundedConstraintLayout_rcl_topLeftRadius, -1f
        )
        val topRight = attributeArray.getDimension(
            R.styleable.RoundedConstraintLayout_rcl_topRightRadius, -1f
        )
        val bottomLeft = attributeArray.getDimension(
            R.styleable.RoundedConstraintLayout_rcl_bottomLeftRadius, -1f
        )
        val bottomRight = attributeArray.getDimension(
            R.styleable.RoundedConstraintLayout_rcl_bottomRightRadius, -1f
        )
