package com.tokopedia.broadcaster.chucker.ui.fragment.detail
...
class ChuckerDetailBottomSheet : BottomSheetDialogFragment() {
    ...
    private lateinit var detailModel: ChuckerLogUIModel
    ...
    private fun initParam() {
        arguments?.getParcelable<ChuckerLogUIModel>(BUNDLE_CHUCKER_LOG_KEY)?.let {
            detailModel = it
        }
    }
    ...
    companion object {
        ...
        fun create(fragmentManager: FragmentManager, model: ChuckerLogUIModel) {
