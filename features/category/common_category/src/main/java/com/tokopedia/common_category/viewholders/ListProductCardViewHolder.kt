...
class ListProductCardViewHolder(itemView: View,productCardListener: com.tokopedia.common_category.interfaces.ProductCardListener) : ProductCardViewHolder(itemView,productCardListener) {
