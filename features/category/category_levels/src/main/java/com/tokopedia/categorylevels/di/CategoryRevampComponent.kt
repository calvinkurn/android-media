...
import com.tokopedia.categorylevels.domain.repository.CategoryTopAdsHeadlineUseCase
...
interface CategoryRevampComponent {
    ...
    fun getCategoryTopAdsHeadlineRepository(): CategoryTopAdsHeadlineUseCase
}