package com.tokopedia.category_levels.view.activity
...
import com.tokopedia.category_levels.view.fragment.CatalogNavFragment
import com.tokopedia.category_levels.view.fragment.ProductNavFragment
...
class CategoryNavActivity : BaseActivity(), CategoryNavigationListener,
    ...
    private var categorySectionPagerAdapter: com.tokopedia.category_levels.adapters.CategoryNavigationPagerAdapter? = null
    ...
    private lateinit var categoryNavComponent: com.tokopedia.category_levels.di.CategoryNavComponent

    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory

    @Inject
    lateinit var categoryNavViewModel: com.tokopedia.category_levels.viewmodel.CategoryNavViewModel
    ...
    private fun prepareView() {
        this.let { observer ->
            ...
            categoryNavViewModel = viewModelProvider.get(com.tokopedia.category_levels.viewmodel.CategoryNavViewModel::class.java)
    ...
    private fun loadSection() {
        ...
        categorySectionPagerAdapter = com.tokopedia.category_levels.adapters.CategoryNavigationPagerAdapter(supportFragmentManager)
