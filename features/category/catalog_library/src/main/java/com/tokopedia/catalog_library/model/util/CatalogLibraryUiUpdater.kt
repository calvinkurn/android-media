...
class CatalogLibraryUiUpdater(var mapOfData: MutableMap<String, BaseCatalogLibraryDataModel>) {
    ...
    fun setUpForLandingPage(){
        updateModel(CatalogShimmerDataModel(CatalogLibraryConstant.CATALOG_TOP_FIVE,CatalogLibraryConstant.CATALOG_TOP_FIVE,1))
        updateModel(CatalogShimmerDataModel(CatalogLibraryConstant.CATALOG_MOST_VIRAL,CatalogLibraryConstant.CATALOG_MOST_VIRAL,2))
        updateModel(CatalogShimmerDataModel(CatalogLibraryConstant.CATALOG_LIST,CatalogLibraryConstant.CATALOG_LIST,3))
    }
