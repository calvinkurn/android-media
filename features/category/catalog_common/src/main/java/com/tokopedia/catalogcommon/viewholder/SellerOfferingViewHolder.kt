...
class SellerOfferingViewHolder(
    ...
    fun setStyleWidget(element: SellerOfferingUiModel) = binding?.apply {
        ...
        tvShopName.setTextColor(element.widgetTextColor.orZero())
        tvShopLocation.setTextColor(element.widgetTextColor.orZero())
        tvShopResposiveChat.setTextColor(element.widgetTextColor.orZero())
        tvShopResponsiveOrder.setTextColor(element.widgetTextColor.orZero())
        tvProductName.setTextColor(element.widgetTextColor.orZero())
        tvPrice.setTextColor(element.widgetTextColor.orZero())
        tvSlashPrice.setTextColor(element.widgetTextColor.orZero())
        tvLabelPromo.setTextColor(element.widgetTextColor.orZero())
        tvSalesRatingFloat.setTextColor(element.widgetTextColor.orZero())
        tvTotalSold.setTextColor(element.widgetTextColor.orZero())
        tvEstimation.setTextColor(element.widgetTextColor.orZero())
        tvGuarantee.setTextColor(element.widgetTextColor.orZero())
        tvInstallment.setTextColor(element.widgetTextColor.orZero())
    }
}
