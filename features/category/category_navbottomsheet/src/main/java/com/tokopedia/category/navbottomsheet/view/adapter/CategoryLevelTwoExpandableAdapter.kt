...
class CategoryLevelTwoExpandableAdapter(var levelTwoList: List<ChildItem?>?)
    ...
    override fun getChildView(listPosition: Int, expandedListPosition: Int,
        ...
        val expandedListTextView = convertView?.findViewById<View>(R.id.expandedListItem) as? Typography
    ...
    override fun getGroupView(listPosition: Int, isExpanded: Boolean,
        ...
        val listTitleTextView = convertView?.findViewById<View>(R.id.listTitle) as? Typography
