...
class AffiliateIncomeViewModelTest {
    ...
    fun `Get Affiliate Balance`() {
        ...
        assertEquals(affiliateIncomeViewModel.getAffiliateBalanceData().value, affiliateBalance.affiliateBalance?.balanceData)
    }
    ...
    fun getTransactionDetailsTest() {
        ...
        val response = affiliateIncomeViewModel.convertDataToVisitables(transaction.getAffiliateTransactionHistory?.transactionData)
