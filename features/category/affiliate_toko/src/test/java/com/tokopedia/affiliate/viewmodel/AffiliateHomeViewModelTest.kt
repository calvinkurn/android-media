...
class AffiliateHomeViewModelTest {
    ...
    private var affiliateHomeViewModel = spyk(
        AffiliateHomeViewModel(
            userSessionInterface, affiliateValidateUserStatus,
            affiliateAffiliateAnnouncementUseCase, affiliateUserPerformanceUseCase,
            affiliatePerformanceItemTypeUseCase, affiliatePerformanceDataUseCase
        )
    )
    ...
    fun getAffiliatePerformance() {
        ...
        coEvery {
            affiliatePerformanceDataUseCase.affiliateItemPerformanceList(any(), any(), any())
        ...
        coEvery {
            affiliateUserPerformanceUseCase.affiliateUserperformance(affiliateHomeViewModel.getSelectedDate())
