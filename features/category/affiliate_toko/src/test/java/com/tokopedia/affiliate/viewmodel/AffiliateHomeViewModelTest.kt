...
class AffiliateHomeViewModelTest{
    ...
    private val affiliateValidateUserStatus: AffiliateValidateUserStatus = mockk()
    ...
    fun getAffiliateValidateUser() {
        ...
        coEvery { affiliateValidateUserStatus.validateUserStatus(any(), any()) } returns affiliateValidateUserData
    ...
    fun getAffiliateValidateUserException() {
        ...
        coEvery { affiliateValidateUserStatus.validateUserStatus(any(), any()) } throws Exception(exception)
    ...
    fun getAffiliatePerformance() {
        ...
        coEvery { affiliatePerformanceUseCase.affiliatePerformance(any()) } returns affiliatePerformanceData
    ...
    fun getAffiliatePerformanceException() {
        ...
        coEvery { affiliatePerformanceUseCase.affiliatePerformance(any()) } throws Exception(exception)
