...
import com.tokopedia.affiliate.PAGE_ANNOUNCEMENT_ADP
...
class AffiliateHomeViewModelTest{
    ...
    fun getAnnouncementInformation(){
        ...
        coEvery { affiliateAffiliateAnnouncementUseCase.getAffiliateAnnouncement(PAGE_ANNOUNCEMENT_ADP) } returns affiliateAnnouncementData
    ...
    fun getAnnouncementValidateException() {
        ...
        coEvery { affiliateAffiliateAnnouncementUseCase.getAffiliateAnnouncement(PAGE_ANNOUNCEMENT_ADP) } throws throwable
