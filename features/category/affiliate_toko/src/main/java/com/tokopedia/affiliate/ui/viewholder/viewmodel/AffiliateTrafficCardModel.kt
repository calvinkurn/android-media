...
class AffiliateTrafficCardModel(val product: AffiliateTrafficCommissionCardDetails.GetAffiliateTrafficCommissionDetailCards.Data.TrafficCommissionCardDetail?) : Visitable<AffiliateAdapterTypeFactory> {
