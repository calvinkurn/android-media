...
//        )
        return getDummyData(filter)
    }

    fun getDummyData(filter: ArrayList<String>): AffiliateSearchData {
        ...
        if (filter.contains("0")) {
            val error = AffiliateSearchData.Error(1, "",
                    "", 0,
                    ...
                    null)
            return AffiliateSearchData(0, null, error)
        } else if (filter.contains("1")) {
            val error = AffiliateSearchData.Error(0, "Oops, produk nggak ditemukan",
                    "Cek ulang atau coba link lain untuk temukan produk yang diinginkan.", 1, AffiliateSearchData.Cards.Items.Image("", "", "", "https://www.pinclipart.com/picdir/big/194-1948210_open-jpg-100x100-pixels-clipart.png"),
                    arrayListOf(AffiliateSearchData.Error.ErrorCta("Ganti Link", 0, 0,
            ...
            val error = AffiliateSearchData.Error(0, "Produk ini belum bisa dipromosikan",
                    "Pilih produk dari kategori yang dapat dipromosikan, ya.", 2, AffiliateSearchData.Cards.Items.Image("", "", "", "https://www.pinclipart.com/picdir/big/194-1948210_open-jpg-100x100-pixels-clipart.png"),
                    arrayListOf(AffiliateSearchData.Error.ErrorCta("Lihat Kategori", 1, 0,
                            AffiliateSearchData.Error.ErrorCta.CtaLink("", "", "", "https://www.pinclipart.com/picdir/big/194-1948210_open-jpg-100x100-pixels-clipart.png")),
                            AffiliateSearchData.Error.ErrorCta("Ganti Link", 0, 0,
                            AffiliateSearchData.Error.ErrorCta.CtaLink("", "", "", "https://www.pinclipart.com/picdir/big/194-1948210_open-jpg-100x100-pixels-clipart.png"))))
            return AffiliateSearchData(0, null, error)
        } else if (filter.contains("3")) {
            val error = AffiliateSearchData.Error(0, "Oops, produk ini belum bisa dipromosikan",
                    "Kamu bisa pilih produk dari toko Official Store maupun Power Merchant.", 3, AffiliateSearchData.Cards.Items.Image("", "", "", "https://www.pinclipart.com/picdir/big/194-1948210_open-jpg-100x100-pixels-clipart.png"),
                    arrayListOf(AffiliateSearchData.Error.ErrorCta("Ganti Link", 0, 0,
                            AffiliateSearchData.Error.ErrorCta.CtaLink("", "", "", "https://www.pinclipart.com/picdir/big/194-1948210_open-jpg-100x100-pixels-clipart.png"))))
            return AffiliateSearchData(0, null, error)
        }
        return AffiliateSearchData(1, card, null)
    }
