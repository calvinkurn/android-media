...
class AffiliatePerformaSharedProductCardsModel(val product: AffiliatePerformanceListData.GetAffiliatePerformanceList.Data.Data.Item) : Visitable<AffiliateAdapterTypeFactory> {
