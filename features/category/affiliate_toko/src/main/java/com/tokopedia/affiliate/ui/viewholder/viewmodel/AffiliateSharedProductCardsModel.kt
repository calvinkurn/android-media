...
class AffiliateSharedProductCardsModel(val product: AffiliatePerformanceData.GetAffiliateItemsPerformanceList.Data.SectionData.Item) : Visitable<AffiliateAdapterTypeFactory> {
