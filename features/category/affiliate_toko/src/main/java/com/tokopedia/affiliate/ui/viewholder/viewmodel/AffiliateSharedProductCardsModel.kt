...
class AffiliateSharedProductCardsModel(val product: AffiliatePerformanceData.AffiliatePerformance.Data.Links.Item) : Visitable<AffiliateAdapterTypeFactory> {
