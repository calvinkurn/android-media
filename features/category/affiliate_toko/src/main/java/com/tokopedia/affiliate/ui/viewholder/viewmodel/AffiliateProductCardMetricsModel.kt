...
class AffiliateProductCardMetricsModel(val metrics: AffiliatePerformanceListData.GetAffiliatePerformanceList.Data.Data.Item.Metric?) : Visitable<AffiliateAdapterTypeFactory> {
