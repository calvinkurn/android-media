...
class AffiliateGenerateLinkUseCase @Inject constructor(
    ...
    private fun createRequestParams(id: Int?, url: String?, identifier: String?, type: String): Map<String, Any> {
    ...
    suspend fun affiliateGenerateLink(id: Int?, url: String?, identifier: String?,type: String): AffiliateGenerateLinkData.AffiliateGenerateLink.Data? {
        return repository.getGQLData(
                GQL_Affiliate_Generate_Link,
                AffiliateGenerateLinkData::class.java,
                createRequestParams(id, url, identifier,type)
