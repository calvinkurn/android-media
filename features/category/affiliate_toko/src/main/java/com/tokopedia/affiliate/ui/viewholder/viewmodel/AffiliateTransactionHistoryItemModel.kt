...
class AffiliateTransactionHistoryItemModel(var transaction: AffiliateTransactionHistoryData.GetAffiliateTransactionHistory.Data.Transaction) : Visitable<AffiliateAdapterTypeFactory> {
