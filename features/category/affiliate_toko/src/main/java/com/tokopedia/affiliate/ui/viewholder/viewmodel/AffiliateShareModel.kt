...
class AffiliateShareModel(var name: String, var iconId: Int?, var serviceFormat : String?, var id : Int? = 0 ,
                          ...
                          var buttonLoad: Boolean = false, var isChecked : Boolean = false, var isLinkGenerationEnabled : Boolean = true ,var regex : String? = null) : Visitable<AffiliateAdapterTypeFactory> {
