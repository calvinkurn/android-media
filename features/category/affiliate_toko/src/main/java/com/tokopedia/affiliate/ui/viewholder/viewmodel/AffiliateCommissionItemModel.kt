...
class AffiliateCommissionItemModel(var data: AffiliateCommissionDetailsData.GetAffiliateCommissionDetail.Data.Detail?) : Visitable<AffiliateAdapterTypeFactory> {
