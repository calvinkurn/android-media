...
class AffiliateHowToPromoteBottomSheet : BottomSheetUnify() {
    ...
    companion object {
        ...
        fun newInstance(
            ...
            type: String? = ""
        ): AffiliateHowToPromoteBottomSheet {
    ...
    private fun init() {
        ...
        arguments?.let {
            ...
            type = it.getString(TYPE, PAGE_TYPE_PDP)
        }
        when (state) {
            ...
            STATE_PRODUCT_INACTIVE -> {
                ...
                if (type == PAGE_TYPE_PDP) {
                    ...
                    steps.add(Pair(getString(R.string.affiliate_shop_inactive_text), false))
                }
            }
            STATE_PERFORMA_INFO -> {
                arguments?.let {
    ...
    private fun getSpannableString(string: String, typography: Typography) {
        ...
        val clickableSpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(textView: View) {
                dismiss()
                RouteManager.routeNoFallbackCheck(
                    context,
                    AFFILIATE_LIHAT_KATEGORI,
                    AFFILIATE_LIHAT_KATEGORI
                )
            }
