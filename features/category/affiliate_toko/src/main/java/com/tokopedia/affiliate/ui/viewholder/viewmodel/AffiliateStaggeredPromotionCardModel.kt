...
class AffiliateStaggeredPromotionCardModel(val product: AffiliatePerformanceData.GetAffiliateItemsPerformanceList.Data.SectionData.Item)  : Visitable<AffiliateAdapterTypeFactory> {
