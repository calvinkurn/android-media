...
interface EPharmacyAdapterFactory {
    ...
    fun type(data : EPharmacyOrderDetailHeaderDataModel) : Int
    fun type(data : EPharmacyOrderDetailInfoDataModel) : Int
    fun type(data : EPharmacyOrderDetailPaymentDataModel) : Int
