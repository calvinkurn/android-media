...
class EPharmacyPrescriptionGalleryItemViewHolder(private val viewItem: View) : RecyclerView.ViewHolder(viewItem) {
    ...
    private var cameraIcon = viewItem.findViewById<IconUnify>(R.id.camera_button)
    private var cancelButton = viewItem.findViewById<IconUnify>(R.id.cross_image_button)
