...
class DiscoveryAnalytics(private val pageType: String = "",
    ...
    companion object {
        val discoveryAnalytics: DiscoveryAnalytics by lazy { DiscoveryAnalytics() }
    }
    ...
    //41
    fun trackImpressionIconDynamicComponent(headerName: String, headerPosition: String, icons: ArrayList<DataItem>?, trackingQueue: TrackingQueue) {
    ...
    //42
    fun trackClickIconDynamicComponent(headerName: String, headerPosition: String, icons: ArrayList<DataItem>?, trackingQueue: TrackingQueue) {
