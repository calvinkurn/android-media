...
open class BaseDiscoveryAnalytics(val pageType: String = DISCOVERY_DEFAULT_PAGE_TYPE,
    ...
    open fun trackPlayWidgetImpression(componentsItem : ComponentsItem,userID: String?, widgetPosition: Int) {}
    open fun trackPlayWidgetClick(componentsItem : ComponentsItem,userID: String?,destinationURL: String?, widgetPosition: Int) {}
