...
open class BaseDiscoveryAnalytics(val pageType: String = DISCOVERY_DEFAULT_PAGE_TYPE,
    ...
    open fun trackTDNBannerImpression(componentsItem: ComponentsItem, userID: String?, positionInPage: Int) {}
    open fun trackTDNBannerClick(componentsItem: ComponentsItem,userID: String?, positionInPage: Int){}
