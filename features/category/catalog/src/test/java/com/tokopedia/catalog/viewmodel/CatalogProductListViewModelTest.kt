...
class CatalogProductListViewModelTest {
    ...
    fun `Get Catalog Product Response Success`() {
        val mockGqlResponse: GraphqlResponse =
            createMockGraphqlResponse(
                ...
                CatalogSearchProductForReimaganeResponse().javaClass
            )
        val data = mockGqlResponse.getData(CatalogSearchProductForReimaganeResponse::class.java) as CatalogSearchProductForReimaganeResponse
    ...
    fun `Get Catalog Product Response Empty`() {
        ...
        val mockGqlResponse: GraphqlResponse =
            createMockGraphqlResponse(
                getJsonObject("catalog_empty_dummy_response.json"),
                CatalogSearchProductForReimaganeResponse().javaClass
            )
        val data =
            mockGqlResponse.getData(CatalogSearchProductForReimaganeResponse::class.java) as CatalogSearchProductForReimaganeResponse
        coEvery {
            getProductListUseCase.execute(param)
        } returns data
