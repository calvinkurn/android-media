package com.tokopedia.kyc.view.widget;
...
public class RectangleOverlayView extends LinearLayout {
    ...
    public RectangleOverlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.KycRectangleOverlayView);
        insetDist = convertPixelsToDp(
                arr.getDimension(R.styleable.KycRectangleOverlayView_inset_distance, 0), context);
        outLineImageId = arr.getResourceId(R.styleable.KycRectangleOverlayView_outline_img, -1);
        colorId = arr.getResourceId(R.styleable.KycRectangleOverlayView_fg_color, -1);
    }
