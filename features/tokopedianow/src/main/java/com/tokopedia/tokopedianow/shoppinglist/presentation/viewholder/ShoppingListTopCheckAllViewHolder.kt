...
import com.tokopedia.tokopedianow.databinding.ItemTokopedianowTopCheckAllBinding
...
class ShoppingListTopCheckAllViewHolder(
    ...
    companion object {
        @LayoutRes
        val LAYOUT = R.layout.item_tokopedianow_top_check_all
    }

    private var binding: ItemTokopedianowTopCheckAllBinding? by viewBinding()
