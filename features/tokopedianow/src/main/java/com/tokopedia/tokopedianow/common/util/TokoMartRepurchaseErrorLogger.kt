...
object TokoMartRepurchaseErrorLogger {

    private const val ERROR_TAG = "TOKO_MART_REPURCHASE_ERROR"
    ...
    internal const val LOAD_MORE_ERROR = "error load more layout data"
