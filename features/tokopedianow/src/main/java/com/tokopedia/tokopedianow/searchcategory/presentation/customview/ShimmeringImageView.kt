...
import kotlinx.android.synthetic.main.layout_tokopedianow_shimmering_image_view.view.*
...
class ShimmeringImageView @JvmOverloads constructor(context: Context, private val attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun init(){
        View.inflate(context, R.layout.layout_tokopedianow_shimmering_image_view, this)
