...
class HomeQuestCardAdapter : ListAdapter<HomeQuestCardItemUiModel, HomeQuestCardItemViewHolder>(HomeQuestCardDiffCallback()) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeQuestCardItemViewHolder {
        ...
        return HomeQuestCardItemViewHolder(binding)
    }
