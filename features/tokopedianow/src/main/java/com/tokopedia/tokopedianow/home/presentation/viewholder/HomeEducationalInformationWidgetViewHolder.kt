...
class HomeEducationalInformationWidgetViewHolder(
    ...
    companion object {
        private const val LOTTIE = ImageUrl.LOTTIE
        private const val IMG_TIME = ImageUrl.IMG_TIME
        private const val IMG_STOCK_AVAILABLE = ImageUrl.IMG_STOCK_AVAILABLE
        private const val IMG_GUARANTEED_QUALITY = ImageUrl.IMG_GUARANTEED_QUALITY
        private const val IMG_FREE_SHIPPING = ImageUrl.IMG_FREE_SHIPPING
