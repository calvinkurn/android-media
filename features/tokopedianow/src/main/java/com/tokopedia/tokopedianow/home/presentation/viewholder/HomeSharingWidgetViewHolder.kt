...
class HomeSharingWidgetViewHolder(
    ...
    companion object {
        private const val IMG_SHARING_EDUCATION = ImageUrl.IMG_SHARING_EDUCATION
        private const val LOTTIE_REFERRAL = ImageUrl.LOTTIE_REFERRAL
        private const val IMG_SHARING_REFERRAL_BG_BTM = ImageUrl.IMG_SHARING_REFERRAL_BG_BTM
        private const val IMG_SHARING_REFERRAL_BG_TOP = ImageUrl.IMG_SHARING_REFERRAL_BG_TOP
