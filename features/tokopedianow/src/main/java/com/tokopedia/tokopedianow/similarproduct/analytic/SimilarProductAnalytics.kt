...
class SimilarProductAnalytics(
    ...
    override fun trackImpressionProduct(product: SimilarProductUiModel) {
        val items = listOf(
    ...
    override fun trackClickProduct(product: SimilarProductUiModel) {
        val items = listOf(
            createProductItemDataLayer(
                index = product.position,
                id = product.id,
    ...
    override fun trackClickAddToCart(product: SimilarProductUiModel) {
        val items = listOf(
    ...
    override fun trackImpressionOutOfStockProduct(product: SimilarProductUiModel) {
        val items = listOf(
            createProductItemDataLayer(
                index = product.position,
                id = product.id,
