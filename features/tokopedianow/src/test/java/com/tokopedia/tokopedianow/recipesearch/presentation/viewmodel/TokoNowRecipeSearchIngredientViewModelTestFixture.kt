...
open class TokoNowRecipeSearchIngredientViewModelTestFixture {
    ...
    protected lateinit var viewModel: TokoNowRecipeSearchIngredientViewModel

    @Before
    fun setUp() {
        getSortFilterUseCase = mockk(relaxed = true)

        viewModel = TokoNowRecipeSearchIngredientViewModel(
