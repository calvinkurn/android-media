...
open class UnifyDialog(private val activity: Activity,
    ...
    private fun layoutResId(): Int = R.layout.layout_unify_dialog
    ...
    private fun initListener(dialog: AlertDialog?) {
    ...
    fun setOkOnClickListener(listener: View.OnClickListener){
    ...
    fun setSecondaryOnClickListener(listener: View.OnClickListener){
        if (actionType != SINGLE_ACTION) {
