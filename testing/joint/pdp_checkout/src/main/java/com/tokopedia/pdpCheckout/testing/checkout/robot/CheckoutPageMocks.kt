...
object CheckoutPageMocks {
    ...
    val SHIPMENT_ADDRESS_FORM_BUNDLE_PROMO_RESPONSE = R.raw.saf_bundle_analytics_promo_response
    val SHIPMENT_ADDRESS_FORM_BUNDLE_TOKONOW_RESPONSE = R.raw.saf_bundle_tokonow_default_response
    val SHIPMENT_ADDRESS_FORM_BUNDLE_TOKONOW_WITH_FAILED_DEFAULT_DURATION_RESPONSE = R.raw.saf_bundle_tokonow_with_failed_default_duration_response
