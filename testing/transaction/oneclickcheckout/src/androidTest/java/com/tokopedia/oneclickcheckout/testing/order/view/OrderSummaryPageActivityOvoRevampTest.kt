...
class OrderSummaryPageActivityOvoRevampTest {
    ...
    fun happyFlow_OvoActivationFlow() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_OVO_ACTIVATION_REVAMP_RESPONSE_PATH
        ...
        orderSummaryPage {
            ...
            clickOvoActivationButtonRevamp {
                cartInterceptor.customGetOccCartResponsePath =
                    GET_OCC_CART_PAGE_OVO_ACTIVATED_REVAMP_RESPONSE_PATH
    ...
    fun happyFlow_OvoNoPhoneFlow() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_OVO_NO_PHONE_REVAMP_RESPONSE_PATH
    ...
    fun happyFlow_OvoTopUpFlow() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_OVO_LOW_WALLET_REVAMP_RESPONSE_PATH
        ...
        orderSummaryPage {
            ...
            cartInterceptor.customGetOccCartResponsePath =
                GET_OCC_CART_PAGE_OVO_TOP_UP_REVAMP_RESPONSE_PATH
