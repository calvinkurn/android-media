...
class OrderSummaryPageActivityMultiProductTest {
    ...
    fun errorFlow_PartialCheckout() {
        ...
        orderSummaryPage {
            ...
            cartInterceptor.customGetOccCartResponsePath =
                GET_OCC_CART_PAGE_MULTI_PRODUCT_WITH_SOME_ERROR_RESPONSE_PATH
    ...
    fun errorFlow_OrderLevel() {
        ...
        orderSummaryPage {
            ...
            cartInterceptor.customGetOccCartResponsePath =
                GET_OCC_CART_PAGE_MULTI_PRODUCT_ORDER_ERROR_RESPONSE_PATH
            checkoutInterceptor.customCheckoutResponsePath = CHECKOUT_EMPTY_STOCK_RESPONSE_PATH
            pay()
    ...
    fun errorFlow_AllProduct() {
        ...
        orderSummaryPage {
            ...
            cartInterceptor.customGetOccCartResponsePath =
                GET_OCC_CART_PAGE_MULTI_PRODUCT_ALL_ERROR_RESPONSE_PATH
            checkoutInterceptor.customCheckoutResponsePath = CHECKOUT_EMPTY_STOCK_RESPONSE_PATH
            pay()
    ...
    fun happyFlow_WholeSale() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_MULTI_PRODUCT_WHOLESALE_RESPONSE_PATH
