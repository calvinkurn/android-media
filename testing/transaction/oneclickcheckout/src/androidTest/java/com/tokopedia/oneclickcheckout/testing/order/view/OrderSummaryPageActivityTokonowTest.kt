...
import com.tokopedia.oneclickcheckout.interceptor.VALIDATE_USE_PROMO_REVAMP_TOKONOW_RP0_APPLIED_RESPONSE
...
class OrderSummaryPageActivityTokonowTest {
    ...
    fun tokonow_logistics() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_MULTI_PRODUCT_TOKONOW_RESPONSE_PATH
        ...
        orderSummaryPage {
            ...
            promoInterceptor.customValidateUseResponsePath =
                VALIDATE_USE_PROMO_REVAMP_TOKONOW_RP0_APPLIED_RESPONSE
    ...
    fun tokonow_overweight() {
        ...
        orderSummaryPage {
            ...
            assertShipmentDisabled(
                "Pengiriman tidak tersedia.",
                "Berat belanjaanmu melebihi batas untuk satu kali pengiriman."
            )
