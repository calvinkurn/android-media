...
class OrderSummaryPageActivityRevampTest {
    ...
    fun happyFlow_ChangeAddress() {
        ...
        orderSummaryPage {
            ...
            cartInterceptor.customGetOccCartResponsePath =
                GET_OCC_CART_PAGE_ONE_PROFILE_REVAMP_WITH_ADDRESS_2_RESPONSE_PATH
    ...
    fun happyFlow_ChangePayment() {
        ...
        orderSummaryPage {
            ...
            cartInterceptor.customGetOccCartResponsePath =
                GET_OCC_CART_PAGE_ONE_PROFILE_REVAMP_WITH_PAYMENT_2_RESPONSE_PATH
    ...
    fun happyFlow_UseRecommendationSpId() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_ONE_PROFILE_REVAMP_WITH_RECOMMENDATION_SPID_RESPONSE_PATH
    ...
    fun happyFlow_ShopBadge() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_SHOP_TYPE_PM_PRO_RESPONSE_PATH
    ...
    fun errorFlow_GetOccCartPageReturnNoShipmentData() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_REMOVE_PROFILE_POST_NO_SHIPMENT_RESPONSE_PATH
