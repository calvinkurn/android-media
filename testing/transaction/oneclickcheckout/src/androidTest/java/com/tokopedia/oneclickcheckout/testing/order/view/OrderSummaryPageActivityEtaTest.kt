...
import com.tokopedia.oneclickcheckout.interceptor.VALIDATE_USE_PROMO_REVAMP_BOE_APPLIED_RESPONSE
...
class OrderSummaryPageActivityEtaTest {
    ...
    fun happyFlow_BebasOngkirExtra() {
        cartInterceptor.customGetOccCartResponsePath =
            GET_OCC_CART_PAGE_ONE_PROFILE_REVAMP_WITH_BOE_RESPONSE_PATH
        ...
        orderSummaryPage {
            ...
            promoInterceptor.customValidateUseResponsePath =
                VALIDATE_USE_PROMO_REVAMP_BOE_APPLIED_RESPONSE
            clickApplyShipmentPromoRevamp()
