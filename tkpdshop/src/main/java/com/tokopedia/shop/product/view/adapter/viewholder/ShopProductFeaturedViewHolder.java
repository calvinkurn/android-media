...
public class ShopProductFeaturedViewHolder extends AbstractViewHolder<ShopFeaturedProductViewModel> {
    ...
    @Override
    public void bind(ShopFeaturedProductViewModel element) {
