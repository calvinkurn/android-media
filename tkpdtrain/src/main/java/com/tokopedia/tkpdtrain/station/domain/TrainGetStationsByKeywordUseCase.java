...
public class TrainGetStationsByKeywordUseCase extends UseCase<List<TrainStation>> {
    private static final String PARAM_KEYWORD = "PARAM_KEYWORD";
    private TrainRepository trainRepository;

    public TrainGetStationsByKeywordUseCase(TrainRepository trainRepository) {
