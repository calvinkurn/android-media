...
public class TrainScheduleDbDataStore implements TrainDataDBSource<TrainScheduleEntity, TrainSchedule> {
    ...
    @Override
    public Observable<List<TrainSchedule>> getDatas(final Specification specification) {
    ...
    public Observable<TrainSchedule> getData(final Specification specification) {
        ...
        }).map(new Func1<TrainScheduleDbTable, TrainSchedule>() {
            @Override
            public TrainSchedule call(TrainScheduleDbTable trainScheduleDbTable) {
