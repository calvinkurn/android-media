...
public final class FeedQuery implements Query<FeedQuery.Data, FeedQuery.Data, FeedQuery.Variables> {
  public static final String OPERATION_DEFINITION = "query FeedQuery($userID: Int!, $limit: Int!, $cursor: String) {\n"
  ...
  public FeedQuery(int userID, int limit, @Nullable String cursor) {
    variables = new FeedQuery.Variables(userID, limit, cursor);
  }
  ...
  public static final class Builder {
    ...
    public FeedQuery build() {
      return new FeedQuery(userID, limit, cursor);
    }
  }
  ...
  public static class Data implements Operation.Data {
    ...
    public static final class Mapper implements ResponseFieldMapper<Data> {
      ...
      final Field[] fields = {
        Field.forObject("feed", "feed", new UnmodifiableMapBuilder<String, Object>(3)
    ...
    public static class Content {
      ...
      public Content(@Nullable String type, @Nullable Integer total_product,
          @Nullable List<Product> products, @Nullable List<Promotion> promotions,
          @Nullable List<Official_store> official_store, @Nullable String redirect_url_app,
          @Nullable Seller_story seller_story, @Nullable List<Top_pick> top_picks,
          @Nullable String status_activity, @Nullable New_status_activity new_status_activity,
          @Nullable List<Inspirasi> inspirasi, @Nullable Kolpost kolpost,
          @Nullable Followedkolpost followedkolpost, @Nullable Kolrecommendation kolrecommendation,
          @Nullable Favorite_cta favorite_cta, @Nullable Kol_cta kol_cta) {
        this.type = type;
      ...
      public static final class Mapper implements ResponseFieldMapper<Content> {
        ...
        public Content map(ResponseReader reader) throws IOException {
          ...
          final List<Promotion> promotions = reader.read(fields[3]);
          final List<Official_store> official_store = reader.read(fields[4]);
          final String redirect_url_app = reader.read(fields[5]);
          final Seller_story seller_story = reader.read(fields[6]);
          final List<Top_pick> top_picks = reader.read(fields[7]);
          final String status_activity = reader.read(fields[8]);
          final New_status_activity new_status_activity = reader.read(fields[9]);
          final List<Inspirasi> inspirasi = reader.read(fields[10]);
          final Kolpost kolpost = reader.read(fields[11]);
          final Followedkolpost followedkolpost = reader.read(fields[12]);
          final Kolrecommendation kolrecommendation = reader.read(fields[13]);
          final Favorite_cta favorite_cta = reader.read(fields[14]);
          final Kol_cta kol_cta = reader.read(fields[15]);
          return new Content(type, total_product, products, promotions, official_store, redirect_url_app, seller_story, top_picks, status_activity, new_status_activity, inspirasi, kolpost, followedkolpost, kolrecommendation, favorite_cta, kol_cta);
        }
      }
    }
