...
public class EmptyTopAdsProductViewHolder extends AbstractViewHolder<EmptyTopAdsProductModel> {


    private static final int MAX_TOPADS = 4;
    ...
    @LayoutRes
    public static final int LAYOUT = R.layout.list_feed_topads_product_empty;

    public EmptyTopAdsProductViewHolder(View itemView,
    ...
    @Override
    public void bind(EmptyTopAdsProductModel element) {
