...
public class ResolutionDispute implements Parcelable {
    ...
    @SerializedName("dispute_create_time_short")
    @Expose
    private String disputeCreateTimeShort;
     ...
     * 
     * @return
     *     The disputeCreateTimeShort
     */
    public String getDisputeCreateTimeShort() {
        return disputeCreateTimeShort;
    }

    /**
     * 
     * @param disputeCreateTimeShort
     *     The dispute_create_time_short
     */
    public void setDisputeCreateTimeShort(String disputeCreateTimeShort) {
        this.disputeCreateTimeShort = disputeCreateTimeShort;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.disputeCreateTimeShort);
    ...
    protected ResolutionDispute(Parcel in) {
        ...
        this.disputeCreateTimeShort = in.readString();
    ...
    public static final Creator<ResolutionDispute> CREATOR = new Creator<ResolutionDispute>() {
        @Override
