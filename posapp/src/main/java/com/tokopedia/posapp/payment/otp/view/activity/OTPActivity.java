package com.tokopedia.posapp.payment.otp.view.activity;
...
import com.tokopedia.posapp.payment.otp.view.presenter.OTPPresenter;
...
public class OTPActivity extends BasePresenterActivity<OTP.Presenter>
    ...
    @DeepLink(PosAppLink.PAYMENT_OTP)
