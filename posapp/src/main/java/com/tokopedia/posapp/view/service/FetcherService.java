...
public class FetcherService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.tokopedia.posapp.view.service.action.FOO";
    private static final String ACTION_BAZ = "com.tokopedia.posapp.view.service.action.BAZ";
