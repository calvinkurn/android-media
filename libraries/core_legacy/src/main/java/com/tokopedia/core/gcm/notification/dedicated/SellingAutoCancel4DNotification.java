...
public class SellingAutoCancel4DNotification extends BaseNotification {
    public SellingAutoCancel4DNotification(Context context) {
        super(context);
    }

    @Override
    protected void configureNotificationData(Bundle data) {
        Intent intent = RouteManager.getIntent(mContext, ApplinkConst.SELLER_PURCHASE_CANCELED, "");
