...
public class RemoteConfigKey {
    ...
    public static final String ANDROID_CUSTOMER_FLIGHT_SHOW_FREE_RAPID_TEST = "android_customer_flight_show_free_rapid";
    public static final String ANDROID_CUSTOMER_FLIGHT_SHOW_SEAT_DISTANCING = "android_customer_flight_show_seat_distancing";
