...
object RollenceKey {
    ...
    const val HOME_COMPONENT_HPB_DOTS_INFINITE_EXP = "hpb_dots_infinite"
    const val HOME_COMPONENT_HPB_DOTS_INFINITE_CONTROL = "control_no_dots"
    const val HOME_COMPONENT_HPB_DOTS_INFINITE_VARIANT = "dots_infinitescroll"
