...
object ImageEditorTrackingConstant {
    ...
    const val LABEL_REMOVE_BACKGROUND_NORMAL = "remove background - design1"
    const val LABEL_REMOVE_BACKGROUND_WHITE = "remove background - design2"
    const val LABEL_REMOVE_BACKGROUND_GREY = "remove background - design3"
}