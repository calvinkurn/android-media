...
public class ImageEditorActivity extends BaseSimpleActivity implements ImageDownloadPresenter.OnImageDownloadListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        vgProgressBar = findViewById(R.id.vg_progress_bar);
        hideProgressDialog();
    ...
    protected ImageEditorFragment getNewEditorFragment() {
        return ImageEditorFragment.newInstance();
    }
