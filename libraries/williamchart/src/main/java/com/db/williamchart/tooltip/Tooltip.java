...
public class Tooltip extends RelativeLayout {
    ...
    private boolean isSearchForTextView;
    private TooltipSearchForTextViewListener searchForTextViewListener;
    ...
    public Tooltip(Context context, int layoutId, int valueId, boolean isSearchForTextView) {
        super(context);
        this.isSearchForTextView = isSearchForTextView;
        init();
        initView(context, layoutId);
    ...
    public Tooltip(Context context, int layoutId,
                   int valueId, StringFormatRenderer stringFormatRenderer,
                   boolean isSearchForTextView) {

        this(context, layoutId, valueId, isSearchForTextView);
    ...
    public void setSearchForTextViewListener(TooltipSearchForTextViewListener searchForTextViewListener) {
        this.searchForTextViewListener = searchForTextViewListener;
    }

    private void searchForTextView(ViewGroup group) {
    ...
    public void prepare(Rect rect, TooltipModel value) {
        ...
        if (isSearchForTextView) {
            if (stringFormatRenderer instanceof TooltipFormatRenderer) {
