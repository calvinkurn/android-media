...
class DevToolsRemoteConfig {
    ...
    companion object {
        private const val ANDROID_MAIN_APP_DEV_TOOLS_CONFIG = "android_main_app_dev_tools_config"
        ...
        fun getConfig(context: Context): DevToolsConfig {
            if (devToolsConfig == null) {
                ...
                val dfRemoteConfig = remoteConfig.getString(ANDROID_MAIN_APP_DEV_TOOLS_CONFIG)
                dfRemoteConfig?.let {
