...
class DeepLinkMapperFromHttpTest: DeepLinkMapperTestFixture() {
    ...
    @Test
    fun `check url link of pulsa then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=1&menu_id=2"
        assertEqualsDeepLinkMapper(PULSA_URL_LINK, actualDeepLink)
    }

    @Test
    fun `check url link of pulsa axis then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa IM3 then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=1&operator_id=1&menu_id=2"
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.AXIS, actualDeepLink)
    }

    @Test
    fun `check url link of pulsa bolt then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa tri then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa xl then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa smartfren then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa simpati then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa as then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pulsa mentari then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of token listrik then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of streaming then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pajak then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of PBB then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of retribusi then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of PDAM then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of angsuran then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pasca bayar then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of telepon then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of PGN then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of indovision then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of indiehome then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of transvision then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of big tv then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of orange tv prabayar then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of orange tv pascabayar then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of kvision then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of top tv then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of first media then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of nex media then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of okevision then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of viu then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of joox then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of catch play then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of iflix then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of genflix then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of wifi id then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of hooq then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of tagihan listrik then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of donasi then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of kfc voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of  lotteria voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of hop hop voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of tour les jours voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of breadlife voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of tagihan pdam then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=5"
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.TAGIHAN_PDAM, actualDeepLink)
    }

    @Test
    fun `check url link of angsuran mobil then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of angsuran motor then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of angsuran aeon then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of angsuran astra then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=7&operator_id=168"
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.ANGSURAN_ASTRA, actualDeepLink)
    }

    @Test
    fun `check url link of angsuran kreditplus then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of angsuran mandiri tunas finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of artha prima finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of woka finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of mega finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of al ijarah finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of al bima finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of mega auto finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of mega central finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of mpm finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of radana finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of smart multi finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of nsc finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of baf finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of indomobil finance then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=7&operator_id=255"
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.ANGSURAN_INDOMOBIL_FINANCE, actualDeepLink)
    }

    @Test
    fun `check url link of tagihan then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=3&operator_id=18"
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.TAGIHAN, actualDeepLink)
    }

    @Test
    fun `check url link of bpjs then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of voucher es teler 77 then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of roaming then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of roaming indosat then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of roaming xl then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of roaming telkomsel then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of top up mtix then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.TOP_UP_MTIX, "")
    }

    @Test
    fun `check url link of tori ichi voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of excelso voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of bpjs kesehatan then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of bpjs ketenagakerjaan then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data telkomsel then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data indosat then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data xl then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data axis then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data im3 then should be equal to the actual`() {
        val actualDeepLink = "${DeeplinkConstant.SCHEME_TOKOPEDIA}://digital/form?category_id=2&operator_id=2&menu_id=2"
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PAKET_DATA_IM3, actualDeepLink)
    }

    @Test
    fun `check url link of paket data mentari then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data tri then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of paket data bolt then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of shaburi voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of kintan buffet voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of bakerzin voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of boga group voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of carls jr voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of shihlin voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of gaya gelato voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of gokana voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of platinum resto voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of fish n co voucher then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of bfi finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of suzuki finance then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of olympindo then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of top up emoney then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of taralite then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of kredivo then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of btn then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of home credit then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of top up ovo then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of squaline then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of ruang guru then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of quipper then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of zenius then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of ilp then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of algoritma then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of purwadhika then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of belajar then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pajak samsat then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pdam bekasi then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of bein sports then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of bea cukai then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of spotify then should be equal to the actual`() {
    ...
    @Test
    fun `check url link of pbb bekasi then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_BEKASI, "")
    }

    @Test
    fun `check url link of pbb bandung then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_BANDUNG, "")
    }

    @Test
    fun `check url link of pbb cirebon then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_CIREBON, "")
    }

    @Test
    fun `check url link of pbb kota serang then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_KOTA_SERANG, "")
    }

    @Test
    fun `check url link of pbb kab serang then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_KAB_SERANG, "")
    }

    @Test
    fun `check url link of pbb sukabumi then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_SUKABUMI, "")
    }

    @Test
    fun `check url link of pbb tangerang then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_TANGERANG, "")
    }

    @Test
    fun `check url link of pbb tangerang selatan then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_TANGERANG_SELATAN, "")
    }

    @Test
    fun `check url link of pbb lebak then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_KAB_LEBAK, "")
    }

    @Test
    fun `check url link of pbb kab bekasi then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_KAB_BEKASI, "")
    }

    @Test
    fun `check url link of pbb subang then should be equal to the actual`() {
        assertEqualsDeepLinkMapper(DeepLinkUrlConstant.DIGITAL.PBB_SUBANG, "")
    }

    @Test
    fun `check url link of samsat jawa tengah then should be equal to the actual`() {
