...
import com.tokopedia.applink.internal.ApplinkConstInternalContent.INTERNAL_POST_DETAIL
    ...
    fun getKolDeepLink(deepLink: String): String {
        when {
            ...
            deepLink.startsWithPattern(ApplinkConst.CONTENT_DETAIL) -> {
                return deepLink.replace(ApplinkConst.CONTENT_DETAIL.substringBefore("{"), INTERNAL_POST_DETAIL.substringBefore("{"))
            }
