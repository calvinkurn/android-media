...
object ApplinkConstInternalSellerapp {
    ...
    const val CENTRALIZED_PROMO_COMPOSE = "$INTERNAL_SELLERAPP/centralized-promo-compose"
    ...
    // SellerMenuComposeActivity
    const val SELLER_MENU_COMPOSE = "$INTERNAL_SELLERAPP/seller-menu-compose"
