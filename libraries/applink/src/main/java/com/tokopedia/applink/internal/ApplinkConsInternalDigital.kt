...
object ApplinkConsInternalDigital {
    ...
    const val SMARTCARD_WITH_BRIZZI = "${DeeplinkConstant.SCHEME_INTERNAL}://smartcard/emoneybrizzi?$PARAM_SMARTCARD={type}"
    const val SMARTCARD_WITH_EMONEY = "${DeeplinkConstant.SCHEME_INTERNAL}://smartcard/emoney?$PARAM_SMARTCARD={type}"
