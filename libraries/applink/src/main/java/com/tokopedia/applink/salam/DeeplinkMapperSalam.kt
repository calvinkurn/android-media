...
object DeeplinkMapperSalam{
    ...
    fun getRegisteredNavigationSalamUmrahShop(deeplink: String):String{
        return deeplink.replace(ApplinkConst.SALAM_UMRAH_SHOP, ApplinkConstInternalSalam.SALAM_UMRAH_HOME_PAGE)
    }
}
