...
object DeeplinkMapper {
    ...
    val deeplinkPatternTokopediaSchemeList: MutableList<DLP> = mutableListOf(
            ...
            DLP.exact(ApplinkConst.MEDIA_PICKER, ApplinkConstInternalMedia.INTERNAL_MEDIA_PICKER),
            DLP.exact(ApplinkConst.MEDIA_PICKER_PREVIEW, ApplinkConstInternalMedia.INTERNAL_MEDIA_PICKER_PREVIEW),
        )
