...
object DeeplinkMapper {
    ...
    val deeplinkPatternTokopediaSchemeList: MutableList<DLP> = mutableListOf(
            ...
            DLP.startWith(ApplinkConst.TokopediaNow.REPURCHASE) { ctx, _, deeplink, _ -> getRegisteredNavigationTokopediaNowRepurchase(ctx) },
            DLP.exact(ApplinkConst.TokoMart.HOME) { ctx, _, deeplink, _ -> getRegisteredNavigationTokopediaNowHome(ctx, deeplink) },
            ...
            DLP.startWith(ApplinkConst.TokoMart.REPURCHASE) { ctx, _, deeplink, _ -> getRegisteredNavigationTokopediaNowRepurchase(ctx) },
