...
import com.tokopedia.applink.internal.ApplinkConstInternalUserPlatform.getInactivePhoneInternalDeepLink
...
import com.tokopedia.applink.order.DeeplinkMapperOrder.getReschedulePickupDeeplink
...
object DeeplinkMapper {
    ...
    val deeplinkPatternTokopediaSchemeList: MutableList<DLP> = mutableListOf(
            ...
            DLP.startWith(ApplinkConst.SELLER_ORDER_RESCHEDULE) { context, uri, deeplink, _ -> getReschedulePickupDeeplink(context, uri, deeplink) },
            ...
            DLP.startWith(ApplinkConst.CHANGE_INACTIVE_PHONE) {_, _, deeplink, _ -> getInactivePhoneInternalDeepLink(deeplink)},
