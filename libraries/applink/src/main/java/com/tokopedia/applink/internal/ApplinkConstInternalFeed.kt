...
object ApplinkConstInternalFeed {
    ...
    const val FEED_UNIFIED_DETAILS = "tokopedia://content/detail"
    ...
    const val INTERNAL_UNIFIED_FEED_DETAILS = "${DeeplinkConstant.SCHEME_INTERNAL}://${HOST_UNIFIED_FEED_DETAILS}"
