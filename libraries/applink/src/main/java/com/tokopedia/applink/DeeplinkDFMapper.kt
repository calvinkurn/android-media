...
object DeeplinkDFMapper {
    ...
    private val deeplinkDFPatternListCustomerApp: List<DFP> by lazy {
        mutableListOf<DFP>().apply {
            ...
            add(DFP({ it.startsWith(CHANGE_PASSWORD) }, DFM_USER, R.string.applink_change_password))
            add(DFP({ it.startsWith(INBOX_TALK) }, DFM_USER, R.string.talk_title))
            add(DFP({ it.startsWith(SHOP_TALK) }, DFM_USER, R.string.talk_title))
            add(DFP({ it.startsWith(PRODUCT_TALK) }, DFM_USER, R.string.talk_title))
            add(DFP({ it.startsWith(DETAIL_TALK) }, DFM_USER, R.string.talk_title))
            add(DFP({ it.startsWith(ADD_TALK) }, DFM_USER, R.string.talk_title))
