...
import com.tokopedia.applink.internal.ApplinkConstInternalMarketplace.RESERVED_STOCK
    ...
    val deeplinkDFPatternListSellerApp: List<DFP> by lazy {
        mutableListOf<DFP>().apply {
            ...
            add(DFP({ it.startsWith(PRODUCT_MANAGE_LIST)
                    || it.startsWith(RESERVED_STOCK) }, DF_BASE_SELLER_APP, R.string.title_applink_product_manage))
