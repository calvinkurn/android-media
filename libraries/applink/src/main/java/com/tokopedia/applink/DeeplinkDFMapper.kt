...
object DeeplinkDFMapper : CoroutineScope {
    ...
    val deeplinkDFPatternListCustomerApp: List<DFP> by lazy {
        mutableListOf<DFP>().apply {
            ...
            add(DFP({ it.startsWithPattern(USER_IDENTIFICATION_FORM) }, DF_USER_LIVENESS, R.string.user_identification_common_title))
            add(DFP({ it.startsWithPattern(USER_IDENTIFICATION_INFO_SIMPLE) }, DF_USER_LIVENESS, R.string.user_identification_info_simple))
