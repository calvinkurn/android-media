...
object DeeplinkDFMapper : CoroutineScope {
    ...
    val deeplinkDFPatternListCustomerApp: List<DFP> by lazy {
        mutableListOf<DFP>().apply {
            ...
            add(DFP({ it.startsWithPattern(INTERNAL_AFFILIATE_CREATE_POST) }, DF_FEED, R.string.applink_af_title_create_post))
            add(DFP({ it.startsWithPattern(INTERNAL_AFFILIATE_DRAFT_POST) }, DF_FEED, R.string.applink_af_title_create_post))
            add(DFP({ it.startsWithPattern(AFFILIATE_EDIT) }, DF_FEED, R.string.applink_af_title_create_post))
            add(DFP({ it.startsWithPattern(ApplinkConstInternalContent.INTERNAL_CONTENT_CREATE_POST) }, DF_FEED, R.string.applink_af_title_create_post))
            add(DFP({ it.startsWithPattern(ApplinkConstInternalContent.INTERNAL_CONTENT_DRAFT_POST) }, DF_FEED, R.string.applink_af_title_create_post))
            add(DFP({ it.startsWithPattern(ApplinkConstInternalContent.SHOP_POST_EDIT) }, DF_FEED, R.string.applink_af_title_create_post))
            ...
            }, DF_FEED, R.string.title_image_picker))

            add(DFP({ it.startsWithPattern(ApplinkConstInternalContent.INTERNAL_AFFILIATE_CREATE_POST_V2) }, DF_FEED, R.string.title_feed_create_post))
            add(DFP({ it.startsWithPattern(ApplinkConstInternalGlobal.IMAGE_PICKER_V2) }, DF_FEED, R.string.title_image_picker))
            ...
            add(DFP({ it.startsWithPattern(USER_IDENTIFICATION_INFO) }, DF_USER_SETTINGS, R.string.user_identification_common_title))
            add(DFP({ it.startsWithPattern(USER_IDENTIFICATION_FORM) }, DF_USER_SETTINGS, R.string.user_identification_form_title))
