...
object ApplinkConstInternalMarketplace {
    ...
    const val SHOP_MVC_LOCKED_TO_PRODUCT_SHOP_ID = "$INTERNAL_MARKETPLACE/shop/widget/voucher/shop_id/{shop_id}/{voucher_id}/"
    const val SHOP_MVC_LOCKED_TO_PRODUCT_SHOP_DOMAIN = "$INTERNAL_MARKETPLACE/shop/widget/voucher/shop_domain/{shop_domain}/{voucher_id}/"
