...
public class RestDatabaseModel extends BaseModel {
    ...
    private RestDatabaseModel(Builder builder) {
        key = builder.key;
        value = builder.value;
    ...
    public static final class Builder {
        ...
        public RestDatabaseModel build() {
            return new RestDatabaseModel(this);
        }
    }
}
