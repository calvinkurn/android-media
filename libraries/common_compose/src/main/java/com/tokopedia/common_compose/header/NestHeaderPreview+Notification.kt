        ...
        NestHeader(
            type = NestHeaderType.SingleLine().copy(
                ...
                optionsButton = listOf(
                    HeaderActionButton(
                        icon = HeaderIconSource.Painter(painterResource(id = R.drawable.iconunify_bell)),
                        notification = HeaderNotification("1", Color.PRIMARY)
                    ),
        ...
        NestHeader(
            ...
            type = NestHeaderType.SingleLine().copy(
                ...
                optionsButton = listOf(
                    HeaderActionButton(
                        icon = HeaderIconSource.Painter(painterResource(id = R.drawable.iconunify_bell)),
                        notification = HeaderNotification("100", Color.PRIMARY)
                    ),
                    HeaderTextButton(text = "Action"),
                    HeaderTextButton(text = "Add")
                )
        ...
        NestHeader(
            type = NestHeaderType.DoubleLine().copy(
                ...
                optionsButton = listOf(
                    HeaderActionButton(
                        icon = HeaderIconSource.Painter(painterResource(id = R.drawable.iconunify_bell)),
                        notification = HeaderNotification("BARU", Color.PRIMARY)
                    ),
                    HeaderTextButton(text = "Action"),
                    HeaderTextButton(text = "Add")
                )
        ...
        NestHeader(
            type = NestHeaderType.Location().copy(
                ...
                optionsButton = listOf(
                    HeaderActionButton(
                        icon = HeaderIconSource.Painter(painterResource(id = R.drawable.iconunify_bell)),
                        notification = HeaderNotification("1", Color.SECONDARY)
                    ),
                    HeaderTextButton(text = "Action"),
                    HeaderTextButton(text = "Add")
                )
        ...
        NestHeader(
            ...
            type = NestHeaderType.Location().copy(
                ...
                optionsButton = listOf(
                    HeaderActionButton(
                        icon = HeaderIconSource.Painter(painterResource(id = R.drawable.iconunify_bell)),
                        notification = HeaderNotification("PROMO", Color.SECONDARY)
                    ),
                    HeaderTextButton(text = "Action"),
                    HeaderTextButton(text = "Add")
                )
        ...
        NestHeader(
            type = NestHeaderType.Profile().copy(
                ...
                optionsButton = listOf(
                    HeaderActionButton(
                        icon = HeaderIconSource.Painter(painterResource(id = R.drawable.iconunify_bell)),
                        notification = HeaderNotification("100", Color.SECONDARY)
                    ),
                    HeaderTextButton(text = "Action"),
                    HeaderTextButton(text = "Add")
                )
