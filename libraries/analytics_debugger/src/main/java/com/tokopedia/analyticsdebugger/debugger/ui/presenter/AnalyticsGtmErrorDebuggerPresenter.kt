...
class AnalyticsGtmErrorDebuggerPresenter(private val getGtmErrorLogUseCase: GetGtmErrorLogUseCase,
                                         private val deleteGtmErrorLogUseCase: DeleteGtmErrorLogUseCase) : AnalyticsDebugger.Presenter {
    ...
    override fun deleteAll() {
        deleteGtmErrorLogUseCase.execute(object : Subscriber<Boolean>() {
