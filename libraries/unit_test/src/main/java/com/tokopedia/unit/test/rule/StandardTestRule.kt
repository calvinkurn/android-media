...
import com.tokopedia.unit.test.dispatcher.StandardTestDispatchers
...
class StandardTestRule : TestWatcher(), AbstractTestRule {

    override val dispatchers = StandardTestDispatchers
