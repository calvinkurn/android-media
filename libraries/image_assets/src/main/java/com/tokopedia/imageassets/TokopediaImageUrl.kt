...
object TokopediaImageUrl {
    ...
    const val LOTTIE = "https://assets.tokopedia.net/asts/android/tokonow/tokopedianow_educational_information_chevron_lottie.json"
    const val IMG_TIME = "https://images.tokopedia.net/img/android/tokonow/tokonow_ic_educational_information_two_hours.png"
    const val IMG_STOCK_AVAILABLE = "https://images.tokopedia.net/img/android/tokonow/tokonow_ic_educational_information_stock_available.png"
    const val IMG_GUARANTEED_QUALITY = "https://images.tokopedia.net/img/android/tokonow/tokonow_ic_educational_information_guaranteed_quality.png"
    const val IMG_FREE_SHIPPING = "https://images.tokopedia.net/img/android/tokonow/ic_educational_information_free_shipping.png"
    ...
    const val BG_SAH_OTHER_CURVED_HEADER_THEMATIC_RM = "https://images.tokopedia.net/img/android/seller_home/bg_base_sah_other_curved_header_thematic_rm@3x.png"
    const val BG_SAH_OTHER_CURVED_HEADER_THEMATIC_PM = "https://images.tokopedia.net/img/android/seller_home/bg_base_sah_other_curved_header_thematic_pm@3x.png"
    const val BG_SAH_OTHER_CURVED_HEADER_THEMATIC_OS = "https://images.tokopedia.net/img/android/seller_home/bg_base_sah_other_curved_header_thematic_os@3x.png"
