...
public class FpmDebuggerFragment
        extends BaseSearchListFragment<Visitable, FpmDebuggerTypeFactory>
        implements AnalyticsDebugger.View {

    public static final String TAG = FpmDebuggerFragment.class.getSimpleName();
    ...
    public static Fragment newInstance() {
        return new FpmDebuggerFragment();
    }
    ...
    @Override
    protected FpmDebuggerTypeFactory getAdapterTypeFactory() {
        return new FpmDebuggerTypeFactory();
    }

    @Override
    public void onItemClicked(Visitable visitable) {
        if (visitable instanceof FpmDebuggerViewModel) {
            openDetail((FpmDebuggerViewModel) visitable);
        }
    }
    ...
    private void injectToFragment(AnalyticsDebuggerComponent component) {
        presenter = component.getFpmPresenter();
    }

    @Override
    protected String getScreenName() {
        return FpmDebuggerFragment.class.getSimpleName();
    }
    ...
    private void openDetail(FpmDebuggerViewModel viewModel) {
        startActivity(FpmDebuggerDetailActivity.newInstance(getContext(), viewModel));
    }
}
