...
//    public static final String BASE_WS_DOMAIN = "https://ws-staging.tokopedia.com/";
    ...
    public static LoginService getLoginService(InstrumentationTestApp application) {
    ...
    public static AccountService getAccountService(InstrumentationTestApp application) {
    ...
    public static WSService getWsService(InstrumentationTestApp application) {
        if (wsService == null) {
            final Retrofit.Builder builder = new Retrofit.Builder()
                    .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                    .addConverterFactory(GsonConverterFactory.create());
    ...
    public static WSLogoutService getWsLogoutService(InstrumentationTestApp application) {
