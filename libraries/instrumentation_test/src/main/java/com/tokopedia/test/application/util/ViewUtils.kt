...
object ViewUtils {
    ...
    fun View?.takeScreenShot(fileName: String, dir: String = "") {
        if (this != null) {
            this.setBackgroundColor(ContextCompat.getColor(this.context, com.tokopedia.unifycomponents.R.color.Unify_N0))
        ...
        views?.forEachIndexed { index, it ->
            ...
            Handler(Looper.getMainLooper()).post {
                ...
                if (bgDrawable != null) {
                    ...
                    b1.drawColor(ContextCompat.getColor(context!!, com.tokopedia.unifycomponents.R.color.Unify_N0))
                }
                view.draw(b1)
