...
data class BaseNotificationModel(
    ...
    constructor(parcel: Parcel) : this(
            ...
            parcel.readString(),
            parcel.createTypedArrayList(ActionButton)?: arrayListOf(ActionButton()),
            parcel.readString(),
            parcel.readString(),
            parcel.readString(),
            ...
            parcel.readByte() != 0.toByte(),
            parcel.readByte() != 0.toByte(),
            parcel.createTypedArrayList(Carousel)?: arrayListOf(Carousel()),
            parcel.createTypedArrayList(Grid)?: arrayListOf(Grid()),
            parcel.createTypedArrayList(ProductInfo)?: arrayListOf(ProductInfo(
                    "",
                    "",
                    "",
                    "",
