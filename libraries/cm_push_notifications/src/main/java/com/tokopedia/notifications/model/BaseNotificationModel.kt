...
data class BaseNotificationModel(
    ...
    constructor(parcel: Parcel) : this(
            ...
            parcel.readByte() != 0.toByte(),
            parcel.readByte() != 0.toByte(),
            parcel.createTypedArrayList(Carousel) as ArrayList<Carousel>,
            parcel.createTypedArrayList(Grid) as ArrayList<Grid>,
            parcel.createTypedArrayList(ProductInfo) as ArrayList<ProductInfo>,
            parcel.readLong(),
            parcel.readString(),
