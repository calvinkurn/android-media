...
internal class RoundedBarChart(context: Context?, attrs: AttributeSet?) : BarChart(context, attrs) {

    fun setRadius(radius: Int) {
        renderer = RoundedBarChartRenderer(this, animator, viewPortHandler, radius)
    }

    private class RoundedBarChartRenderer internal constructor(chart: BarDataProvider?, animator: ChartAnimator?, viewPortHandler: ViewPortHandler?, private val mRadius: Int) : BarChartRenderer(chart, animator, viewPortHandler) {
