...
public class Card extends LinearLayout {
    ...
    private void initBackground() {
        setBackground(generateBackgroundWithShadow(this,R.color.Neutral_N0,
                R.dimen.cardview_default_radius, R.color.Neutral_N100, R.dimen.cardview_default_elevation, Gravity.BOTTOM));
    }
