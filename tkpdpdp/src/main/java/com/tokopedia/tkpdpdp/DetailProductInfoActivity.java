...
public class DetailProductInfoActivity extends TActivity implements View.OnClickListener,YoutubeThumbnailViewHolder.YouTubeThumbnailLoadInProcess {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localCacheHandler = new LocalCacheHandler(DetailProductInfoActivity.this, PRODUCT_DETAIL);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.simple_top_bar_close_button) {
            finish();
            DetailProductInfoActivity.this.overridePendingTransition(0,com.tokopedia.core2.R.anim.push_down);
        }
    }
