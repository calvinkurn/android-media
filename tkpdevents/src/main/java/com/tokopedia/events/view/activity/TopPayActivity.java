...
import com.tokopedia.events.view.presenter.TopPayPresenter;
...
public class TopPayActivity extends Activity implements TopPayContractor.ITopPayView {
    ...
    private class TopPayWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (!TextUtils.isEmpty(paymentPassData.getCallbackSuccessUrl()) &&
                ...
                view.stopLoading();
                showToastMessageWithForceCloseView(com.tokopedia.payment.utils.ErrorNetMessage.MESSAGE_ERROR_TOPPAY);
                return true;
            } else {
