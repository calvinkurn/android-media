...
public class ExpandableRelativeLayout extends RelativeLayout implements ExpandableLayout {
    ...
    private void init(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.ExpandableLayoutStyleable, defStyleAttr, 0);
        duration = a.getInteger(
                R.styleable.ExpandableLayoutStyleable_expandable_layout_duration, DEFAULT_DURATION
        );
        defaultExpanded = a.getBoolean(
                R.styleable.ExpandableLayoutStyleable_expandable_layout_expanded, DEFAULT_EXPANDED
        );
        orientation = a.getInteger(
                R.styleable.ExpandableLayoutStyleable_expandable_layout_orientation, VERTICAL
        );
        defaultChildIndex = a.getInteger(
                R.styleable.ExpandableLayoutStyleable_expandable_layout_defaultChildIndex,
                Integer.MAX_VALUE
        );
        defaultPosition = a.getDimensionPixelSize(
                R.styleable.ExpandableLayoutStyleable_expandable_layout_defaultPosition,
                Integer.MIN_VALUE
        );
        final int interpolatorType = a.getInteger(
                R.styleable.ExpandableLayoutStyleable_expandable_layout_interpolator,
