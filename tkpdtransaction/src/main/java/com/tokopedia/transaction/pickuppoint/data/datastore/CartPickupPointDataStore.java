...
public class CartPickupPointDataStore {
    ...
    public Observable<Response<String>> editPickupPoints(TKPDMapParam<String, String> params) {
        return service.getApi().editPickupPoint(params);
    }

    public Observable<Response<String>> removePickupPoints(TKPDMapParam<String, String> params) {
