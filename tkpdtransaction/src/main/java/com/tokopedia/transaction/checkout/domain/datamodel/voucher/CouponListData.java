...
public class CouponListData implements Parcelable {
    ...
    public static final Creator<CouponListData> CREATOR = new Creator<CouponListData>() {
        @Override
        public CouponListData createFromParcel(Parcel source) {
            return new CouponListData(source);
        }
