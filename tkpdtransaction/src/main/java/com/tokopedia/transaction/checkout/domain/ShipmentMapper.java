...
import com.tokopedia.transaction.checkout.view.data.cartshipmentform.ProductShipment;
import com.tokopedia.transaction.checkout.view.data.cartshipmentform.ProductShipmentMapping;
import com.tokopedia.transaction.checkout.view.data.cartshipmentform.ServiceId;
        ...
        if (!mapperUtil.isEmpty(shipmentAddressFormDataResponse.getGroupAddress())) {
            ...
            for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.GroupAddress
                ...
                if (groupAddress.getUserAddress() != null) {
                    com.tokopedia.transaction.checkout.view.data.cartshipmentform.UserAddress userAddressResult =
                            new com.tokopedia.transaction.checkout.view.data.cartshipmentform.UserAddress();
                ...
                if (!mapperUtil.isEmpty(groupAddress.getGroupShop())) {
                    ...
                    for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.GroupShop
                            groupShop : groupAddress.getGroupShop()) {
                        com.tokopedia.transaction.checkout.view.data.cartshipmentform.GroupShop groupShopResult =
                                new com.tokopedia.transaction.checkout.view.data.cartshipmentform.GroupShop();
                        ...
                        if (!mapperUtil.isEmpty(groupShop.getShopShipments())) {
                            ...
                            for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.ShopShipment shopShipment :
                                ...
                                if (!mapperUtil.isEmpty(shopShipment.getShipProds())) {
                                    ...
                                    for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.ShipProd shipProd :
                        ...
                        if (!mapperUtil.isEmpty(groupShop.getProducts())) {
                            ...
                            for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.Product product
                                ...
                                if (!mapperUtil.isEmpty(product.getProductShipment())) {
                                    ...
                                    for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.ProductShipment
                                ...
                                if (!mapperUtil.isEmpty(product.getProductShipmentMapping())) {
                                    ...
                                    for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.ProductShipmentMapping
                                        ...
                                        if (!mapperUtil.isEmpty(productShipmentMapping.getServiceIds())) {
                                            ...
                                            for (com.tokopedia.transaction.checkout.domain.response.shippingaddressform.ServiceId serviceId :
