...
public class ReferralPhoneNumberVerificationFragment extends BasePresenterFragmentV4 {
    ...
    protected void setViewListener() {
        btnActivation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listener != null) {
                    UnifyTracking.eventReferralAndShare(getActivity(), AppEventTracking.Action.CLICK_VERIFY_NUMBER, tvPhoneNumber.getText().toString().replace("-", ""));
