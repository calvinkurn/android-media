...
import com.tokopedia.session.session.presenter.OldRegisterInitialPresenter;
...
public class OldRegisterInitialFragment extends Fragment
    ...
    protected OldRegisterInitialPresenter presenter;
    ...
    public static OldRegisterInitialFragment newInstance() {
        return new OldRegisterInitialFragment();
    }
            ...
            for (int i = 0; i < listProvider.size(); i++) {
                ...
                if (listProvider.get(i).getId().equalsIgnoreCase("facebook")) {
                    ...
                    tv.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            OldRegisterInitialFragmentPermissionsDispatcher
    ...
    private void loginProvideOnClick(final String url, final String name) {
        WebViewLoginFragment newFragment = WebViewLoginFragment
                .createInstance(url);
        newFragment.setTargetFragment(OldRegisterInitialFragment.this, 100);
...
//        ((GoogleActivity) getActivity()).onSignInClicked();
    ...
    protected void initialPresenter() {
        presenter = new OldRegisterInitialPresenterImpl(this);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        OldRegisterInitialFragmentPermissionsDispatcher.onRequestPermissionsResult(OldRegisterInitialFragment.this, requestCode, grantResults);
    }
