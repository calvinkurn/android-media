...
public class GetFacebookCredentialUseCase {
    ...
    private static final String REQUEST_PERMISSION = "id,name,gender,birthday,email";
    ...
    private boolean isNotAllPermissionGranted(LoginResult loginResult) {
        return loginResult.getAccessToken().getDeclinedPermissions().size() > 0;
    }
