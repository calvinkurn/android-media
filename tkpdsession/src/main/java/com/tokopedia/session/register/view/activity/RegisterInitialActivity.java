...
/**
 * @author by nisie on 6/20/17.
 */

public class RegisterInitialActivity extends BasePresenterActivity {
    ...
    protected void initView() {
        ...
        RegisterInitialFragment fragment =
                (RegisterInitialFragment) getFragmentManager().findFragmentByTag(
                        RegisterInitialFragment.class.getSimpleName());
        if (fragment == null) {
            fragment = RegisterInitialFragment.newInstance();
        }
