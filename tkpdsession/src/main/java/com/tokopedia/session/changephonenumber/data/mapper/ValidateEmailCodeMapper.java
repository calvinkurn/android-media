...
import com.tokopedia.session.changephonenumber.data.model.ValidateEmailCodeData;
...
public class ValidateEmailCodeMapper implements Func1<Response<TkpdResponse>, Boolean> {
    @Inject
    public ValidateEmailCodeMapper() {
    }
