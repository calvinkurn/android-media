...
public class MitraAppBaseUrl {
    ...
    public static final String BASE_WEB_DOMAIN = "https://www.staging.tokopedia.com/";
    ...
    public static final String UPDATE_INACTIVE_PHONE_IMAGE_UPLOAD = "https://up-staging.tokopedia.net/";
