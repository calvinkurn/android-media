...
public class FingerprintModelGenerator {
    ...
    public static FingerprintModel generateFingerprintModel(Context context) {
        ...
        fingerprintModel.setRegistrarionId("");
    ...
    private static String getGoogleAdId(final Context context) {
        LocalCacheHandler localCacheHandler = new LocalCacheHandler(context, ConstactsFingerprint.ADVERTISINGID);

        String adsId = localCacheHandler.getString(ConstactsFingerprint.Key.KEY_ADVERTISINGID);
        if (adsId != null && !TextUtils.isEmpty(adsId.trim())) {
            ...
            if (adInfo != null) {
                ...
                if (!TextUtils.isEmpty(adID)) {
                    localCacheHandler.putString(ConstactsFingerprint.Key.KEY_ADVERTISINGID, adID);
