...
class OldMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.old_main_testapp)
        ...
        loginButton.setOnClickListener {
            ...
            if (userSession.isLoggedIn) {
                Toast.makeText(this@OldMainActivity, "already login", Toast.LENGTH_LONG).show()
                goTo()
                ...
                DataSource.getLoginService(application as MyApplication).getToken(hashMapOf(
                        ...
                        .subscribe(object : Observer<Boolean> {
                            override fun onError(e: Throwable?) {
                                Toast.makeText(this@OldMainActivity, e?.message, Toast.LENGTH_LONG).show()
                            }

                            override fun onNext(t: Boolean?) {
                                Toast.makeText(this@OldMainActivity, "success login", Toast.LENGTH_LONG).show()
                                goTo()
                            }
