...
keys_arrary = ["JeyuQt7BvAPMu9TQNy8C2uSMVqY3Qcsf", "6q4OXCyMdyCExeU4U0DZDeuhCisONRY2", "juzKWsnIlZpUbm3u6kkqVDqIea0qp7M4", "jdrBmFSpiJc61hT9Nfjxo7YJNiughkxz", "croZ0IpdQKmcVGtuL6gUHA4Bv7xtpP3o", "Bp6732SLBFyWL3ornF2yNJ5RGKc4XX4h"]
...
Dir.glob('**/*.png') do |file|
	...
	if (files_count - count) < 264
		...
		request.basic_auth("api", keys_arrary[count/500])
