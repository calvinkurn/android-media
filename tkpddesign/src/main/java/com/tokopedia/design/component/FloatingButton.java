...
public class FloatingButton extends BaseCustomView {
    ...
    private LayerDrawable createShadow() {
        ...
        shapeDrawable1.getPaint().setColor(ContextCompat.getColor(getContext(), com.tokopedia.unifyprinciples.R.color.shadow_dms_1));

        ShapeDrawable shapeDrawable2 = new ShapeDrawable();
        shapeDrawable2.setPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        shapeDrawable2.getPaint().setColor(ContextCompat.getColor(getContext(), com.tokopedia.unifyprinciples.R.color.shadow_dms_2));

        ShapeDrawable shapeDrawable3 = new ShapeDrawable();
        shapeDrawable3.setPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        shapeDrawable3.getPaint().setColor(ContextCompat.getColor(getContext(), com.tokopedia.unifyprinciples.R.color.shadow_dms_3));
        ...
        shapeDrawable4.getPaint().setColor(ContextCompat.getColor(getContext(), com.tokopedia.unifyprinciples.R.color.shadow_dms_4));

        ShapeDrawable shapeDrawable5 = new ShapeDrawable();
        shapeDrawable5.setPadding(1, 1, 1,1);
        shapeDrawable5.getPaint().setColor(ContextCompat.getColor(getContext(), com.tokopedia.unifyprinciples.R.color.shadow_dms_5));
