...
public class Tabs extends TabLayout {
    ...
    private void mainStyle() {
        int white = ContextCompat.getColor(getContext(), com.tokopedia.unifyprinciples.R.color.Unify_N0);
    ...
    private void secondaryStyle() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            this.setElevation(10);
            this.setBackgroundResource(com.tokopedia.unifyprinciples.R.color.Unify_N0);
        } else {
