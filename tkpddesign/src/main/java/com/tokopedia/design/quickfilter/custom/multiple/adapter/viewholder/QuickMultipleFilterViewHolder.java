...
public class QuickMultipleFilterViewHolder extends BaseMultipleQuickFilterViewHolder {
    ...
    public QuickMultipleFilterViewHolder(View itemView, Context context, QuickMultipleItemListener listener) {
    ...
    public void renderItemViewHolder(final QuickMultipleFilterItem filterItem) {
